...
public class TestFileBasedSystemAccessControl
{
    ...
    {
        String rulesFile = new File("../trino-docs/src/main/sphinx/security/query-access.json").getAbsolutePath();
    ...
    {
        String rulesFile = new File("../trino-docs/src/main/sphinx/security/system-information-access.json").getAbsolutePath();
        SystemAccessControl accessControlManager = newFileBasedSystemAccessControl(ImmutableMap.of("security.config-file", rulesFile));
    ...
    {
        String rulesFile = new File("../trino-docs/src/main/sphinx/security/session-property-access.json").getAbsolutePath();
