        ...
        implements Runnable
{
    ...
    private Map<String, KinesisStreamDescription> internalMap = Collections.synchronizedMap(new HashMap<String, KinesisStreamDescription>());
    ...
    {
        //TODO: fi required make the update interval configurable
    ...
    protected void updateTablesFromS3()
    {
        ...
        for (S3ObjectSummary summary : summaries) {
            if (!this.internalMap.containsKey(summary.getKey()) || summary.getLastModified().getTime() >= this.lastCheck) {
                ...
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(object.getObjectContent()))) {
                    ...
                    internalMap.put(summary.getKey(), table);
