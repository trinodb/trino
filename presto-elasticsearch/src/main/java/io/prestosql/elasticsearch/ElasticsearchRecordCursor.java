        ...
        implements RecordCursor
{
    ...
    public ElasticsearchRecordCursor(ElasticsearchClient client, List<ElasticsearchColumnHandle> columns, ElasticsearchConfig config, ElasticsearchSplit split, ElasticsearchTableHandle table)
    {
