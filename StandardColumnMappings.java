...
public final class StandardColumnMappings
{
    ...
    public static Optional<ColumnMapping> jdbcTypeToPrestoType(JdbcTypeHandle typeHandle)
    {
        switch (typeHandle.getJdbcType()) {
            ...
            case Types.NUMERIC:
            case Types.DECIMAL:
                int decimalDigits = typeHandle.getDecimalDigits().isEmpty() ? 0 : typeHandle.getRequiredDecimalDigits();
            ...
            case Types.CHAR:
            case Types.NCHAR:
                return Optional.of(defaultCharColumnMapping((typeHandle.getColumnSize().isEmpty()) ? Integer.MAX_VALUE : typeHandle.getRequiredColumnSize()));

            case Types.VARCHAR:
            case Types.NVARCHAR:
            case Types.LONGVARCHAR:
            case Types.LONGNVARCHAR:
                return Optional.of(defaultVarcharColumnMapping((typeHandle.getColumnSize().isEmpty()) ? Integer.MAX_VALUE : typeHandle.getRequiredColumnSize()));
                //firebird has BLOB SUB_TYPE TEXT type with column_size null
