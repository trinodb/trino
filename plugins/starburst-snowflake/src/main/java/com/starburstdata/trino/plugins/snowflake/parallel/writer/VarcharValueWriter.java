...
public class VarcharValueWriter
        implements BlockWriter
{
    ...
    public VarcharValueWriter(ArrowVectorConverter converter, int rowCount, Type type)
    {
            ...
            throws SFException
    {
        for (int row = 0; row < rowCount; row++) {
            if (converter.isNull(row)) {
                ...
                type.writeSlice(output, utf8Slice(converter.toString(row)));
            }
        }
    }
}
