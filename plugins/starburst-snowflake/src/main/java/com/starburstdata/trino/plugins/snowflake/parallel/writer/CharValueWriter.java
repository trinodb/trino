        ...
        implements BlockWriter
{
    ...
    public CharValueWriter(ArrowVectorConverter converter, int rowCount, Type type)
    {
            ...
            throws SFException
    {
        for (int row = 0; row < rowCount; row++) {
            if (converter.isNull(row)) {
                ...
                String stringValue = converter.toString(row);
                type.writeSlice(output, utf8Slice(CharMatcher.is(' ').trimTrailingFrom(stringValue)));
            }
        }
    }
}
