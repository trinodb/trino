...
import io.trino.plugin.oracle.TestView;
...
public abstract class BaseOracleIntegrationSmokeTest
        // TODO remove and make subclasses extend BaseOracleConnectorTest
        extends AbstractTestIntegrationSmokeTest
{
    ...
    {
        try (io.trino.plugin.oracle.TestView view = new TestView(onOracle(), getUser() + ".test_view", "AS SELECT 'O' as status FROM dual")) {
    ...
    {
        try (io.trino.plugin.oracle.TestSynonym synonym = new TestSynonym(onOracle(), getUser() + ".test_synonym", "FOR ORDERS")) {
