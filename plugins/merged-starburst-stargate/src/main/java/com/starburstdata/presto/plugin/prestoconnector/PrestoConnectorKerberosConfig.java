...
public class PrestoConnectorKerberosConfig
{
    ...
    public PrestoConnectorKerberosConfig setClientPrincipal(String clientPrincipal)
    {
    ...
    public PrestoConnectorKerberosConfig setClientKeytabFile(File clientKeytabFile)
    {
    ...
    public PrestoConnectorKerberosConfig setConfigFile(File configFile)
    {
    ...
    public PrestoConnectorKerberosConfig setServiceName(String serviceName)
    {
    ...
    public PrestoConnectorKerberosConfig setServicePrincipalPattern(String servicePrincipalPattern)
    {
    ...
    public PrestoConnectorKerberosConfig setServiceUseCanonicalHostname(boolean serviceUseCanonicalHostname)
    {
