...
public class StarburstRemoteImpersonatingCredentialPropertiesProvider
        implements CredentialPropertiesProvider
{
    private final CredentialProvider credentialProvider;
    private final AuthToLocal authToLocal;

    public StarburstRemoteImpersonatingCredentialPropertiesProvider(CredentialProvider credentialProvider, AuthToLocal authToLocal)
    {
