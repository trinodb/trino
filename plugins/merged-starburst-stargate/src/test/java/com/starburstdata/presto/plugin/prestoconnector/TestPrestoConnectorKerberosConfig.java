...
public class TestPrestoConnectorKerberosConfig
{
    @Test
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(PrestoConnectorKerberosConfig.class)
            ...
            throws IOException
    {
        ...
        PrestoConnectorKerberosConfig expected = new PrestoConnectorKerberosConfig()
