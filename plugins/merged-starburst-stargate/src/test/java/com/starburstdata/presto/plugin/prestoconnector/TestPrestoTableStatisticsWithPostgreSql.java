        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testNumericCornerCasesFromPresto()
    {
        try (TestTable table = fromColumns(
                // TODO(https://starburstdata.atlassian.net/browse/PRESTO-4832) we cannot use getQueryRunner()::execute due to current Presto connector write limitations
                this::executeInRemotePresto,
