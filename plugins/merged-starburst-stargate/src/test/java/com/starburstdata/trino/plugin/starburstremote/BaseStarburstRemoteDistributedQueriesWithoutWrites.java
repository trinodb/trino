...
public abstract class BaseStarburstRemoteDistributedQueriesWithoutWrites
        extends BaseStarburstRemoteDistributedQueries
{
    ...
    {
        // This is covered by TestStarburstRemoteDistributedQueriesWritesEnabled.testDataMappingSmokeTest
