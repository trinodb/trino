...
public class TestStarburstRemoteKerberosConfig
{
    @Test
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(StarburstRemoteKerberosConfig.class)
            ...
            throws IOException
    {
        ...
        StarburstRemoteKerberosConfig expected = new StarburstRemoteKerberosConfig()
