...
public class StarburstRemoteSslConfig
{
    ...
    public StarburstRemoteSslConfig setTruststoreFile(File truststoreFile)
    {
    ...
    public StarburstRemoteSslConfig setTruststorePassword(String truststorePassword)
    {
    ...
    public StarburstRemoteSslConfig setTruststoreType(String truststoreType)
    {
