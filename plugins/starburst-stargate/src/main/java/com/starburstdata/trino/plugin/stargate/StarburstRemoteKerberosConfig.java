...
public class StarburstRemoteKerberosConfig
{
    ...
    public StarburstRemoteKerberosConfig setClientPrincipal(String clientPrincipal)
    {
    ...
    public StarburstRemoteKerberosConfig setClientKeytabFile(File clientKeytabFile)
    {
    ...
    public StarburstRemoteKerberosConfig setConfigFile(File configFile)
    {
    ...
    public StarburstRemoteKerberosConfig setServiceName(String serviceName)
    {
    ...
    public StarburstRemoteKerberosConfig setServicePrincipalPattern(String servicePrincipalPattern)
    {
    ...
    public StarburstRemoteKerberosConfig setServiceUseCanonicalHostname(boolean serviceUseCanonicalHostname)
    {
