...
public enum PropertyName
{
    ...
    EXTERNAL_AUTHENTICATION_CLIENT_ID("externalAuthenticationClientId"),
    EXTERNAL_AUTHENTICATION_CLIENT_SECRET("externalAuthenticationClientSecret"),
    EXTERNAL_AUTHENTICATION_ISSUER("externalAuthenticationIssuer"),
    EXTERNAL_AUTHENTICATION_SCOPES("externalAuthenticationScopes"),
