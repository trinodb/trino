...
public class SourceBuilder
{
    ...
    public static String createSource(String product)
    {
        return createSource(product, getProductVersion());
    }

    public static String createSource(String product, String version)
    {
        return createSource(product, version, ImmutableMap.of());
    }

    public static String createSource(String product, Map<String, String> metadata)
    {
        return createSource(product, getProductVersion(), metadata);
    }

    public static String createSource(String product, String version, Map<String, String> metadata)
    {
