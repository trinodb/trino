...
class MaterializingReaderTest
{
    @Test
    void testBufferInitialCharsWithBufferFull()
            throws IOException
    {
        ...
        assertThat(reader.getInitalString()).isEqualTo("abcd");
    }

    @Test
    void testBufferInitialCharsWithBufferNotFullyUsed()
            throws IOException
    {
        ...
        reader.transferTo(new StringWriter()); // Trigger reading
        assertThat(reader.getInitalString()).isEqualTo("abcdabc");
    }
}
