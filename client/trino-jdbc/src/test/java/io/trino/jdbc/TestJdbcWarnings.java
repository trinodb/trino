...
public class TestJdbcWarnings
{
            ...
            throws SQLException
    {
        try (Connection connection = createConnection();
            ...
            assertThat((Iterable<? extends Throwable>) warning).isNotNull();
            ...
            assertThat((Iterable<? extends Throwable>) statement.getWarnings()).isNull();
        }
    }
            ...
            throws SQLException
    {
        try (Connection connection = createConnection();
            ...
            assertThat((Iterable<? extends Throwable>) statement.getConnection().getWarnings()).isNull();
    ...
    {
        assertThat((Iterable<? extends Throwable>) expected).isNotNull();
        assertThat((Iterable<? extends Throwable>) warning).isNotNull();
        while (true) {
