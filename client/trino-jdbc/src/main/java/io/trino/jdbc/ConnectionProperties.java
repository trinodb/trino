            ...
            extends AbstractConnectionProperty<String, SslVerificationMode>
    {
        ...
        static Validator<Properties> validateEnabled(PropertyName propertyName)
        {
            return validator(
                    ...
                    format("Connection property %s cannot be set if %s is %s", propertyName, PropertyName.SSL_VERIFICATION, SslVerificationMode.NONE));
        }
        ...
        static Validator<Properties> validateFull(PropertyName propertyName)
        {
            return validator(
                    ...
                    format("Connection property %s requires %s to be %s", propertyName, PropertyName.SSL_VERIFICATION, SslVerificationMode.FULL));
        }
        ...
        public SslVerification()
        {
            super(
                    ...
                    NOT_REQUIRED,
                    validator(IF_SSL_ENABLED, format("Connection property %s requires %s to be enabled", PropertyName.SSL_VERIFICATION, PropertyName.SSL)),
