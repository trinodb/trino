        ...
        implements ResultSet
{
    ...
    static final TypeConversions TYPE_CONVERSIONS =
            TypeConversions.builder()
                    ...
                    .add("timestamp", String.class, Instant.class, string -> parseTimestampAsInstant(string, SYSTEM_DEFAULT_ZONE_ID))
                    .add("timestamp", String.class, LocalDateTime.class, string -> parseTimestampAsLocalDateTime(string, SYSTEM_DEFAULT_ZONE_ID))
