        ...
        implements DatabaseMetaData
{
            ...
            throws SQLException
    {
        ...
        emptyStringEqualsFilter(filters, "TABLE_CAT", getCatalogFallback(catalog));
            ...
            throws SQLException
    {
        ...
        List<String> filters = new ArrayList<>();
        emptyStringEqualsFilter(filters, "TABLE_CATALOG", getCatalogFallback(catalog));
    ...
    private String getCatalogFallback(String catalog)
            throws SQLException
    {
