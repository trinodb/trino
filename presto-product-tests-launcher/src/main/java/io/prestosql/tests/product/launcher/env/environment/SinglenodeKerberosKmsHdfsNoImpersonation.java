        ...
        extends AbstractEnvironmentProvider
{
    ...
    @Inject
    public SinglenodeKerberosKmsHdfsNoImpersonation(DockerFiles dockerFiles, Standard standard, Hadoop hadoop, Kerberos kerberos, EnvironmentOptions environmentOptions)
    {
    ...
    protected void extendEnvironment(Environment.Builder builder)
    {
        ...
        builder.configureContainer("hadoop-master", container -> {
            ...
            container
                    .withFileSystemBind(
                            dockerFiles.getDockerFilesHostPath("conf/environment/singlenode-kerberos-kms-hdfs-no-impersonation/kms-core-site.xml"),
