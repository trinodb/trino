        ...
        extends EnvironmentProvider
{
            ...
            @Debug boolean debug)
    {
        ...
        this.javaHome = format("/usr/lib/jvm/zulu-%s", config.getPrestoJavaVersion());
    ...
    {
        return createPrestoContainer(dockerFiles, serverPackage, debug, javaHome, prestoDockerImageName, workerName)
