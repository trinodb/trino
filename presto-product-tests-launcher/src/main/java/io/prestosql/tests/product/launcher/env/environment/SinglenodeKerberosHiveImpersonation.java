...
@TestsEnvironment
public final class SinglenodeKerberosHiveImpersonation
        extends EnvironmentProvider
{
    private final DockerFiles dockerFiles;

    @Inject
    public SinglenodeKerberosHiveImpersonation(DockerFiles dockerFiles, Standard standard, Hadoop hadoop, HadoopKerberos hadoopKerberos)
    {
