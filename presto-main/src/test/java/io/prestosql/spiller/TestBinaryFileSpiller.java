...
public class TestBinaryFileSpiller
{
    ...
    public void setUp()
    {
        ...
        singleStreamSpillerFactory = new FileSingleStreamSpillerFactory(metadata, spillerStats, new ServerConfig(), new NodeSchedulerConfig(), featuresConfig, nodeSpillConfig);
