...
public class BenchmarkPageProcessor
{
    ...
    public void setup()
    {
        ...
        RowExpression filterExpression = createFilterExpression(metadata.getFunctionManager());
        RowExpression projectExpression = createProjectExpression(metadata.getFunctionManager());
    ...
    //    and discount <= 0.07
    //    and quantity < 24;
    private static RowExpression createFilterExpression(FunctionManager functionManager)
    {
    ...
    private static RowExpression createProjectExpression(FunctionManager functionManager)
    {
