...
public class TestMinMaxByAggregation
{
        ...
        for (Type keyType : orderableTypes) {
            for (Type valueType : getTypes()) {
                if (StateCompiler.getSupportedFieldTypes().contains(valueType.getJavaType())) {
                    assertNotNull(getInternalAggregationFunction("min_by", valueType, keyType));
                    assertNotNull(getInternalAggregationFunction("max_by", valueType, keyType));
                }
            }
        }
    }
    ...
    {
        InternalAggregationFunction unknownKey = getInternalAggregationFunction("min_by", UNKNOWN, DOUBLE);
        assertAggregation(
                unknownKey,
                null,
    ...
    {
        InternalAggregationFunction unknownKey = getInternalAggregationFunction("max_by", UNKNOWN, DOUBLE);
        assertAggregation(
                unknownKey,
                null,
                createBooleansBlock(null, null),
                createDoublesBlock(1.0, 2.0));
        InternalAggregationFunction unknownValue = getInternalAggregationFunction("max_by", DOUBLE, UNKNOWN);
        assertAggregation(
                unknownKey,
                null,
                createDoublesBlock(1.0, 2.0),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", DOUBLE, DOUBLE);
        assertAggregation(
                function,
                1.0,
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", DOUBLE, DOUBLE);
        assertAggregation(
                function,
                null,
                createDoublesBlock(1.0, null),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, DOUBLE);
        assertAggregation(
                function,
                "z",
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, DOUBLE);
        assertAggregation(
                function,
                "a",
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), BIGINT);
        assertAggregation(
                function,
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", BIGINT, new ArrayType(BIGINT));
        assertAggregation(
                function,
                3L,
                createLongsBlock(1L, 2L, 2L, 3L),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", BIGINT, new ArrayType(BIGINT));
        assertAggregation(
                function,
                1L,
                createLongsBlock(1L, 2L, 2L, 3L),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), BIGINT);
        assertAggregation(
                function,
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", createDecimalType(19, 1), createDecimalType(19, 1));
        assertAggregation(
                function,
                SqlDecimal.of("2.2"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", createDecimalType(19, 1), createDecimalType(19, 1));
        assertAggregation(
                function,
                SqlDecimal.of("3.3"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", createDecimalType(10, 1), createDecimalType(10, 1));
        assertAggregation(
                function,
                SqlDecimal.of("2.2"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", createDecimalType(10, 1), createDecimalType(10, 1));
        assertAggregation(
                function,
                SqlDecimal.of("3.3"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, BOOLEAN);
        assertAggregation(
                function,
                "b",
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, BOOLEAN);
        assertAggregation(
                function,
                "c",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, INTEGER);
        assertAggregation(
                function,
                "a",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, INTEGER);
        assertAggregation(
                function,
                "c",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), BOOLEAN);
        assertAggregation(
                function,
                null,
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), BOOLEAN);
        assertAggregation(
                function,
                asList(2L, 2L),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, BIGINT);
        assertAggregation(
                function,
                "a",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, BIGINT);
        assertAggregation(
                function,
                "c",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), DOUBLE);
        assertAggregation(
                function,
                asList(3L, 4L),
                createArrayBigintBlock(asList(asList(3L, 4L), null, asList(2L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), DOUBLE);
        assertAggregation(
                function,
                null,
                createArrayBigintBlock(asList(asList(3L, 4L), null, asList(2L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), VARCHAR);
        assertAggregation(
                function,
                asList(3L, 4L),
                createArrayBigintBlock(asList(asList(3L, 4L), null, asList(2L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), VARCHAR);
        assertAggregation(
                function,
                asList(2L, 2L),
                createArrayBigintBlock(asList(asList(3L, 4L), null, asList(2L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), new ArrayType(BIGINT));
        assertAggregation(
                function,
                asList(1L, 2L),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), new ArrayType(BIGINT));
        assertAggregation(
                function,
                asList(3L, 3L),
                createArrayBigintBlock(asList(asList(3L, 3L), null, asList(1L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, new ArrayType(BIGINT));
        assertAggregation(
                function,
                "c",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, new ArrayType(BIGINT));
        assertAggregation(
                function,
                "a",
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", VARCHAR, UNKNOWN);
        assertAggregation(
                function,
                null,
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", VARCHAR, UNKNOWN);
        assertAggregation(
                function,
                null,
                createStringsBlock("a", "b", "c"),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("min_by", new ArrayType(BIGINT), UNKNOWN);
        assertAggregation(
                function,
                null,
                createArrayBigintBlock(asList(asList(3L, 3L), null, asList(1L, 2L))),
    ...
    {
        InternalAggregationFunction function = getInternalAggregationFunction("max_by", new ArrayType(BIGINT), UNKNOWN);
        assertAggregation(
                function,
                null,
                createArrayBigintBlock(asList(asList(3L, 3L), null, asList(1L, 2L))),
