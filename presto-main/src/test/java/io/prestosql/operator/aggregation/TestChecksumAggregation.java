...
public class TestChecksumAggregation
{
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(BOOLEAN));
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(BIGINT));
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(DOUBLE));
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(VARCHAR));
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(createDecimalType(10, 2)));
    ...
    {
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(createDecimalType(19, 2)));
        InternalAggregationFunction decimalAgg = functionManager.getAggregateFunctionImplementation(functionHandle);
    ...
    public void testArray()
    {
        ...
        FunctionHandle functionHandle = functionManager.lookupFunction(QualifiedName.of("checksum"), fromTypes(arrayType));
        InternalAggregationFunction stringAgg = functionManager.getAggregateFunctionImplementation(functionHandle);
