        ...
        extends SqlAggregationFunction
{
    ...
    private InternalAggregationFunction generateAggregation(Type valueType, Type keyType, FunctionManager functionManager)
    {
        ...
        MethodHandle compareMethod = functionManager.getScalarFunctionImplementation(functionManager.lookupOperator(operator, fromTypes(keyType, keyType))).getMethodHandle();
