...
import io.prestosql.operator.aggregation.state.GenericBooleanState;
import io.prestosql.operator.aggregation.state.GenericBooleanStateSerializer;
import io.prestosql.operator.aggregation.state.GenericDoubleState;
import io.prestosql.operator.aggregation.state.GenericDoubleStateSerializer;
import io.prestosql.operator.aggregation.state.GenericLongState;
import io.prestosql.operator.aggregation.state.GenericLongStateSerializer;
