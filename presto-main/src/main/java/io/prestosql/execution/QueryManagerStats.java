...
public class QueryManagerStats
{
    ...
    public void trackQueryStats(DispatchQuery managedQueryExecution)
    {
        ...
        managedQueryExecution.addStateChangeListener(new StatsQueryStateChangeListener(managedQueryExecution));
    }
    ...
    public void trackQueryStats(QueryExecution managedQueryExecution)
    {
        submittedQueries.update(1);
        queuedQueries.incrementAndGet();
        managedQueryExecution.addStateChangeListener(new StatsQueryStateChangeListener());
    ...
    private class StatsQueryStateChangeListener
            implements StateChangeListener<QueryState>
    {
        ...
        public StatsQueryStateChangeListener()
        {
            finalQueryInfoSupplier = Optional::empty;
        }

        public StatsQueryStateChangeListener(DispatchQuery managedQueryExecution)
        {
