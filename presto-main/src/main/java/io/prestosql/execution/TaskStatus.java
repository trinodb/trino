...
public class TaskStatus
{
    ...
    private final Map<DynamicFilterId, Long> dynamicFilterVersions;
    ...
    public TaskStatus(
            ...
            @JsonProperty("dynamicFilterVersions") Map<DynamicFilterId, Long> dynamicFilterVersions)
    {
        ...
        dynamicFilterVersions.values().forEach(dynamicFiltersVersion ->
                checkArgument(dynamicFiltersVersion >= INITIAL_DYNAMIC_FILTER_VERSION, "dynamicFiltersVersion must be >= INITIAL_DYNAMIC_FILTERS_VERSION"));
        this.dynamicFilterVersions = ImmutableMap.copyOf(requireNonNull(dynamicFilterVersions, "dynamicFilterVersions is null"));
    }
    ...
    public static TaskStatus failWith(TaskStatus taskStatus, TaskState state, List<ExecutionFailureInfo> exceptions)
    {
        return new TaskStatus(
                ...
                taskStatus.getDynamicFilterVersions());
    }
}
