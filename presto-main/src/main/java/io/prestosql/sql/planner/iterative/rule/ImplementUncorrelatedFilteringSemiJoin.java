 ...
 * </pre>
 */
public class ImplementUncorrelatedFilteringSemiJoin
        implements Rule<FilterNode>
{
    ...
    public Result apply(FilterNode filterNode, Captures captures, Context context)
    {
        ...
        FilterNode result = new FilterNode(
                filterNode.getId(),
                projectTrue(innerJoin, semiJoinSymbol, context.getIdAllocator()),
                filteredPredicate);
    ...
    private static PlanNode projectTrue(PlanNode node, Symbol alwaysTrueSymbol, PlanNodeIdAllocator idAllocator)
    {
        return new ProjectNode(
                idAllocator.getNextId(),
                node,
                Assignments.builder()
                        .putIdentities(node.getOutputSymbols())
