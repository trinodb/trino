...
public class PushAggregationIntoTableScanWithoutGroupingSets
        implements Rule<AggregationNode>
{
    ...
    {
        final List<List<Symbol>> groupBySymbols = List.of(node.getGroupingSets().getGroupingKeys());
        final Map<Symbol, Symbol> groupingSetSymbolMapping = node.getGroupingSets().getGroupingKeys().stream()
