            ...
            extends SimplePlanRewriter<Context>
    {
        ...
        private WriterTarget createWriterTarget(WriterTarget target)
        {
            ...
            if (target instanceof InsertReference) {
                ...
                return new InsertTarget(metadata.beginInsert(session, insert.getHandle(), insert.getColumnsToBeInserted()), metadata.getTableMetadata(session, insert.getHandle()).getTable());
            }
