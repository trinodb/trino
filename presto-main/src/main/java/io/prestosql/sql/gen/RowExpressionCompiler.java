...
public class RowExpressionCompiler
{
            ...
            implements RowExpressionVisitor<BytecodeNode, Context>
    {
        ...
        public BytecodeNode visitCall(CallExpression call, Context context)
        {
            ...
            checkArgument(!context.getOutputBlockVariable().isPresent(), "call expression does not support writing to block");
        ...
        {
            // TODO: support write to output block
            checkArgument(!context.getOutputBlockVariable().isPresent(), "constant expression does not support writing to block");
        ...
        {
            // TODO: support write to output block
            checkArgument(!context.getOutputBlockVariable().isPresent(), "input reference expression does not support writing to block");
