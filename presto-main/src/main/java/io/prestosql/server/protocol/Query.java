...
class Query
{
    ...
    private static StatementStats toStatementStats(QueryInfo queryInfo)
    {
        ...
        return StatementStats.builder()
                ...
                .setProcessedRows(queryStats.getPhysicalInputPositions() + queryStats.getInternalNetworkInputPositions())
    ...
    private static StageStats toStageStats(StageInfo stageInfo)
    {
        ...
        return StageStats.builder()
                ...
                .setProcessedRows(stageStats.getPhysicalInputPositions() + stageStats.getInternalNetworkInputPositions())
