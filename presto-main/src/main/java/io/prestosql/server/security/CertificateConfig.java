...
public class CertificateConfig
{
    ...
    @Config("http-server.authentication.certificate.user-extraction.pattern")
    public CertificateConfig setUserExtractionPattern(String userExtractionPattern)
    {
    ...
    @Config("http-server.authentication.certificate.user-extraction.file")
    public CertificateConfig setUserExtractionFile(File userExtractionFile)
    {
