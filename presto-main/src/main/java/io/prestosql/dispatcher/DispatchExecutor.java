...
public class DispatchExecutor
{
    ...
    public DispatchExecutor(QueryManagerConfig config)
    {
        ...
        ScheduledExecutorService coreScheduledExecutor = newScheduledThreadPool(config.getQueryManagerExecutorPoolSize(), daemonThreadsNamed("dispatcher-management-%s"));
