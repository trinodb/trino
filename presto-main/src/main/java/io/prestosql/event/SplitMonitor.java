            ...
            eventListenerManager.splitCompleted(
                    new SplitCompletedEvent(
                            ...
                            new SplitStatistics(
                                    ...
                                    elapsedTime,
                                    queuedTime,
                                    ofMillis(driverStats.getPhysicalInputReadTime().toMillis()),
                                    driverStats.getProcessedInputPositions(),
                                    driverStats.getPhysicalInputDataSize().toBytes() + driverStats.getInternalNetworkInputDataSize().toBytes(),
