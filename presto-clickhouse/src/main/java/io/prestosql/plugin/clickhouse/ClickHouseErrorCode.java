...
{
    CLICKHOUSE_INTERNAL_ERROR(0, INTERNAL_ERROR),
    CLICKHOUSE_QUERY_ERROR(1, EXTERNAL),
    CLICKHOUSE_CONFIG_ERROR(2, INTERNAL_ERROR),
    CLICKHOUSE_METADATA_ERROR(3, EXTERNAL),
    CLICKHOUSE_SPLIT_ERROR(4, EXTERNAL);
