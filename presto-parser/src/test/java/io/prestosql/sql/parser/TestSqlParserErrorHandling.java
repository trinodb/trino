    ...
    public Object[][] getStatements()
    {
        return new Object[][] {
                ...
                {"select CAST(-12223222232535343423232435343 AS BIGINT)",
                        "line 1:1: Invalid numeric literal: -12223222232535343423232435343"},
                {"select foo.!",
                        "line 1:12: mismatched input '!'. Expecting: '*', <expression>, <identifier>"},
                {"select foo(,1)",
                ...
                {"CREATE TABLE ) AS (VALUES 1)",
                        "line 1:14: mismatched input ')'. Expecting: 'OR', 'ROLE', 'SCHEMA', 'TABLE', 'VIEW'"},
                {"CREATE TABLE foo ",
                        "line 1:18: mismatched input '<EOF>'. Expecting: 'OR', 'ROLE', 'SCHEMA', 'TABLE', 'VIEW'"},
