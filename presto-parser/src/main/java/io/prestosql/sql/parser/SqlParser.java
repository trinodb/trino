...
public class SqlParser
{
    ...
    private static final BiConsumer<SqlBaseLexer, SqlBaseParser> DEFAULT_BASE_PARSER_INITIALIZER = (SqlBaseLexer lexer, SqlBaseParser parser) -> {};
    ...
    private final BiConsumer<SqlBaseLexer, SqlBaseParser> sqlBaseParserInitializer;
    ...
    {
        this(options, DEFAULT_BASE_PARSER_INITIALIZER);
    }

    public SqlParser(SqlParserOptions options, BiConsumer<SqlBaseLexer, SqlBaseParser> sqlBaseParserInitializer)
    {
        this.sqlBaseParserInitializer = requireNonNull(sqlBaseParserInitializer, "sqlBaseParserInitializer is null");
    ...
    private Node invokeParser(String name, String sql, Function<SqlBaseParser, ParserRuleContext> parseFunction, ParsingOptions parsingOptions)
    {
        try {
            ...
            sqlBaseParserInitializer.accept(lexer, parser);
