        ...
        implements WarningCodeSupplier
{
    ...
    USER_MEMORY_LIMIT_OVER_THRESHOLD_VAL(0x0000_0103),
    TOTAL_MEMORY_LIMIT_OVER_THRESHOLD_VAL(0x0000_0104),
    TOTAL_CPU_TIME_OVER_THRESHOLD_VAL(0x0000_0105),
    STAGE_SKEW(0x0000_0106),
    BETTER_JOIN_ORDERING(0x0000_0107)
