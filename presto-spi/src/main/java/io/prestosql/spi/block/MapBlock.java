...
import static io.prestosql.spi.block.MapBlockBuilder.verify;
        ...
        extends AbstractMapBlock
{
            ...
            MapType mapType)
    {
        ...
        return createMapBlockInternal(
                ...
                keyBlock,
                valueBlock,
                new HashTables(Optional.empty(), offsets.length - 1, keyBlock.getPositionCount() * HASH_MULTIPLIER));
    }
            ...
            HashTables hashTables)
    {
        ...
        this.retainedSizeInBytes = INSTANCE_SIZE + sizeOf(offsets) + sizeOf(mapIsNull) + hashTables.getRetainedSizeInBytes();
    }
    ...
    public long getSizeInBytes()
    {
        ...
        return baseSizeInBytes + keySizeInBytes + valueSizeInBytes + hashTables.getInstanceSizeInBytes();   // TODO mjung
    }
