...
public final class TestGroups
{
    ...
    public static final String HIVE4_HTTP_THRIFT_METASTORE = "hive4_http_thrift_metastore";
    public static final String HIVE4_HTTPS_THRIFT_METASTORE = "hive4_https_thrift_metastore";
