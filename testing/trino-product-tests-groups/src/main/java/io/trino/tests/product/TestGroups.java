...
public final class TestGroups
{
    ...
    public static final String DELTA_LAKE_DATABRICKS_173 = "delta-lake-databricks-173";
    // TODO: Remove it once we support generatedColumns, particularly for writes in Delta Lake
    public static final String DELTA_LAKE_EXCLUDE_143 = "delta-lake-exclude-143";
    public static final String DELTA_LAKE_EXCLUDE_182 = "delta-lake-exclude-182";
