...
import io.trino.plugin.iceberg.BaseIcebergParquetConnectorCoverage;
...
public class TestIcebergParquetFaultTolerantExecutionConnectorCoverage
        extends BaseIcebergParquetConnectorCoverage
{
    private MinioStorage minioStorage;

    public TestIcebergParquetFaultTolerantExecutionConnectorCoverage()
    {
        super(2);
    }
