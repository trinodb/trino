...
{
    @Test
    void testReadFromTableRestoredToPreviousVersion(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testSelectForVersionAsOf(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testSelectForTemporalAsOf(DeltaLakeOssEnvironment env)
            throws InterruptedException
    {
        ...
        try {
            ...
            // S3-compatible stores may expose modification times with one-second precision.
            SECONDS.sleep(1);
            env.executeSparkUpdate("ALTER TABLE default." + tableName + " ADD COLUMN new_column INT");
