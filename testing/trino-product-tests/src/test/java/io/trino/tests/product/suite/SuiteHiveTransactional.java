...
import io.trino.tests.product.hive.HiveTransactionalEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteHiveTransactional
{
    private SuiteHiveTransactional() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(HiveTransactionalEnvironment.class)
                .includeTag(TestGroup.HiveTransactional.class)
                .run());
