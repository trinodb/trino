...
@ProductTest
abstract class BaseTestDeltaLakeFlociReadsJunit
{
    ...
    @BeforeEach
    void setUp(DeltaLakeFlociEnvironment env)
    {
        env.copyResources(regionResourcePath(), tableName());
    }

    @Test
    @TestGroup.DeltaLakeFloci
    @TestGroup.ProfileSpecificTests
    void testReadRegionTable(DeltaLakeFlociEnvironment env)
    {
        try {
