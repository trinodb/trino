...
import io.trino.tests.product.ranger.RangerEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteRanger
{
    private SuiteRanger() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(RangerEnvironment.class)
                .includeTag(TestGroup.ConfiguredFeatures.class)
                .includeTag(TestGroup.Ranger.class)
                .run());
