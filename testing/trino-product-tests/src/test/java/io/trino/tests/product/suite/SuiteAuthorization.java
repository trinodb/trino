...
import io.trino.tests.product.hive.HiveKerberosImpersonationEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteAuthorization
{
    private SuiteAuthorization() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(HiveKerberosImpersonationEnvironment.class)
                .includeTag(TestGroup.Authorization.class)
                .run());
