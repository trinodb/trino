...
import io.trino.tests.product.AllConnectorsSmokeEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteAllConnectorsSmoke
{
    private SuiteAllConnectorsSmoke() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(AllConnectorsSmokeEnvironment.class)
                .includeTag(SuiteTag.AllConnectorsSmoke.class)
                .run());
