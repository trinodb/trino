...
class TestAvroSchemaUrl
{
    ...
    private static final String LOCAL_SCHEMA_PATH = "/tmp/TestAvroSchemaUrl-original_schema.avsc";
            ...
            throws IOException
    {
        ...
        env.copyFileToContainers(LOCAL_SCHEMA_PATH, ORIGINAL_SCHEMA);
    }
    ...
    void testAvroSchemaUrlInSerdeProperties(HiveStorageFormatsEnvironment env)
    {
        ...
        env.executeHiveUpdate(
                ...
                INPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerInputFormat'
                OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerOutputFormat'
                """.formatted(schemaLocationOnHdfs));
            ...
            throws IOException
    {
        ...
        env.executeHiveUpdate(
                ...
                INPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerInputFormat'
                OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerOutputFormat'
                TBLPROPERTIES ('avro.schema.url'='%s/column_with_long_type_definition_schema.avsc')
                """.formatted(SCHEMAS_PATH));
    ...
    void testHiveCreatedCamelCaseColumnTable(HiveStorageFormatsEnvironment env)
    {
        ...
        env.executeHiveUpdate(
                ...
                INPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerInputFormat'
                OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.avro.AvroContainerOutputFormat'
                TBLPROPERTIES ('avro.schema.url'='%s/camelCaseSchema.avsc')
                """.formatted(SCHEMAS_PATH));
