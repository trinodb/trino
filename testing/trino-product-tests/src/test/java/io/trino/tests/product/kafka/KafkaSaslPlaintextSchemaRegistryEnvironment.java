...
public class KafkaSaslPlaintextSchemaRegistryEnvironment
        extends KafkaSchemaRegistryEnvironment
{
    @Override
    protected TestingKafka createKafka()
    {
        return TestingKafka.createSaslPlaintextWithSchemaRegistry();
    }
    ...
    protected Map<String, String> getKafkaCatalogProperties()
    {
        ...
        KafkaSaslPlaintextEnvironment.configureCatalog(properties);
        return properties;
    }
    ...
    {
        KafkaSaslPlaintextEnvironment.configureTrinoContainer(container);
    }
}
