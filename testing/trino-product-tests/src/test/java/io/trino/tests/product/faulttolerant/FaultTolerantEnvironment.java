        ...
        extends ProductTestEnvironment
{
    ...
    public void start()
    {
        ...
        floci.start();
        floci.createBucket(EXCHANGE_BUCKET);
        ...
        trinoCluster = MultiNodeTrinoCluster.builder()
                ...
                .withExchangeManager(Map.of(
                        ...
                        "exchange.s3.endpoint", "http://" + FLOCI_HOST_NAME + ":" + Floci.FLOCI_PORT + "/",
                        "exchange.s3.region", Floci.FLOCI_REGION,
                        "exchange.s3.aws-access-key", Floci.FLOCI_ACCESS_KEY,
                        "exchange.s3.aws-secret-key", Floci.FLOCI_SECRET_KEY,
