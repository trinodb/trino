 ...
 */
@ProductTest
@RequiresEnvironment(MultiNodeIcebergFlociCachingEnvironment.class)
@TestGroup.IcebergAlluxioCaching
class TestIcebergAlluxioCaching
{
    @Test
    void testConfiguredConnectors(MultiNodeIcebergFlociCachingEnvironment env)
    {
        assertDefaultConnectors(env, "iceberg");
    }

    @Test
    void testReadFromCache(MultiNodeIcebergFlociCachingEnvironment env)
    {
    ...
    private void testReadFromTable(MultiNodeIcebergFlociCachingEnvironment env, String bucketName, String tableNameSuffix)
    {
     ...
     */
    private void createTestTable(MultiNodeIcebergFlociCachingEnvironment env, String bucketName, String schemaName, String tableName)
    {
        env.executeTrinoUpdate("DROP TABLE IF EXISTS " + tableName);
        env.executeTrinoUpdate("DROP SCHEMA IF EXISTS iceberg." + schemaName);
    ...
    private CacheStats getCacheStats(MultiNodeIcebergFlociCachingEnvironment env)
    {
