...
import io.trino.tests.product.iceberg.SparkIcebergCompatibilityEnvironment;
...
public final class SuiteCompatibility
{
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(SparkIcebergCompatibilityEnvironment.class)
                .includeTag(TestGroup.IcebergFormatVersionCompatibility.class)
                .run());
