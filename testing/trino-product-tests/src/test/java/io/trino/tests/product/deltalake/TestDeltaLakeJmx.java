...
/**
 * Tests JMX tables exposed by Delta Lake connector.
 * <p>
 */
@ProductTest
@RequiresEnvironment(DeltaLakeMinioEnvironment.class)
@TestGroup.DeltaLakeMinio
class TestDeltaLakeJmx
{
    @Test
    void testJmxTablesExposedByDeltaLakeConnectorBackedByThriftMetastore(DeltaLakeMinioEnvironment env)
    {
