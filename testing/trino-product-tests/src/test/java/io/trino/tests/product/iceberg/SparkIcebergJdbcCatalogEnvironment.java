        ...
        extends SparkIcebergEnvironment
{
    ...
    private Connection sparkConnection;
    ...
    {
        if (sparkConnection != null) {
            try {
                sparkConnection.close();
            }
            catch (SQLException _) {
                // Continue closing the containers.
            }
            sparkConnection = null;
        }
        if (trino != null) {
            trino.close();
            trino = null;
    ...
    private Connection sparkConnection()
            throws SQLException
    {
        if (sparkConnection == null || sparkConnection.isClosed()) {
            sparkConnection = createSparkConnection();
        }
