...
/**
 * PostgreSQL product test environment with result spooling via Floci.
 * <p>
 * This environment provides:
 * <ul>
 *   <li>PostgreSQL 11 container (oldest supported version)</li>
 *   <li>Floci container for result spooling</li>
        ...
        extends PostgresqlEnvironment
{
    ...
    public void start()
    {
        ...
        floci.start();
        floci.createBucket(SPOOLING_BUCKET);
