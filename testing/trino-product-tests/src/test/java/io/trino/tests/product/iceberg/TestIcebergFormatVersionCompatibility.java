 ...
 */
@ProductTest
@RequiresEnvironment(CompatibilityEnvironment.class)
@TestGroup.Compatibility
@TestGroup.IcebergFormatVersionCompatibility
class TestIcebergFormatVersionCompatibility
{
    @Test
    void testTrinoTimeTravelReadTableCreatedByEarlyVersionTrino(CompatibilityEnvironment env)
    {
