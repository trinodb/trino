...
import io.trino.tests.product.hive.MultinodeHiveCachingEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteHiveAlluxioCaching
{
    private SuiteHiveAlluxioCaching() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(MultinodeHiveCachingEnvironment.class)
                .includeTag(TestGroup.HiveAlluxioCaching.class)
                .run());
