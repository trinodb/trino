...
/**
 * Tests Hive catalog view compatibility through current and compatibility Trino servers.
 */
@ProductTest
...
class TestHiveViewCompatibility
{
    ...
    @Test
    void testSelectOnViewFromDifferentSchema(CompatibilityEnvironment env)
    {
        prepareSourceTable(env);
        try {
    ...
    @Test
    void testExistingView(CompatibilityEnvironment env)
    {
        prepareSourceTable(env);
        try {
    ...
    @Test
    void testCommentOnViewColumn(CompatibilityEnvironment env)
    {
        prepareSourceTable(env);
        try {
     ...
     */
    private static void assertViewQuery(CompatibilityEnvironment env, String trinoQuery, Consumer<QueryResultAssert> assertion)
    {
    ...
    private static void prepareSourceTable(CompatibilityEnvironment env)
    {
        cleanupSourceTable(env);
    ...
    private static void cleanupSourceTable(CompatibilityEnvironment env)
    {
