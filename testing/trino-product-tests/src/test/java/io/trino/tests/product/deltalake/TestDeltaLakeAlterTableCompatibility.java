...
{
    @Test
    void testAddColumnWithCommentOnTrino(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testRenameColumn(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testRenamePartitionedColumn(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testDropNotNullConstraint(DeltaLakeOssEnvironment env)
    {
    ...
    private void testDropNotNullConstraint(String columnMappingMode, DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testCommentOnTable(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testCommentOnColumn(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoPreservesReaderAndWriterVersions(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoPreservesTableFeature(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTypeWideningInteger(DeltaLakeOssEnvironment env)
    {
    ...
    private String getColumnCommentOnTrino(DeltaLakeOssEnvironment env, String schemaName, String tableName, String columnName)
    {
    ...
    private String getColumnCommentOnSpark(DeltaLakeOssEnvironment env, String schemaName, String tableName, String columnName)
    {
        return (String) env.executeSpark(format("DESCRIBE %s.%s %s", schemaName, tableName, columnName))
                .rows().get(2).get(1);
    }

    private String getTableCommentOnTrino(DeltaLakeOssEnvironment env, String schemaName, String tableName)
    {
    ...
    private String getTableCommentOnSpark(DeltaLakeOssEnvironment env, String schemaName, String tableName)
    {
    ...
    private String getTablePropertyOnSpark(DeltaLakeOssEnvironment env, String schemaName, String tableName, String propertyName)
    {
