...
class TestDeltaLakeGcs
{
    ...
    {
        verifyCreateAndSelectNationTable(env, "delta");
    }

    @Test
    void testBasicWriteOperations(GcsEnvironment env)
    {
        verifyBasicWriteOperations(env, "delta");
    }

    @Test
    void testPathContainsSpecialCharacter(GcsEnvironment env)
    {
        verifyPathContainsSpecialCharacter(env, "delta", "partitioned_by", null);
    }

    @Test
    void testLocationContainsDiscouragedCharacter(GcsEnvironment env)
    {
        verifyLocationContainsDiscouragedCharacter(env, "delta");
    }
}
