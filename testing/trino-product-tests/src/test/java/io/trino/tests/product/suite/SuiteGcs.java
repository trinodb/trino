...
public final class SuiteGcs
{
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(GcsEnvironment.class)
                .includeTag(TestGroup.ConfiguredFeatures.class)
                .includeTag(TestGroup.DeltaLakeGcs.class)
                .run());

        results.add(SuiteRunner.forEnvironment(GcsEnvironment.class)
                .includeTag(TestGroup.ConfiguredFeatures.class)
                .includeTag(TestGroup.IcebergGcs.class)
                .run());

        results.add(SuiteRunner.forEnvironment(GcsEnvironment.class)
                .includeTag(TestGroup.ConfiguredFeatures.class)
                .includeTag(TestGroup.HiveGcs.class)
                .run());
