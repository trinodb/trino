...
{
    @Test
    void testInsertCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testPartitionedInsertCompatibility(DeltaLakeOssEnvironment env)
    {
        ...
        try {
            ...
            env.executeSparkUpdate("INSERT INTO default." + tableName + " VALUES (null, 'mysz')");
            env.executeTrinoUpdate("INSERT INTO delta.default." + tableName + " VALUES (3, 'psa'), (4, 'bobra')");
            env.executeTrinoUpdate("INSERT INTO delta.default." + tableName + " VALUES (4, 'lwa'), (5, 'jeza')");
            env.executeTrinoUpdate("INSERT INTO delta.default." + tableName + " VALUES (null, 'kon')");
            ...
            assertThat(env.executeTrino("SELECT \"$path\" FROM delta.default." + tableName + " WHERE a_number IS NULL").column(1))
                    .hasSize(2)
    ...
    @Test
    void testTimestampInsertCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTimestampWithTimeZonePartitionedInsertCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoPartitionedDifferentOrderInsertCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testDeltaPartitionedDifferentOrderInsertCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testInsertNonLowercaseColumnsCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testInsertNestedNonLowercaseColumnsCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testPartitionedInsertNonLowercaseColumnsCompatibility(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void verifyCompressionCodecsDataProvider(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoCreatedTableWithDeltaLengthByteArrayCompatibility(DeltaLakeOssEnvironment env)
    {
        ...
        try {
            ...
            assertThat(env.executeSpark("SELECT count(*) FROM default." + tableName))
                    .containsOnly(row(5000L));
            assertThat(env.executeSpark("SELECT count(DISTINCT str) FROM default." + tableName))
                    .containsOnly(row(5000L));
            assertThat(env.executeSpark("SELECT count(DISTINCT bin) FROM default." + tableName))
                    .containsOnly(row(5000L));
        }
        finally {
            env.executeSparkUpdate("DROP TABLE IF EXISTS default." + tableName);
