...
class TestDeltaLakeInsertCompatibility
{
    ...
    @Test
    void testPartitionedInsertCompatibility(DeltaLakeMinioEnvironment env)
    {
    ...
    @Test
    void testTrinoCreatedTableWithDeltaLengthByteArrayCompatibility(DeltaLakeMinioEnvironment env)
    {
