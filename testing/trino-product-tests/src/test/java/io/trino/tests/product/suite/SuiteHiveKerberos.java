...
public final class SuiteHiveKerberos
{
    private SuiteHiveKerberos() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(HiveKerberosEnvironment.class)
                .includeTag(TestGroup.HiveKerberos.class)
                .run());
