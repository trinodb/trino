...
{
    @Test
    void testSparkCanReadTrinoCheckpoint(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testSparkCanReadTrinoCheckpointWithMultiplePartitionColumns(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoUsesCheckpointInterval(DeltaLakeOssEnvironment env)
    {
        trinoUsesCheckpointInterval(env, "'delta.checkpointInterval' = '5'");
    }

    @Test
    void testTrinoUsesCheckpointIntervalWithTableFeature(DeltaLakeOssEnvironment env)
    {
        trinoUsesCheckpointInterval(env, "'delta.checkpointInterval' = '5', 'delta.feature.columnMapping'='supported'");
    }

    private void trinoUsesCheckpointInterval(DeltaLakeOssEnvironment env, String deltaTableProperties)
    {
        String tableName = "test_dl_checkpoints_compat_" + randomNameSuffix();
    ...
    @Test
    void testTrinoWriteStatsAsJsonDisabled(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testSparkWriteStatsAsJsonDisabled(DeltaLakeOssEnvironment env)
    {
    ...
    private void testWriteStatsAsJsonDisabled(DeltaLakeOssEnvironment env, Consumer<String> sqlExecutor, String tableName, String qualifiedTableName, Double dataSize, Double distinctValues)
    {
        env.executeSparkUpdate(format(
                "CREATE TABLE default.%s" +
                        "(a_number INT, a_string STRING) " +
    ...
    @Test
    void testTrinoWriteStatsAsStructDisabled(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testSparkWriteStatsAsStructDisabled(DeltaLakeOssEnvironment env)
    {
    ...
    private void testWriteStatsAsStructDisabled(DeltaLakeOssEnvironment env, Consumer<String> sqlExecutor, String tableName, String qualifiedTableName)
    {
        env.executeSparkUpdate(format(
                "CREATE TABLE default.%s" +
                        "(a_number INT, a_string STRING) " +
    ...
    void testTrinoWriteStatsAsJsonEnabled(String type, String inputValue, Double dataSize, Double distinctValues, Double nullsFraction, Object statsValue, DeltaLakeOssEnvironment env)
    {
    ...
    private void testWriteStatsAsJsonEnabled(DeltaLakeOssEnvironment env, Consumer<String> sqlExecutor, String tableName, String qualifiedTableName, String type, String inputValue, Double dataSize, Double distinctValues, Double nullsFraction, Object statsValue)
    {
    ...
    @Test
    void testTrinoWriteStatsAsStructEnabled(DeltaLakeOssEnvironment env)
    {
    ...
    private void testWriteStatsAsStructEnabled(DeltaLakeOssEnvironment env, Consumer<String> sqlExecutor, String tableName, String qualifiedTableName, Double dataSize, Double distinctValues)
    {
        env.executeSparkUpdate(format(
                "CREATE TABLE default.%s" +
                        "(a_number INT, a_string STRING) " +
    ...
    void testV2CheckpointMultipleSidecars(String format, DeltaLakeOssEnvironment env)
    {
    ...
    private void fillWithInserts(DeltaLakeOssEnvironment env, String tableName, String values, int toCreate)
    {
    ...
    private List<String> listCheckpointFiles(DeltaLakeOssEnvironment env, String tableDirectory)
    {
    ...
    private List<String> listSidecarFiles(DeltaLakeOssEnvironment env, String tableDirectory)
    {
        return listS3Directory(env, tableDirectory + "/_delta_log/_sidecars");
    }

    private List<String> listS3Directory(DeltaLakeOssEnvironment env, String directory)
    {
        return env.listObjects(directory);
    }
}
