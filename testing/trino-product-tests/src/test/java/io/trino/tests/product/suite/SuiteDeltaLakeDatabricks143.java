...
import io.trino.tests.product.deltalake.DeltaLakeDatabricks143Environment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteDeltaLakeDatabricks143
{
    // Parity note: legacy launcher keeps a dedicated 143 lane filtered by DELTA_LAKE_DATABRICKS_143.
    // There are currently no tests tagged for that group, so this lane intentionally discovers 0 tests.
    private SuiteDeltaLakeDatabricks143() {}
