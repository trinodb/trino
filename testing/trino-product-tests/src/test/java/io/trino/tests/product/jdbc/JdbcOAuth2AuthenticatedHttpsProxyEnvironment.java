...
public class JdbcOAuth2AuthenticatedHttpsProxyEnvironment
        extends AbstractJdbcOAuth2ProxyEnvironment
{
    ...
    {
        return "oauth2/proxy/authenticated-https-proxy/httpd.conf";
    }

    @Override
    protected String getProxyHtpasswdResource()
    {
        return "oauth2/proxy/authenticated-https-proxy/.htpasswd";
    }
