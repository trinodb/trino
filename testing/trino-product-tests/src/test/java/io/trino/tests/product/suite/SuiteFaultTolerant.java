...
import io.trino.tests.product.faulttolerant.FaultTolerantEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteFaultTolerant
{
    private SuiteFaultTolerant() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(FaultTolerantEnvironment.class)
                .includeTag(TestGroup.FaultTolerant.class)
                .run());
