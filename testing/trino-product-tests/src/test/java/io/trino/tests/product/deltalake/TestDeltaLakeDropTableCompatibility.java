...
class TestDeltaLakeDropTableCompatibility
{
    ...
    void testDropTable(Engine creator, Engine dropper, boolean explicitLocation, DeltaLakeOssEnvironment env)
    {
        ...
        try {
            ...
            List<String> tableFiles = env.listObjects(objectPrefix);
            ...
            tableFiles = env.listObjects(objectPrefix);
            if (explicitLocation) {
                assertThat(tableFiles).isNotEmpty();
            }
            else {
