...
import io.trino.tests.product.hudi.HudiEnvironment;
import io.trino.tests.product.suite.SuiteRunner.TestRunResult;

import java.util.ArrayList;
import java.util.List;

public final class SuiteHudi
{
    private SuiteHudi() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(HudiEnvironment.class)
                .includeTag(TestGroup.Hudi.class)
                .run());

        results.add(SuiteRunner.forEnvironment(HiveHudiRedirectionsEnvironment.class)
                .includeTag(TestGroup.HiveHudiRedirections.class)
                .run());
