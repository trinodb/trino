...
public final class SuiteStorageFormatsDetailed
{
    private SuiteStorageFormatsDetailed() {}
    ...
    public static void main(String[] args)
    {
        ...
        results.add(SuiteRunner.forEnvironment(HiveStorageFormatsEnvironment.class)
                .includeTag(TestGroup.StorageFormatsDetailed.class)
                .excludeTag(TestGroup.HiveCompression.class)
                .run());
        results.add(SuiteRunner.forEnvironment(HiveStorageFormatsEnvironment.class)
                .includeTag(TestGroup.HiveCompression.class)
                .run());
