...
{
    @Test
    void testSparkCanReadFromCtasTableCreatedByTrinoWithSpecialCharactersInPartitioningColumn(DeltaLakeOssEnvironment env)
    {
    ...
    private void testSparkCanReadFromCtasTableCreatedByTrinoWithSpecialCharactersInPartitioningColumnWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testTrinoCanReadFromCtasTableCreatedBySparkWithSpecialCharactersInPartitioningColumn(DeltaLakeOssEnvironment env)
    {
    ...
    private void testTrinoCanReadFromCtasTableCreatedBySparkWithSpecialCharactersInPartitioningColumnWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
        String tableName = format("test_dl_create_table_partition_by_special_char_with_%d_partitions_%s", interval, randomNameSuffix());
        String tableDirectory = "delta-compatibility-test-" + tableName;
    ...
    @Test
    void testSparkCanReadTableCreatedByTrinoWithSpecialCharactersInPartitioningColumn(DeltaLakeOssEnvironment env)
    {
    ...
    private void testSparkCanReadTableCreatedByTrinoWithSpecialCharactersInPartitioningColumnWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
        String tableName = format("test_dl_create_table_partition_by_special_char_with_%d_partitions_%s", interval, randomNameSuffix());
        String tableDirectory = "delta-compatibility-test-" + tableName;
    ...
    @Test
    void testTrinoCanReadTableCreatedBySparkWithSpecialCharactersInPartitioningColumn(DeltaLakeOssEnvironment env)
    {
    ...
    private void testTrinoCanReadTableCreatedBySparkWithSpecialCharactersInPartitioningColumnWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
        String tableName = format("test_dl_create_table_partition_by_special_char_with_%d_partitions_%s", interval, randomNameSuffix());
        String tableDirectory = "delta-compatibility-test-" + tableName;
    ...
    @Test
    void testSparkCanReadFromTableUpdatedByTrino(DeltaLakeOssEnvironment env)
    {
    ...
    private void testSparkCanReadFromTableUpdatedByTrinoWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
        String tableName = format("test_dl_create_table_partition_by_special_char_with_%d_partitions_%s", interval, randomNameSuffix());
        String tableDirectory = "delta-compatibility-test-" + tableName;
    ...
    @Test
    void testTrinoCanReadFromTableUpdatedBySpark(DeltaLakeOssEnvironment env)
    {
    ...
    private void testTrinoCanReadFromTableUpdatedBySparkWithCpIntervalSet(int interval, DeltaLakeOssEnvironment env)
    {
        String tableName = format("test_dl_create_table_partition_by_special_char_with_%d_partitions_%s", interval, randomNameSuffix());
        String tableDirectory = "delta-compatibility-test-" + tableName;
    ...
    @Test
    void testTrinoCanReadFromTablePartitionChangedBySpark(DeltaLakeOssEnvironment env)
    {
    ...
    @Test
    void testPartitionedByNonLowercaseColumn(DeltaLakeOssEnvironment env)
    {
