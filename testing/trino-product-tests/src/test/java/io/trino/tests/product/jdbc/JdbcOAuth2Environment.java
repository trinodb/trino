        ...
        extends ProductTestEnvironment
{
        ...
        try {
            ...
            hydraClientPreparation = new GenericContainer<>(DockerImageName.parse(HYDRA_IMAGE))
                    ...
                    .withCommand(
                            ...
                            "client_secret_basic",
                            "--callbacks",
                            "https://" + TRINO_HOST + ":" + HTTPS_PORT + "/oauth2/callback,https://localhost:" + HTTPS_PORT + "/oauth2/callback")
                    .dependsOn(hydra)
                    .withStartupCheckStrategy(new OneShotStartupCheckStrategy());
    ...
    public String getTrinoJdbcUrl()
    {
        return trinoContainer != null
                ? String.format(
                "jdbc:trino://%s:%d?SSL=true&SSLVerification=NONE&externalAuthentication=true&externalAuthenticationTimeout=30s",
