        ...
        extends HiveProductTest
{
    ...
    private static final String NOT_SUPPORTED_ERROR_MESSAGE = "Hive Connector doesn't support modification operations (write, DDL, comment, statistics collection, set authorization) " +
            "on Iceberg tables when redirection to Iceberg catalog is enabled";
    ...
    public void testSelectSuccess()
    {
        ...
        onPresto().executeQuery("DROP TABLE iceberg.default.test_select_drop");
    }
    ...
    public void testInsertFailure()
    {
        ...
        assertThat(() -> onPresto().executeQuery(format(INSERT_TEMPLATE, "hive.default.test_insert")))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);
    ...
    @Test(groups = {HIVE_REDIRECTION_TO_ICEBERG, PROFILE_SPECIFIC_TESTS})
    public void testShowCreateTableSuccess()
    {
    ...
    @Test(groups = {HIVE_REDIRECTION_TO_ICEBERG, PROFILE_SPECIFIC_TESTS})
    public void testAlterTableFailure()
    {
        ...
        assertThat(() -> onPresto().executeQuery("ALTER TABLE hive.default.test_alter_table RENAME TO default.test_alter_table_new"))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);

        assertThat(() -> onPresto().executeQuery("ALTER TABLE hive.default.test_alter_table ADD COLUMN _double DOUBLE"))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);
        assertThat(() -> onPresto().executeQuery("ALTER TABLE hive.default.test_alter_table DROP COLUMN _string"))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);
        assertThat(() -> onPresto().executeQuery("ALTER TABLE hive.default.test_alter_table RENAME COLUMN _bigint TO _bi"))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);

        onPresto().executeQuery("DROP TABLE iceberg.default.test_alter_table");
    }

    @Test(groups = {HIVE_REDIRECTION_TO_ICEBERG, PROFILE_SPECIFIC_TESTS})
    public void testCommentTableFailure()
    {
        ...
        assertThat(() -> onPresto().executeQuery("COMMENT ON TABLE hive.default.test_comment_table IS 'this is an iceberg table'"))
                .failsWithMessage(NOT_SUPPORTED_ERROR_MESSAGE);
    ...
    @Test(groups = {HIVE_REDIRECTION_TO_ICEBERG, PROFILE_SPECIFIC_TESTS})
    public void testCreateHiveTableSuccess()
    {
    ...
    @Test(groups = {HIVE_REDIRECTION_TO_ICEBERG, PROFILE_SPECIFIC_TESTS})
    public void testInformationSchemaColumnsSuccess()
    {
