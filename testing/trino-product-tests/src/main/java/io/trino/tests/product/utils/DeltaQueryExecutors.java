...
public final class DeltaQueryExecutors
{
    ...
    public static JdbcQueryExecutor configureJar(JdbcQueryExecutor jdbcQueryExecutor)
    {
        try {
            Field field = jdbcQueryExecutor.getClass().getDeclaredField("jdbcParamsState");
            field.setAccessible(true);
            field.set(jdbcQueryExecutor, withRuntimeJar((JdbcConnectivityParamsState) field.get(jdbcQueryExecutor)));
