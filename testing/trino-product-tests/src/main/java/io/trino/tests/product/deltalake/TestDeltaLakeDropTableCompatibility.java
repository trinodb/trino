        ...
        extends BaseTestDeltaLakeS3Storage
{
    ...
    private void testDropTableAccuracy(Engine creator, Engine dropper, boolean explicitLocation)
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP TABLE IF EXISTS " + schemaName + "." + tableName));
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP SCHEMA " + schemaName));
        }
    }
}
