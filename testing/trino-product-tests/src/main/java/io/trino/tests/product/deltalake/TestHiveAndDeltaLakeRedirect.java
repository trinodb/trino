        ...
        extends BaseTestDeltaLakeS3Storage
{
    ...
    public void testHiveToDeltaNonDefaultSchemaRedirect()
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery(format("DROP TABLE %s.%s", schemaName, tableName)));
    ...
    public void testHiveToDeltaAlterTable()
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP TABLE " + newTableName));
        }
        catch (QueryExecutionException e) {
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP TABLE " + tableName));
            throw e;
    ...
    public void testInsertIntoDeltaTableFromHiveNonDefaultSchemaRedirect()
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery(format("DROP TABLE %s.%s", destSchema, destTableName)));
    ...
    public void testInformationSchemaColumnsHiveToDeltaRedirect()
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery(format("DROP TABLE IF EXISTS %s.%s", schemaName, tableName)));
            onTrino().executeQuery("DROP SCHEMA " + schemaName);
        }
    }
    ...
    public void testViewReferencingHiveAndDeltaTable(boolean legacyHiveViewTranslation)
    {
        ...
        try {
            ...
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP VIEW IF EXISTS " + viewName));
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP TABLE IF EXISTS " + deltaTableName));
            retryOnModifiedConcurrentlyFailure(() -> onDelta().executeQuery("DROP TABLE IF EXISTS " + deltaRegionTableName));
