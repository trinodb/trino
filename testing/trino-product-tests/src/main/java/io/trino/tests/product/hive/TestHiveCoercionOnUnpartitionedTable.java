        ...
        extends BaseTestHiveCoercion
{
    ...
    protected Map<ColumnContext, String> expectedExceptionsWithTrinoContext()
    {
        ...
        return ImmutableMap.<ColumnContext, String>builder()
                ...
                .put(columnContext("parquet", "tinyint_to_double"), "Unsupported Trino column type (double) for Parquet column ([tinyint_to_double] optional int32 tinyint_to_double (INTEGER(8,true)))")
                ...
                .put(columnContext("parquet", "smallint_to_double"), "Unsupported Trino column type (double) for Parquet column ([smallint_to_double] optional int32 smallint_to_double (INTEGER(16,true)))")
                ...
                .put(columnContext("parquet", "int_to_double"), "Unsupported Trino column type (double) for Parquet column ([int_to_double] optional int32 int_to_double (INTEGER(32,true)))")
                ...
                .put(columnContext("parquet", "bigint_to_double"), "Unsupported Trino column type (double) for Parquet column ([bigint_to_double] optional int64 bigint_to_double (INTEGER(64,true)))")
                ...
                .put(columnContext("parquet", "timestamp_to_string"), "Unsupported Trino column type (varchar) for Parquet column ([timestamp_to_string] optional int96 timestamp_to_string)")
                .put(columnContext("parquet", "timestamp_to_bounded_varchar"), "Unsupported Trino column type (varchar(30)) for Parquet column ([timestamp_to_bounded_varchar] optional int96 timestamp_to_bounded_varchar)")
                .put(columnContext("parquet", "timestamp_to_smaller_varchar"), "Unsupported Trino column type (varchar(4)) for Parquet column ([timestamp_to_smaller_varchar] optional int96 timestamp_to_smaller_varchar)")
