        ...
        extends BaseTestHiveCoercion
{
    ...
    protected Map<ColumnContext, String> expectedExceptionsWithTrinoContext()
    {
        ...
        return ImmutableMap.<ColumnContext, String>builder()
                ...
                .put(columnContext("parquet", "short_decimal_to_varchar"), "Unsupported Trino column type (varchar) for Parquet column ([short_decimal_to_varchar] optional fixed_len_byte_array(5) short_decimal_to_varchar (DECIMAL(10,2)))")
                .put(columnContext("parquet", "long_decimal_to_varchar"), "Unsupported Trino column type (varchar) for Parquet column ([long_decimal_to_varchar] optional fixed_len_byte_array(5) long_decimal_to_varchar (DECIMAL(20,4)))")
