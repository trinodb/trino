        ...
        extends HiveProductTest
{
    ...
    @FlakyTest(issue = "https://github.com/trinodb/trino/issues/4927", match = "Hive table .* is corrupt. Found sub-directory in bucket directory for partition")
    @Test(groups = HIVE_TRANSACTIONAL, timeOut = TEST_TIMEOUT)
    ...
    @Test(groups = HIVE_TRANSACTIONAL)
    @FlakyTest(issue = "https://github.com/trinodb/trino/issues/5463", match = "Expected row count to be <4>, but was <6>")
