        ...
        extends HiveProductTest
{
    ...
    public void testOrcColumnDropAdd(boolean transactional)
    {
        ...
        withTemporaryTable("test_orc_add_drop", false, NONE, tableName -> {
            ...
            assertQueryFailure(() -> onTrino().executeQuery(format("ALTER TABLE %s DROP COLUMN old_state", tableName)))
            ...
            onTrino().executeQuery(format("INSERT INTO %s VALUES (333, 'Kelly', 45, 'CA', 'CA')", tableName));
            verifySelectForTrinoAndHive(
                    "SELECT * FROM " + tableName,
                    row(111, "Katy", 57, "CA", null),
                    row(222, "Joe", 72, "WA", null),
                    row(333, "Kelly", 45, "CA", "CA"));
        });
    }
