...
, "ss_item_sk"
, "ss_customer_sk"
, "round"((CAST("ss_qty" AS DECIMAL(10,2)) / (COALESCE("ws_qty", 0) + COALESCE("cs_qty", 0))), 2) "ratio"
, "ss_qty" "store_qty"
...
ORDER BY "ss_sold_year" ASC, "ss_item_sk" ASC, "ss_customer_sk" ASC, "ss_qty" DESC, "ss_wc" DESC, "ss_sp" DESC, "other_chan_qty" ASC, "other_chan_wholesale_cost" ASC, "other_chan_sales_price" ASC, "round"((CAST("ss_qty" AS DECIMAL(10,2)) / (COALESCE("ws_qty", 0) + COALESCE("cs_qty", 0))), 2) ASC
LIMIT 100
