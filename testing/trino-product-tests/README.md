...
testing/trino-product-tests-launcher/bin/run-launcher test run --environment <environment> \
...
```
./mvnw install -DskipTests
testing/trino-product-tests-launcher/bin/run-launcher env list
```
...
testing/trino-product-tests-launcher/bin/run-launcher test run \
...
```
testing/trino-product-tests-launcher/bin/run-launcher suite list
```

Command `testing/trino-product-tests-launcher/bin/run-launcher/suite describe --suite <suite name>` shows list of tests that will be executed and environments 
that will be used when `suite run` is invoked.

You can execute single suite using command:

```
testing/trino-product-tests-launcher/bin/run-launcher suite run --suite <suite name> \
    [--config <environment config>]
```
