...
/**
 * Marks a test method as flaky and enables automatic retry on CI when the failure matches the specified pattern.
 * <p>
 * Use of this annotation is strongly discouraged. Instead prefer to find the cause of the issue
 * and either fix the test or rewrite it to not be flaky.
 *
...
{
    /**
     * The issue tracker reference for this flaky test (e.g., "https://github.com/trinodb/trino/issues/12345").
     */
    String issue();
