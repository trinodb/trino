        ...
        extends EnvironmentProvider
{
    ...
    {
        builder.addContainer(createPrestoContainer(dockerFiles, serverPackage, cliExecutable, debug, "ghcr.io/trinodb/testing/centos7-oj11:" + imagesVersion, worker(workerNumber))
