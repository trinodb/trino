...
@TestsEnvironment
public final class EnvMultinodePostgresqlPostgis
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvMultinodePostgresqlPostgis(StandardMultinode standardMultinode, DockerFiles dockerFiles, PortBinder portBinder)
    {
    ...
    private DockerContainer createPostgreSql()
    {
        ...
        DockerContainer container = new DockerContainer("postgis/postgis:11-3.2", "postgresql")
