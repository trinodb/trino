...
@TestsEnvironment
public class EnvSinglenodeOauth2
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeOauth2(DockerFiles dockerFiles, PortBinder binder, MultinodeProvider multinodeProvider, HydraIdentityProvider hydraIdentityProvider)
    {
