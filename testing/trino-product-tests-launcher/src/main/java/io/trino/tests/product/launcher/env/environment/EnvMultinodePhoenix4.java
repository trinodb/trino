...
@TestsEnvironment
public final class EnvMultinodePhoenix4
        extends EnvironmentProvider
{
    ...
    public EnvMultinodePhoenix4(StandardMultinode standardMultinode, Phoenix phoenix, DockerFiles dockerFiles)
    {
        ...
        this.configDir = requireNonNull(dockerFiles, "dockerFiles is null").getDockerFilesHostDirectory("conf/environment/multinode-phoenix4/");
    }

    @Override
    public void extendEnvironment(Environment.Builder builder)
    {
        String phoenixDockerImageName = "ghcr.io/trinodb/testing/phoenix4:" + TestingProperties.getDockerImagesVersion();
