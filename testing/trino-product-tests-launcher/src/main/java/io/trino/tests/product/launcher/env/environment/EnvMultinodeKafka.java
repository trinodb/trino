...
@TestsEnvironment
public final class EnvMultinodeKafka
        extends EnvironmentProvider
{
    private final ResourceProvider configDir;

    @Inject
    public EnvMultinodeKafka(Kafka kafka, MultinodeProvider multinodeProvider, DockerFiles dockerFiles)
    {
        super(ImmutableList.of(multinodeProvider.singleWorker(), kafka));
