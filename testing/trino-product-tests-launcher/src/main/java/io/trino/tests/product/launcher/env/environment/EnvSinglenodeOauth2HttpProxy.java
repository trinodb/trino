        ...
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeOauth2HttpProxy(DockerFiles dockerFiles, PortBinder binder, MultinodeProvider multinodeProvider, HydraIdentityProvider hydraIdentityProvider)
    {
