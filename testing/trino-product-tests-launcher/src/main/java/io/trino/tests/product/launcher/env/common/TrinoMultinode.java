        ...
        implements EnvironmentExtender
{
    ...
    public void extendEnvironment(Environment.Builder builder)
    {
        builder.configureContainer(COORDINATOR, container -> container
                .withCopyFileToContainer(forHostPath(dockerFiles.getDockerFilesHostPath("common/standard/multinode-master-config.properties")), CONTAINER_PRESTO_CONFIG_PROPERTIES));
    ...
    private DockerContainer createTrinoWorker()
    {
        return createPrestoContainer(dockerFiles, serverPackage, debug, "ghcr.io/trinodb/testing/centos7-oj11:" + imagesVersion, WORKER)
                .withCopyFileToContainer(forHostPath(dockerFiles.getDockerFilesHostPath("common/standard/multinode-worker-config.properties")), CONTAINER_PRESTO_CONFIG_PROPERTIES);
    }
}
