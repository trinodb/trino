...
@TestsEnvironment
public class EnvSinglenodeOidc
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeOidc(DockerFiles dockerFiles, PortBinder binder, Standard standard, HydraIdentityProvider hydraIdentityProvider)
    {
        ...
        this.configDir = dockerFiles.getDockerFilesHostDirectory("conf/environment/singlenode-oidc/");
    }
    ...
    public void extendEnvironment(Environment.Builder builder)
    {
        ...
        DockerContainer hydraClientConfig = hydraIdentityProvider.createClient(
                ...
                "client_secret_basic",
                "trinodb_client_id/",
                "https://trino-coordinator:7778/oauth2/callback,https://localhost:7778/oauth2/callback");
