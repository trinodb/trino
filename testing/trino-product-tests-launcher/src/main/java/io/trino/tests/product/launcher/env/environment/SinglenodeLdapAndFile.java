...
@TestsEnvironment
public class SinglenodeLdapAndFile
        extends AbstractSinglenodeLdap
{
    @Inject
    public SinglenodeLdapAndFile(Standard standard, Hadoop hadoop, DockerFiles dockerFiles, PortBinder portBinder, EnvironmentConfig config)
    {
