        ...
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeLdapReferrals(Standard standard, Hadoop hadoop, OpenLdapReferral openLdapReferral, DockerFiles dockerFiles, PortBinder portBinder)
    {
        super(standard, hadoop, openLdapReferral);
    ...
    {
        builder.addPasswordAuthenticator("ldap", forHostPath(dockerFiles.getDockerFilesHostPath("conf/environment/singlenode-ldap-referrals/password-authenticator.properties")));
