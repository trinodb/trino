...
{
    @Inject
    public EnvSinglenodeLdapReferrals(MultinodeProvider multinodeProvider, Hadoop hadoop, DockerFiles dockerFiles, PortBinder portBinder, EnvironmentConfig config)
    {
