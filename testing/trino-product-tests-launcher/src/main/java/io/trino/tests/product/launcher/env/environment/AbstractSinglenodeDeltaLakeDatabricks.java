        ...
        extends EnvironmentProvider
{
    ...
    public void extendEnvironment(Environment.Builder builder)
    {
        ...
        String databricksServerHostname = requireNonNull(System.getenv("DATABRICKS_SERVER_HOSTNAME"), "Environment DATABRICKS_SERVER_HOSTNAME was not set");
        String databricksOrganisationId = requireNonNull(System.getenv("DATABRICKS_ORGANISATION_ID"), "Environment DATABRICKS_ORGANISATION_ID was not set");
