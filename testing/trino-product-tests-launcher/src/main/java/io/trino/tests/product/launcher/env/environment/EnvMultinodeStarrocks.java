...
@TestsEnvironment
public final class EnvMultinodeStarrocks
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvMultinodeStarrocks(StandardMultinode standardMultinode, DockerFiles dockerFiles, PortBinder portBinder)
    {
    ...
    {
        builder.addConnector(STARROCKS, forHostPath(configDir.getPath("starrocks.properties")));
    ...
    {
        DockerContainer container = new DockerContainer("starrocks/allin1-ubuntu:2.5.6", STARROCKS)
