        ...
        extends EnvironmentProvider
{
    ...
    @Inject
    public EnvSinglenodeSparkIceberg(MultinodeProvider multinodeProvider, Hadoop hadoop, DockerFiles dockerFiles, EnvironmentConfig config, PortBinder portBinder)
    {
