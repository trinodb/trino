...
/**
 * A reusable Spark container for Iceberg product tests.
 * <p>
 * This container provides a Spark Thrift Server configured with Iceberg catalogs
 * that share the same Hive Metastore as Trino, enabling interoperability testing.
 * <p>
 * Key features:
 * <ul>
 *   <li>Spark Thrift Server on port 10213</li>
 *   <li>Iceberg catalog (iceberg_test) pointing to HMS</li>
 *   <li>SparkSessionCatalog for spark_catalog</li>
 *   <li>HDFS access via hadoop-master:9000</li>
 * </ul>
 */
public class SparkIcebergContainer
        extends GenericContainer<SparkIcebergContainer>
{
    ...
    public SparkIcebergContainer()
    {
        this(DEFAULT_IMAGE + ":" + TestingProperties.getDockerImagesVersion());
    }

    public SparkIcebergContainer(String imageName)
    {
    ...
    public SparkIcebergContainer withAwsKmsEncryption(String kmsEndpoint)
    {
        withEnv("AWS_ACCESS_KEY_ID", "test");
        withEnv("AWS_SECRET_ACCESS_KEY", "test");
        withEnv("AWS_REGION", "us-east-1");
        withEnv("AWS_ENDPOINT_URL_KMS", kmsEndpoint);
        withCopyToContainer(
