 ...
 */
public class TestIcebergSmallFilesTpcdsCostBasedPlan
        extends BaseIcebergCostBasedPlanTest
{
    public TestIcebergSmallFilesTpcdsCostBasedPlan()
    {
    ...
    {
        new TestIcebergSmallFilesTpcdsCostBasedPlan().generate();
    }
}
