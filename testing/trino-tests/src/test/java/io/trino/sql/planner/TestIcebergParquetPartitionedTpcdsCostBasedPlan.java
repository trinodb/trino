 ...
 */
public class TestIcebergParquetPartitionedTpcdsCostBasedPlan
        extends BaseIcebergCostBasedPlanTest
{
    protected TestIcebergParquetPartitionedTpcdsCostBasedPlan()
    {
    ...
    {
        new TestIcebergParquetPartitionedTpcdsCostBasedPlan().generate();
    }
}
