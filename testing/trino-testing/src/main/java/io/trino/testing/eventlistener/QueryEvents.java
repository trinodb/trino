...
public class QueryEvents
{
    ...
    synchronized void addQueryCreated(QueryCreatedEvent event)
    {
    ...
    synchronized void addQueryCompleted(QueryCompletedEvent event)
    {
        requireNonNull(event, "event is null");
        if (queryCompletedEvent != null) {
    ...
    synchronized void addSplitCompleted(SplitCompletedEvent event)
    {
