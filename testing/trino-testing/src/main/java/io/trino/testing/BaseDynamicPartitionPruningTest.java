        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testJoinLargeBuildSideRangeDynamicFiltering()
    {
        ...
        DynamicFilterDomainStats domainStats = getOnlyElement(dynamicFiltersStats.getDynamicFilterDomainStats());
        assertThat(domainStats.getSimplifiedDomain()).isEqualTo("[ Bloom filter approx cardinality: 15000, range [1, 60000], size: 2MB ]");
    }
    ...
    public void testSemiJoinLargeBuildSideRangeDynamicFiltering()
    {
        ...
        DynamicFilterDomainStats domainStats = getOnlyElement(dynamicFiltersStats.getDynamicFilterDomainStats());
        assertThat(domainStats.getSimplifiedDomain()).isEqualTo("[ Bloom filter approx cardinality: 15002, range [1, 60000], size: 2MB ]");
    }
