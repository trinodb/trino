        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testInsert()
    {
        ...
        try (TestTable table = createTable("test_insert_", getCreateTableDefaultDefinition())) {
    ...
    public void verifySupportsDeleteDeclaration()
    {
        ...
        try (TestTable table = createTable("test_supports_delete", "AS SELECT * FROM region")) {
    ...
    public void verifySupportsRowLevelDeleteDeclaration()
    {
        ...
        assumeTrue(hasBehavior(SUPPORTS_CREATE_TABLE));
        try (TestTable table = createTable("test_supports_row_level_delete", "AS SELECT * FROM region")) {
    ...
    public void testRowLevelUpdate()
    {
        ...
        try (TestTable table = createTable("test_update_", getCreateTableDefaultDefinition())) {
    ...
    public void testMerge()
    {
        ...
        try (TestTable table = createTable("test_merge_", getCreateTableDefaultDefinition())) {
            assertUpdate("INSERT INTO " + table.getName() + " (a, b) SELECT regionkey, regionkey * 2.5 FROM region", "SELECT count(*) FROM region");
            assertThat(query("SELECT a, b FROM " + table.getName()))
                    .matches(expectedValues("(0, 0.0), (1, 2.5), (2, 5.0), (3, 7.5), (4, 10.0)"));
