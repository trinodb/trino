...
public class RangerAccessControlConfig
{
    ...
    public RangerAccessControlConfig setConfigFile(String configFile)
    {
    ...
    public RangerAccessControlConfig setRefreshPeriod(Duration refreshPeriod)
    {
