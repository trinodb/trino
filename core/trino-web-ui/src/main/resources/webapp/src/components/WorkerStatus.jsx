                        ...
                        <div className="col-xs-12">
                            ...
                            <div className="progress">
                                <div
                                    ...
                                    role="progressbar"
                                    style={{
                                        width: percentageReservedNonRevocable + '%',
                                    }}
                                >
                                ...
                                <div
                                    className="progress-bar memory-progress-bar progress-bar-success"
                                    role="progressbar"
            ...
            if (this.state.initialized === false) {
                ...
                return (
                    <div className="row error-message">
                        <div className="col-xs-12">
                            <h4>Node information could not be loaded</h4>
                        </div>
                    </div>
                )
            }
                                ...
                                <table className="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="info-text wrap-text">{serverInfo.uptime}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <table className="table">
                                            <tbody>
                                                ...
                                                <tr className="tr-noborder">
                                                    <td className="info-sparkline-text">
                                                        {formatDataSize(
                                                            this.state.nonHeapUsed[this.state.nonHeapUsed.length - 1]
                                                        )}
                                                    </td>
                                                </tr>
                                            </tbody>
