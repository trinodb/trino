...
if(CAST(event.event_info['avgspeed'] AS REAL) <= 0, 'avgspeed_0', 'avgspeed_1') as avgspeed,
...
if(CAST(event.event_info['firstrestime'] AS REAL) <= 0, 'firstrestime_0', 'firstrestime_1') as firstrestime,
count(1)
...
if(CAST(event.event_info['avgspeed'] AS REAL) <= 0, 'avgspeed_0', 'avgspeed_1'),
...
if(CAST(event.event_info['firstrestime'] AS REAL) <= 0, 'firstrestime_0', 'firstrestime_1') limit 200000