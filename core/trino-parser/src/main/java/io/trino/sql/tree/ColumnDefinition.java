        ...
        extends TableElement
{
    ...
    public ColumnDefinition(QualifiedName name, DataType type, Optional<String> defaultValue, boolean nullable, List<Property> properties, Optional<String> comment)
    {
        this(Optional.empty(), name, type, defaultValue, nullable, properties, comment);
    }

    public ColumnDefinition(NodeLocation location, QualifiedName name, DataType type, Optional<String> defaultValue, boolean nullable, List<Property> properties, Optional<String> comment)
    {
