        ...
        extends Expression
{
    ...
    public Measure(Identifier name, Window window)
    {
        this(Optional.empty(), name, window);
    }

    public Measure(NodeLocation location, Identifier name, Window window)
    {
        this(Optional.of(location), name, window);
    }

    private Measure(Optional<NodeLocation> location, Identifier name, Window window)
    {
        super(location);
    ...
    {
        return visitor.visitMeasure(this, context);
    }
