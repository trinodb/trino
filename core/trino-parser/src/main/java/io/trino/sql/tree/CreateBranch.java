        ...
        extends Statement
{
    ...
    public CreateBranch(NodeLocation location, SaveMode saveMode, QualifiedName tableName, Identifier branchName, List<Property> properties)
    {
        super(location);
    ...
    public int hashCode()
    {
        return Objects.hash(tableName, saveMode, branchName, properties);
    }
