        ...
        extends Statement
{
    ...
    public CreateBranch(NodeLocation location, QualifiedName tableName, Identifier branchName)
    {
        super(location);
    ...
    public int hashCode()
    {
        return Objects.hash(tableName, branchName);
    }
