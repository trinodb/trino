...
public final class DecimalTypeUtils
{
    ...
    {
        public PrecisionAndScale
        {
            verify(precision > 0 && precision <= 38, "precision must be between 0 and 38");
            verify(scale >= 0 && scale <= precision, "scale must be between 0 and precision");
        }
    }
}
