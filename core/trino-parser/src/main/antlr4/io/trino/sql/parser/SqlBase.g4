...
nonReserved
    ...
    | ERROR | EXCLUDING | EXPLAIN
    | FILTER | FINAL | FIRST | FOLLOWING | FORMAT | FUNCTIONS
    ...
    | MAP | MATCHED | MATERIALIZED | MEASURES | MERGE | MINUTE | MONTH
    | NEXT | NFC | NFD | NFKC | NFKD | NO | NONE | NULLIF | NULLS
    | ONLY | OPTION | ORDINALITY | OUTPUT | OVER | OVERFLOW
    | PARTITION | PARTITIONS | PAST | PATH | PERMUTE | POSITION | PRECEDING | PRECISION | PRIVILEGES | PROPERTIES
