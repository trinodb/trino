...
public interface ConnectorCacheMetadata
{
     ...
     * (e.g. rows order) must be part of {@link CacheTableId} if they are present. {@link CacheTableId}
     * shouldn't contain elements that are specific to splits or columns. For example, partition predicate
     * can be implicitly derived from list of enumerated splits. Hence, partition predicate shouldn't
     * be part of {@link CacheTableId}.
     */
