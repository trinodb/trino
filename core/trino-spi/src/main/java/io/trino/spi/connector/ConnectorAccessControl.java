...
public interface ConnectorAccessControl
{
     ...
     * @throws AccessDeniedException if not allowed
     */
    default void canCanDropBranch(ConnectorSecurityContext context, SchemaTableName tableName, String branchName)
    {
     ...
     * @throws AccessDeniedException if not allowed
     */
    default void canCanFastForwardBranch(ConnectorSecurityContext context, SchemaTableName tableName, String sourceBranchName, String targetBranchName)
    {
