...
public interface ExchangeManager
{
     ...
     */
    Exchange create(ExchangeContext context, int outputPartitionCount);
     ...
     * The coordinator decided what items from that list should be handled by what task and creates
     * sub-list that are further getting sent to a worker to be read.
