        ...
        implements BlockEncoding
{
    ...
    public void writeBlock(BlockEncodingSerde blockEncodingSerde, SliceOutput sliceOutput, Block block)
    {
        ...
        if (!int128ArrayBlock.mayHaveNull()) {
            MaskedLongVByte.writeLongs(sliceOutput, int128ArrayBlock.getRawValues(), int128ArrayBlock.getRawOffset() * 2, int128ArrayBlock.getPositionCount() * 2);
        }
        else {
    ...
    public Int128ArrayBlock readBlock(BlockEncodingSerde blockEncodingSerde, SliceInput sliceInput)
    {
        ...
        if (valueIsNull == null) {
            ...
            MaskedLongVByte.readLongs(sliceInput, values, 0, nonNullPositionCount * 2);
