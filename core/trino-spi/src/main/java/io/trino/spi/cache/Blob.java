        ...
        extends Closeable
{
    ...
    /**
     * Read up to {@code length} bytes anchored at the end of the blob and return the number
     * of bytes actually read, which is smaller than {@code length} when the blob holds fewer bytes.
     * <p>
            ...
            throws IOException
    {
        ...
        int readSize = (int) min(length, length());
