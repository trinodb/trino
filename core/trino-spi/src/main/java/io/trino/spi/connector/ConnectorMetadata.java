...
public interface ConnectorMetadata
{
     ...
     * The returned compensations (constraints and limits) will be applied to the unified branches of the plan in order to restore the original table semantics.
     * The constraint will be applied before the limit.
