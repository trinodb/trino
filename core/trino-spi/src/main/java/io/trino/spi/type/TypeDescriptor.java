...
public final class TypeDescriptor
{
    ...
    // The internal `base(arg, …)` form used for descriptor serialization and debugging.
    // TypeSyntax renders the SQL spelling used by Type#getTypeId and getDisplayName.
