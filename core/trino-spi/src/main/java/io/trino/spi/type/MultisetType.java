        ...
        extends AbstractType
{
    ...
    {
        super(new TypeDescriptor(NAME, TypeParameter.typeParameter(elementType.getTypeDescriptor())), SqlMultiset.class, ArrayBlock.class);
    ...
    /// used to build a [SqlMultiset]'s index. Never null — the constructor
    /// rejects non-comparable element types.
