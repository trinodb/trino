 ...
 * TODO this is not meant to be infinite precision. Add limits, roundings, etc.
 * <p>
 * Stack representation of this type is {@link Bigdecimal} which wraps a slice with the format documented below.
 ...
 *         The remaining 15 bits store the scale + {@value Bigdecimal#SCALE_BASE} as an unsigned integer.
 *      </dd>
        ...
        extends AbstractVariableWidthType
{
    ...
    private static final TypeOperatorDeclaration TYPE_OPERATOR_DECLARATION = extractOperatorDeclaration(BigdecimalType.class, lookup(), Bigdecimal.class);

    private BigdecimalType()
    {
        super(new TypeSignature(NAME), Bigdecimal.class);
    }
    ...
    public Object getObjectValue(Block block, int position)
    {
        ...
        return new SqlBigdecimal(((Bigdecimal) getObject(block, position)).toBigDecimal());
    }
    ...
    private static boolean equalOperator(Bigdecimal left, Bigdecimal right)
    {
    ...
    private static long xxHash64Operator(Bigdecimal value)
    {
    ...
    private static long comparisonOperator(Bigdecimal left, Bigdecimal right)
    {
        // TODO NaN
    ...
    private static boolean lessThanOperator(Bigdecimal left, Bigdecimal right)
    {
