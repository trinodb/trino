...
public class QueryPlanDetails
{
    ...
    private final List<QueryPlanStageInfo> stages;

    @JsonCreator
    public QueryPlanDetails(
            @JsonProperty("finalQueryInfo") boolean finalQueryInfo,
            @JsonProperty("stages") List<QueryPlanStageInfo> stages)
    {
    ...
    @JsonProperty
    public List<QueryPlanStageInfo> getStages()
    {
        return stages;
    }
}
