...
public class TableScanRedirectApplicationResult
{
    ...
    public TableScanRedirectApplicationResult(CatalogSchemaTableName destinationTable, Map<ColumnHandle, String> destinationColumns, TupleDomain<String> filter, boolean allowCoercions)
    {
        this.redirections = singletonList(new Redirection(destinationTable, destinationColumns, filter, allowCoercions));
    }
