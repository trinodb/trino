    ...
    public void writeBlock(BlockEncodingSerde blockEncodingSerde, SliceOutput sliceOutput, Block block)
    {
        ...
        if (isNull == null) {
            ...
            if (enableVectorizedNullSuppression) {
                EncoderUtil.compactIntsWithNullsVectorized(sliceOutput, rawValues, isNull, rawOffset, positionCount);
            }
            else {
                EncoderUtil.compactIntsWithNullsScalar(sliceOutput, rawValues, isNull, rawOffset, positionCount);
            }
        }
    }
