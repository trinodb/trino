        ...
        implements BlockEncoding
{
    ...
    public void writeBlock(BlockEncodingSerde blockEncodingSerde, SliceOutput sliceOutput, Block block)
    {
        ...
        if (!intArrayBlock.mayHaveNull()) {
            MaskedIntVByte.writeInts(sliceOutput, intArrayBlock.getRawValues(), intArrayBlock.getRawValuesOffset(), intArrayBlock.getPositionCount());
        }
        else {
    ...
    public IntArrayBlock readBlock(BlockEncodingSerde blockEncodingSerde, SliceInput sliceInput)
    {
        ...
        MaskedIntVByte.readInts(sliceInput, values, 0, nonNullPositionCount);
