...
public interface ConnectorMergeTableHandle
{
     ...
     * {@link ConnectorMetadata#beginMerge} is in general different than the
     * one passed to that method, but the updated handle must be made
     * available to {@link ConnectorMetadata#finishMerge}
     * @return Return the {@link ConnectorTableHandle} returned by
     * {@link ConnectorMetadata#beginMerge}
     */
