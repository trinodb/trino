        ...
        implements Metadata
{
    ...
    @Override
    public Optional<ConnectorTableVersioningLayout> getTableVersioningLayout(Session session, TableHandle handle)
    {
        return delegate.getTableVersioningLayout(session, handle);
    }
}
