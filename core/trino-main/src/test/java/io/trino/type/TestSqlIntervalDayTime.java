...
public class TestSqlIntervalDayTime
{
    ...
    @Test
    public void testLegacyRoundingOverflow()
    {
        for (long micros : new long[] {Long.MIN_VALUE, Long.MAX_VALUE}) {
            assertTrinoExceptionThrownBy(() -> new SqlIntervalDayTime(micros, 0, 6).roundTo(3))
                    .hasErrorCode(NUMERIC_VALUE_OUT_OF_RANGE);
        }
        assertThat(new SqlIntervalDayTime(Long.MAX_VALUE - 1000, 0, 6).roundTo(3).getMicros()).isEqualTo(9_223_372_036_854_775_000L);
        assertThat(new SqlIntervalDayTime(Long.MIN_VALUE + 1000, 0, 6).roundTo(3).getMicros()).isEqualTo(-9_223_372_036_854_775_000L);
    }
}
