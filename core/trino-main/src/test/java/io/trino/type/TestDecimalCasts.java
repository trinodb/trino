        ...
        extends AbstractTestFunctions
{
    ...
    {
        assertDecimalFunction("CAST(true AS DECIMAL(2, 0))", decimal("01", createDecimalType(2)));
        assertDecimalFunction("CAST(true AS DECIMAL(3, 1))", decimal("01.0", createDecimalType(3, 1)));
        assertDecimalFunction("CAST(true AS DECIMAL)", decimal("1", createDecimalType(38)));
        assertDecimalFunction("CAST(true AS DECIMAL(2))", decimal("01", createDecimalType(2)));
        assertDecimalFunction("CAST(false AS DECIMAL(2, 0))", decimal("00", createDecimalType(2)));
        assertDecimalFunction("CAST(false AS DECIMAL(2))", decimal("00", createDecimalType(2)));
        assertDecimalFunction("CAST(false AS DECIMAL)", decimal("0", createDecimalType(38)));
        assertDecimalFunction("CAST(true AS DECIMAL(18, 0))", decimal("000000000000000001", createDecimalType(18)));
        assertDecimalFunction("CAST(false AS DECIMAL(18, 2))", decimal("0000000000000000.00", createDecimalType(18, 2)));

        assertDecimalFunction("CAST(true AS DECIMAL(20, 10))", decimal("0000000001.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(false AS DECIMAL(20, 10))", decimal("0000000000.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(true as DECIMAL(30, 20))", decimal("0000000001.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(false as DECIMAL(30, 20))", decimal("0000000000.00000000000000000000", createDecimalType(30, 20)));
    }
    ...
    {
        assertDecimalFunction("CAST(BIGINT '234' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(BIGINT '234' AS DECIMAL(5,2))", decimal("234.00", createDecimalType(5, 2)));
        assertDecimalFunction("CAST(BIGINT '234' AS DECIMAL(4,0))", decimal("0234", createDecimalType(4)));
        assertDecimalFunction("CAST(BIGINT '-234' AS DECIMAL(4,1))", decimal("-234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(BIGINT '0' AS DECIMAL(4,2))", decimal("00.00", createDecimalType(4, 2)));
        assertDecimalFunction("CAST(BIGINT '12345678901234567' AS DECIMAL(17, 0))", decimal("12345678901234567", createDecimalType(17)));
        assertDecimalFunction("CAST(BIGINT '123456789012345679' AS DECIMAL(18, 0))", decimal("123456789012345679", createDecimalType(18)));
        assertDecimalFunction("CAST(BIGINT '1234567890' AS DECIMAL(20, 10))", decimal("1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(BIGINT '-1234567890' AS DECIMAL(20, 10))", decimal("-1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(BIGINT '1234567890' AS DECIMAL(30, 20))", decimal("1234567890.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(BIGINT '-1234567890' AS DECIMAL(30, 20))", decimal("-1234567890.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(BIGINT '-1234567' AS DECIMAL(17, 10))", decimal("-1234567.0000000000", createDecimalType(17, 10)));
    ...
    {
        assertDecimalFunction("CAST(INTEGER '234' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(INTEGER '234' AS DECIMAL(5,2))", decimal("234.00", createDecimalType(5, 2)));
        assertDecimalFunction("CAST(INTEGER '234' AS DECIMAL(4,0))", decimal("0234", createDecimalType(4)));
        assertDecimalFunction("CAST(INTEGER '-234' AS DECIMAL(4,1))", decimal("-234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(INTEGER '0' AS DECIMAL(4,2))", decimal("00.00", createDecimalType(4, 2)));
        assertDecimalFunction("CAST(INTEGER '1345678901' AS DECIMAL(18,8))", decimal("1345678901.00000000", createDecimalType(18, 8)));
        assertDecimalFunction("CAST(INTEGER '1234567890' AS DECIMAL(20, 10))", decimal("1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(INTEGER '-1234567890' AS DECIMAL(20, 10))", decimal("-1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(INTEGER '1234567890' AS DECIMAL(30, 20))", decimal("1234567890.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(INTEGER '-1234567890' AS DECIMAL(30, 20))", decimal("-1234567890.00000000000000000000", createDecimalType(30, 20)));
    ...
    {
        assertDecimalFunction("CAST(SMALLINT '234' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(SMALLINT '234' AS DECIMAL(5,2))", decimal("234.00", createDecimalType(5, 2)));
        assertDecimalFunction("CAST(SMALLINT '234' AS DECIMAL(4,0))", decimal("0234", createDecimalType(4)));
        assertDecimalFunction("CAST(SMALLINT '-234' AS DECIMAL(4,1))", decimal("-234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(SMALLINT '0' AS DECIMAL(4,2))", decimal("00.00", createDecimalType(4, 2)));
        assertDecimalFunction("CAST(SMALLINT '1234' AS DECIMAL(20, 10))", decimal("0000001234.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(SMALLINT '-1234' AS DECIMAL(20, 10))", decimal("-0000001234.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(SMALLINT '1234' AS DECIMAL(30, 20))", decimal("0000001234.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(SMALLINT '-1234' AS DECIMAL(30, 20))", decimal("-0000001234.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(SMALLINT '12345' AS DECIMAL(18,13))", decimal("12345.0000000000000", createDecimalType(18, 13)));
    ...
    {
        assertDecimalFunction("CAST(TINYINT '23' AS DECIMAL(4,1))", decimal("023.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(TINYINT '23' AS DECIMAL(5,2))", decimal("023.00", createDecimalType(5, 2)));
        assertDecimalFunction("CAST(TINYINT '23' AS DECIMAL(4,0))", decimal("0023", createDecimalType(4)));
        assertDecimalFunction("CAST(TINYINT '-23' AS DECIMAL(4,1))", decimal("-023.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(TINYINT '0' AS DECIMAL(4,2))", decimal("00.00", createDecimalType(4, 2)));
        assertDecimalFunction("CAST(TINYINT '123' AS DECIMAL(20, 10))", decimal("0000000123.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(TINYINT '-123' AS DECIMAL(20, 10))", decimal("-0000000123.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(TINYINT '123' AS DECIMAL(30, 20))", decimal("0000000123.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(TINYINT '-123' AS DECIMAL(30, 20))", decimal("-0000000123.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST(TINYINT '123' AS DECIMAL(18,15))", decimal("123.000000000000000", createDecimalType(18, 15)));
    ...
    {
        assertDecimalFunction("CAST(DOUBLE '234.0' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(DOUBLE '.01' AS DECIMAL(3,3))", decimal(".010", createDecimalType(3, 3)));
        assertDecimalFunction("CAST(DOUBLE '.0' AS DECIMAL(3,3))", decimal(".000", createDecimalType(3, 3)));
        assertDecimalFunction("CAST(DOUBLE '0.0' AS DECIMAL(1,0))", decimal("0", createDecimalType(1)));
        assertDecimalFunction("CAST(DOUBLE '0.0' AS DECIMAL(4,0))", decimal("0000", createDecimalType(4, 0)));
        assertDecimalFunction("CAST(DOUBLE '1000.0' AS DECIMAL(4,0))", decimal("1000", createDecimalType(4, 0)));
        assertDecimalFunction("CAST(DOUBLE '1000.01' AS DECIMAL(7,2))", decimal("01000.01", createDecimalType(7, 2)));
        assertDecimalFunction("CAST(DOUBLE '-234.0' AS DECIMAL(3,0))", decimal("-234", createDecimalType(3)));
        assertDecimalFunction("CAST(DOUBLE '1234567890123456.0' AS DECIMAL(16,0))", decimal("1234567890123456", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890123456.0' AS DECIMAL(16,0))", decimal("-1234567890123456", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '1234567890123456.0' AS DECIMAL(17,0))", decimal("01234567890123456", createDecimalType(17)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890123456.0' AS DECIMAL(17,0))", decimal("-01234567890123456", createDecimalType(17)));
        ...
        // test rounding
        assertDecimalFunction("CAST(DOUBLE '1234567890.49' AS DECIMAL(16,0))", decimal("0000001234567890", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '1234567890.51' AS DECIMAL(16,0))", decimal("0000001234567891", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890.49' AS DECIMAL(16,0))", decimal("-0000001234567890", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890.51' AS DECIMAL(16,0))", decimal("-0000001234567891", createDecimalType(16)));
    ...
    {
        assertDecimalFunction("CAST(DOUBLE '234.0' AS DECIMAL(20,1))", decimal("0000000000000000234.0", createDecimalType(20, 1)));
        assertDecimalFunction("CAST(DOUBLE '.25' AS DECIMAL(20,5))", decimal("000000000000000.25000", createDecimalType(20, 5)));
        assertDecimalFunction("CAST(DOUBLE '.01' AS DECIMAL(20,3))", decimal("00000000000000000.010", createDecimalType(20, 3)));
        assertDecimalFunction("CAST(DOUBLE '.0' AS DECIMAL(20,3))", decimal("00000000000000000.000", createDecimalType(20, 3)));
        assertDecimalFunction("CAST(DOUBLE '0.0' AS DECIMAL(20,0))", decimal("00000000000000000000", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '1000.01' AS DECIMAL(20,2))", decimal("000000000000001000.01", createDecimalType(20, 2)));
        assertDecimalFunction("CAST(DOUBLE '-234.0' AS DECIMAL(20,0))", decimal("-00000000000000000234", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '12345678901234567.0' AS DECIMAL(20,0))", decimal("00012345678901234568", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '-12345678901234567.0' AS DECIMAL(20,0))", decimal("-00012345678901234568", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '1234567890.0' AS DECIMAL(20,10))", decimal("1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890.0' AS DECIMAL(20,10))", decimal("-1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST(DOUBLE '1234567890123456.9' AS DECIMAL(16,0))", decimal("1234567890123457", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890123456.9' AS DECIMAL(16,0))", decimal("-1234567890123457", createDecimalType(16)));
        assertDecimalFunction("CAST(DOUBLE '1234567890123456789012345' AS DECIMAL(30,5))", decimal("1234567890123456800000000.00000", createDecimalType(30, 5)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890123456789012345' AS DECIMAL(30,5))", decimal("-1234567890123456800000000.00000", createDecimalType(30, 5)));
        assertDecimalFunction("CAST(DOUBLE '1.2345678901234568E24' AS DECIMAL(30,5))", decimal("1234567890123456800000000.00000", createDecimalType(30, 5)));
        assertDecimalFunction("CAST(DOUBLE '-1.2345678901234568E24' AS DECIMAL(30,5))", decimal("-1234567890123456800000000.00000", createDecimalType(30, 5)));
        assertDecimalFunction("CAST(DOUBLE '.1234567890123456789012345' AS DECIMAL(30,30))", decimal(".123456789012345680000000000000", createDecimalType(30, 30)));
        assertDecimalFunction("CAST(DOUBLE '-.1234567890123456789012345' AS DECIMAL(30,30))", decimal("-.123456789012345680000000000000", createDecimalType(30, 30)));
        ...
        // test rounding
        assertDecimalFunction("CAST(DOUBLE '1234567890.49' AS DECIMAL(20,0))", decimal("00000000001234567890", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '1234567890.51' AS DECIMAL(20,0))", decimal("00000000001234567891", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890.49' AS DECIMAL(20,0))", decimal("-00000000001234567890", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '-1234567890.51' AS DECIMAL(20,0))", decimal("-00000000001234567891", createDecimalType(20)));
        assertDecimalFunction("CAST(DOUBLE '1234567890.49' AS DECIMAL(10,0))", decimal("1234567890", createDecimalType(10)));
        assertDecimalFunction("CAST(DOUBLE '1234567890.51' AS DECIMAL(10,0))", decimal("1234567891", createDecimalType(10)));
    ...
    {
        assertDecimalFunction("CAST(REAL '234.0' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST(REAL '.01' AS DECIMAL(3,3))", decimal(".010", createDecimalType(3, 3)));
        assertDecimalFunction("CAST(REAL '.0' AS DECIMAL(3,3))", decimal(".000", createDecimalType(3, 3)));
        assertDecimalFunction("CAST(REAL '0' AS DECIMAL(1,0))", decimal("0", createDecimalType(1)));
        assertDecimalFunction("CAST(REAL '0' AS DECIMAL(4,0))", decimal("0000", createDecimalType(4)));
    ...
    {
        assertDecimalFunction("CAST('234.0' AS DECIMAL(4,1))", decimal("234.0", createDecimalType(4, 1)));
        assertDecimalFunction("CAST('.01' AS DECIMAL(3,3))", decimal(".010", createDecimalType(3, 3)));
        assertDecimalFunction("CAST('.0' AS DECIMAL(3,3))", decimal(".000", createDecimalType(3, 3)));
        assertDecimalFunction("CAST('0' AS DECIMAL(1,0))", decimal("0", createDecimalType(1)));
        assertDecimalFunction("CAST('0' AS DECIMAL(4,0))", decimal("0000", createDecimalType(4)));
        assertDecimalFunction("CAST('1000' AS DECIMAL(4,0))", decimal("1000", createDecimalType(4)));
        assertDecimalFunction("CAST('1000.01' AS DECIMAL(7,2))", decimal("01000.01", createDecimalType(7, 2)));
        assertDecimalFunction("CAST('-234.0' AS DECIMAL(3,0))", decimal("-234", createDecimalType(3)));
        assertDecimalFunction("CAST('12345678901234567' AS DECIMAL(17,0))", decimal("12345678901234567", createDecimalType(17)));
        assertDecimalFunction("CAST('123456789012345679' AS DECIMAL(18,0))", decimal("123456789012345679", createDecimalType(18)));
        assertDecimalFunction("CAST('1234567890.12345679' AS DECIMAL(18,8))", decimal("1234567890.12345679", createDecimalType(18, 8)));
        assertDecimalFunction("CAST('-12345678901234567' AS DECIMAL(17,0))", decimal("-12345678901234567", createDecimalType(17)));
        assertDecimalFunction("CAST('1234567890' AS DECIMAL(20,10))", decimal("1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST('-1234567890' AS DECIMAL(20,10))", decimal("-1234567890.0000000000", createDecimalType(20, 10)));
        assertDecimalFunction("CAST('1234567890' AS DECIMAL(30,20))", decimal("1234567890.00000000000000000000", createDecimalType(30, 20)));
        assertDecimalFunction("CAST('-1234567890' AS DECIMAL(30,20))", decimal("-1234567890.00000000000000000000", createDecimalType(30, 20)));
