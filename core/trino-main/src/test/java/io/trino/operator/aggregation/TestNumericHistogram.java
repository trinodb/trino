...
public class TestNumericHistogram
{
    ...
    public void testBasic()
    {
        ...
        assertThat(histogram.getBuckets()).containsExactlyInAnyOrderEntriesOf(expected);
    }
    ...
    public void testRoundtrip()
    {
        ...
        assertThat(deserialized.getBuckets()).containsExactlyInAnyOrderEntriesOf(histogram.getBuckets());
    }
    ...
    public void testMergeDifferent()
    {
        ...
        assertThat(histogram1.getBuckets()).containsExactlyInAnyOrderEntriesOf(expected.getBuckets());
    }
}
