        ...
        extends AbstractTestExtract
{
    ...
    public void testYear()
    {
        ...
        assertThat(assertions.expression("year(DATE '2020-05-10')")).matches("INTEGER '2020'");
        assertThat(assertions.expression("year(DATE '1960-05-10')")).matches("INTEGER '1960'");
    }
    ...
    public void testMonth()
    {
        ...
        assertThat(assertions.expression("month(DATE '2020-05-10')")).matches("TINYINT '5'");
        assertThat(assertions.expression("month(DATE '1960-05-10')")).matches("TINYINT '5'");
    }
    ...
    public void testWeek()
    {
        ...
        assertThat(assertions.expression("week(DATE '2020-05-10')")).matches("TINYINT '19'");
        assertThat(assertions.expression("week(DATE '1960-05-10')")).matches("TINYINT '19'");
    }
    ...
    public void testDay()
    {
        ...
        assertThat(assertions.expression("day(DATE '2020-05-10')")).matches("TINYINT '10'");
        assertThat(assertions.expression("day(DATE '1960-05-10')")).matches("TINYINT '10'");
    }
    ...
    public void testDayOfMonth()
    {
        ...
        assertThat(assertions.expression("day_of_month(DATE '2020-05-10')")).matches("TINYINT '10'");
        assertThat(assertions.expression("day_of_month(DATE '1960-05-10')")).matches("TINYINT '10'");
    }
    ...
    public void testDayOfWeek()
    {
        ...
        assertThat(assertions.expression("day_of_week(DATE '2020-05-10')")).matches("TINYINT '7'");
        assertThat(assertions.expression("day_of_week(DATE '1960-05-10')")).matches("TINYINT '2'");
    }
    ...
    public void testDow()
    {
        ...
        assertThat(assertions.expression("dow(DATE '2020-05-10')")).matches("TINYINT '7'");
        assertThat(assertions.expression("dow(DATE '1960-05-10')")).matches("TINYINT '2'");
    }
    ...
    public void testDayOfYear()
    {
        ...
        assertThat(assertions.expression("day_of_year(DATE '2020-05-10')")).matches("SMALLINT '131'");
        assertThat(assertions.expression("day_of_year(DATE '1960-05-10')")).matches("SMALLINT '131'");
    }
    ...
    public void testDoy()
    {
        ...
        assertThat(assertions.expression("doy(DATE '2020-05-10')")).matches("SMALLINT '131'");
        assertThat(assertions.expression("doy(DATE '1960-05-10')")).matches("SMALLINT '131'");
    }
    ...
    public void testQuarter()
    {
        ...
        assertThat(assertions.expression("quarter(DATE '2020-05-10')")).matches("TINYINT '2'");
        assertThat(assertions.expression("quarter(DATE '1960-05-10')")).matches("TINYINT '2'");
    }
    ...
    public void testYearOfWeek()
    {
        ...
        assertThat(assertions.expression("year_of_week(DATE '2020-05-10')")).matches("INTEGER '2020'");
        assertThat(assertions.expression("year_of_week(DATE '1960-05-10')")).matches("INTEGER '1960'");
    }
    ...
    public void testYow()
    {
        ...
        assertThat(assertions.expression("yow(DATE '2020-05-10')")).matches("INTEGER '2020'");
        assertThat(assertions.expression("yow(DATE '1960-05-10')")).matches("INTEGER '1960'");
    }
}
