...
public class TestExtract
{
    ...
    {
        assertThat(assertions.expression("EXTRACT(YEAR FROM DATE '2020-05-10')")).matches("SMALLINT '2020'");
        assertThat(assertions.expression("EXTRACT(YEAR FROM DATE '1960-05-10')")).matches("SMALLINT '1960'");
    ...
    {
        assertThat(assertions.expression("EXTRACT(YEAR_OF_WEEK FROM DATE '2020-05-10')")).matches("SMALLINT '2020'");
        assertThat(assertions.expression("EXTRACT(YEAR_OF_WEEK FROM DATE '1960-05-10')")).matches("SMALLINT '1960'");
    ...
    public void testYow()
    {
        assertThat(assertions.expression("EXTRACT(YOW FROM DATE '2020-05-10')")).matches("SMALLINT '2020'");
        assertThat(assertions.expression("EXTRACT(YOW FROM DATE '1960-05-10')")).matches("SMALLINT '1960'");
