...
public final class GroupByHashFactoryTestUtils
{
    ...
    {
        return createGroupByHashFactory(new JoinCompiler(typeOperators), blockTypeOperators);
    }
    ...
    {
        return new GroupByHashFactory(joinCompiler, blockTypeOperators, new IsolatedHashTableFactory());
    }
}
