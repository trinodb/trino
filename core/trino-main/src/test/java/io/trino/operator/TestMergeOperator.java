...
public class TestMergeOperator
{
    ...
    {
        return new Split(ExchangeOperator.REMOTE_CONNECTOR_ID, new RemoteSplit(new DirectExchangeInput(taskId, URI.create("http://localhost/" + taskId))), Lifespan.taskWide());
    }
