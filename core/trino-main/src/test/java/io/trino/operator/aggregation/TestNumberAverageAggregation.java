...
public class TestNumberAverageAggregation
        extends AbstractTestAggregationFunction
{
    ...
    protected Object getExpectedValue(int start, int length)
    {
        ...
        BigDecimal average = sum.divide(BigDecimal.valueOf(length), 6, RoundingMode.HALF_UP);
        return new SqlNumber(average.stripTrailingZeros());
    }
