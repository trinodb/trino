...
public class TestColumnarPageProcessor
{
    ...
    private PageProcessor newPageProcessor()
    {
        ...
        return compiler.compilePageProcessor(getTypeResolutionPolicy(TEST_SESSION), true, true, Optional.empty(), Optional.empty(), projections, layout, Optional.empty(), OptionalInt.of(MAX_BATCH_SIZE))
