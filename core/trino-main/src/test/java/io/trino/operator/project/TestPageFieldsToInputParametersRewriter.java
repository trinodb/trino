...
public class TestPageFieldsToInputParametersRewriter
{
    ...
    public void testEagerLoading()
    {
                ...
                ImmutableList.of(new MatchClause(
                        new Bind(
                                ...
                                new Lambda(
                                        ...
                                        new Comparison(EQUAL, new Reference(BIGINT, "operand"), new Reference(BIGINT, "captured")))),
        ...
        verifyEagerlyLoadedColumns(builder.buildExpression(IrExpressions.nullIf(new SymbolAllocator(), new Reference(BIGINT, "bigint0"), new Reference(BIGINT, "bigint1"))), 2);
