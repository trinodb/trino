...
public class TestLookupJoinPageBuilder
{
    ...
    public void testPageBuilder()
    {
        ...
        JoinProbeFactory joinProbeFactory = new JoinProbeFactory(new int[] {0, 1}, ImmutableList.of(0, 1), OptionalInt.empty(), false);
    ...
    public void testDifferentPositions()
    {
        ...
        JoinProbeFactory joinProbeFactory = new JoinProbeFactory(new int[] {0}, ImmutableList.of(0), OptionalInt.empty(), false);
    ...
    public void testCrossJoinWithEmptyBuild()
    {
        ...
        JoinProbe probe = (new JoinProbeFactory(new int[] {0}, ImmutableList.of(0), OptionalInt.empty(), false)).createJoinProbe(page, lookupSource);
        LookupJoinPageBuilder lookupJoinPageBuilder = new LookupJoinPageBuilder(ImmutableList.of(BIGINT));
