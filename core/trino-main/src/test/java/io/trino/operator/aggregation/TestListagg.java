...
public class TestListagg
{
    ...
    private static final InternalAggregationFunction listagg = metadata.getAggregateFunctionImplementation(metadata.resolveFunction(QualifiedName.of("listagg"),
