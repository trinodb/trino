...
public class BenchmarkArrayInnerProduct
{
    ...
    {
        private String name = "inner_product";
    ...
    public void verify()
    {
        ...
        data.setup();
        new BenchmarkArrayInnerProduct().arrayIntersect(data);
    }
            ...
            throws Exception
    {
        ...
        benchmark(BenchmarkArrayInnerProduct.class).run();
    }
}
