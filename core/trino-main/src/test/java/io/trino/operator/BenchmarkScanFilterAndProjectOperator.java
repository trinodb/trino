...
public class BenchmarkScanFilterAndProjectOperator
{
    ...
    public static class Context
    {
        ...
        public void setup()
        {
            ...
            PageProcessor pageProcessor = new ExpressionCompiler(pageFunctionCompiler, compiler).compilePageProcessor(getTypeResolutionPolicy(TEST_SESSION), true, true, Optional.of(getFilter(type)), Optional.empty(), projections, sourceLayout, Optional.empty(), OptionalInt.empty()).apply(DynamicFilter.EMPTY);
