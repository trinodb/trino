...
public class TestPageProcessor
{
    ...
    public void testSelectAllFilterLazyBlock()
    {
        ...
        assertThat(inputFilterBlock.isLoaded()).isTrue();
        assertThat(inputProjectionBlock.isLoaded()).isFalse();
        assertThat(outputPages).hasSize(1);
        ...
        assertThat(inputProjectionBlock.isLoaded()).isTrue();
    }
    ...
    public void testOptimisticProcessing()
    {
        ...
        assertThat(firstProjection.getInvocationCount()).isLessThan(secondProjection.getInvocationCount());
    }
