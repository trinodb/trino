...
public class TestApproximateMostFrequentHistogram
{
    ...
    public void testLongHistogram()
    {
        ...
        assertThat(buckets).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(1L, 2L, 2L, 1L, 3L, 1L));
    }
    ...
    public void testLongRoundtrip()
    {
        ...
        assertThat(deserialized.getBuckets()).containsExactlyInAnyOrderEntriesOf(original.getBuckets());
    }
    ...
    public void testLongMergeOverMaxbuckets()
    {
        ...
        assertThat(buckets).hasSize(3);
        assertThat(buckets).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(1L, 4L, 2L, 4L, 3L, 4L));
    }
    ...
    public void testStringHistogram()
    {
        ...
        assertThat(buckets).hasSize(3);
        assertThat(buckets).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(Slices.utf8Slice("A"), 2L, Slices.utf8Slice("B"), 1L, Slices.utf8Slice("C"), 1L));
    }
    ...
    public void testStringMergeOverMaxbuckets()
    {
        ...
        assertThat(buckets).hasSize(3);
        assertThat(buckets).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(Slices.utf8Slice("A"), 4L, Slices.utf8Slice("B"), 4L, Slices.utf8Slice("C"), 4L));
    }
}
