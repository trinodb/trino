...
public class TestMarkDistinctOperator
{
    ...
    public void testMarkDistinct(boolean hashEnabled)
    {
        ...
        OperatorFactory operatorFactory = new MarkDistinctOperatorFactory(0, new PlanNodeId("test"), rowPagesBuilder.getTypes(), ImmutableList.of(0), rowPagesBuilder.getHashChannel(), groupByHashFactory);
    ...
    public void testMemoryReservationYield(Type type)
    {
        ...
        OperatorFactory operatorFactory = new MarkDistinctOperatorFactory(0, new PlanNodeId("test"), ImmutableList.of(type), ImmutableList.of(0), Optional.of(1), groupByHashFactory);
