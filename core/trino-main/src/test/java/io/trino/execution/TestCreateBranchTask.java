        ...
        extends BaseDataDefinitionTaskTest
{
    ...
    void testCreateDuplicateBranch()
    {
        ...
        assertTrinoExceptionThrownBy(() -> getFutureValue(executeCreateBranch(asQualifiedName(tableName), "main")))
    ...
    void testCreateBranchOnNotExistingTable()
    {
        ...
        assertTrinoExceptionThrownBy(() -> getFutureValue(executeCreateBranch(asQualifiedName(tableName), "not_found")))
    ...
    void testCreateBranchOnView()
    {
        ...
        assertTrinoExceptionThrownBy(() -> getFutureValue(executeCreateBranch(asQualifiedName(viewName), "main")))
    ...
    void testCreateBranchOnMaterializedView()
    {
        ...
        assertTrinoExceptionThrownBy(() -> getFutureValue(executeCreateBranch(viewName, "main")))
                .hasErrorCode(GENERIC_USER_ERROR)
                .hasMessage("line 1:1: Dropping branch from materialized view is not supported");
    }

    private ListenableFuture<Void> executeCreateBranch(QualifiedName tableName, String branchName)
    {
        return new CreateBranchTask(metadata, new AllowAllAccessControl())
                .execute(new CreateBranch(new NodeLocation(1, 1), tableName, new Identifier(branchName)), queryStateMachine, ImmutableList.of(), WarningCollector.NOOP);
    }
