...
public class MockCatalogStoreModule
        implements Module
{
    private final CatalogStore catalogStore;

    public MockCatalogStoreModule(CatalogStore catalogStore)
    {
    ...
    {
        MockCatalogStoreFactory factory = new MockCatalogStoreFactory();
        catalogStoreManager.addCatalogStoreFactory(factory);
        return factory;
    }

    private class MockCatalogStoreFactory
