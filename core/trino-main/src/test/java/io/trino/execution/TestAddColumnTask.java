        ...
        extends BaseDataDefinitionTaskTest
{
    ...
    void testAddDefaultColumn()
    {
        ...
        assertThat(columns.get(1).getDefaultValue()).contains(NullableValue.of(INTEGER, 123L));
    }
    ...
    void testAddDefaultNullAndNotNullColumn()
    {
        ...
        assertThat(columns.get(1).getName()).isEqualTo("new_col");
        assertThat(columns.get(1).getDefaultValue()).contains(NullableValue.asNull(INTEGER));
    }
