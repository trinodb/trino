...
public class TestDynamicFiltersCollector
{
    ...
    public void testDynamicFiltersCollector()
    {
        ...
        assertThat(domains.getDynamicFilterDomains()).isEmpty();
        ...
        assertThat(domains.getDynamicFilterDomains()).containsExactlyEntriesOf(ImmutableMap.of(filter, initialDomain));
        ...
        assertThat(domains.getDynamicFilterDomains()).containsExactlyEntriesOf(ImmutableMap.of(filter, Domain.none(BIGINT)));
        ...
        assertThat(domains.getDynamicFilterDomains()).containsExactlyEntriesOf(ImmutableMap.of(filter2, singleValue(BIGINT, 1L)));
    }
}
