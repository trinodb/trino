...
public class TestCommitTask
{
    ...
    public void testCommit()
    {
        ...
        getFutureValue(new CommitTask().execute(new Commit(), transactionManager, metadata, new AllowAllAccessControl(), stateMachine, emptyList(), EventCollector.NOOP));
    ...
    public void testUnknownTransactionCommit()
    {
        ...
        Future<?> future = new CommitTask().execute(new Commit(), transactionManager, metadata, new AllowAllAccessControl(), stateMachine, emptyList(), EventCollector.NOOP);
