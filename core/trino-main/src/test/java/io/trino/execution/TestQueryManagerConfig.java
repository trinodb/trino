...
public class TestQueryManagerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(QueryManagerConfig.class)
                ...
                .setFaultTolerantExecutionAdaptiveTaskSizingStepSize(10)
                .setFaultTolerantExecutionAdaptiveTaskSizingGrowthFactor(2.0)
                .setFaultTolerantExecutionNonWriterTaskInitTargetInputSize(DataSize.of(512, MEGABYTE))
                .setFaultTolerantExecutionNonWriterTaskMaxInputSize(DataSize.of(4, GIGABYTE))
                .setFaultTolerantExecutionWriterTaskInitTargetInputSize(DataSize.of(4, GIGABYTE))
                .setFaultTolerantExecutionWriterTaskMaxInputSize(DataSize.of(16, GIGABYTE))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("fault-tolerant-execution-adaptive-task-sizing-step-size", "15")
                .put("fault-tolerant-execution-adaptive-task-sizing-growth-factor", "3.0")
                .put("fault-tolerant-execution-non-writer-task-init-target-input-size", "500MB")
                .put("fault-tolerant-execution-non-writer-task-max-input-size", "5GB")
                .put("fault-tolerant-execution-writer-task-init-target-input-size", "2GB")
                .put("fault-tolerant-execution-writer-task-max-input-size", "20GB")
                .put("fault-tolerant-execution-standard-split-size", "256MB")
        ...
        QueryManagerConfig expected = new QueryManagerConfig()
                ...
                .setFaultTolerantExecutionAdaptiveTaskSizingStepSize(15)
                .setFaultTolerantExecutionAdaptiveTaskSizingGrowthFactor(3.0)
                .setFaultTolerantExecutionNonWriterTaskInitTargetInputSize(DataSize.of(500, MEGABYTE))
                .setFaultTolerantExecutionNonWriterTaskMaxInputSize(DataSize.of(5, GIGABYTE))
                .setFaultTolerantExecutionWriterTaskInitTargetInputSize(DataSize.of(2, GIGABYTE))
                .setFaultTolerantExecutionWriterTaskMaxInputSize(DataSize.of(20, GIGABYTE))
                .setFaultTolerantExecutionStandardSplitSize(DataSize.of(256, MEGABYTE))
