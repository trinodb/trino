...
public class TestSetSessionTask
{
    ...
    private void testSetSessionWithParameters(String property, Expression expression, String expectedValue, List<Expression> parameters)
    {
        ...
        QueryStateMachine stateMachine = QueryStateMachine.begin(
                ...
                EventCollector.NOOP,
                Optional.empty());
        getFutureValue(new SetSessionTask().execute(new SetSession(qualifiedPropName, expression), transactionManager, metadata, accessControl, stateMachine, parameters, EventCollector.NOOP));
