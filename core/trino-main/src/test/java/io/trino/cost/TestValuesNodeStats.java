        ...
        extends BaseStatsCalculatorTest
{
    ...
    public void testStatsForValuesNode()
    {
        tester().assertStatsFor(pb -> pb
                        .values(ImmutableList.of(pb.symbol("a", BIGINT), pb.symbol("b", DOUBLE)),
                                ImmutableList.of(
                                        ImmutableList.of(new ArithmeticBinaryExpression(ADD, new Constant(BIGINT, 3L), new Constant(BIGINT, 3L)), new Constant(DOUBLE, 13.5e0)),
    ...
    public void testDivisionByZero()
    {
        tester().assertStatsFor(pb -> pb
                        .values(ImmutableList.of(pb.symbol("a", BIGINT)),
                                ImmutableList.of(ImmutableList.of(new ArithmeticBinaryExpression(DIVIDE, new Constant(INTEGER, 1L), new Constant(INTEGER, 0L))))))
    ...
    public void testStatsForValuesNodeWithJustNulls()
    {
        ...
        tester().assertStatsFor(pb -> pb
                        .values(ImmutableList.of(pb.symbol("a", BIGINT)),
                                ImmutableList.of(
                                        ImmutableList.of(new ArithmeticBinaryExpression(ADD, new Constant(INTEGER, 3L), new Constant(UNKNOWN, null))))))
