...
public class TestFilterStatsCalculator
{
    ...
    public void testAndStats()
    {
        ...
        assertExpression(
                new Logical(AND, ImmutableList.of(
                        IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "x"), new Constant(DOUBLE, -5.0), new Constant(DOUBLE, 5.0)),
        ...
        assertExpression(
                new Logical(AND, ImmutableList.of(
                        IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "x"), new Cast(new Constant(INTEGER, -5L), DOUBLE), new Cast(new Constant(INTEGER, 5L), DOUBLE)),
    ...
    {
        // Only right side cut
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "x"), new Constant(DOUBLE, 7.5), new Constant(DOUBLE, 12.0)))
        ...
        // Only left side cut
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "x"), new Constant(DOUBLE, -12.0), new Constant(DOUBLE, -7.5)))
                .outputRowsCount(93.75)
                .symbolStats("x", symbolStats ->
                        symbolStats.distinctValuesCount(5.0)
                                .lowValue(-10)
        ...
        // Both sides cut
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "x"), new Constant(DOUBLE, -2.5), new Constant(DOUBLE, 2.5)))
        ...
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "unknownRange"), new Constant(DOUBLE, 2.72), new Constant(DOUBLE, 3.14)))
        ...
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "leftOpen"), new Constant(DOUBLE, -10.0), new Constant(DOUBLE, 10.0)))
        ...
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "rightOpen"), new Constant(DOUBLE, -10.0), new Constant(DOUBLE, 10.0)))
                .outputRowsCount(112.5)
        ...
        // Filter all
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "y"), new Constant(DOUBLE, 27.5), new Constant(DOUBLE, 107.0)))
                .outputRowsCount(0.0)
                .symbolStats("y", DOUBLE, SymbolStatsAssertion::empty);

        // Filter nothing
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "y"), new Constant(DOUBLE, -100.0), new Constant(DOUBLE, 100.0)))
        ...
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Reference(DOUBLE, "z"), new Constant(DOUBLE, -100.0), new Constant(DOUBLE, 100.0)))
        ...
        assertExpression(IrExpressions.between(new SymbolAllocator(), new Cast(new Reference(DOUBLE, "x"), createDecimalType(7, 2)), new Constant(createDecimalType(7, 2), Decimals.valueOfShort(new BigDecimal("-2.50"))), new Constant(createDecimalType(7, 2), Decimals.valueOfShort(new BigDecimal("2.50")))))
