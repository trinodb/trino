...
public class TestComparisonStatsCalculator
{
    ...
    {
        // Simple case
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 2.5)))
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("x"), GenericLiteral.constant(DOUBLE, 10.0)))
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 10.0)))
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("leftOpen"), GenericLiteral.constant(DOUBLE, 2.5)))
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("rightOpen"), GenericLiteral.constant(DOUBLE, -2.5)))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("unknownRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("emptyRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
    ...
    {
        // Simple case
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 2.5)))
        ...
        // Literal on the edge of symbol range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("x"), GenericLiteral.constant(DOUBLE, 10.0)))
        ...
        // Literal out of symbol range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 10.0)))
        ...
        // Literal in left open range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("leftOpen"), GenericLiteral.constant(DOUBLE, 2.5)))
        ...
        // Literal in right open range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("rightOpen"), GenericLiteral.constant(DOUBLE, -2.5)))
        ...
        // Literal in unknown range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("unknownRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(882.0) // all rows minus nulls divided by distinct values count
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(49.0)
        ...
        // Literal in empty range
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("emptyRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));
    ...
    {
        // Simple case
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 2.5)))
        ...
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("x"), GenericLiteral.constant(DOUBLE, 10.0)))
        ...
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, -10.0)))
        ...
        // Literal in left open range
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("leftOpen"), GenericLiteral.constant(DOUBLE, 0.0)))
        ...
        // Literal in right open range
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("rightOpen"), GenericLiteral.constant(DOUBLE, 0.0)))
        ...
        // Literal in unknown range
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("unknownRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) // (50% heuristic)
        ...
        // Literal in empty range
        assertCalculate(new ComparisonExpression(LESS_THAN, new SymbolReference("emptyRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));
    }
    ...
    {
        // Simple case
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 2.5)))
                .outputRowsCount(250.0) // all rows minus nulls times range coverage (50%)
                .symbolStats("y", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(10.0)
        ...
        // Literal on the edge of symbol range (whole range included)
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("x"), GenericLiteral.constant(DOUBLE, -10.0)))
                .outputRowsCount(750.0) // all rows minus nulls times range coverage (100%)
                .symbolStats("x", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(40.0)
        ...
        // Literal range out of symbol range
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("y"), GenericLiteral.constant(DOUBLE, 10.0)))
                .outputRowsCount(0.0) // all rows minus nulls times range coverage (0%)
                .symbolStats("y", symbolAssert -> {
                    symbolAssert.averageRowSize(0.0)
                            .distinctValuesCount(0.0)
        ...
        // Literal in left open range
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("leftOpen"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(225.0) // all rows minus nulls times range coverage (25% - heuristic)
                .symbolStats("leftOpen", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(12.5) //(25% heuristic)
        ...
        // Literal in right open range
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("rightOpen"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("rightOpen", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) //(50% heuristic)
        ...
        // Literal in unknown range
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("unknownRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) // (50% heuristic)
        ...
        // Literal in empty range
        assertCalculate(new ComparisonExpression(GREATER_THAN, new SymbolReference("emptyRange"), GenericLiteral.constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));
    }
    ...
    public void symbolToCastExpressionNotEqual()
    {
        ...
        rowCount = 897.0;
        assertCalculate(new ComparisonExpression(NOT_EQUAL, new SymbolReference("u"), new Cast(GenericLiteral.constant(INTEGER, 10L), DOUBLE)))
                .outputRowsCount(rowCount)
