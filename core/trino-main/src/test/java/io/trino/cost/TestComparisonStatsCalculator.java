...
public class TestComparisonStatsCalculator
{
    ...
    {
        // Simple case
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 2.5)))
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "x"), new Constant(DOUBLE, 10.0)))
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 10.0)))
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "leftOpen"), new Constant(DOUBLE, 2.5)))
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "rightOpen"), new Constant(DOUBLE, -2.5)))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "unknownRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
        ...
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "emptyRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));

        // Column with values not representable as double (unknown range)
        assertCalculate(comparison(EQUAL, new Reference(createVarcharType(10), "varchar"), new Constant(createVarcharType(10), Slices.utf8Slice("blah"))))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
    ...
    {
        // Simple case
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 2.5)))
        ...
        // Literal on the edge of symbol range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "x"), new Constant(DOUBLE, 10.0)))
        ...
        // Literal out of symbol range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 10.0)))
        ...
        // Literal in left open range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "leftOpen"), new Constant(DOUBLE, 2.5)))
        ...
        // Literal in right open range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "rightOpen"), new Constant(DOUBLE, -2.5)))
        ...
        // Literal in unknown range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "unknownRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(882.0) // all rows minus nulls divided by distinct values count
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(49.0)
        ...
        // Literal in empty range
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "emptyRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));

        // Column with values not representable as double (unknown range)
        assertCalculate(comparison(NOT_EQUAL, new Reference(createVarcharType(10), "varchar"), new Constant(createVarcharType(10), Slices.utf8Slice("blah"))))
                .outputRowsCount(882.0) // all rows minus nulls divided by distinct values count
                .symbolStats("varchar", createVarcharType(10), symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(49.0)
    ...
    {
        // Simple case
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 2.5)))
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Constant(DOUBLE, 10.0)))
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "y"), new Constant(DOUBLE, -10.0)))
        ...
        // Literal in left open range
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "leftOpen"), new Constant(DOUBLE, 0.0)))
        ...
        // Literal in right open range
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "rightOpen"), new Constant(DOUBLE, 0.0)))
        ...
        // Literal in unknown range
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "unknownRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) // (50% heuristic)
        ...
        // Literal in empty range
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "emptyRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));
    }
    ...
    {
        // Simple case
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 2.5)))
                .outputRowsCount(250.0) // all rows minus nulls times range coverage (50%)
                .symbolStats("y", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(10.0)
        ...
        // Literal on the edge of symbol range (whole range included)
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "x"), new Constant(DOUBLE, -10.0)))
                .outputRowsCount(750.0) // all rows minus nulls times range coverage (100%)
                .symbolStats("x", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(40.0)
        ...
        // Literal range out of symbol range
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "y"), new Constant(DOUBLE, 10.0)))
                .outputRowsCount(0.0) // all rows minus nulls times range coverage (0%)
                .symbolStats("y", symbolAssert -> {
                    symbolAssert.averageRowSize(0.0)
                            .distinctValuesCount(0.0)
        ...
        // Literal in left open range
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "leftOpen"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(225.0) // all rows minus nulls times range coverage (25% - heuristic)
                .symbolStats("leftOpen", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(12.5) // (25% heuristic)
        ...
        // Literal in right open range
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "rightOpen"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("rightOpen", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) // (50% heuristic)
        ...
        // Literal in unknown range
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "unknownRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(450.0) // all rows minus nulls times range coverage (50% - heuristic)
                .symbolStats("unknownRange", symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(25.0) // (50% heuristic)
        ...
        // Literal in empty range
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "emptyRange"), new Constant(DOUBLE, 0.0)))
                .outputRowsCount(0.0)
                .symbolStats("emptyRange", equalTo(emptyRangeStats));
    }
    ...
    public void symbolToSymbolEqualStats()
    {
        ...
        // Equal ranges
        double rowCount = 2.7;
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "u"), new Reference(DOUBLE, "w")))
        ...
        rowCount = 9.375;
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> {
        ...
        rowCount = 16.875;
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> {
        ...
        rowCount = 2.25;
        assertCalculate(comparison(EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "u")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> {
                    symbolAssert.averageRowSize(6)
                            .lowValue(0)
    ...
    public void symbolToSymbolNotEqual()
    {
        ...
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "u"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
        ...
        // One symbol's range is within the other's
        rowCount = 365.625;
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
        ...
        // Partially overlapping ranges
        rowCount = 658.125;
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
                .symbolStats("x", equalTo(capNDV(zeroNullsFraction(xStats), rowCount)))
                .symbolStats("w", equalTo(capNDV(zeroNullsFraction(wStats), rowCount)))
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        ...
        // None of the ranges is included in the other, and one symbol has much higher cardinality, so that it has bigger NDV in intersect than the other in total
        rowCount = 672.75;
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "u")))
                .outputRowsCount(rowCount)
                .symbolStats("x", equalTo(capNDV(zeroNullsFraction(xStats), rowCount)))
                .symbolStats("u", equalTo(capNDV(zeroNullsFraction(uStats), rowCount)))
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
    ...
    public void symbolToCastExpressionNotEqual()
    {
        ...
        assertCalculate(comparison(NOT_EQUAL, new Reference(DOUBLE, "u"), new Constant(DOUBLE, 10.0)))
                .outputRowsCount(rowCount)
    ...
    public void symbolToSymbolInequalityStats()
    {
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "x")))
                .outputRowsCount(rowCount)
                .symbolStats("x", equalTo(capNDV(zeroNullsFraction(xStats), rowCount)));
        ...
        // Equal ranges
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "u"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
                .symbolStats("u", equalTo(capNDV(zeroNullsFraction(uStats), rowCount)))
                .symbolStats("w", equalTo(capNDV(zeroNullsFraction(wStats), rowCount)))
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        ...
        // One symbol's range is within the other's
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
                ...
                .symbolStats("y", symbolAssert -> symbolAssert.averageRowSize(4)
                        ...
                        .nullsFraction(0))
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        assertCalculate(comparison(LESS_THAN_OR_EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(-10)
                        .highValue(5)
        ...
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "y"), new Reference(DOUBLE, "x")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(-10)
                        .highValue(5)
        ...
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(0)
                        .highValue(10)
                ...
                .symbolStats("y", symbolAssert -> symbolAssert.averageRowSize(4)
                        ...
                        .nullsFraction(0))
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        assertCalculate(comparison(GREATER_THAN_OR_EQUAL, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "y")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(0)
                        .highValue(10)
                ...
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        // Flip symbols to be on opposite sides
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "y"), new Reference(DOUBLE, "x")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(0)
                        .highValue(10)
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
                .symbolStats("x", symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(-10)
                        .highValue(10)
                ...
                .symbolStats("z", equalTo(capNDV(zStats, rowCount)));
        // Flip symbols to be on opposite sides
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "w"), new Reference(DOUBLE, "x")))
                .outputRowsCount(rowCount)
        ...
        assertCalculate(comparison(GREATER_THAN, new Reference(DOUBLE, "x"), new Reference(DOUBLE, "w")))
                .outputRowsCount(rowCount)
                .symbolStats("x", DOUBLE, symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(0)
                        .highValue(10)
                ...
                .symbolStats("z", DOUBLE, equalTo(capNDV(zStats, rowCount)));
        // Flip symbols to be on opposite sides
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "w"), new Reference(DOUBLE, "x")))
                .outputRowsCount(rowCount)
                .symbolStats("x", DOUBLE, symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(0)
                        .highValue(10)
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "leftOpen"), new Reference(DOUBLE, "rightOpen")))
                .outputRowsCount(rowCount)
        ...
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "leftOpen"), new Reference(DOUBLE, "unknownNdvRange")))
                .outputRowsCount(rowCount)
                .symbolStats("leftOpen", DOUBLE, symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(NEGATIVE_INFINITY)
                        .highValue(10)
        ...
        rowCount = nonNullRowCount * OVERLAPPING_RANGE_INEQUALITY_FILTER_COEFFICIENT;
        assertCalculate(comparison(LESS_THAN, new Reference(DOUBLE, "leftOpen"), new Reference(DOUBLE, "unknownRange")))
                .outputRowsCount(rowCount)
                .symbolStats("leftOpen", DOUBLE, symbolAssert -> symbolAssert.averageRowSize(4)
                        .lowValue(NEGATIVE_INFINITY)
                        .highValue(15)
