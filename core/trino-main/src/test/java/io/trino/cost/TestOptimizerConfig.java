...
public class TestOptimizerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(OptimizerConfig.class)
                ...
                .setMaxEnumeratedJoinOrders(10_000)
                .setUsePartitioningInJoinCost(false)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("optimizer.low-confidence-cost-margin", "2.5")
                ...
                .put("optimizer.max-enumerated-join-orders", "1234")
                .put("optimizer.use-partitioning-in-join-cost", "true")
        ...
        OptimizerConfig expected = new OptimizerConfig()
                ...
                .setLowConfidenceCostMargin(2.5)
                ...
                .setMaxEnumeratedJoinOrders(1234)
                .setUsePartitioningInJoinCost(true)
