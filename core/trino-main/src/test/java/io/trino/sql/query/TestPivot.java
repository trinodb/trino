...
public class TestPivot
{
    ...
    {
        // IN values are evaluated per input row, so they cannot contain an aggregate
        // any more than WHERE or PARTITION BY can.
        assertThat(assertions.query(
                """
                SELECT *
                FROM %s
    ...
    public void testGroupByAutoRejected()
    {
        ...
        assertThat(assertions.query(
                ...
                .hasMessageContaining("GROUP BY AUTO requires a SELECT list");
    }
