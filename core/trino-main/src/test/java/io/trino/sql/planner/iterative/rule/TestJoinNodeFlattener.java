...
public class TestJoinNodeFlattener
{
    ...
    public void testDoesNotAllowOuterJoin()
    {
        ...
        JoinNode outerJoin = p.join(
                ...
                ImmutableList.of(b1),
                Optional.empty());
        assertThatThrownBy(() -> toMultiJoinNode(queryRunner.getMetadata(), outerJoin, noLookup(), planNodeIdAllocator, DEFAULT_JOIN_LIMIT, false, testSessionBuilder().build(), createTestingTypeAnalyzer(queryRunner.getMetadata()), p.getTypes()))
    ...
    public void testDoesNotConvertNestedOuterJoins()
    {
        ...
        MultiJoinNode expected = MultiJoinNode.builder()
                ...
                .build();
        assertEquals(
                toMultiJoinNode(queryRunner.getMetadata(), joinNode, noLookup(), planNodeIdAllocator, DEFAULT_JOIN_LIMIT, false, testSessionBuilder().build(), createTestingTypeAnalyzer(queryRunner.getMetadata()), p.getTypes()),
                expected);
    }
    ...
    public void testPushesProjectionsThroughJoin()
    {
        ...
        JoinNode joinNode = p.join(
                ...
                valuesC,
                equiJoinClause(d, c));
        MultiJoinNode actual = toMultiJoinNode(queryRunner.getMetadata(), joinNode, noLookup(), planNodeIdAllocator, DEFAULT_JOIN_LIMIT, true, testSessionBuilder().build(), createTestingTypeAnalyzer(queryRunner.getMetadata()), p.getTypes());
    ...
    public void testConvertsBushyTrees()
    {
        ...
        MultiJoinNode expected = MultiJoinNode.builder()
                ...
                .build();
        assertEquals(
                toMultiJoinNode(queryRunner.getMetadata(), joinNode, noLookup(), planNodeIdAllocator, 5, false, testSessionBuilder().build(), createTestingTypeAnalyzer(queryRunner.getMetadata()), p.getTypes()),
                expected);
    }
    ...
    public void testMoreThanJoinLimit()
    {
        ...
        MultiJoinNode expected = MultiJoinNode.builder()
                ...
                .build();
        assertEquals(
                toMultiJoinNode(queryRunner.getMetadata(), joinNode, noLookup(), planNodeIdAllocator, 2, false, testSessionBuilder().build(), createTestingTypeAnalyzer(queryRunner.getMetadata()), p.getTypes()),
                expected);
    }
