        ...
        extends BasePlanTest
{
    ...
    {
        testUnwrap("date", "year(a) = -0001", IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-12-31"))));
        testUnwrap("date", "year(a) = 1960", IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-12-31"))));
        testUnwrap("date", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-12-31"))));
        testUnwrap("date", "year(a) = 9999", IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-12-31"))));

        testUnwrap("timestamp", "year(a) = -0001", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "-0001-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "-0001-12-31 23:59:59.999"))));
        testUnwrap("timestamp", "year(a) = 1960", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1960-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1960-12-31 23:59:59.999"))));
        testUnwrap("timestamp", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-12-31 23:59:59.999"))));
        testUnwrap("timestamp", "year(a) = 9999", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "9999-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "9999-12-31 23:59:59.999"))));

        testUnwrap("timestamp(0)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(0), "a"), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-01-01 00:00:00")), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-12-31 23:59:59"))));
        testUnwrap("timestamp(1)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(1), "a"), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-01-01 00:00:00.0")), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-12-31 23:59:59.9"))));
        testUnwrap("timestamp(2)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(2), "a"), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-01-01 00:00:00.00")), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-12-31 23:59:59.99"))));
        testUnwrap("timestamp(3)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-12-31 23:59:59.999"))));
        testUnwrap("timestamp(4)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(4), "a"), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-01-01 00:00:00.0000")), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-12-31 23:59:59.9999"))));
        testUnwrap("timestamp(5)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(5), "a"), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-01-01 00:00:00.00000")), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-12-31 23:59:59.99999"))));
        testUnwrap("timestamp(6)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(6), "a"), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-01-01 00:00:00.000000")), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-12-31 23:59:59.999999"))));
        testUnwrap("timestamp(7)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(7), "a"), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-01-01 00:00:00.0000000")), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-12-31 23:59:59.9999999"))));
        testUnwrap("timestamp(8)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(8), "a"), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-01-01 00:00:00.00000000")), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-12-31 23:59:59.99999999"))));
        testUnwrap("timestamp(9)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(9), "a"), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-01-01 00:00:00.000000000")), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-12-31 23:59:59.999999999"))));
        testUnwrap("timestamp(10)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(10), "a"), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-01-01 00:00:00.0000000000")), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-12-31 23:59:59.9999999999"))));
        testUnwrap("timestamp(11)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(11), "a"), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-01-01 00:00:00.00000000000")), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-12-31 23:59:59.99999999999"))));
        testUnwrap("timestamp(12)", "year(a) = 2022", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(12), "a"), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-01-01 00:00:00.000000000000")), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-12-31 23:59:59.999999999999"))));
    }

    @Test
    public void testInPredicate()
    {
        testUnwrap("date", "year(a) IN (1000, 1400, 1800)", new Logical(OR, ImmutableList.of(IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1000-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("1000-12-31"))), IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1400-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("1400-12-31"))), IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1800-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("1800-12-31"))))));
        testUnwrap("timestamp", "year(a) IN (1000, 1400, 1800)", new Logical(OR, ImmutableList.of(IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1000-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1000-12-31 23:59:59.999"))), IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1400-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1400-12-31 23:59:59.999"))), IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1800-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1800-12-31 23:59:59.999"))))));
    }

    @Test
    public void testNotEquals()
    {
        testUnwrap("date", "year(a) <> -0001", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-12-31"))))));
        testUnwrap("date", "year(a) <> 1960", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-12-31"))))));
        testUnwrap("date", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-12-31"))))));
        testUnwrap("date", "year(a) <> 9999", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-12-31"))))));

        testUnwrap("timestamp", "year(a) <> -0001", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "-0001-01-01 00:00:00.000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "-0001-12-31 23:59:59.999"))))));
        testUnwrap("timestamp", "year(a) <> 1960", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1960-01-01 00:00:00.000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "1960-12-31 23:59:59.999"))))));
        testUnwrap("timestamp", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-01-01 00:00:00.000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-12-31 23:59:59.999"))))));
        testUnwrap("timestamp", "year(a) <> 9999", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "9999-01-01 00:00:00.000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "9999-12-31 23:59:59.999"))))));

        testUnwrap("timestamp(0)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(0), "a"), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-01-01 00:00:00"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(0), "a"), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-12-31 23:59:59"))))));
        testUnwrap("timestamp(1)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(1), "a"), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-01-01 00:00:00.0"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(1), "a"), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-12-31 23:59:59.9"))))));
        testUnwrap("timestamp(2)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(2), "a"), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-01-01 00:00:00.00"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(2), "a"), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-12-31 23:59:59.99"))))));
        testUnwrap("timestamp(3)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-01-01 00:00:00.000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2022-12-31 23:59:59.999"))))));
        testUnwrap("timestamp(4)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(4), "a"), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-01-01 00:00:00.0000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(4), "a"), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-12-31 23:59:59.9999"))))));
        testUnwrap("timestamp(5)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(5), "a"), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-01-01 00:00:00.00000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(5), "a"), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-12-31 23:59:59.99999"))))));
        testUnwrap("timestamp(6)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(6), "a"), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-01-01 00:00:00.000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(6), "a"), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-12-31 23:59:59.999999"))))));
        testUnwrap("timestamp(7)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(7), "a"), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-01-01 00:00:00.0000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(7), "a"), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-12-31 23:59:59.9999999"))))));
        testUnwrap("timestamp(8)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(8), "a"), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-01-01 00:00:00.00000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(8), "a"), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-12-31 23:59:59.99999999"))))));
        testUnwrap("timestamp(9)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(9), "a"), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-01-01 00:00:00.000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(9), "a"), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-12-31 23:59:59.999999999"))))));
        testUnwrap("timestamp(10)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(10), "a"), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-01-01 00:00:00.0000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(10), "a"), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-12-31 23:59:59.9999999999"))))));
        testUnwrap("timestamp(11)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(11), "a"), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-01-01 00:00:00.00000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(11), "a"), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-12-31 23:59:59.99999999999"))))));
        testUnwrap("timestamp(12)", "year(a) <> 2022", new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN, new Reference(createTimestampType(12), "a"), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-01-01 00:00:00.000000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(12), "a"), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-12-31 23:59:59.999999999999"))))));
    }
    ...
    {
        testUnwrap("date", "year(a) IS DISTINCT FROM -0001", new Logical(OR, ImmutableList.of(new IsNull(new Reference(DATE, "a")), new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("-0001-12-31"))))));
        testUnwrap("date", "year(a) IS DISTINCT FROM 1960", new Logical(OR, ImmutableList.of(new IsNull(new Reference(DATE, "a")), new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("1960-12-31"))))));
        testUnwrap("date", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(DATE, "a")), new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-12-31"))))));
        testUnwrap("date", "year(a) IS DISTINCT FROM 9999", new Logical(OR, ImmutableList.of(new IsNull(new Reference(DATE, "a")), new Comparison(LESS_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-01-01"))), new Comparison(GREATER_THAN, new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("9999-12-31"))))));
        ...
        testUnwrap("timestamp(0)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(0), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(0), "a"), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-01-01 00:00:00"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(0), "a"), new Constant(createTimestampType(0), DateTimes.parseTimestamp(0, "2022-12-31 23:59:59"))))));
        testUnwrap("timestamp(1)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(1), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(1), "a"), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-01-01 00:00:00.0"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(1), "a"), new Constant(createTimestampType(1), DateTimes.parseTimestamp(1, "2022-12-31 23:59:59.9"))))));
        testUnwrap("timestamp(2)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(2), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(2), "a"), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-01-01 00:00:00.00"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(2), "a"), new Constant(createTimestampType(2), DateTimes.parseTimestamp(2, "2022-12-31 23:59:59.99"))))));
        ...
        testUnwrap("timestamp(4)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(4), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(4), "a"), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-01-01 00:00:00.0000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(4), "a"), new Constant(createTimestampType(4), DateTimes.parseTimestamp(4, "2022-12-31 23:59:59.9999"))))));
        testUnwrap("timestamp(5)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(5), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(5), "a"), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-01-01 00:00:00.00000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(5), "a"), new Constant(createTimestampType(5), DateTimes.parseTimestamp(5, "2022-12-31 23:59:59.99999"))))));
        testUnwrap("timestamp(6)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(6), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(6), "a"), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-01-01 00:00:00.000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(6), "a"), new Constant(createTimestampType(6), DateTimes.parseTimestamp(6, "2022-12-31 23:59:59.999999"))))));
        testUnwrap("timestamp(7)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(7), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(7), "a"), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-01-01 00:00:00.0000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(7), "a"), new Constant(createTimestampType(7), DateTimes.parseTimestamp(7, "2022-12-31 23:59:59.9999999"))))));
        testUnwrap("timestamp(8)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(8), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(8), "a"), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-01-01 00:00:00.00000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(8), "a"), new Constant(createTimestampType(8), DateTimes.parseTimestamp(8, "2022-12-31 23:59:59.99999999"))))));
        testUnwrap("timestamp(9)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(9), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(9), "a"), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-01-01 00:00:00.000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(9), "a"), new Constant(createTimestampType(9), DateTimes.parseTimestamp(9, "2022-12-31 23:59:59.999999999"))))));
        testUnwrap("timestamp(10)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(10), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(10), "a"), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-01-01 00:00:00.0000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(10), "a"), new Constant(createTimestampType(10), DateTimes.parseTimestamp(10, "2022-12-31 23:59:59.9999999999"))))));
        testUnwrap("timestamp(11)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(11), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(11), "a"), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-01-01 00:00:00.00000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(11), "a"), new Constant(createTimestampType(11), DateTimes.parseTimestamp(11, "2022-12-31 23:59:59.99999999999"))))));
        testUnwrap("timestamp(12)", "year(a) IS DISTINCT FROM 2022", new Logical(OR, ImmutableList.of(new IsNull(new Reference(createTimestampType(12), "a")), new Comparison(LESS_THAN, new Reference(createTimestampType(12), "a"), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-01-01 00:00:00.000000000000"))), new Comparison(GREATER_THAN, new Reference(createTimestampType(12), "a"), new Constant(createTimestampType(12), DateTimes.parseTimestamp(12, "2022-12-31 23:59:59.999999999999"))))));
    }
    ...
    public void smokeTests()
    {
        ...
        for (String type : asList("SMALLINT", "INTEGER", "BIGINT", "REAL", "DOUBLE")) {
            testUnwrap("date", format("year(a) = %s '2022'", type), IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-12-31"))));
        }
    }
    ...
    public void testTermOrder()
    {
        ...
        assertPlan(
                ...
                output(
                        filter(
                                IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "A"), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("2022-12-31"))),
                                values("A"))));
    }
    ...
    {
        testUnwrap("date", "year(a) = 2024", IrExpressions.between(new SymbolAllocator(), new Reference(DATE, "a"), new Constant(DATE, (long) DateTimeUtils.parseDate("2024-01-01")), new Constant(DATE, (long) DateTimeUtils.parseDate("2024-12-31"))));
        testUnwrap("timestamp", "year(a) = 2024", IrExpressions.between(new SymbolAllocator(), new Reference(createTimestampType(3), "a"), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2024-01-01 00:00:00.000")), new Constant(createTimestampType(3), DateTimes.parseTimestamp(3, "2024-12-31 23:59:59.999"))));
    }
