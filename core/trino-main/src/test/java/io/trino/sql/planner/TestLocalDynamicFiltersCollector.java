...
public class TestLocalDynamicFiltersCollector
{
    ...
    public void testSingleEquality()
    {
        ...
        assertThat(filter.getColumnsCovered()).withFailMessage("columns covered").hasSameElementsAs(Set.of(column));
    ...
    public void testMultipleProbeColumns()
    {
        ...
        assertThat(filter.getColumnsCovered()).withFailMessage("columns covered").hasSameElementsAs(Set.of(column1, column2));
