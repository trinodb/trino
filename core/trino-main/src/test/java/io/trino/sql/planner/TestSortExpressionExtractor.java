...
public class TestSortExpressionExtractor
{
    ...
    public void testGetSortExpression()
    {
        ...
        assertGetSortExpression(
                new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Call(SIN, ImmutableList.of(new Reference(BIGINT, "p1")))),
                "b2");

        assertNoSortExpression(new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Call(RANDOM, ImmutableList.of(new Reference(BIGINT, "p1")))));

        assertGetSortExpression(
                new Logical(AND, ImmutableList.of(new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Call(RANDOM, ImmutableList.of(new Reference(BIGINT, "p1")))), new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")))),
                "b2",
                new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")));
        ...
        assertNoSortExpression(new Comparison(GREATER_THAN, new Reference(BIGINT, "b1"), new Arithmetic(ADD_INTEGER, ADD, new Reference(INTEGER, "p1"), new Reference(INTEGER, "b2"))));

        assertNoSortExpression(new Comparison(GREATER_THAN, new Call(SIN, ImmutableList.of(new Reference(BIGINT, "b1"))), new Reference(BIGINT, "p1")));
        ...
        assertNoSortExpression(new Logical(AND, ImmutableList.of(new Comparison(GREATER_THAN, new Call(SIN, ImmutableList.of(new Reference(BIGINT, "b2"))), new Reference(BIGINT, "p1")), new Logical(OR, ImmutableList.of(new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")), new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Arithmetic(ADD_INTEGER, ADD, new Reference(INTEGER, "p1"), new Constant(INTEGER, 10L))))))));

        assertGetSortExpression(
                new Logical(AND, ImmutableList.of(new Comparison(GREATER_THAN, new Call(SIN, ImmutableList.of(new Reference(BIGINT, "b2"))), new Reference(BIGINT, "p1")), new Logical(AND, ImmutableList.of(new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")), new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Arithmetic(ADD_INTEGER, ADD, new Reference(INTEGER, "p1"), new Constant(INTEGER, 10L))))))),
                "b2",
                new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")),
                new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "b2"), new Arithmetic(ADD_INTEGER, ADD, new Reference(INTEGER, "p1"), new Constant(INTEGER, 10L))));
        ...
        assertGetSortExpression(
                ...
                "b2",
                new Comparison(GREATER_THAN, new Reference(BIGINT, "b2"), new Reference(BIGINT, "p1")),
                new Comparison(LESS_THAN, new Reference(BIGINT, "b2"), new Arithmetic(ADD_INTEGER, ADD, new Reference(INTEGER, "p1"), new Constant(INTEGER, 10L))),
