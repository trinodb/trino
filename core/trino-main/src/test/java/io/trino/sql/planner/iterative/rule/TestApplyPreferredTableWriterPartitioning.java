...
public class TestApplyPreferredTableWriterPartitioning
{
    ...
    public Object[][] preferWritePartitioningDataProvider()
    {
        return new Object[][] {
                ...
                new Object[] {SESSION_WITH_PREFERRED_PARTITIONING_DEFAULT_THRESHOLD, NO_STATS, true},
                new Object[] {SESSION_WITH_PREFERRED_PARTITIONING_DEFAULT_THRESHOLD, NaN, true},
