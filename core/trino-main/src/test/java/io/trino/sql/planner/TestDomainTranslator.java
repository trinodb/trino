...
public class TestDomainTranslator
{
    ...
    public void testFromCoercionComparisonsWithNaN()
    {
        ...
        assertUnsupportedPredicate(equal(cast(C_TINYINT, DOUBLE), nanDouble));
        assertUnsupportedPredicate(equal(cast(C_SMALLINT, DOUBLE), nanDouble));
        assertUnsupportedPredicate(equal(cast(C_INTEGER, DOUBLE), nanDouble));
    }
