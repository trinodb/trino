        ...
        extends BaseRuleTest
{
    ...
    private Rule<?> rule = new TransformCorrelatedScalarSubquery(createTestingMetadataManager());
    ...
    private Expression ensureScalarSubquery()
    {
        return new Match(
                ...
                new Cast(
                        failFunction(tester().getMetadata(), getTypeResolutionPolicy(TEST_SESSION), SUBQUERY_MULTIPLE_ROWS, "Scalar sub-query has returned multiple rows"),
                        BOOLEAN));
    }
