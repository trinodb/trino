...
public class TestAggregationsInRowPatternMatching
{
    ...
    public void testSimpleQuery()
    {
        ...
        assertThat(assertions.query("SELECT m.id, m.running_sum " +
                "          FROM (VALUES " +
                "                   (1), " +
                "                   (2), " +
                "                   (3), " +
        ...
        assertThat(assertions.query("SELECT m.id, m.running_labels " +
                "          FROM (VALUES " +
                "                   (1), " +
                "                   (2), " +
                "                   (3), " +
    ...
    public void testPartitioning()
    {
        ...
        assertThat(assertions.query("SELECT m.part as partition, m.id AS row_id, m.running_sum " +
                "          FROM (VALUES " +
                "                   (1, 'p1', 1), " +
                "                   (2, 'p1', 1), " +
                "                   (6, 'p1', 1), " +
        ...
        assertThat(assertions.query("SELECT m.part as partition, m.match_no, m.id AS row_id, m.running_sum " +
                "          FROM (VALUES " +
                "                   (1, 'p1', 1), " +
                "                   (2, 'p1', 1), " +
                "                   (6, 'p1', 1), " +
    ...
    {
        assertThat(assertions.query("SELECT m.id, m.classy, m.running_avg_B " +
                "          FROM (VALUES " +
                "                   (1, 4), " +
                "                   (2, 6), " +
                "                   (3, 0) " +
        ...
        assertThat(assertions.query("SELECT m.id, m.classy, m.running_avg_A " +
                "          FROM (VALUES " +
                "                   (1, 4), " +
                "                   (2, 6), " +
                "                   (3, 0), " +
        ...
        // need to drop the tentative match of label `A`.
        assertThat(assertions.query("SELECT m.part as partition, m.id AS row_id, m.classy, m.running_sum " +
                "          FROM (VALUES " +
                "                   (1, 'p1', 1), " +
                "                   (2, 'p1', 1), " +
                "                   (3, 'p1', 1), " +
        ...
        // need to drop the tentative match of label `A`.
        assertThat(assertions.query("SELECT m.part as partition, m.id AS row_id, m.classy, m.running_max " +
                "          FROM (VALUES " +
                "                   (1, 'p1', 1), " +
                "                   (2, 'p1', 2), " +
                "                   (3, 'p1', 3), " +
    ...
    public void testAggregationArguments()
    {
        ...
        assertThat(assertions.query("SELECT m.part, m.id, m.measure " +
                "          FROM (VALUES " +
                "                   ('p1', 1, 'a'), " +
                "                   ('p1', 2, 'b'), " +
                "                   ('p1', 3, 'c'), " +
        ...
        assertThat(assertions.query("SELECT m.id, m.measure " +
                "          FROM (VALUES " +
                "                   (1, 'a'), " +
                "                   (2, 'b'), " +
                "                   (3, 'c') " +
        ...
        assertThat(assertions.query("SELECT m.id, m.measure_1, m.measure_2, m.measure_3 " +
                "          FROM (VALUES " +
                "                   (1, 'a'), " +
                "                   (2, 'b'), " +
                "                   (3, 'c') " +
    ...
    {
        assertThat(assertions.query("SELECT m.id, m.measure_1, m.measure_2 " +
                "          FROM (VALUES " +
                "                   (1, 'a'), " +
                "                   (2, 'b'), " +
                "                   (3, 'c'), " +
        ...
        assertThat(assertions.query("SELECT m.id, m.measure_1, m.measure_2, m.measure_3, m.measure_4 " +
                "          FROM (VALUES " +
                "                   (1, 'a'), " +
                "                   (2, 'b'), " +
                "                   (3, 'c'), " +
    ...
    public void testLabelAndColumnNames()
    {
        ...
        assertThat(assertions.query("SELECT m.id, m.classy, m.measure_1, m.measure_2, m.measure_3 " +
                "          FROM (VALUES " +
                "                   (1, 'p'), " +
                "                   (2, 'q'), " +
                "                   (3, null), " +
                ...
                "                   MEASURES " +
                "                           CLASSIFIER() AS classy, " +
                "                           count(A.A) AS measure_1, " + // count non-null values in column `A`, in rows matched to label `A`
                "                           count(A) AS measure_2, " + // count non-null values in column `A`, regardless of matched label
                "                           count(A.*) AS measure_3 " + // count rows matched to label `A`
                "                   ALL ROWS PER MATCH " +
                "                   PATTERN (A B A A) " +
                "                   DEFINE A AS true " +
                "                ) AS m"))
    ...
    {
        assertThat(assertions.query("SELECT m.part, m.measure " +
                "          FROM (VALUES " +
                "                   ('p1', 1, 'a'), " +
                "                   ('p1', 2, 'b'), " +
                "                   ('p1', 3, 'c'), " +
    ...
    public void testSeek()
    {
        ...
        assertThat(assertions.query("SELECT part, id, measure_1 OVER w, measure_2 OVER w " +
                "          FROM (VALUES " +
                "                   (1, 'p1', 'A'), " +
                "                   (2, 'p1', 'B'), " +
                "                   (3, 'p1', 'C'), " +
    ...
    {
        assertThat(assertions.query("SELECT m.part, m.measure_1, m.measure_2 " +
                "          FROM (VALUES " +
                "                   ('p1', 1, '1a'), " +
                "                   ('p1', 2, '1b'), " +
                "                   ('p1', 3, '1c'), " +
    ...
    {
        assertThat(assertions.query("SELECT m.id, m.classy, m.running_sum_A, m.running_sum_B " +
                "          FROM (VALUES " +
                "                   (1, 4), " +
                "                   (2, 6), " +
                "                   (3, 10), " +
    ...
    {
        assertThat(assertions.query("SELECT user_id, CAST(periods_total AS integer) " +
                "          FROM (VALUES " +
                "                   (1, 3), " +
                "                   (1, 4), " +
                "                   (1, 5), " +
                ...
                "                   ONE ROW PER MATCH " +
                "                   PATTERN ((A B* C | D)*) " + // D is for 1-element sequences; A B* C is for longer sequences
                "                   DEFINE " +
    ...
    public void testMultipleAggregationsInDefine()
    {
        ...
        assertThat(assertions.query("SELECT m.match_no, m.labels " +
                "          FROM (VALUES (1), (2), (3), (4), (5), (6), (7), (8)) t(id) " +
                "                 MATCH_RECOGNIZE ( " +
                "                   ORDER BY id " +
                "                   MEASURES " +
    ...
    public void testRunningAndFinalAggregations()
    {
        ...
        assertThat(assertions.query("SELECT m.id, m.match, m.running_labels, m.final_labels, m.running_match, m.final_match " +
                "          FROM (VALUES (1), (2), (3), (4), (5), (6), (7), (8)) t(id) " +
                "                 MATCH_RECOGNIZE ( " +
                "                   ORDER BY id " +
                "                   MEASURES " +
    ...
    public void testMultipleAggregationArguments()
    {
        ...
        assertThat(assertions.query("SELECT m.id, m.classy, m.match, m.running_measure, m.final_measure " +
                "          FROM (VALUES (1), (2), (3), (4), (5), (6), (7), (8)) t(id) " +
                "                 MATCH_RECOGNIZE ( " +
                "                   ORDER BY id " +
                "                   MEASURES " +
