                        ...
                        join(INNER, builder -> builder
                                ...
                                .right(
                                        anyTree(
                                                project(
                                                        filter(
                                                                comparison(EQUAL, new Constant(createVarcharType(4), Slices.utf8Slice("x")), new Cast(new Reference(createVarcharType(4), "u_v"), createVarcharType(4))),
                ...
                anyTree(
                        join(INNER, builder -> builder
                                ...
                                .right(
                                        anyTree(
                                                filter(
                                                        not(getPlanTester().getPlannerContext().getMetadata(), getTypeResolutionPolicy(TEST_SESSION), new IsNull(new Reference(VARCHAR, "c_name"))),
