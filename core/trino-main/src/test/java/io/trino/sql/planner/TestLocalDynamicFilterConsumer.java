        ...
        extends BasePlanTest
{
    ...
    public void testSimple()
    {
        ...
        assertThat(filter.getBuildChannels()).containsExactlyEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), 0));
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), Domain.singleValue(INTEGER, 7L)));
    }
    ...
    public void testShortCircuitOnAllTupleDomain()
    {
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), Domain.all(INTEGER)));
    ...
    public void testMultiplePartitions()
    {
        ...
        assertThat(collector.isCollectionComplete()).isFalse();
        filter.setPartitionCount(2);
        assertThat(collector.getCollectedDomains()).containsExactlyEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), Domain.multipleValues(INTEGER, ImmutableList.of(10L, 20L))));
    }
    ...
    public void testAllDomain()
    {
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(filter1, Domain.all(INTEGER), filter2, Domain.singleValue(INTEGER, 1L)));
    }
    ...
    public void testNone()
    {
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), Domain.none(INTEGER)));
    }
    ...
    public void testMultipleColumns()
    {
        ...
        LocalDynamicFilterConsumer filter = new LocalDynamicFilterConsumer(
                ...
                DataSize.of(100, KILOBYTE));
        filter.setPartitionCount(1);
        assertThat(filter.getBuildChannels()).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(new DynamicFilterId("123"), 0, new DynamicFilterId("456"), 1));
        assertThat(collector.isCollectionComplete()).isFalse();

        filter.addPartition(TupleDomain.withColumnDomains(ImmutableMap.of(
                new DynamicFilterId("123"), Domain.singleValue(INTEGER, 10L),
                new DynamicFilterId("456"), Domain.singleValue(INTEGER, 20L))));
        assertThat(collector.getCollectedDomains()).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(
                new DynamicFilterId("123"), Domain.singleValue(INTEGER, 10L),
                new DynamicFilterId("456"), Domain.singleValue(INTEGER, 20L)));
    }
    ...
    public void testDynamicFilterPruning()
    {
        ...
        LocalDynamicFilterConsumer consumer = LocalDynamicFilterConsumer.create(
                ...
                ImmutableList.of(collector),
                DataSize.of(100, KILOBYTE));
        assertThat(consumer.getBuildChannels()).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(filter1, 0, filter3, 2));
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyInAnyOrderEntriesOf(ImmutableMap.of(filter1, Domain.none(BIGINT), filter3, Domain.none(SMALLINT)));
    }
    ...
    public void testSizeLimitExceededAfterCompaction()
    {
        ...
        assertThat(collector.getCollectedDomains()).containsExactlyEntriesOf(ImmutableMap.of(filterId, Domain.all(VARCHAR)));
    }
