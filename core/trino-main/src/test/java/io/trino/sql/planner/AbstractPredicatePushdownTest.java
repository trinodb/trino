    ...
    public void testBetweenPredicatePushdown()
    {
        ...
        assertPlan(
                ...
                output(
                        join(INNER, builder -> builder
                                ...
                                .filter(new ComparisonExpression(LESS_THAN_OR_EQUAL, new SymbolReference("name"), new Cast(new SymbolReference("comment"), dataType("varchar(55)"))))
                                .left(anyIfDynamicFilteringEnabled(tableScan(
                                        "lineitem",
                                        ImmutableMap.of("l_partkey", "partkey", "comment", "comment"))))
                                .right(anyTree(
                                        filter(
                                                new ComparisonExpression(GREATER_THAN_OR_EQUAL, new SymbolReference("name"), new Cast(new StringLiteral("f"), dataType("varchar(55)"))),
                                                tableScan(
                                                        "part",
                ...
                output(
                        join(INNER, builder -> builder
                                ...
                                .filter(new BetweenPredicate(
                                        new FunctionCall(QualifiedName.of("concat"), ImmutableList.of(new Cast(new SymbolReference("name"), dataType("varchar")), new GenericLiteral("VARCHAR", "X"))),
                                        new GenericLiteral("VARCHAR", "f"),
                                        new Cast(new SymbolReference("comment"), dataType("varchar"))))
        ...
        assertPlan(
                ...
                output(
                        join(INNER, builder -> builder
                                .equiCriteria("l_partkey", "p_partkey")
                                .filter(new ComparisonExpression(GREATER_THAN_OR_EQUAL, new SymbolReference("name"), new Cast(new SymbolReference("comment"), dataType("varchar(55)"))))
                                .left(anyIfDynamicFilteringEnabled(tableScan(
                                        "lineitem",
                                        ImmutableMap.of("l_partkey", "partkey", "comment", "comment"))))
                                .right(anyTree(
                                        filter(
                                                new ComparisonExpression(LESS_THAN_OR_EQUAL, new SymbolReference("name"), new Cast(new StringLiteral("f"), dataType("varchar(55)"))),
                                                tableScan(
                                                        "part",
                                                        ImmutableMap.of("p_partkey", "partkey", "name", "name"))))))));
        ...
        assertPlan(
                ...
                output(
                        join(INNER, builder -> builder
                                .equiCriteria("l_partkey", "p_partkey")
                                .filter(new ComparisonExpression(LESS_THAN_OR_EQUAL, new Cast(new SymbolReference("comment"), dataType("varchar(55)")), new SymbolReference("name")))
                                .left(filter(
                                        new ComparisonExpression(GREATER_THAN_OR_EQUAL, new SymbolReference("comment"), new Cast(new StringLiteral("f"), dataType("varchar(44)"))),
                                        tableScan(
                                                "lineitem",
                                                ImmutableMap.of("l_partkey", "partkey", "comment", "comment"))))
                                .right(anyTree(
        ...
        assertPlan(
                ...
                output(
                        join(INNER, builder -> builder
                                .equiCriteria("l_partkey", "p_partkey")
                                .filter(new ComparisonExpression(GREATER_THAN_OR_EQUAL, new Cast(new SymbolReference("comment"), dataType("varchar(55)")), new SymbolReference("name")))
                                .left(filter(
                                        new ComparisonExpression(LESS_THAN_OR_EQUAL, new SymbolReference("comment"), new Cast(new StringLiteral("f"), dataType("varchar(44)"))),
                                        tableScan(
                                                "lineitem",
                                                ImmutableMap.of("l_partkey", "partkey", "comment", "comment"))))
                                .right(anyTree(
                ...
                output(
                        join(INNER, builder -> builder
                                ...
                                .filter(new BetweenPredicate(
                                        ...
                                        new Cast(new SymbolReference("linestatus"), dataType("varchar(55)")),
                                        new Cast(new SymbolReference("comment"), dataType("varchar(55)"))))
                                .left(anyIfDynamicFilteringEnabled(tableScan(
                                        "lineitem",
