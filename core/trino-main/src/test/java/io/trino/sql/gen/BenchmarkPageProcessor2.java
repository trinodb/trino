...
public class BenchmarkPageProcessor2
{
    ...
    public void setup()
    {
        ...
        pageProcessor = new ExpressionCompiler(pageFunctionCompiler, columnarFilterCompiler)
                .compilePageProcessor(getTypeResolutionPolicy(TEST_SESSION), true, true, Optional.of(getFilter(type)), Optional.empty(), projections, sourceLayout, Optional.empty(), OptionalInt.empty())
