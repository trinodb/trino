...
public class TestSimplifyStackedNot
{
    ...
    {
        assertThat(optimize(
                not(PLANNER_CONTEXT.getMetadata(), getTypeResolutionPolicy(TEST_SESSION), not(PLANNER_CONTEXT.getMetadata(), getTypeResolutionPolicy(TEST_SESSION), new Reference(BOOLEAN, "a")))))
