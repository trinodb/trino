                                                ...
                                                aggregation(
                                                        ...
                                                        exchange(
                                                                project(ImmutableMap.of(
                                                                                ...
                                                                                "VALUE_BIGINT", expression(new Case(ImmutableList.of(new WhenClause(IrExpressions.between(new SymbolAllocator(), new Reference(BIGINT, "COL_BIGINT"), new Constant(BIGINT, 1L), new Constant(BIGINT, 2L)), new Call(MULTIPLY_BIGINT, ImmutableList.of(new Reference(BIGINT, "COL_BIGINT"), new Constant(BIGINT, 2L))))), new Constant(BIGINT, null))),
