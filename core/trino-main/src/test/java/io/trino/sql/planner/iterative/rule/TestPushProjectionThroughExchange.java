    ...
    public void testHashMapping()
    {
        tester().assertThat(new PushProjectionThroughExchange())
                .on(p -> {
                    ...
                    return p.project(
                            Assignments.of(
                                    cTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("c"), new Constant(INTEGER, 5L))),
                            p.exchange(e -> e
                                    .addSource(
                                            p.values(a, h1))
                                    .addInputsSet(a, h1)
                                ...
                                exchange(
                                        strictProject(
                                                ImmutableMap.of(
                                                        ...
                                                        "a_times_5", expression(new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("a"), new Constant(INTEGER, 5L)))),
    ...
    public void testSkipIdentityProjectionIfOutputPresent()
    {
        ...
        tester().assertThat(new PushProjectionThroughExchange())
                .on(p -> {
                    ...
                    return p.project(
                            Assignments.of(
                                    aTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("a"), new Constant(INTEGER, 5L)),
                ...
                .matches(
                        exchange(
                                strictProject(
                                        ImmutableMap.of("a_0", expression(new SymbolReference("a")), "a_times_5", expression(new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("a"), new Constant(INTEGER, 5L)))),
                                        values(ImmutableList.of("a")))));
        ...
        tester().assertThat(new PushProjectionThroughExchange())
                .on(p -> {
                    ...
                    return p.project(
                            Assignments.of(
                                    bTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("b"), new Constant(INTEGER, 5L)),
    ...
    public void testPartitioningColumnAndHashWithoutIdentityMappingInProjection()
    {
        tester().assertThat(new PushProjectionThroughExchange())
                .on(p -> {
                    ...
                    return p.project(
                            Assignments.builder()
                                    .put(aTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("a"), new Constant(INTEGER, 5L)))
                                    .put(bTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("b"), new Constant(INTEGER, 5L)))
                                    .put(hTimes5, new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("h"), new Constant(INTEGER, 5L)))
                                    .build(),
                            p.exchange(e -> e
                                    .addSource(
                                            p.values(a, b, h))
                        ...
                        project(
                                exchange(
                                        project(
                                                ...
                                                .withAlias("a_times_5", expression(new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("a"), new Constant(INTEGER, 5L))))
                                                .withAlias("b_times_5", expression(new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("b"), new Constant(INTEGER, 5L))))
                                                .withAlias("h_times_5", expression(new ArithmeticBinaryExpression(MULTIPLY, new SymbolReference("h"), new Constant(INTEGER, 5L)))))
