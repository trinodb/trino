...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(FeaturesConfig.class)
                ...
                .setMergePagesMaxSmallPagesRowRatio(0.1)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("experimental.merge-pages-small-pages-row-ratio-threshold", "0.42")
                ...
                .put("late-materialization.enabled", "false")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setMergePagesMaxSmallPagesRowRatio(0.42)
