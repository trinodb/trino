    ...
    void testArray()
    {
        ...
        assertThat(optimize(
                ...
                .isEqualTo(Optional.of(
                        new Call(
                                PLANNER_CONTEXT.getMetadata().resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), JSON_STRING_ARRAY_EXTRACT_SCALAR_NAME, ImmutableList.of(VARCHAR, JsonPathType.JSON_PATH)),
                                ImmutableList.of(
