    ...
    void test()
    {
        ...
        assertThat(optimize(
                new Match(
                        ...
                        ImmutableList.of(equalityClause(new Constant(DOUBLE, 0.0), new Reference(VARCHAR, "r"))),
                        new Reference(VARCHAR, "d"))))
                .describedAs("constant clause equal to a constant operand under `=`, but holding a different value")
                .isEqualTo(Optional.of(new Reference(VARCHAR, "r")));
