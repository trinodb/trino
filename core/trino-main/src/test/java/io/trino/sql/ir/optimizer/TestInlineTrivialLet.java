...
public class TestInlineTrivialLet
{
        ...
        assertThat(optimize(
                new Let(new Symbol(BIGINT, "x"),
                        ...
                        new Logical(AND, ImmutableList.of(
                                new Comparison(GREATER_THAN_OR_EQUAL, new Reference(BIGINT, "x"), new Constant(BIGINT, 0L)),
                                new Comparison(LESS_THAN_OR_EQUAL, new Reference(BIGINT, "x"), new Constant(BIGINT, 5L)))))))
                .isEqualTo(Optional.of(new Logical(AND, ImmutableList.of(
                        new Comparison(GREATER_THAN_OR_EQUAL, new Constant(BIGINT, 3L), new Constant(BIGINT, 0L)),
                        new Comparison(LESS_THAN_OR_EQUAL, new Constant(BIGINT, 3L), new Constant(BIGINT, 5L))))));
    }
    ...
    void testReferenceValue()
    {
        assertThat(optimize(
                ...
                .isEqualTo(Optional.of(new Comparison(EQUAL, new Reference(BIGINT, "a"), new Constant(BIGINT, 1L))));
    }
