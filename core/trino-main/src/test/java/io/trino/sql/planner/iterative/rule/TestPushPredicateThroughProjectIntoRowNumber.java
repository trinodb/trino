    ...
    public void testNonPositiveUpperBoundForRowNumberSymbol()
    {
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            new Logical(AND, ImmutableList.of(comparison(EQUAL, new Reference(BIGINT, "a"), new Constant(BIGINT, 1L)), comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, -10L)))),
                            p.project(
                                    Assignments.identity(a, rowNumber),
                                    p.rowNumber(
                                            ImmutableList.of(),
    ...
    public void testPredicateNotSatisfied()
    {
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            new Logical(AND, ImmutableList.of(comparison(GREATER_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 2L)), comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 5L)))),
                            p.project(
    ...
    public void testPredicateSatisfied()
    {
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 5L)),
                            p.project(
                                    Assignments.identity(rowNumber),
                                    p.rowNumber(
                                            ImmutableList.of(),
        ...
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 3L)),
                            p.project(
                                    Assignments.identity(rowNumber),
                                    p.rowNumber(
                                            ImmutableList.of(),
    ...
    public void testPredicatePartiallySatisfied()
    {
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            new Logical(AND, ImmutableList.of(comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 5L)), comparison(GREATER_THAN, new Reference(BIGINT, "a"), new Constant(BIGINT, 0L)))),
                            p.project(
        ...
        tester().assertThat(new PushPredicateThroughProjectIntoRowNumber(tester().getPlannerContext()))
                .on(p -> {
                    ...
                    Symbol rowNumber = p.symbol("row_number");
                    return p.filter(
                            new Logical(AND, ImmutableList.of(comparison(LESS_THAN, new Reference(BIGINT, "row_number"), new Constant(BIGINT, 5L)), comparison(EQUAL, new Call(MODULO_INTEGER, ImmutableList.of(new Reference(INTEGER, "row_number"), new Constant(INTEGER, 2L))), new Constant(INTEGER, 0L)))),
                            p.project(
                                    Assignments.identity(rowNumber),
                                    p.rowNumber(
                                            ImmutableList.of(),
                ...
                .matches(filter(
                        comparison(EQUAL, new Call(MODULO_INTEGER, ImmutableList.of(new Reference(INTEGER, "row_number"), new Constant(INTEGER, 2L))), new Constant(INTEGER, 0L)),
                        project(
                                ImmutableMap.of("row_number", expression(new Reference(BIGINT, "row_number"))),
                                rowNumber(
                                        pattern -> pattern
