        ...
        implements Matcher
{
    ...
    public static class Builder
    {
        ...
        {
            this.dynamicFilter = Optional.of(ImmutableList.of(new PlanMatchPattern.DynamicFilterPattern(new SymbolReference(key), EQUAL, value, false, OptionalLong.of(timeout))));
