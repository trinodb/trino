    ...
    public void testBasics()
    {
        tester().assertThat(new PruneOrderByInWindowAggregation(METADATA))
                .on(planBuilder -> {
                    ...
                    ResolvedFunction avgFunction = METADATA.resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), "avg", ImmutableList.of(BIGINT));
                    ResolvedFunction arrayAggFunction = METADATA.resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), "array_agg", ImmutableList.of(BIGINT));
