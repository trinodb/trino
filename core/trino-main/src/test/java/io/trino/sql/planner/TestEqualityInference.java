...
public class TestEqualityInference
{
    ...
    public void testEqualityPartitionGeneration()
    {
        ...
        assertThat(setCopy(equalityPartition.getScopeEqualities())).hasSameElementsAs(setCopy(newEqualityPartition.getScopeEqualities()));
        assertThat(setCopy(equalityPartition.getScopeComplementEqualities())).hasSameElementsAs(setCopy(newEqualityPartition.getScopeComplementEqualities()));
        assertThat(setCopy(equalityPartition.getScopeStraddlingEqualities())).hasSameElementsAs(setCopy(newEqualityPartition.getScopeStraddlingEqualities()));
    }
    ...
    public void testConstantEqualities()
    {
        ...
        assertThat(equalitiesAsSets(equalityPartition.getScopeEqualities())).hasSameElementsAs(set(set(nameReference("a1"), number(1)), set(nameReference("b1"), number(1))));
        assertThat(equalitiesAsSets(equalityPartition.getScopeComplementEqualities())).hasSameElementsAs(set(set(nameReference("c1"), number(1))));
