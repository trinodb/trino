...
public class TestShowQueries
{
                ...
                .withGetColumns(schemaTableName -> {
                    if (schemaTableName.getTableName().equals("default_column_value")) {
                        return ImmutableList.<ColumnMetadata>builder()
                                ...
                                .add(columnMetadata("col_int", INTEGER, 100L))
                                .add(columnMetadata("col_bigint", BIGINT, 1000L))
                                .add(columnMetadata("col_real", REAL, (long) floatToIntBits(1.1f)))
                                .add(columnMetadata("col_double", DOUBLE, 2.2))
                                .add(columnMetadata("col_short_decimal", DecimalType.createDecimalType(3, 1), 321L))
                                .add(columnMetadata("col_long_decimal", DecimalType.createDecimalType(38, 18), Int128.valueOf("12345678901234567890123456789012345678")))
                                .add(columnMetadata("col_char", createCharType(5), utf8Slice("char")))
                                .add(columnMetadata("col_varchar", createVarcharType(10), utf8Slice("varchar")))
                                ...
                                .add(columnMetadata("col_short_timestamptz", createTimestampWithTimeZoneType(0), 0L))
                                .add(columnMetadata("col_long_timestamptz", createTimestampWithTimeZoneType(12), fromEpochMillisAndFraction(0, 0, UTC_KEY)))
                                .build();
                    }
                ...
                .isEqualTo(
                        """
                                CREATE TABLE mock.mockschema.default_column_value (
                                   ...
                                   col_double double DEFAULT 2.2E0,
    ...
    private static ColumnMetadata columnMetadata(String name, Type type, Object value)
    {
        return ColumnMetadata.builder().setName(name).setType(type).setDefaultValue(Optional.of(new Constant(value, type))).build();
    }
}
