                ...
                .withGetColumns(schemaTableName -> {
                    if (schemaTableName.getTableName().equals("default_column_value")) {
                        return ImmutableList.<ColumnMetadata>builder()
                                ...
                                .add(columnMetadata("col_real", REAL, floatToIntBits(1.1f)))
                                .add(columnMetadata("col_double", DOUBLE, doubleToLongBits(2.2)))
                                .add(columnMetadata("col_short_decimal", DecimalType.createDecimalType(3, 1), 321))
                ...
                .isEqualTo(
                        """
                                CREATE TABLE mock.mockschema.default_column_value (
                                   ...
                                   col_varbinary varbinary DEFAULT X'65683F',
