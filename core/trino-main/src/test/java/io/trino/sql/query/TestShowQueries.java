                ...
                .withGetColumns(schemaTableName -> {
                    if (schemaTableName.getTableName().equals("default_column_value")) {
                        return ImmutableList.<ColumnMetadata>builder()
                                ...
                                .add(columnMetadata("col_real", REAL, "1.1"))
                                .add(columnMetadata("col_double", DOUBLE, "2.2"))
                                .add(columnMetadata("col_short_decimal", DecimalType.createDecimalType(3, 1), "32.1"))
                                .add(columnMetadata("col_long_decimal", DecimalType.createDecimalType(38, 18), "12345678901234567890.123456789012345678"))
                ...
                .isEqualTo(
                        """
                                CREATE TABLE mock.mockschema.default_column_value (
                                   ...
                                   col_real real DEFAULT 1.1,
                                   col_double double DEFAULT 2.2,
                                   col_short_decimal decimal(3, 1) DEFAULT 32.1,
                                   col_long_decimal decimal(38, 18) DEFAULT 12345678901234567890.123456789012345678,
