...
public class TestRecursiveCte
{
    ...
    {
        // Zero-source table function as the anchor of a recursive CTE.
        assertThat(assertions.query(
                """
    ...
    {
        // table function in recursive CTE with recursion depth exceeded
        assertThat(assertions.query(
                """
                WITH RECURSIVE t(n) AS (
    ...
    {
        // exclude_columns gives the TableFunctionNode a non-empty source list
        assertThat(assertions.query(
                """
                WITH RECURSIVE t(n) AS (
