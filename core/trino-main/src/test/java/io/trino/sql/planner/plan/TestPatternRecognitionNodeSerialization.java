...
public class TestPatternRecognitionNodeSerialization
{
    ...
    {
        ResolvedFunction countFunction = createTestingMetadataManager().resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), "count", ImmutableList.of());
        ...
        ResolvedFunction maxFunction = createTestingMetadataManager().resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), "max", ImmutableList.of(BIGINT));
        assertJsonRoundTrip(VALUE_POINTER_CODEC, new AggregationValuePointer(
                maxFunction,
    ...
    {
        ResolvedFunction rankFunction = createTestingMetadataManager().resolveBuiltinFunction(getTypeResolutionPolicy(TEST_SESSION), "rank", ImmutableList.of());
