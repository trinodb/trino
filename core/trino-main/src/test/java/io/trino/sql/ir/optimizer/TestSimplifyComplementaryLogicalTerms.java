...
class TestSimplifyComplementaryLogicalTerms
{
    ...
    {
        return VERIFIER.verify(expression, new SimplifyComplementaryLogicalTerms(PLANNER_CONTEXT).apply(expression, testSession(), emptySymbolAllocator(), ImmutableMap.of()));
    }
}
