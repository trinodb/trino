...
final class TestSystemSplitManager
{
    ...
    {
        // a system split addressed outside the query's group could not be scheduled anywhere
    ...
    {
        // the coordinator is never excluded, so there is always something to schedule on
