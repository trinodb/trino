...
public class MockPlanAlternativeConnectorFactory
        implements ConnectorFactory
{
    private final ConnectorFactory delegate;

    public MockPlanAlternativeConnectorFactory(ConnectorFactory delegate)
    {
    ...
    {
        return "plan_alternatives_" + delegate.getName();
    }
