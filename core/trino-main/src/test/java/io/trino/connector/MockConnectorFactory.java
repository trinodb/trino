        ...
        implements ConnectorFactory
{
    ...
    public static final class Builder
    {
        ...
        private BiFunction<ConnectorSession, SchemaTableName, Optional<MaterializedViewFreshness>> getMaterializedViewFreshness = (session, viewName) -> Optional.empty();
        ...
        public Builder withGetMaterializedViewsFreshness(BiFunction<ConnectorSession, SchemaTableName, Optional<MaterializedViewFreshness>> getMaterializedViewFreshness)
        {
            this.getMaterializedViewFreshness = requireNonNull(getMaterializedViewFreshness, "getMaterializedViewFreshness is null");
            return this;
        }
