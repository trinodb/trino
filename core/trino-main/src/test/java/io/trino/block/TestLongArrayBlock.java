        ...
        extends AbstractTestBlock
{
    ...
    public void testCompactBlock()
    {
        ...
        testCompactBlock(new LongArrayBlock(longArray.length, Optional.of(valueIsValid), longArray));
        testNotCompactBlock(new LongArrayBlock(longArray.length - 1, Optional.of(valueIsValid), longArray));
    }
