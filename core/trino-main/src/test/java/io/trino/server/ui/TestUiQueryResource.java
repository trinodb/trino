...
final class TestUiQueryResource
{
    ...
    @Test
    void testGetQueryInfosWithRedactedSecretsInPreparedStatement()
    {
        String catalog = "catalog_" + randomNameSuffix();
        String queryId = runToCompletion(
        ...
        List<TrimmedBasicQueryInfo> infos = getQueryInfos().stream()
                ...
                .collect(toImmutableList());
        assertThat(infos.size()).isEqualTo(1);
        assertThat(infos.getFirst().getQueryTextPreview()).isEqualTo("EXECUTE create_catalog");
    ...
    @Test
    void testGetQueryInfoWithRedactedSecretsInPreparedStatement()
    {
        String catalog = "catalog_" + randomNameSuffix();
        String queryId = runToCompletion(
                "EXECUTE create_catalog",
