...
public class TestSessionPropertyDefaults
{
    ...
    {
        SessionPropertyDefaults sessionPropertyDefaults = new SessionPropertyDefaults(TEST_NODE_INFO, new ConfigurationResolver(ImmutableMap.of()), new AllowAllAccessControl());
