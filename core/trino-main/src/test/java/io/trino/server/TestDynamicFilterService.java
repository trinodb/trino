...
public class TestDynamicFilterService
{
            ...
            ExchangeNode.Type exchangeType)
    {
        ...
        FilterNode filterNode = new FilterNode(
                ...
                tableScan,
                createDynamicFilterExpression(createTestingMetadataManager(), getTypeResolutionPolicy(TEST_SESSION), consumedDynamicFilterId, VARCHAR, symbol.toSymbolReference()));
