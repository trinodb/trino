...
public class JoinDomainBuilder
{
    ...
    private BloomFilterWithRange.LongBloomFilter bloomFilter;
            ...
            TypeOperators typeOperators)
    {
        ...
        this.collectBloomFilter = bloomFilterMaxDistinctValues > maxDistinctValues && type.getJavaType() == long.class && collectMinMax;
        ...
        if (collectBloomFilter) {
            this.bloomFilter = new BloomFilterWithRange.LongBloomFilter();
    ...
    public DynamicFilterDomain build()
    {
        ...
        if (collectBloomFilter) {
            ...
            return new DynamicFilterDomain(bloomFilter, range, type, false);
        }
