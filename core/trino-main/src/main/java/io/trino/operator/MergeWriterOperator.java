        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        public MergeWriterOperatorFactory(int operatorId, PlanNodeId planNodeId, PageSinkManager pageSinkManager, MergeTarget target, Optional<TableCredentials> tableCredentials, Session session, Function<Page, Page> pagePreprocessor)
        {
