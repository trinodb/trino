        ...
        implements Operator
{
            ...
            BlockTypeOperators blockTypeOperators)
    {
        ...
        checkArgument(!maxPartialMemory.isPresent() || !generateRanking, "no partial memory on final TopN");
        this.maxFlushableBytes = maxPartialMemory.map(dataSize -> dataSize.toBytes()).orElse(Long.MAX_VALUE);
