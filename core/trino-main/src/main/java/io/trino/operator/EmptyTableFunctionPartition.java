        ...
        implements TableFunctionPartition
{
    ...
    public WorkProcessor<Page> toOutputPages()
    {
        return WorkProcessor.create(() -> {
            TableFunctionProcessState state = tableFunction.process(null);
            ...
            if (state.result() != null) {
                return WorkProcessor.ProcessState.ofResult(appendNullsForPassThroughColumns(state.result()));
            }
    ...
    private Page appendNullsForPassThroughColumns(TableFunctionResult result)
    {
