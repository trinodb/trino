        ...
        implements PositionsAppender
{
    ...
    {
        checkArgument(block instanceof ByteArrayBlock, "Block must be instance of %s", ByteArrayBlock.class);
    ...
    {
        checkArgument(source instanceof ByteArrayBlock, "Block must be instance of %s", ByteArrayBlock.class);
