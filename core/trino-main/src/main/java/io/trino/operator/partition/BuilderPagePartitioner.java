...
import io.trino.operator.partition.PartitionedOutputOperator.PartitionedOutputInfo;
...
public abstract class BuilderPagePartitioner
        implements PagePartitioner
{
    protected final Type[] sourceTypes;
    protected final PageBuilder[] pageBuilders;
    protected final PartitionFunction partitionFunction;
    protected final boolean replicatesAnyRow;
    protected final int nullChannel; // when >= 0, send the position to every partition if this channel is null
    ...
    protected boolean hasAnyRowBeenReplicated;

    public BuilderPagePartitioner(
    ...
    protected Page getPartitionFunctionArguments(Page page)
    {
