...
public final class JoniRegexpFunctions
{
    ...
    public static int getSearchingOffset(Matcher matcher, int at, int range)
    {
        try {
            ...
            throw new TrinoException(GENERIC_USER_ERROR, "Regular expression matching was interrupted, likely because it took too long. Regular expression in the worst case can have a catastrophic amount of backtracking and having exponential time complexity");
        }
    }
}
