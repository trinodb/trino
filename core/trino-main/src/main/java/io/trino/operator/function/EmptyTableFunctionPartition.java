        ...
        implements TableFunctionPartition
{
    ...
    public EmptyTableFunctionPartition(TableFunctionWorkProcessor tableFunctionWorkProcessor, int properChannelsCount, int passThroughSourcesCount, List<Type> passThroughTypes)
    {
        this.tableFunctionWorkProcessor = requireNonNull(tableFunctionWorkProcessor, "tableFunctionWorkProcessor is null");
