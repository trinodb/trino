        ...
        extends AccumulatorState
{
    ...
    void setOverflowTruncationFiller(Slice overflowTruncationFiller);

    Slice getOverflowTruncationFiller();

    void setOverflowError(boolean overflowError);

    boolean isOverflowError();

    void setOverflowTruncationCountIndication(boolean overflowTruncationCountIndication);

    boolean isOverflowTruncationCountIndication();
