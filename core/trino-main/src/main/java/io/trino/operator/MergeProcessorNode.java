        ...
        extends PlanNode
{
            ...
            @JsonProperty("outputs") List<Symbol> outputs)
    {
        ...
        this.mergeRowSymbol = requireNonNull(mergeRowSymbol, "mergeRow is null");
    ...
    {
        return new MergeProcessorNode(getId(), Iterables.getOnlyElement(newChildren), target, mergeRowSymbol, outputs);
    }
}
