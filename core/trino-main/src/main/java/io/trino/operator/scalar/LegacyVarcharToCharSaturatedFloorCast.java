 ...
 * length when casting back. Registered in place of {@link VarcharToCharSaturatedFloorCast} when
 * the {@code deprecated.legacy-varchar-to-char-coercion} configuration property is set.
 */
