...
public final class TimeZone
{
    ...
    public static Slice extractTimeZoneFromTimestamp(
            @SqlType("timestamp(p) with time zone")
            final LongTimestampWithTimeZone timestampWithTimeZone)
    {
        short timeZoneKey = timestampWithTimeZone.getTimeZoneKey();
        TimeZoneKey zoneKey = TimeZoneKey.getTimeZoneKey(timeZoneKey);
