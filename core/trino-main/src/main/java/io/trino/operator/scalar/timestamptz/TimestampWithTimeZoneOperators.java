...
public final class TimestampWithTimeZoneOperators
{
    ...
    public static final class TimestampPlusIntervalDayToSecond
    {
        ...
        {
            try {
                return packDateTimeWithZone(addExact(unpackMillisUtc(packedEpochMillis), interval / MICROSECONDS_PER_MILLISECOND), unpackZoneKey(packedEpochMillis));
            }
