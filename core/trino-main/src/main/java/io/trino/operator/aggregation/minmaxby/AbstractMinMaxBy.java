        ...
        extends SqlAggregationFunction
{
    ...
    private InternalAggregationFunction generateAggregation(Type valueType, Type keyType, FunctionDependencies functionDependencies)
    {
        ...
        AccumulatorStateDescriptor<?> accumulatorStateDescriptor = generateAccumulatorStateDescriptor(valueType, keyType, stateClass, classLoader);
    ...
    private static <T extends AccumulatorState> AccumulatorStateDescriptor<?> generateAccumulatorStateDescriptor(Type valueType, Type keyType, Class<T> stateClass, DynamicClassLoader classLoader)
    {
        ...
        if (valueType.getJavaType().isPrimitive()) {
            ...
            return new AccumulatorStateDescriptor<>(
                    stateClass,
                    generateStateSerializer(stateClass, stateFieldTypes, classLoader),
                    generateStateFactory(stateClass, stateFieldTypes, classLoader));
        }
        ...
        AccumulatorStateFactory<T> stateFactory = generateStateFactory(stateClass, stateFieldTypes, classLoader);
