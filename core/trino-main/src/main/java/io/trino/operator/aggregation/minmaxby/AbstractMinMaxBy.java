        ...
        extends SqlAggregationFunction
{
    ...
    private InternalAggregationFunction generateAggregation(Type valueType, Type keyType, FunctionDependencies functionDependencies)
    {
        ...
        if (valueType.getJavaType().isPrimitive()) {
            ...
            // We deliberately make "SecondBlock" an array type so that the compiler will treat it as a block to work around the sanity check.
            ...
            // States can be generated by StateCompiler given they are simply classes with getters and setters.
