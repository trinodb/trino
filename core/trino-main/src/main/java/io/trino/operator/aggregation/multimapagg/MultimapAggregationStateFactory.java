        ...
        implements AccumulatorStateFactory<MultimapAggregationState>
{
    ...
    {
        return new SingleMultimapAggregationState(keyType, keyReadFlat, keyWriteFlat, keyHashFlat, keyIdenticalFlatBlock, keyHashBlock, valueType, valueReadFlat, valueWriteFlat);
    }

    @Override
    public MultimapAggregationState createGroupedState()
    {
        return new GroupedMultimapAggregationState(keyType, keyReadFlat, keyWriteFlat, keyHashFlat, keyIdenticalFlatBlock, keyHashBlock, valueType, valueReadFlat, valueWriteFlat);
    }
}
