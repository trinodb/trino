...
public interface HashTableValuesAppender
{
    ...
    WorkProcessor<Page> buildResult(HashTableData hashTableData, IntIterator groupIds, PageBuilder pageBuilder, List<GroupedAggregator> groupedAggregators, int accumulatorChannelOffset, boolean outputHash);
}
