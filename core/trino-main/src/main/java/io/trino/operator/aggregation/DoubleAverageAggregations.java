...
public final class DoubleAverageAggregations
{
    ...
    @SqlNullable
    @OutputFunction(value = StandardTypes.DOUBLE, decomposition = @Decomposition(partial = "avg$intermediate", output = "avg$final", subsumes = {@Subsumed(function = "sum", output = "avg_sum$final"), @Subsumed(function = "count", output = "avg_count$final")}))
