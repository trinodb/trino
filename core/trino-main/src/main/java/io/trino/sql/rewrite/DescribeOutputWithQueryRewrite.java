...
public final class DescribeOutputWithQueryRewrite
        implements StatementRewrite.Rewrite
{
    @Inject
    public DescribeOutputWithQueryRewrite()
    {}
    ...
    {
        return (Statement) new Visitor(session, analyzerFactory, parameters, parameterLookup, warningCollector, planOptimizersStatsCollector).process(node, null);
    }
            ...
            extends AstVisitor<Node, Void>
    {
        ...
        @Override
        protected Node visitDescribeOutputWithQuery(DescribeOutputWithQuery node, Void context)
        {
            Statement statement = node.getQuery();
