...
{
    public static Optional<Supplier<FilterEvaluator>> createAndExpressionEvaluator(TypeResolutionPolicy typeResolutionPolicy, ColumnarFilterCompiler compiler, Logical logical, Map<Symbol, Integer> layout, boolean filterReorderingEnabled, boolean dynamicFilter)
    {
        ...
        for (Expression expression : terms) {
            Optional<Supplier<FilterEvaluator>> subExpressionEvaluator = FilterEvaluator.createColumnarFilterEvaluator(typeResolutionPolicy, expression, layout, compiler, filterReorderingEnabled, dynamicFilter);
        ...
        boolean reorderingSafe = filterReorderingEnabled && isReorderingSafe(compiler.getPlannerContext(), typeResolutionPolicy, terms);
        return Optional.of(() -> {
