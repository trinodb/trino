        ...
        implements PlanOptimizersFactory
{
            ...
            RuleStatsRecorder ruleStats)
    {
        ...
        builder.add(
                ...
                // limits between nested unions and block MergeUnion (see TestMergeUnionAndPushLimitInteraction).
                new IterativeOptimizer(
                        "PushdownAndSimplifyBeforeUnalias",
                        plannerContext,
                        ruleStats,
                        statsCalculator,
                        costCalculator,
        ...
        builder.add(pushIntoTableScanOptimizer
                .withName("PushIntoTableScanBeforeUnalias"));
        ...
        builder.add(pushIntoTableScanOptimizer // TODO (https://github.com/trinodb/trino/issues/811) merge with the above after migrating UnaliasSymbolReferences to rules
                .withName("PushIntoTableScanAfterUnalias"));
        ...
        builder.add(
                ...
                new IterativeOptimizer(
                        "CleanupAfterDistinctAggregations",
                        plannerContext,
                        ruleStats,
                        statsCalculator,
                        costCalculator,
        ...
        builder.add(new IterativeOptimizer(
                "PruneEmptyPlansAfterScanPushdown",
                plannerContext,
                ruleStats,
                statsCalculator,
                costCalculator,
        ...
        builder.add(new IterativeOptimizer(
                "OptimizeLocalExchangeConsumers",
                plannerContext,
                ruleStats,
                statsCalculator,
                costCalculator,
        ...
        adaptivePlanOptimizers.add(new IterativeOptimizer(
                "AdaptiveReorderPartitionedJoin",
                plannerContext,
                ruleStats,
                statsCalculator,
                costCalculator,
