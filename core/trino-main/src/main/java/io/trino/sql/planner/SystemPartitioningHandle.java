        ...
        implements ConnectorPartitioningHandle
{
    ...
    public static final PartitioningHandle SCALED_WRITER_HASH_DISTRIBUTION = createSystemPartitioning(SystemPartitioning.SCALED, SystemPartitionFunction.HASH);
