        ...
        implements Rule<ApplyNode>
{
    ...
    public Result apply(ApplyNode apply, Captures captures, Context context)
    {
        ...
        ProjectNode conditions = new ProjectNode(
                ...
                apply.getSubquery(),
                Assignments.builder()
                        .put(matchCondition, comparison(metadata, EQUAL, probe.toSymbolReference(), reference.toSymbolReference()))
        ...
        Expression inExpression = new Case(
                ImmutableList.of(
                        new WhenClause(comparison(metadata, GREATER_THAN, countMatches.toSymbolReference(), new Constant(BIGINT, 0L)), TRUE),
                        new WhenClause(comparison(metadata, GREATER_THAN, countNullMatches.toSymbolReference(), new Constant(BIGINT, 0L)), new Constant(BOOLEAN, null))),
                FALSE);
