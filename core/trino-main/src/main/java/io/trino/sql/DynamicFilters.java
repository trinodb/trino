...
public final class DynamicFilters
{
    ...
    {
        return createDynamicFilterExpression(metadata, typeResolutionPolicy, id, inputType, input, operator, false);
    }
    ...
    @VisibleForTesting
    public static Expression createDynamicFilterExpression(Metadata metadata, TypeResolutionPolicy typeResolutionPolicy, DynamicFilterId id, Type inputType, Expression input)
    {
        return createDynamicFilterExpression(metadata, typeResolutionPolicy, id, inputType, input, EQUAL);
    }
