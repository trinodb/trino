...
public class BytecodeGeneratorContext
{
    ...
    /**
     * Built-in functions keep the session variable as-is, so their generated bytecode is unchanged.
     * A connector function gets the session rebound to its own catalog, once per generated instance.
     */
