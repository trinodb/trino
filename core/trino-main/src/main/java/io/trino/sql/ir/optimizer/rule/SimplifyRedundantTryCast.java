...
///
/// Lowering to a [Cast] exposes the expression to the cast-specific rules ([EvaluateCast],
/// [SimplifyRedundantCast], comparison unwrapping, connector pushdown) that do not match the opaque
/// `$try_cast` call, and drops the runtime exception-handler wrapper.
