...
public final class InSetDynamicFilterGenerator
{
    ...
    public static Optional<InSetDynamicFilterGenerator> tryCreate(In in, Map<Symbol, Integer> layout, Metadata metadata, TypeResolutionPolicy typeResolutionPolicy, FunctionManager functionManager)
    {
        ...
        ResolvedFunction resolvedEquals = metadata.resolveOperator(typeResolutionPolicy, EQUAL, ImmutableList.of(valueType, valueType));
        ResolvedFunction resolvedHashCode = metadata.resolveOperator(typeResolutionPolicy, HASH_CODE, ImmutableList.of(valueType));
