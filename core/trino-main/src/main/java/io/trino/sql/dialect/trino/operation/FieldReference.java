        ...
        implements Operation
{
    ...
    public FieldReference(String resultName, Value base, int fieldIndex, Map<AttributeKey, Object> sourceAttributes)
    {
        ...
        this.attributes = deriveAttributes(fieldIndex, sourceAttributes);
    }

    private Map<AttributeKey, Object> deriveAttributes(int fieldIndex, Map<AttributeKey, Object> sourceAttributes)
    {
        return FIELD_INDEX.asMap(fieldIndex);
