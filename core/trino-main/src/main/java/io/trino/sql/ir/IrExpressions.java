...
public final class IrExpressions
{
    ...
    /// Whether the call is `at_timezone` over a `timestamp with time zone` value. Such a call changes
    ...
    public static boolean isInstantPreservingAtTimeZone(Call call)
    {
