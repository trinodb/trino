...
/**
 * This rule is to push subscript lambdas into below projection through filter. This rule increases the
 ...
 * </pre>
 */
public class PushDownSubscriptLambdaThroughFilter
        implements Rule<ProjectNode>
{
    private static final Capture<FilterNode> CHILD = newCapture();
    private final TypeAnalyzer typeAnalyzer;

    public PushDownSubscriptLambdaThroughFilter(TypeAnalyzer typeAnalyzer)
    {
