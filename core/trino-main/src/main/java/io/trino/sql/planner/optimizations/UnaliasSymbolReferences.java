        ...
        implements PlanOptimizer
{
            ...
            extends PlanVisitor<PlanAndMappings, UnaliasContext>
    {
        ...
        public PlanAndMappings visitOutput(OutputNode node, UnaliasContext context)
        {
            ...
            return new PlanAndMappings(
                    new OutputNode(node.getId(), rewrittenSource.getRoot(), node.getCatalogNames(), node.getSchemaNames(), node.getTableNames(), node.getColumnNames(), node.getColumnLabels(), newOutputs),
                    mapping);
        }
