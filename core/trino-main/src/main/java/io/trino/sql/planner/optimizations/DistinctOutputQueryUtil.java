...
public final class DistinctOutputQueryUtil
{
            ...
            extends PlanVisitor<Boolean, Void>
    {
        ...
        */
        ...
        {
            return node.isDistinct() || lookupFunction.apply(node.sources().get(0)).accept(this, null);
        }
        ...
        {
            return node.isDistinct() || node.sources().stream().allMatch(source -> lookupFunction.apply(source).accept(this, null));
        }
