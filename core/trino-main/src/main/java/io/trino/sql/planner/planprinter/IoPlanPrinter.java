...
public class IoPlanPrinter
{
    ...
    private IoPlanPrinter(Plan plan, PlannerContext plannerContext, Session session, Analysis analysis)
    {
    ...
    {
        return new IoPlanPrinter(plan, plannerContext, session, analysis).print();
    }
    ...
    public static class IoPlan
    {
        ...
        protected static class IoPlanBuilder
        {
            ...
            private IoPlanBuilder(Plan plan, Analysis analysis)
            {
                this.plan = plan;
            ...
            private IoPlanBuilder setOutputColumns()
            {
                Optional<List<OutputColumnMetadata>> outputColumnMetadata = analysis.getTarget().flatMap(
                        target -> target.getColumns()
                ...
                return this.setOutputColumns(outputColumnMetadata);
            }
