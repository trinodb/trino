        ...
        implements Operation
{
    ...
    public Values(String resultName, RowType rowType, List<Block> rows)
    {
        ...
        this.result = new Result(resultName, new MultisetType(outputType));
        ...
        this.rows = rows.stream()
                .map(rowBlock -> {
                    ...
                    Type blockType = rowBlock.getReturnedType();
                    ...
                    if (!((RowType) blockType).getTypeParameters().equals(rowType.getTypeParameters())) {
    ...
    private Values(String resultName, int rows)
    {
        ...
        this.result = new Result(resultName, EMPTY_ROW);
