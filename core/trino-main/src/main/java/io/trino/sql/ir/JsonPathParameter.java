        ...
        extends Node
{
    ...
    public JsonPathParameter(Identifier name, Expression parameter, Optional<JsonFormat> format)
    {
    ...
    public boolean shallowEquals(Node other)
    {
        ...
        return name.equals(otherRelation.name) && format.equals(otherRelation.format);
    }
}
