    ...
    private Optional<Expression> processChildren(Expression expression, Session session, SymbolAllocator symbolAllocator, Map<Symbol, Expression> bindings)
    {
        return switch (expression) {
            ...
            case Comparison comparison -> {
                Optional<Expression> left = process(comparison.left(), session, symbolAllocator, bindings);
                Optional<Expression> right = process(comparison.right(), session, symbolAllocator, bindings);
