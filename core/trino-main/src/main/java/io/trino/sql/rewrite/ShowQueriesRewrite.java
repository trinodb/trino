            ...
            extends AstVisitor<Node, Void>
    {
        ...
        protected Node visitShowTables(ShowTables showTables, Void context)
        {
            ...
            if (likePattern.isPresent()) {
                Expression likePredicate = new Predicated(null, delimitedIdentifier("table_name"), new LikePredicate(null, false, new StringLiteral(likePattern.get()), showTables.getEscape().map(StringLiteral::new)));
        ...
        protected Node visitShowSchemas(ShowSchemas node, Void context)
        {
            ...
            if (likePattern.isPresent()) {
                predicate = Optional.of(new Predicated(null, delimitedIdentifier("schema_name"), new LikePredicate(null, false, new StringLiteral(likePattern.get()), node.getEscape().map(StringLiteral::new))));
            }
        ...
        protected Node visitShowCatalogs(ShowCatalogs node, Void context)
        {
            ...
            // FIXME: predicate must be Catalog and not catalog, why?
                ...
                predicate = Optional.of(new Predicated(null, delimitedIdentifier("Catalog"), new LikePredicate(null, false, new StringLiteral(node.getLikePattern().get()), node.getEscape().map(StringLiteral::new))));
            }
        ...
        protected Node visitShowColumns(ShowColumns showColumns, Void context)
        {
            ...
            if (likePattern.isPresent()) {
                Expression likePredicate = new Predicated(null, delimitedIdentifier("column_name"), new LikePredicate(null, false, new StringLiteral(likePattern.get()), showColumns.getEscape().map(StringLiteral::new)));
                predicate = logicalAnd(predicate, likePredicate);
            }
        ...
        protected Node visitShowFunctions(ShowFunctions node, Void context)
        {
            ...
            return simpleQuery(
                    ...
                    node.getLikePattern()
                            .map(like -> new Predicated(null, delimitedIdentifier("function_name"), new LikePredicate(null, false, new StringLiteral(like), node.getEscape().map(StringLiteral::new))))
        ...
        protected Node visitShowSession(ShowSession node, Void context)
        {
            ...
            Optional<String> likePattern = node.getLikePattern();
            if (likePattern.isPresent()) {
                predicate = and(predicate, new Predicated(null, delimitedIdentifier("name"), new LikePredicate(null, false, new StringLiteral(likePattern.get()), node.getEscape().map(StringLiteral::new))));
            }
