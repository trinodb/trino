        ...
        extends PlanNode
{
            ...
            extends WriterTarget
    {
        ...
        {
            return new RefreshMaterializedViewReference(table, storageTableHandle, sourceTableHandles, sourceViewHandles, sourceTableFunctions, hasNonDeterministicFunctions, refreshType);
        }
    }
