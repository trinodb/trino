...
public class DesugarCurrentSchema
        extends ExpressionRewriteRuleSet
{
    public DesugarCurrentSchema(Metadata metadata)
    {
    ...
    {
        return (expression, context) -> rewriteCurrentSchema(context.getSession(), metadata, expression);
    }

    private static Expression rewriteCurrentSchema(Session session, Metadata metadata, Expression expression)
    {
        return ExpressionTreeRewriter.rewriteWith(new io.trino.sql.tree.ExpressionRewriter<>()
        {
            ...
            {
                return desugarCurrentSchema(session, node, metadata);
            }
        }, expression);
    }
