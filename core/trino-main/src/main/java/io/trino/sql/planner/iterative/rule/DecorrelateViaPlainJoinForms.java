        ...
        extends DependentJoinFrameworkRule
{
    ...
    protected Optional<PlanNode> apply(CorrelatedJoinNode correlatedJoin, DependentJoinAlgebra algebra, Context context)
    {
        ...
        PlainJoinForms forms = new PlainJoinForms(context.getIdAllocator(), context.getSymbolAllocator(), context.getLookup(), plannerContext(), getCharVarcharCoercion(context.getSession()));
