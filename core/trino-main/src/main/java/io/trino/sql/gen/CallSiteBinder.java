...
public final class CallSiteBinder
{
    ...
    /**
     * Marks the generated bytecode as dependent on constant values, e.g. switch labels
     * derived from literals, so it cannot serve as a template for other constants.
     */
    public void markValueDependent()
    {
        valueDependent = true;
    }
