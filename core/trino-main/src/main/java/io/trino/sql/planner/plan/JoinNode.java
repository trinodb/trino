        ...
        extends PlanNode
{
    ...
    public static class EquiJoinClause
    {
        ...
        public Expression toExpression(Metadata metadata, TypeResolutionPolicy typeResolutionPolicy)
        {
            return comparison(metadata, typeResolutionPolicy, ComparisonOperator.EQUAL, left.toSymbolReference(), right.toSymbolReference());
        }
