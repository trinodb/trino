...
{
    public static Optional<Supplier<FilterEvaluator>> createOrExpressionEvaluator(TypeResolutionPolicy typeResolutionPolicy, ColumnarFilterCompiler compiler, Logical logical, Map<Symbol, Integer> layout, boolean filterReorderingEnabled, boolean dynamicFilter)
    {
        ...
        boolean reorderingSafe = filterReorderingEnabled && isReorderingSafe(compiler.getPlannerContext(), typeResolutionPolicy, logical.terms());
