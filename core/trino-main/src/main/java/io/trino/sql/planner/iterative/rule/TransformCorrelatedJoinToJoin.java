        ...
        implements Rule<CorrelatedJoinNode>
{
    ...
    public Result apply(CorrelatedJoinNode correlatedJoinNode, Captures captures, Context context)
    {
        ...
        PlanNodeDecorrelator planNodeDecorrelator = new PlanNodeDecorrelator(plannerContext, getTypeResolutionPolicy(context.getSession()), context.getSymbolAllocator(), context.getLookup());
