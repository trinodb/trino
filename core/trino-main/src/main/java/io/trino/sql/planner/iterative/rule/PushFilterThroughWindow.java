...
public final class PushFilterThroughWindow
        extends FilterPushdownRule<WindowNode>
{
    public PushFilterThroughWindow(PlannerContext plannerContext, boolean useTableProperties, boolean dynamicFiltering)
    {
        super(plannerContext, useTableProperties, dynamicFiltering, window());
    }

    @Override
    protected PlanNode pushDown(Pushdown pushdown, WindowNode node, Expression inheritedPredicate)
    {
