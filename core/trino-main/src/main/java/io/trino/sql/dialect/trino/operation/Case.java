        ...
        implements Operation
{
    ...
    public Case(String resultName, List<Value> when, List<Value> then, Value defaultValue, List<Map<String, Object>> sourceAttributes)
    {
        ...
        Type thenType = then.getFirst().type();
        if (!then.stream()
                .map(Value::type)
