        ...
        extends Encoding
{
    ...
    static {
        ...
        for (int i = 0; i < CodePointSetTable.SETS.length; i++) {
            CHARACTER_PROPERTY_TO_TYPE_MAP.putDirect(CodePointSetTable.SETS[i].name, resolveCharacterType(i));
        }
    }
    ...
    public boolean isCodeCType(int code, int characterType)
    {
        ...
        verify(index >= 0 && index < CodePointSetTable.SETS.length, "set index out of bounds");
        return CodeRange.isInCodeRange(CodePointSetTable.SETS[index].ranges(), code);
    }
    ...
    public int[] ctypeCodeRange(int characterType, IntHolder minMultiByteCodePoint)
    {
        ...
        int index = resolveCodePointSetIndex(characterType);
        verify(index >= 0 && index < CodePointSetTable.SETS.length, "set index out of bounds");
        return CodePointSetTable.SETS[index].ranges();
    }
    ...
    public static boolean isPublicCharacterProperty(String property)
    {
        ...
        int index = resolveCodePointSetIndex(characterType);
        if (index >= 0 && index < CodePointSetTable.SETS.length) {
            return !CodePointSetTable.SETS[index].internal();
        }
        return false;
    }
    ...
    private static final class CodePointSetTable
    {
        ...
        public static final CodePointSet[] SETS = new CodePointSet[] {
