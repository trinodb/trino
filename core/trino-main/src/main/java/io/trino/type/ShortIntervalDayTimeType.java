...
/// The microsecond-backed form of a day-time interval, used when the fractional-seconds precision is at
/// most 6. Stores a signed count of microseconds in a single `long`.
final class ShortIntervalDayTimeType
        extends IntervalDayTimeType
{
    private static final TypeOperatorDeclaration TYPE_OPERATOR_DECLARATION = extractOperatorDeclaration(ShortIntervalDayTimeType.class, lookup(), long.class);
    private static final VarHandle LONG_HANDLE = MethodHandles.byteArrayViewVarHandle(long[].class, ByteOrder.LITTLE_ENDIAN);

    ShortIntervalDayTimeType(IntervalField startField, IntervalField endField, int leadingPrecision, int fractionalPrecision)
    {
        super(startField, endField, leadingPrecision, fractionalPrecision, long.class, LongArrayBlock.class);
    }
    ...
    public Object getObjectValue(Block block, int position)
    {
        ...
        return new SqlIntervalDayTime(getLong(block, position), getFractionalPrecision());
    }
    ...
    @ScalarOperator(value = HASH_CODE)
