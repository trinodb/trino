        ...
        implements SystemTable
{
    ...
    private List<CatalogTableAuthorization> getTablesAuthorization(Session session, TupleDomain<Integer> constraint)
    {
        try {
            ...
            throw handleListingException(exception, "tables_authorization", "system");
        }
    }
            ...
            TupleDomain<Integer> constraint)
    {
        ...
        availableSchemas.forEach(catalogSchemaName -> {
            QualifiedTablePrefix prefix = new QualifiedTablePrefix(catalogSchemaName.getCatalogName(), catalogSchemaName.getSchemaName());
