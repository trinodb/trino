...
public class DefaultSystemTablesProvider
        implements SystemTablesProvider
{
    ...
    public DefaultSystemTablesProvider(TransactionManager transactionManager, Metadata metadata, String catalogName, Set<SystemTable> systemTables, boolean isCoordinator)
    {
    ...
    public Optional<SystemTable> getSystemTable(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        if (staticSystemTable.isPresent() && !isCoordinator) {
