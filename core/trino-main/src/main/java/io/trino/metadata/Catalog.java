...
import static io.trino.metadata.CatalogStatus.FAILED_TO_LOAD;
...
public class Catalog
{
    ...
    {
        return new Catalog(catalogName, createRootCatalogHandle(catalogName, catalogVersion), connectorName, FAILED_TO_LOAD);
    }
