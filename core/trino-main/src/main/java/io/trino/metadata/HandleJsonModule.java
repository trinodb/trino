        ...
        implements Module
{
    ...
    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module viewHandleModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(ConnectorViewHandle.class, resolver::getId, resolver::getHandleClass) {};
    }
