...
import static io.trino.type.DecimalOperators.DECIMAL_DIVIDE_RESCALING_OPERATOR;
...
public final class SystemFunctionBundle
{
    ...
    public static FunctionBundle create(FeaturesConfig featuresConfig, TypeOperators typeOperators, BlockTypeOperators blockTypeOperators, NodeVersion nodeVersion)
    {
        InternalFunctionBundleBuilder builder = InternalFunctionBundle.builder()
                ...
                .functions(DECIMAL_ADD_OPERATOR, DECIMAL_SUBTRACT_OPERATOR, DECIMAL_MULTIPLY_OPERATOR, featuresConfig.isDecimalRescalingEnabled() ? DECIMAL_DIVIDE_RESCALING_OPERATOR : DECIMAL_DIVIDE_OPERATOR, DECIMAL_MODULUS_OPERATOR)
