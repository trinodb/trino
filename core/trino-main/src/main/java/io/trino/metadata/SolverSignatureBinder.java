...
final class SolverSignatureBinder
{
    ...
    {
        return ResolutionBudget.withBudget(() -> bindInternal(parameters, expectedReturn));
    }

    private Optional<GroundSignature> bindInternal(List<? extends TypeDescriptorProvider> parameters, Optional<TypeDescriptor> expectedReturn)
    {
