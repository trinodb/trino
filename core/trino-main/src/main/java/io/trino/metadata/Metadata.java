...
public interface Metadata
{
    ...
    default ResolvedFunction getCoercion(TypeResolutionPolicy typeResolutionPolicy, Type fromType, Type toType)
    {
        return getCoercion(typeResolutionPolicy, CAST, fromType, toType);
    }

    ResolvedFunction getCoercion(TypeResolutionPolicy typeResolutionPolicy, OperatorType operatorType, Type fromType, Type toType);

    ResolvedFunction getCoercion(TypeResolutionPolicy typeResolutionPolicy, CatalogSchemaFunctionName name, Type fromType, Type toType);
