...
public interface Metadata
{
     ...
     */
    Set<SchemaAuthorization> getSchemasAuthorizationInfo(Session session, QualifiedTablePrefix prefix);
     ...
     */
    Set<FunctionAuthorization> getFunctionsAuthorizationInfo(Session session, QualifiedTablePrefix prefix);
}
