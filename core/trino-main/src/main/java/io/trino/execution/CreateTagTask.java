...
public class CreateTagTask
        implements DataDefinitionTask<CreateTag>
{
    private final PlannerContext plannerContext;
    private final AccessControl accessControl;

    @Inject
    public CreateTagTask(PlannerContext plannerContext, AccessControl accessControl)
    {
            ...
            WarningCollector warningCollector)
    {
        ...
        boolean replace = statement.isReplace();
        boolean ifNotExists = statement.isNotExists();
        ...
        plannerContext.getMetadata().createTag(session, tableHandle, tagName, replace, ifNotExists, snapshotId, retention);
