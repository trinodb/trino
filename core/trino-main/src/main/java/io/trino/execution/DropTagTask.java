...
public class DropTagTask
        implements DataDefinitionTask<DropTag>
{
    private final PlannerContext plannerContext;
    private final AccessControl accessControl;

    @Inject
    public DropTagTask(PlannerContext plannerContext, AccessControl accessControl)
    {
            ...
            WarningCollector warningCollector)
    {
        ...
        plannerContext.getMetadata().dropTag(session, tableHandle, tagName);
