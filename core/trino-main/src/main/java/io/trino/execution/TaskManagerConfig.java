...
public class TaskManagerConfig
{
    ...
    private DataSize maxPartialTopNMemoryUsage = DataSize.of(16, Unit.MEGABYTE);
    ...
    @NotNull
    public DataSize getMaxPartialTopNMemoryUsage()
    {
        return maxPartialTopNMemoryUsage;
    }

    @Config("task.max-partial-top-n-memory")
    public TaskManagerConfig setMaxPartialTopNMemoryUsage(DataSize maxPartialTopNMemoryUsage)
    {
        this.maxPartialTopNMemoryUsage = maxPartialTopNMemoryUsage;
        return this;
    }
