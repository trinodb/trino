...
public class StageStateMachine
{
    ...
    {
        // Group each unique pipelineId + operatorId + alternativeId combination into lists
        ...
        // Merge the list of operator stats from each pipelineId + operatorId + alternativeId into a single entry
