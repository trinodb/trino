...
public class NodeRequirements
{
    ...
    private final Optional<Set<HostAddress>> addresses;

    public NodeRequirements(Optional<CatalogName> catalogName, Optional<Set<HostAddress>> addresses)
    {
        this.catalogName = requireNonNull(catalogName, "catalogName is null");
        this.addresses = requireNonNull(addresses, "addresses is null").map(ImmutableSet::copyOf);
    }
    ...
    public Optional<Set<HostAddress>> getAddresses()
    {
        return addresses;
    }
