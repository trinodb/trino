...
public class ColumnInfo
{
    ...
    private ColumnInfo(Optional<CatalogSchemaTableName> schemaTable, String name, Optional<String> label, boolean autoIncrement, boolean nullable, boolean readOnly)
    {
