...
import static io.trino.execution.buffer.OutputBuffers.BufferType.EXTERNAL;
...
public final class OutputBuffers
{
    ...
    public static OutputBuffers createExternalExchangeOutputBuffers(ExchangeSinkInstanceHandle exchangeSinkInstanceHandle)
    {
        return new OutputBuffers(EXTERNAL, 0, true, ImmutableMap.of(), Optional.of(exchangeSinkInstanceHandle));
    }
