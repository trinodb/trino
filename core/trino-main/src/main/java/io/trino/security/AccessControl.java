...
public interface AccessControl
{
     ...
     * @throws AccessDeniedException if not allowed
     */
    void canCanDropBranch(SecurityContext context, QualifiedObjectName tableName, String branchName);
     ...
     * @throws AccessDeniedException if not allowed
     */
    void canCanFastForwardBranch(SecurityContext context, QualifiedObjectName tableName, String sourceBranchName, String targetBranchName);
