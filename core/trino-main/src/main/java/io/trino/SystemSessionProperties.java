        ...
        implements SystemSessionPropertiesProvider
{
            ...
            NodeSchedulerConfig nodeSchedulerConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                integerProperty(
                        ...
                        true),
                integerProperty(
                        TASK_SCALE_WRITERS_PARTITION_COUNT,
                        "Number of partitions created over actual partitioned data. The scaling will only happen on these artificial partitions if task.scale-writers.enabled is set",
                        taskManagerConfig.getScaleWritersPartitionCount(),
                        true),
                dataSizeProperty(
                        WRITER_MIN_SIZE,
    ...
    public static int getTaskScaleWritersPartitionCount(Session session)
    {
        return session.getSystemProperty(TASK_SCALE_WRITERS_PARTITION_COUNT, Integer.class);
    }
