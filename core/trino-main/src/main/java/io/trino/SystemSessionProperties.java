        ...
        implements SystemSessionPropertiesProvider
{
    ...
    public static final String QUERY_MAX_WRITE_PHYSICAL_BYTES = "query_max_write_physical_bytes";
            ...
            NodeSchedulerConfig nodeSchedulerConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                dataSizeProperty(
                        ...
                        false),
                dataSizeProperty(
                        QUERY_MAX_WRITE_PHYSICAL_BYTES,
                        "Maximum write physical bytes of a query",
                        queryManagerConfig.getQueryMaxWritePhysicalBytes().orElse(null),
                        false),
                booleanProperty(
                        RESOURCE_OVERCOMMIT,
    ...
    public static Optional<DataSize> getQueryMaxWritePhysicalBytes(Session session)
    {
        return Optional.ofNullable(session.getSystemProperty(QUERY_MAX_WRITE_PHYSICAL_BYTES, DataSize.class));
    }
