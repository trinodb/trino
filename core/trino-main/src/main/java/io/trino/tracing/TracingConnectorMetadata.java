        ...
        implements ConnectorMetadata
{
    ...
    @Override
    public void addField(ConnectorSession session, ConnectorTableHandle tableHandle, List<String> parentPath, String fieldName, Type type, ColumnPosition position, boolean ignoreExisting)
    {
        Span span = startSpan("addField", tableHandle);
        try (var ignored = scopedSpan(span)) {
            delegate.addField(session, tableHandle, parentPath, fieldName, type, position, ignoreExisting);
        }
    }
