...
public final class TimestampWithTimeZoneMicroWriter
        extends FixedWidthWriter<TimeStampMicroTZVector>
{
    private final TimestampWithTimeZoneType type;

    public TimestampWithTimeZoneMicroWriter(TimeStampMicroTZVector vector, TimestampWithTimeZoneType type)
    {
        super(vector);
        this.type = type;
    }
