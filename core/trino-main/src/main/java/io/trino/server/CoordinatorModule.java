...
import io.trino.execution.scheduler.faulttolerant.ByStatsOutputStatsEstimator;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(ByStatsOutputStatsEstimator.Factory.class).in(Scopes.SINGLETON);
