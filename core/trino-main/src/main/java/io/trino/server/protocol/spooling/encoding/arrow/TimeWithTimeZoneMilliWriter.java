...
public final class TimeWithTimeZoneMilliWriter
        extends FixedWidthWriter<TimeMilliVector>
{
    private final TimeWithTimeZoneType type;

    public TimeWithTimeZoneMilliWriter(TimeMilliVector vector, TimeWithTimeZoneType type)
    {
        super(vector);
        this.type = type;
    }
    ...
    protected void writeValue(Block block, int position)
    {
        ...
        vector.set(position, (int) (normalizedNanos / NANOSECONDS_PER_MILLISECOND));
    }
} 