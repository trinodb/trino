...
public final class TimestampWithTimeZoneSecWriter
        extends FixedWidthWriter<TimeStampSecTZVector>
{
    private final TimestampWithTimeZoneType type;

    public TimestampWithTimeZoneSecWriter(TimeStampSecTZVector vector, TimestampWithTimeZoneType type)
    {
        super(vector);
        this.type = type;
    }
    ...
    protected void writeValue(Block block, int position)
    {
        ...
        vector.set(position, epochMillis / 1_000);
    }
} 