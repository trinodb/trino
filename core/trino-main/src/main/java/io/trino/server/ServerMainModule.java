        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        Multibinder<PluginInstaller> pluginInstallers = newSetBinder(binder, PluginInstaller.class);
        pluginInstallers.addBinding().to(BlockEncodingManager.class);
        pluginInstallers.addBinding().to(TypeRegistry.class);
        pluginInstallers.addBinding().to(GlobalFunctionCatalog.class);
        pluginInstallers.addBinding().to(SessionPropertyDefaults.class);
        pluginInstallers.addBinding().to(ResourceGroupManager.class);
        pluginInstallers.addBinding().to(AccessControlManager.class);
        pluginInstallers.addBinding().to(CertificateAuthenticatorManager.class);
        pluginInstallers.addBinding().to(EventListenerManager.class);
        pluginInstallers.addBinding().to(GroupProviderManager.class);
        pluginInstallers.addBinding().to(ExchangeManagerRegistry.class);
