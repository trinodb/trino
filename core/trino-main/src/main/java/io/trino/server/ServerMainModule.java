...
import static io.trino.operator.table.ExcludeColumns.ExcludeColumnsTableFunctionProvider;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        tableFunctionProviders.addBinding().to(ExcludeColumnsTableFunctionProvider.class).in(Scopes.SINGLETON);
