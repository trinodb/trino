...
public class OAuth2WebUiPreviewResource
        implements AuthPreviewResource
{
    private final OAuth2Client oAuth2Client;
    private final OAuth2WebUiAuthenticationFilter oAuth2WebUiAuthenticationFilter;

    @Inject
    public OAuth2WebUiPreviewResource(OAuth2Client oAuth2Client, OAuth2WebUiAuthenticationFilter oAuth2WebUiAuthenticationFilter)
    {
        this.oAuth2Client = requireNonNull(oAuth2Client, "oAuth2Client is null");
        this.oAuth2WebUiAuthenticationFilter = requireNonNull(oAuth2WebUiAuthenticationFilter, "oAuth2WebUiAuthenticationFilter is null");
    }
    ...
    {
        Optional<String> username = oAuth2WebUiAuthenticationFilter.getAuthenticatedUsername();
    ...
    public Response logout(@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo, @Context SecurityContext securityContext)
    {
        ...
        URI callBackUri = UriBuilder.fromUri(uriInfo.getAbsolutePath())
                ...
                .build();
        oAuth2WebUiAuthenticationFilter.clearAuthenticatedIdentity();
