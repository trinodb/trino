        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, CreateTag.class, CreateTagTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, DropTag.class, DropTagTask.class);
        ...
        bindDataDefinitionTask(binder, executionBinder, ReplaceTag.class, ReplaceTagTask.class);
