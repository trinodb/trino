...
public final class TimeWithTimeZoneMicroWriter
        extends FixedWidthWriter<TimeMicroVector>
{
    private final TimeWithTimeZoneType type;

    public TimeWithTimeZoneMicroWriter(TimeMicroVector vector, TimeWithTimeZoneType type)
    {
        super(vector);
        this.type = type;
    }
    ...
    protected void writeValue(Block block, int position)
    {
        ...
        vector.set(position, normalizedNanos / NANOSECONDS_PER_MICROSECOND);
    }
} 