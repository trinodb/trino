...
public final class TimestampWithTimeZoneMilliWriter
        extends FixedWidthWriter<TimeStampMilliTZVector>
{
    private final TimestampWithTimeZoneType type;

    public TimestampWithTimeZoneMilliWriter(TimeStampMilliTZVector vector, TimestampWithTimeZoneType type)
    {
        super(vector);
        this.type = type;
    }
