            ...
            if (isSpiClass(name)) {
                try {
                    ...
                    if (hasClassLocally(name, resolve)) {
                        throw new ClassNotFoundException("SPI class '%s' was not found in the SPI classloader, but was found in the '%s' plugin classloader".formatted(name, pluginName), e);
                    }
                    throw new ClassNotFoundException("SPI class '%s' was not found in the SPI classloader".formatted(name), e);
                }
            }
