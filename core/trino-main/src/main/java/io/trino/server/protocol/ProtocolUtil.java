...
public final class ProtocolUtil
{
    ...
    private static Column createColumn(Optional<String> catalog, Optional<String> schema, Optional<String> table, String name, Optional<String> label, Type type, boolean supportsParametricDateTime)
    {
