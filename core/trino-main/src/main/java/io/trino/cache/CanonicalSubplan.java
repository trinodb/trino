...
public class CanonicalSubplan
{
    ...
    public SymbolMapper canonicalSymbolMapper()
    {
        return new SymbolMapper(symbol -> {
            ...
            return columnIdToSymbol(columnId, symbol.type());
        });
    }
    ...
    public static CanonicalSubplanBuilder builderExtending(Key key, CanonicalSubplan subplan)
    {
        ...
        return new CanonicalSubplanBuilder(key, subplan.getTableScanId(), subplan.getEnforcedConstraint(), subplan.getTableScan(), subplan.getChildSubplan())
