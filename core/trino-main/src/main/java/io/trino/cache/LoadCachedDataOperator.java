        ...
        implements SourceOperator
{
            ...
            implements SourceOperatorFactory
    {
        ...
        public SourceOperator createOperator(DriverContext driverContext)
        {
            ...
            return new LoadCachedDataOperator(operatorContext, sourceId);
        }
        ...
        {
            return new LoadCachedDataOperatorFactory(operatorId, planNodeId, sourceId);
        }
    }
    ...
    private LoadCachedDataOperator(OperatorContext operatorContext, PlanNodeId sourceId)
    {
