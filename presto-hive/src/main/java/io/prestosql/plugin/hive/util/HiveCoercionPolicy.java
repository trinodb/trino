...
public final class HiveCoercionPolicy
{
    ...
    private boolean canCoerce(HiveType fromHiveType, HiveType toHiveType)
    {
        ...
        if (toType instanceof VarcharType) {
            return fromHiveType.equals(HIVE_BYTE) || fromHiveType.equals(HIVE_SHORT) || fromHiveType.equals(HIVE_INT) || fromHiveType.equals(HIVE_LONG) || fromHiveType.equals(HIVE_FLOAT) || fromHiveType.equals(HIVE_DOUBLE) || fromType instanceof DecimalType;
        }
