            ...
            FileFormatDataSourceStats stats)
    {
        ...
        try {
            ...
            if (isFullAcid) {
                ...
                fileColumns = uniqueIndex(fileColumns, orcColumn -> orcColumn.getColumnName().toLowerCase(ENGLISH)).get(ACID_COLUMN_ROW_STRUCT.toLowerCase(ENGLISH)).getNestedColumns();
            }
