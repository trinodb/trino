...
maven_run_tests="${maven} clean test -Dair.check.skip-all=true -Dmaven.javadoc.skip=true -Dmaven.source.skip=true -B -pl presto-test-jdbc-compatibility-old-driver"
