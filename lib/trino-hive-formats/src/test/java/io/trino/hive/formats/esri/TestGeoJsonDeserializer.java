...
import static io.trino.hive.formats.esri.AbstractDeserializer.INT_HANDLE_BIG_ENDIAN;
...
public class TestGeoJsonDeserializer
{
            ...
            throws IOException
    {
        ...
        assertGeometry(page, new Point(13.0, 37.0));
            ...
            throws IOException
    {
        ...
        GeoJsonDeserializer deserializer = new GeoJsonDeserializer(columns);
    ...
    private static void assertGeometry(Page page, Geometry expected)
    {
        ...
        INT_HANDLE_BIG_ENDIAN.set(expectedBytes, 0, 4326);
