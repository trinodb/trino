        ...
        implements AvroTypeBlockHandler
{
            ...
            implements BlockBuildingDecoder
    {
                ...
                throws IOException
        {
            ...
            long epochMicros = epochNanos / NANOSECONDS_PER_MICROSECOND;
            int picosOfMicro = Math.floorMod(epochNanos, NANOSECONDS_PER_MICROSECOND) * PICOSECONDS_PER_NANOSECOND;
