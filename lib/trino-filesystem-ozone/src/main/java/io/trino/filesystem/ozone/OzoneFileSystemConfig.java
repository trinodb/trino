...
public class OzoneFileSystemConfig
{
    ...
    public OzoneFileSystemConfig setReadBlockSize(DataSize readBlockSize)
    {
    ...
    public OzoneFileSystemConfig setWriteBlockSize(DataSize writeBlockSize)
    {
    ...
    @Config("ozone.page-size")
    @ConfigDescription("The maximum number of blobs to return per page.")
    public OzoneFileSystemConfig setPageSize(int pageSize)
    {
    ...
    public OzoneFileSystemConfig setBatchSize(int batchSize)
    {
    ...
    @Config("ozone.project-id")
    public OzoneFileSystemConfig setProjectId(String projectId)
    {
    ...
    @Config("ozone.use-access-token")
    public OzoneFileSystemConfig setUseGcsAccessToken(boolean useGcsAccessToken)
    {
    ...
    @Config("ozone.json-key")
    @ConfigSecuritySensitive
    public OzoneFileSystemConfig setJsonKey(String jsonKey)
    {
    ...
    @Config("ozone.json-key-file-path")
    @ConfigDescription("JSON key file used to access Google Cloud Storage")
    public OzoneFileSystemConfig setJsonKeyFilePath(String jsonKeyFilePath)
    {
    ...
    @Config("ozone.client.max-retries")
    @ConfigDescription("Maximum number of RPC attempts")
    public OzoneFileSystemConfig setMaxRetries(int maxRetries)
    {
    ...
    @Config("ozone.client.backoff-scale-factor")
    @ConfigDescription("Scale factor for RPC retry delay")
    public OzoneFileSystemConfig setBackoffScaleFactor(double backoffScaleFactor)
    {
    ...
    @Config("ozone.client.max-retry-time")
    @ConfigDescription("Total time limit for an RPC to be retried")
    public OzoneFileSystemConfig setMaxRetryTime(Duration maxRetryTime)
    {
    ...
    @Config("ozone.client.min-backoff-delay")
    @ConfigDescription("Minimum delay between RPC retries")
    public OzoneFileSystemConfig setMinBackoffDelay(Duration minBackoffDelay)
    {
    ...
    @Config("ozone.client.max-backoff-delay")
    @ConfigDescription("Maximum delay between RPC retries.")
    public OzoneFileSystemConfig setMaxBackoffDelay(Duration maxBackoffDelay)
    {
        this.maxBackoffDelay = maxBackoffDelay;
        return this;
    }

    @AssertTrue(message = "ozone.client.min-backoff-delay must be less than or equal to gcs.client.max-backoff-delay")
    ...
    {
        // This cannot be normal validation, as it would make it impossible to write TestOzoneFileSystemConfig.testExplicitPropertyMappings
