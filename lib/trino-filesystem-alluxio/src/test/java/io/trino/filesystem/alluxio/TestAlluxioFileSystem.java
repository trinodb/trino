...
{
    private static final String IMAGE_NAME = "alluxio/alluxio:2.9.4";
    ...
    void testContainer()
    {
        assertTrue(ALLUXIO_MASTER_CONTAINER.isRunning());
        assertTrue(ALLUXIO_WORKER_CONTAINER.isRunning());
    }
}
