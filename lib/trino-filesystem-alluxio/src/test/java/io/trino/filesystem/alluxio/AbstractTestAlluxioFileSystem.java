        ...
        extends AbstractTestTrinoFileSystem
{
            ...
            throws IOException
    {
        ...
        this.alluxioFileSystemFactory = new AlluxioFileSystemFactory();
        this.alluxioFileSystemFactory.setConf(conf);
        this.fileSystem = alluxioFileSystemFactory.create(ConnectorIdentity.ofUser("alluxio"));
        ((AlluxioFileSystem) fileSystem).setRootLocation(rootLocation);
    }
