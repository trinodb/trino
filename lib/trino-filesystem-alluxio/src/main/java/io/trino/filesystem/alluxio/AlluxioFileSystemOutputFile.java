        ...
        implements TrinoOutputFile
{
            ...
            throws IOException
    {
        ...
        try (FileOutStream outStream =
                     fileSystem.createFile(convertToAlluxioURI(location, mountRoot), CreateFilePOptions.newBuilder().setRecursive(true).setOverwrite(true).build())) {
            ...
            throws IOException
    {
        ...
        try (FileOutStream outStream =
                fileSystem.createFile(convertToAlluxioURI(location, mountRoot),
