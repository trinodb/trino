...
public class TestS3FileSystemMinIoSseC
        extends AbstractTestS3FileSystemWithSseC
{
    private static final TrustManager[] TRUST_MANAGERS = createTrustManagers();
    ...
    {
        String truststorePath = getPathFromClassPathResource("minio/certs/truststore.jks");
