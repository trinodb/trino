...
public class TestS3SecurityMappingConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(S3SecurityMappingConfig.class)
                ...
                .setCustomerKeyCredentialName(null)
            ...
            throws IOException
    {
        ...
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("s3.security-mapping.customer-key-credential-name", "sse-customer-key-credential-name")
        ...
        assertThat(config.getCustomerKeyCredentialName()).contains("sse-customer-key-credential-name");
