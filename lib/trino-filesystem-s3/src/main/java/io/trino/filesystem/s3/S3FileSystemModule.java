        ...
        extends AbstractConfigurationAwareModule
{
    ...
    private boolean securityMappingEnabled()
    {
        return buildConfigObject(S3SecurityMappingConfig.class).getConfigFilePath().isPresent();
    }
            ...
            extends AbstractConfigurationAwareModule
    {
        ...
        protected void setup(Binder binder)
        {
            String file = buildConfigObject(S3SecurityMappingConfig.class).getConfigFilePath().orElseThrow();
