        ...
        implements Function<Location, TrinoFileSystemFactory>
{
    ...
    {
        RetryStrategy retryStrategy = requireNonNull(getRetryStrategy(requireNonNull(config.getRetryMode(), "retryMode is null")), "retryStrategy is null");
        RetryStrategy.Builder<?, ?> retryStrategyBuilder = requireNonNull(retryStrategy.toBuilder(), "retryStrategyBuilder is null");
        RetryStrategy configuredRetryStrategy = requireNonNull(
                retryStrategyBuilder
                        .maxAttempts(config.getMaxErrorRetries())
                        .build(),
                "configuredRetryStrategy is null");
