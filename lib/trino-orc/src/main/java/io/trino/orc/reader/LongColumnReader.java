        ...
        implements ColumnReader
{
    ...
    // only one of the four arrays will be used
            ...
            throws OrcCorruptionException
    {
        ...
        verifyStreamType(column, type, t -> t instanceof BigintType || t instanceof IntegerType || t instanceof SmallintType || t instanceof TinyintType
                || t instanceof DateType || t instanceof TimeType);
        this.type = type;
