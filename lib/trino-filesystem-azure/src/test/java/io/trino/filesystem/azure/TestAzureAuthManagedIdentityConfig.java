...
final class TestAzureAuthManagedIdentityConfig
{
    ...
    void testClientIdPropertyMapping()
    {
        AzureAuthManagedIdentityConfig actual = buildManagedConfig(ImmutableMap.<String, String>builder()
                .put("azure.managed-identity.client-id", "clientId")
                .buildOrThrow());
    ...
    {
        AzureAuthManagedIdentityConfig actual = buildManagedConfig(ImmutableMap.<String, String>builder()
                .put("azure.managed-identity.resource-id", "resourceId")
                .buildOrThrow());
    ...
    void testValidation()
    {
        ...
        assertFailsValidation(
                ...
                "configValid",
                "Exactly one of azure.managed-identity.client-id or azure.managed-identity.resource-id must be set",
                AssertTrue.class);
    }
