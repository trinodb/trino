        ...
        extends TrinoInputStream
{
    ...
    public GcsInputStream(GcsLocation location, Storage storage, Blob blob, int readBlockSizeBytes, OptionalLong predeclaredLength, Optional<EncryptionKey> key, Map<String, String> auditHeaders)
            throws IOException
    {
