...
public class GcsAuthDefault
        implements GcsAuth
{
    private final Optional<GoogleCredentials> jsonGoogleCredential;

    @Inject
    public GcsAuthDefault(GcsFileSystemConfig config)
            throws IOException
    {
    ...
    @Override
    public void setAuth(Map<String, String> extraCredentials, StorageOptions.Builder builder)
    {
