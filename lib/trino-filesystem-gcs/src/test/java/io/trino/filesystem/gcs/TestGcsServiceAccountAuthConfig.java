...
public class TestGcsServiceAccountAuthConfig
{
    @Test
    void testDefaults()
    {
    ...
    void testValidation()
    {
        assertFailsValidation(
                ...
                "authMethodValid",
                "Can't set both gcs.json-key and gcs.json-key-file-path",
                AssertTrue.class);
        ...
        assertThat(new GcsServiceAccountAuthConfig().isAuthMethodValid()).isTrue();
    }
}
