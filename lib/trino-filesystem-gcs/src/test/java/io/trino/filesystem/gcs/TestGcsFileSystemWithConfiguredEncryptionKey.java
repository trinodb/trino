...
public class TestGcsFileSystemWithConfiguredEncryptionKey
        extends AbstractTestGcsFileSystem
{
    ...
    public void testPreSignedUris()
            throws IOException
    {
        abort("Pre-signed URIs cannot retrieve CSEK-encrypted objects: GCS requires the encryption key in the request header, which pre-signed URLs do not support");
    }
}
