...
public class TimeMillisColumnReader
        extends PrimitiveColumnReader
{
    public TimeMillisColumnReader(PrimitiveField field)
    {
        super(field);
    }
    ...
    {
        long picos = valuesReader.readLong() * Timestamps.PICOSECONDS_PER_MILLISECOND;
