...
public class ParquetWriterOptions
{
    ...
    public static final int DEFAULT_MAX_BLOOM_FILTER_SIZE = 1024 * 1024;
    ...
    private ParquetWriterOptions(DataSize maxBlockSize, DataSize maxPageSize, int maxPageValueCount, int batchSize, int maxBloomFilterSize, OptionalLong bloomFilterNDV, OptionalDouble bloomFilterFPP, Set<java.lang.String> bloomFilterColumns)
    {
    ...
    public OptionalDouble getBLoomFilterFPP()
    {
    ...
    public static class Builder
    {
        ...
        private int maxBloomFilterSize = DEFAULT_MAX_BLOOM_FILTER_SIZE;
        private Set<String> bloomFilterColumns = ImmutableSet.of();
        private OptionalLong bloomFilterNDV = OptionalLong.empty();
        private OptionalDouble bloomFilterFPP = OptionalDouble.empty();
        ...
        public Builder setMaxBloomFilterSize(int maxBloomFilterSize)
        {
            this.maxBloomFilterSize = maxBloomFilterSize;
            return this;
        }

        public Builder setBloomFilterNDV(OptionalLong bloomFilterNDV)
        {
            this.bloomFilterNDV = bloomFilterNDV;
            return this;
        }

        public Builder setBloomFilterFPP(OptionalDouble bloomFilterNDV)
        {
            this.bloomFilterFPP = bloomFilterNDV;
            return this;
        }
        ...
        {
            return new ParquetWriterOptions(maxBlockSize, maxPageSize, maxPageValueCount, batchSize, maxBloomFilterSize, bloomFilterNDV, bloomFilterFPP, bloomFilterColumns);
        }
    }
}
