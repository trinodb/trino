...
{
    public ParquetCryptoException(ParquetDataSourceId dataSourceId, String message)
    {
    ...
    @FormatMethod
    public ParquetCryptoException(Throwable cause, ParquetDataSourceId dataSourceId, String messageFormat, Object... args)
    {
        super(formatMessage(Optional.of(dataSourceId), messageFormat, args), cause);
    }
