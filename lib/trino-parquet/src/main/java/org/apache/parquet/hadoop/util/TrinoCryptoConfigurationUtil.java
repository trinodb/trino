...
public class TrinoCryptoConfigurationUtil
{
  ...
  public static Class<?> getClassFromConfig(TrinoParquetCryptoConfig config, String configName, Class<?> assignableFrom) {
    final String className = config.get(configName);
    if (className == null) {
      return null;
    }
