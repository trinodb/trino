...
import static io.trino.typesolver.Expression.BinaryOperator.DIVIDE;
...
import static io.trino.typesolver.Expression.BinaryOperator.MULTIPLY;
...
/// Handwritten scalar function signatures for solver unit tests.
/// These fixtures cover selected string, numeric, temporal, JSON, and collection functions.
/// Engine parity tests use Trino's registered signatures instead.
public final class TrinoScalarFunctions
{
    ...
    private static void registerStringFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("concat", new CompiledSignature(
                List.of(),
                List.of(),
        ...
        builder.registerFunction("replace", new CompiledSignature(
        ...
        builder.registerFunction("repeat", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
        ...
        builder.registerFunction("concat_ws", new CompiledSignature(
                List.of(),
                List.of(),
                variadicFunction(List.of(symbol("varchar"), symbol("varchar")), symbol("varchar"), symbol("varchar"))));
        builder.registerFunction("format", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
    ...
    private static CompiledSignature varcharLengthPreserving(List<Expression> parameterTypes, Expression length)
    {
    ...
    private static void registerNumericFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("abs", new CompiledSignature(
        ...
        CompiledSignature decimalRoundToInteger = new CompiledSignature(
                List.of(variable("p"), variable("s")),
                List.of(),
                function(
        ...
        builder.registerFunction("round", new CompiledSignature(
                List.of(variable("p"), variable("s")),
                List.of(),
                function(
        ...
        builder.registerFunction("truncate", new CompiledSignature(
                List.of(variable("p"), variable("s")),
                List.of(),
                function(
                        List.of(apply("decimal", variable("p"), variable("s"))),
        ...
        builder.registerFunction("sign", new CompiledSignature(
                List.of(variable("p"), variable("s")),
                List.of(),
    ...
    private static void registerTemporalFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("date_diff", new CompiledSignature(
        ...
        // Format / parse.
        builder.registerFunction("date_format", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
        ...
        builder.registerFunction("format_datetime", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
                function(List.of(apply("timestamp", variable("p")), symbol("varchar")), symbol("varchar"))));
        ...
        // Unix time.
        builder.registerFunction("to_unixtime", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
        ...
        builder.registerFunction("from_unixtime_nanos", new CompiledSignature(
                List.of(variable("p"), variable("s")),
                List.of(),
        ...
        builder.registerFunction("date", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
        ...
        builder.registerFunction("timezone", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
        ...
        // at_timezone.
        builder.registerFunction("at_timezone", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
                function(List.of(apply("timestamp_with_time_zone", variable("p")), symbol("varchar")), apply("timestamp_with_time_zone", variable("p")))));
        builder.registerFunction("with_timezone", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
        ...
        for (String part : List.of("year", "month", "day", "hour", "minute", "second", "millisecond", "day_of_week", "dow", "day_of_month", "day_of_year", "doy", "week", "week_of_year", "quarter", "yow", "year_of_week")) {
            builder.registerFunction(part, new CompiledSignature(
                    List.of(variable("p")),
                    List.of(),
        ...
        builder.registerFunction("timezone_hour", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
                function(List.of(apply("timestamp_with_time_zone", variable("p"))), symbol("bigint"))));
        builder.registerFunction("timezone_minute", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
                function(List.of(apply("timestamp_with_time_zone", variable("p"))), symbol("bigint"))));
        ...
        builder.registerFunction("to_iso8601", new CompiledSignature(
                List.of(variable("p")),
                List.of(),
                function(
    ...
    private static void registerJsonFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("json_array_contains", new CompiledSignature(
                List.of(variable("T")),
    ...
    {
        // Cardinality.
        builder.registerFunction("cardinality", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T"))), symbol("bigint"))));
        builder.registerFunction("element_at", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), symbol("bigint")), variable("T"))));
        builder.registerFunction("slice", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
        ...
        builder.registerFunction("reverse", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("shuffle", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("array_distinct", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("array_union", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("array_intersect", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("array_except", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), apply("array", variable("T"))), apply("array", variable("T")))));
        builder.registerFunction("array_position", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), variable("T")), symbol("bigint"))));
        builder.registerFunction("array_sort", new CompiledSignature(
                List.of(variable("T")),
        ...
        builder.registerFunction("array_sort", new CompiledSignature(
                ...
                function(
                        ...
                        apply("array", variable("T")))));
        builder.registerFunction("array_min", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireOrderable("T")),
                function(List.of(apply("array", variable("T"))), variable("T"))));
        builder.registerFunction("array_max", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireOrderable("T")),
                function(List.of(apply("array", variable("T"))), variable("T"))));
        builder.registerFunction("array_join", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
        ...
        builder.registerFunction("contains", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
        ...
        builder.registerFunction("flatten", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", apply("array", variable("T")))), apply("array", variable("T")))));
        builder.registerFunction("array_agg", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(variable("T")), apply("array", variable("T")))));
        builder.registerFunction("arrays_overlap", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), apply("array", variable("T"))), symbol("boolean"))));
        builder.registerFunction("zip", new CompiledSignature(
        ...
        builder.registerFunction("zip_with", new CompiledSignature(
        ...
        builder.registerFunction("combinations", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(
        ...
        builder.registerFunction("reduce", new CompiledSignature(
                ...
                function(List.of(
                        ...
                        variable("R"))));
        builder.registerFunction("any_match", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), function(List.of(variable("T")), symbol("boolean"))), symbol("boolean"))));
        builder.registerFunction("all_match", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), function(List.of(variable("T")), symbol("boolean"))), symbol("boolean"))));
        builder.registerFunction("none_match", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), function(List.of(variable("T")), symbol("boolean"))), symbol("boolean"))));

        // Element accessors and structural transforms over the element type T.
        builder.registerFunction("array_first", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T"))), variable("T"))));
        builder.registerFunction("array_first", new CompiledSignature(
        ...
        builder.registerFunction("array_last", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T"))), variable("T"))));
        builder.registerFunction("array_remove", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), variable("T")), apply("array", variable("T")))));
        builder.registerFunction("trim_array", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), symbol("bigint")), apply("array", variable("T")))));
        // ngrams(array(T), integer) -> array(array(T)).
        builder.registerFunction("ngrams", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(apply("array", variable("T")), symbol("integer")), apply("array", apply("array", variable("T"))))));
        builder.registerFunction("contains_sequence", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(apply("array", variable("T")), apply("array", variable("T"))), symbol("boolean"))));
        // array_histogram(array(T)) -> map(T, bigint).
        builder.registerFunction("array_histogram", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
    ...
    private static void registerMapFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("transform_keys", new CompiledSignature(
        ...
        builder.registerFunction("transform_values", new CompiledSignature(
        ...
        builder.registerFunction("multimap_from_entries", new CompiledSignature(
                List.of(variable("K"), variable("V")),
                List.of(),
                function(
        ...
        builder.registerFunction("map_zip_with", new CompiledSignature(
    ...
    private static void registerRegexpFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("regexp_replace", new CompiledSignature(
                List.of(variable("x"), variable("y")),
                List.of(),
                function(
    ...
    private static void registerUrlFunctions(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("url_encode", new CompiledSignature(
                List.of(variable("x")),
                List.of(),
                function(
    ...
    {
        builder.registerFunction("nullif", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireComparable("T")),
                function(List.of(variable("T"), variable("T")), variable("T"))));
        builder.registerFunction("greatest", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireOrderable("T")),
                variadicFunction(List.of(variable("T")), variable("T"), variable("T"))));
        builder.registerFunction("least", new CompiledSignature(
                List.of(variable("T")),
                List.of(new RequireOrderable("T")),
                variadicFunction(List.of(variable("T")), variable("T"), variable("T"))));
        builder.registerFunction("if", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(symbol("boolean"), variable("T"), variable("T")), variable("T"))));
        builder.registerFunction("try", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
                function(List.of(variable("T")), variable("T"))));
        builder.registerFunction("typeof", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
    ...
    private static void registerMiscellaneous(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("value_at_quantile", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
        ...
        builder.registerFunction("values_at_quantiles", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
        ...
        builder.registerFunction("quantile_at_value", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
