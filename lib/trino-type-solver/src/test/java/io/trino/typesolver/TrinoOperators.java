...
import static io.trino.typesolver.Expression.BinaryOperator.MAX;
...
/// Handwritten operator signatures for solver unit tests.
public final class TrinoOperators
{
    ...
    public static TypeLibrary.Builder register(TypeLibrary.Builder builder)
    {
        for (String name : EQUALITY_OPERATORS) {
            builder.registerFunction(name, new CompiledSignature(
                    List.of(variable("T")),
        ...
        builder.registerFunction("-", new CompiledSignature(
        ...
        builder.registerFunction("coalesce", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
    ...
    private static void registerSubscript(TypeLibrary.Builder builder)
    {
        ...
        builder.registerFunction("subscript", new CompiledSignature(
                List.of(variable("T")),
                List.of(),
    ...
    private static CompiledSignature decimalAdditiveScheme()
    {
    ...
    private static CompiledSignature decimalMultiplyScheme()
    {
    ...
    private static CompiledSignature decimalDivisionScheme()
    {
    ...
    static CompiledSignature decimalModuloScheme()
    {
        // scale = max(s1, s2)
