...
public class CastTest
{
    ...
    @Test
    void testCharToVarcharIsImplicitInSqlStandardMode()
    {
        // SQL-standard mode implicitly widens char to varchar; every implicit coercion is also a cast.
        assertThat(LIBRARY.resolveCast(apply("char", literal(10)), apply("varchar", literal(20)))).isPresent();
        assertThat(LIBRARY.typeSystem().coercionPlan(apply("char", literal(10)), apply("varchar", literal(20)))).isPresent();
    }
