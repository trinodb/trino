 ...
 * <p>
 * Either bound may be absent, representing an unbounded side. When {@code min == max}
 * the variable is fully determined and can be materialized to a {@link Expression.Literal}.
 */
