...
/// Restricts a variable to a specific [Kind] (type vs numeric).
///
/// Used by parametric type constructors like `decimal(p, s)` to declare that
/// their arguments must be numeric, and by signatures that walk generic arguments
/// through the kind-aware decomposition in [CompiledSignature].
