...
///
/// Also handles the degenerate variable cases: when either side is a lone [Expression.Variable],
/// the rule produces an [ExactType] constraint binding the variable to the other side.
