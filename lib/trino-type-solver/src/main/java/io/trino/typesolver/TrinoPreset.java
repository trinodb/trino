...
public final class TrinoPreset
{
    ...
    {
        return switch (charVarcharCoercion) {
            case SQL_STANDARD -> Rules.SQL_STANDARD;
            case LEGACY -> Rules.LEGACY;
        };
    }

    private static List<CoercionRule> createCoercionRules(CharVarcharCoercion charVarcharCoercion)
    {
    ...
    private static List<CoercionRule> createCastRules()
    {
    ...
    {
        private static final List<CoercionRule> SQL_STANDARD = createCoercionRules(CharVarcharCoercion.SQL_STANDARD);
        private static final List<CoercionRule> LEGACY = createCoercionRules(CharVarcharCoercion.LEGACY);
        private static final List<CoercionRule> CASTS = createCastRules();
    }
}
