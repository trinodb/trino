...
public record TDigestType()
        implements Type
{
    public static final TypeConstructor CONSTRUCTOR = new PrimitiveTypeConstructor("tdigest", TDigestType::new, Trait.ABSENT, Trait.ABSENT);
}
