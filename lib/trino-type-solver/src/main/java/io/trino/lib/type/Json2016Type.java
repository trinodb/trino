...
public record Json2016Type()
        implements Type
{
    public static final TypeConstructor CONSTRUCTOR = new PrimitiveTypeConstructor("json2016", Json2016Type::new, Trait.ABSENT, Trait.ABSENT);
}
