...
/**
 * Cast rule for {@code json → row(...)}: permits the cast if every field of the target row
 * is individually castable from {@code json}. Mirrors Trino's {@code JsonToRowCast}.
 */
