...
public record HyperLogLogType()
        implements Type
{
    public static final TypeConstructor CONSTRUCTOR = new PrimitiveTypeConstructor("HyperLogLog", HyperLogLogType::new, Trait.ABSENT, Trait.ABSENT);
}
