...
public record VariantType()
        implements Type
{
    // Trino's variant is comparable (equality) but not orderable.
    public static final TypeConstructor CONSTRUCTOR = new PrimitiveTypeConstructor("variant", VariantType::new, Trait.PRESENT, Trait.ABSENT);
}
