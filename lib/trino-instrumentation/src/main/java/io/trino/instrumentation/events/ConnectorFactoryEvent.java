...
@Name("io.trino.spi.connector.ConnectorFactory")
@Label("ConnectorFactory")
@Description("Traces ConnectorFactory SPI invocations")
@Category({"Trino SPI", "Connector"})
public class ConnectorFactoryEvent
        extends Event
{
    @Label("Class")
