...
@Name("io.trino.spi.connector.ConnectorAccessControl")
@Label("ConnectorAccessControl")
@Description("Traces ConnectorAccessControl SPI invocations")
@Category({"Trino SPI", "Connector"})
public class ConnectorAccessControlEvent
        extends Event
{
    @Label("Class")
