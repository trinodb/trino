...
@Name("io.trino.spi.connector.ConnectorRecordSetProvider")
@Label("ConnectorRecordSetProvider")
@Description("Traces ConnectorRecordSetProvider SPI invocations")
@Category({"Trino SPI", "Connector"})
public class ConnectorRecordSetProviderEvent
        extends Event
{
    @Label("Class")
