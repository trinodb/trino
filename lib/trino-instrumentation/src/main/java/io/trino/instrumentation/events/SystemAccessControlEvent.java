...
@Name("io.trino.spi.SystemAccessControl")
@Label("SystemAccessControl")
@Description("Traces SystemAccessControl SPI invocations")
@Category({"Trino SPI", "Security"})
public class SystemAccessControlEvent
        extends Event
{
    @Label("ClassName")
