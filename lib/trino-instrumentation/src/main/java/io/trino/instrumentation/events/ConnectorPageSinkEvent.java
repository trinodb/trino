...
@Name("io.trino.spi.connector.ConnectorPageSink")
@Label("ConnectorPageSink")
@Description("Traces ConnectorPageSink SPI invocations")
@Category({"Trino SPI", "Connector"})
public class ConnectorPageSinkEvent
        extends Event
{
    @Label("Class")
