...
@Name("io.trino.spi.connector.ConnectorPageSource")
@Label("ConnectorPageSource")
@Description("Traces ConnectorPageSource SPI invocations")
@Category({"Trino SPI", "Connector"})
public class ConnectorPageSourceEvent
        extends Event
{
    @Label("Class")
