...
public final class KeyStoreUtils
{
    ...
    public static String readEntity(KeyStore keyStore, String entityAlias, String password)
            throws GeneralSecurityException
    {
        SecretKeyEntry secretKeyEntry = (SecretKeyEntry) keyStore.getEntry(entityAlias, new KeyStore.PasswordProtection(password.toCharArray()));
