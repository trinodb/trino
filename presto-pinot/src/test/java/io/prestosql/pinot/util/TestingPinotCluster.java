        ...
        implements Closeable
{
    ...
    public TestingPinotCluster()
    {
        ...
        server = new FixedHostPortGenericContainer<>(BASE_IMAGE)
                .withNetwork(Network.SHARED)
                ...
                .withFixedExposedPort(SERVER_PORT, SERVER_PORT)
                .withFixedExposedPort(SERVER_ADMIN_PORT, SERVER_ADMIN_PORT);
    }
