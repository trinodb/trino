...
| `pinot.instance-config-refresh-interval`               | No       | How often the cached instance configuration of a Pinot server is refreshed in the background; a refresh that fails keeps the last value. Default is `30m`.                                                                                                                |
