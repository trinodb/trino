...
<https://docs.alluxio.io/os/user/stable/en/compute/Hive.html?utm_source=trino&utm_medium=trinodocs>`_
...
<https://docs.alluxio.io/ee/user/stable/en/compute/Trino.html?utm_source=trino&utm_medium=trinodocs>`_.
