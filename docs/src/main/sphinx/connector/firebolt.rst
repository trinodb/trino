...
`Firebolt <https://www.firebolt.io/>`_ database. This can be used to join data between
...
* `Firebolt account <https://www.firebolt.io/getting-started-now>`_.
