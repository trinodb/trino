...
Additionally, the `datasources` property is now deprecated and should also be
removed (see [Datasource Configuration](rn-069-datasource-configuration)).
:::
...
(rn-069-datasource-configuration)=
