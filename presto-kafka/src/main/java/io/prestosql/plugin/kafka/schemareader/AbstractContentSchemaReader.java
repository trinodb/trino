        ...
        implements ContentSchemaReader
{
    ...
    {
        return readSchema(tableHandle.getKeyDataSchemaLocation(), tableHandle.getKeyDecoderParams());
    }

    @Override
    public Optional<String> readValueContentSchema(KafkaTableHandle tableHandle)
    {
        return readSchema(tableHandle.getMessageDataSchemaLocation(), tableHandle.getMessageDecoderParams());
    }

    protected abstract Optional<String> readSchema(Optional<String> dataSchemaLocation, Optional<Map<String, String>> decoderParams);
}
