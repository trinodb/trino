        ...
        implements ConnectorSplitManager
{
    ...
    private final DispatchingContentSchemaReader dispatchingContentSchemaReader;
    private final int messagesPerSplit;

    @Inject
    public KafkaSplitManager(KafkaConsumerFactory consumerFactory, KafkaConfig kafkaConfig, KafkaFilterManager kafkaFilterManager, DispatchingContentSchemaReader dispatchingContentSchemaReader)
    {
        ...
        this.dispatchingContentSchemaReader = requireNonNull(dispatchingContentSchemaReader, "dispatchingSchemaReader is null");
    }
            ...
            DynamicFilter dynamicFilter)
    {
        ...
        try (KafkaConsumer<byte[], byte[]> kafkaConsumer = consumerFactory.create()) {
            ...
            Optional<String> keyDataSchemaContents = dispatchingContentSchemaReader.readKeyContentSchema(kafkaTableHandle);
            Optional<String> messageDataSchemaContents = dispatchingContentSchemaReader.readValueContentSchema(kafkaTableHandle);
