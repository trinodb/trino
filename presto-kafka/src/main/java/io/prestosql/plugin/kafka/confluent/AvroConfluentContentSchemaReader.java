...
import io.prestosql.plugin.kafka.schemareader.AbstractContentSchemaReader;
        ...
        extends AbstractContentSchemaReader
{
    ...
    @Override
    protected Optional<String> readSchema(Optional<String> dataSchemaLocation, Optional<Map<String, String>> decoderParams)
    {
        Optional<String> subject = decoderParams.map(params -> params.get(SUBJECT));
