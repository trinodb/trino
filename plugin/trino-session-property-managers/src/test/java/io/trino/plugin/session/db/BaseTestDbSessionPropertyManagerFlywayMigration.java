...
public abstract class BaseTestDbSessionPropertyManagerFlywayMigration
{
    ...
    public void testMigrationWithEmptyDatabase()
    {
        ...
        // A dedicated history table is used so this manager can coexist with the resource group manager
        // (which uses the default flyway_schema_history) in the same schema.
        assertThat(tableExists("flyway_schema_history_session_property_manager")).isTrue();
    ...
    protected void dropAllTables()
    {
        ...
        jdbiHandle.execute("DROP TABLE IF EXISTS flyway_schema_history_session_property_manager");
        jdbiHandle.close();
    }
}
