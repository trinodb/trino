...
public class FlywayMigration
{
    ...
    public FlywayMigration(DbSessionPropertyManagerConfig config)
    {
        ...
        flyway = Flyway.configure()
                ...
                .locations(location)
                // Dedicated history table so this manager can share a database schema with the resource group
                // manager (which uses Flyway's default flyway_schema_history) without their histories colliding.
                .table("flyway_schema_history_session_property_manager")
