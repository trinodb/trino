...
public class KingbaseSqlServerConfig
{
    ...
    public KingbaseSqlServerConfig setBulkCopyForWrite(boolean bulkCopyForWrite)
    {
    ...
    public KingbaseSqlServerConfig setBulkCopyForWriteLockDestinationTable(boolean bulkCopyForWriteLockDestinationTable)
    {
    ...
    public KingbaseSqlServerConfig setSnapshotIsolationDisabled(boolean snapshotIsolationDisabled)
    {
    ...
    public KingbaseSqlServerConfig setStoredProcedureTableFunctionEnabled(boolean storedProcedureTableFunctionEnabled)
    {
