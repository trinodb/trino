        ...
        implements AggregateFunctionRule
{
    ...
    public Optional<PinotColumnHandle> rewrite(AggregateFunction aggregateFunction, Captures captures, RewriteContext context)
    {
        ...
        PinotColumnHandle outputColumnHandle = new PinotColumnHandle(format("%s(%s)", aggregateFunction.getFunctionName(), context.getIdentifierQuote().apply(columnHandle.getColumnName())), aggregateFunction.getOutputType());
