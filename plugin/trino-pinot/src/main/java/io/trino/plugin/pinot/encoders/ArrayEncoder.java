        ...
        extends AbstractEncoder
{
    ...
    public ArrayEncoder(FieldSpec fieldSpec, ArrayType arrayType)
    {
        this.arrayType = requireNonNull(arrayType, "arrayType is null");
        Type elementType = arrayType.getElementType();
        this.elementEncoder = EncoderFactory.createEncoder(fieldSpec, elementType);
    ...
    {
        Block arrayBlock = (Block) arrayType.getObject(block, position);
        ...
        for (int index = 0; index < arrayBlock.getPositionCount(); index++) {
            ...
            // Arrays cannot contain null values: see
            // org.apache.pinot.core.segment.processing.genericrow.GenericRowSerializer.serialize method.
