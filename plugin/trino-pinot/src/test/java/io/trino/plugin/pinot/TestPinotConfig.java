...
public class TestPinotConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(
                ConfigAssertions.recordDefaults(PinotConfig.class)
                        ...
                        .setInstanceConfigRefreshInterval(new Duration(30, TimeUnit.MINUTES))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("pinot.instance-config-refresh-interval", "1h")
        ...
        PinotConfig expected = new PinotConfig()
                ...
                .setInstanceConfigRefreshInterval(new Duration(1, TimeUnit.HOURS))
