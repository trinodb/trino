...
public class TestPinotConfig
{
    ...
    {
        // Default behavior
        assertTrue(isControllerUrlValid("my-controller-1:8443,my-controller-2:8443", false));
        assertTrue(isControllerUrlValid("http://my-controller-1:9000,http://my-controller-2:9000", false));
        assertTrue(isControllerUrlValid("https://my-controller-1:8443,https://my-controller-2:8443", false));

        // Tls enabled
        assertFalse(isControllerUrlValid("my-controller-1:8443,my-controller-2:8443", true));
        assertFalse(isControllerUrlValid("http://my-controller-1:9000,http://my-controller-2:9000", true));
        assertTrue(isControllerUrlValid("https://my-controller-1:8443,https://my-controller-2:8443", true));
    }

    private static boolean isControllerUrlValid(String urls, boolean tlsEnabled)
    {
        PinotConfig config = new PinotConfig();
        config.setControllerUrls(urls);
        config.setTlsEnabled(tlsEnabled);
        return config.isControllerUrlValidWhenTlsEnabled();
    }
}
