...
public class TestPinotMetadata
{
    ...
    public void testTables()
    {
        ...
        assertThat(ImmutableSet.copyOf(schemaTableNames)).isEqualTo(ImmutableSet.builder()
                .add(new SchemaTableName("default", metadata.canonicalize(TestPinotSplitManager.realtimeOnlyTable.tableName())))
                .add(new SchemaTableName("default", metadata.canonicalize(TestPinotSplitManager.hybridTable.tableName())))
                .add(new SchemaTableName("default", metadata.canonicalize(TEST_TABLE)))
                .build());
