...
final class TestPaimonRow
{
    ...
    void testPaimonRow()
    {
        ...
        RowType rowType = RowType.builder().fields(DataTypes.BOOLEAN(), DataTypes.BOOLEAN(), DataTypes.SMALLINT(), DataTypes.INT(), DataTypes.BIGINT(),
                DataTypes.FLOAT(), DataTypes.DOUBLE(), DataTypes.STRING(), DataTypes.DECIMAL(2, 2), DataTypes.DECIMAL(38, 2),
                DataTypes.DECIMAL(10, 1), DataTypes.TIMESTAMP(6), DataTypes.VARBINARY(Integer.MAX_VALUE)).build();
