        ...
        implements ConnectorSplitManager
{
            ...
            Constraint constraint)
    {
        try {
            ...
            Table table = metadata.table(session, tableHandle.getSchemaName(), tableHandle.getTableName());
            ...
            throw new TrinoException(PaimonErrorCode.PAIMON_CANNOT_OPEN_SPLIT, "Fetch splits failed!", e);
        }
    }
}
