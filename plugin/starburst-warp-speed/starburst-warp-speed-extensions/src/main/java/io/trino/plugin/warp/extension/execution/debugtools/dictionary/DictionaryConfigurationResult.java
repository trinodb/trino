...
public class DictionaryConfigurationResult
{
    ...
    @JsonCreator
    public DictionaryConfigurationResult(@JsonProperty("maxDictionaryTotalCacheWeight") long dictionaryCacheTotalSize,
    ...
    {
        return maxDictionaryTotalCacheWeight;
    }
