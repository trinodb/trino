...
public class WorkerNodePartitioningProvider
        implements ConnectorNodePartitioningProvider
{
    private final ConnectorNodePartitioningProvider nodePartitionProvider;

    public WorkerNodePartitioningProvider(ConnectorNodePartitioningProvider nodePartitionProvider)
    {
    ...
    {
        return nodePartitionProvider.getBucketNodeMapping(transactionHandle, session, partitioningHandle);
    }
