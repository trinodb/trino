        ...
        extends BasePushdownPlanTest
{
            ...
            throws IOException
    {
        ...
        OpenSearchColumnHandle columnX = projectColumn(ImmutableList.of(column0Handle.path().getFirst(), "x"), BIGINT, new BigintDecoder.Descriptor("col0.x"), true);
        OpenSearchColumnHandle columnY = projectColumn(ImmutableList.of(column0Handle.path().getFirst(), "y"), BIGINT, new BigintDecoder.Descriptor("col0.y"), true);
    ...
    private static OpenSearchColumnHandle projectColumn(List<String> path, Type projectedColumnType, DecoderDescriptor decoderDescriptor, boolean supportsPredicates)
    {
