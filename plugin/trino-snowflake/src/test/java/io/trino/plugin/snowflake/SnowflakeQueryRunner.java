...
public final class SnowflakeQueryRunner
{
    ...
    public static Builder builder()
    {
        ...
        checkArgument(TestingSnowflakeServer.TEST_PRIVATE_KEY.isPresent() || TestingSnowflakeServer.TEST_PASSWORD.isPresent(), "Exactly one of PrivateKey or Password must be set");
