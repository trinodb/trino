...
public class TestTiberoClient
{
    ...
    public void testTypedNullWriteMapping()
            throws SQLException
    {
        testTypedNullWriteMapping(SMALLINT, "smallint", Types.SMALLINT);
        testTypedNullWriteMapping(INTEGER, "integer", Types.INTEGER);
        testTypedNullWriteMapping(BIGINT, "bigint", Types.BIGINT);
        testTypedNullWriteMapping(REAL, "real", Types.REAL);
        testTypedNullWriteMapping(DOUBLE, "double precision", Types.DOUBLE);
        testTypedNullWriteMapping(createCharType(25), "char(25)", Types.CHAR);
