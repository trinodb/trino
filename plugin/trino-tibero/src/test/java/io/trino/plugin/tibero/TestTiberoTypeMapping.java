...
public class TestTiberoTypeMapping
{
    ...
    public void testSmallintMapping()
    {
        assertThat(toTrinoType(Types.SMALLINT, "smallint"))
                .hasValueSatisfying(mapping -> assertThat(mapping.getType()).isEqualTo(SmallintType.SMALLINT));
    }
    ...
    public void testIntegerMapping()
    {
        assertThat(toTrinoType(Types.INTEGER, "integer"))
                .hasValueSatisfying(mapping -> assertThat(mapping.getType()).isEqualTo(IntegerType.INTEGER));
    }
    ...
    public void testBigintMapping()
    {
        assertThat(toTrinoType(Types.BIGINT, "bigint"))
                .hasValueSatisfying(mapping -> assertThat(mapping.getType()).isEqualTo(BigintType.BIGINT));
    }
    ...
    public void testRealMapping()
    {
        assertThat(toTrinoType(Types.REAL, "real"))
                .hasValueSatisfying(mapping -> assertThat(mapping.getType()).isEqualTo(RealType.REAL));
    }
    ...
    public void testDoubleMapping()
    {
        assertThat(toTrinoType(Types.DOUBLE, "double precision"))
                .hasValueSatisfying(mapping -> assertThat(mapping.getType()).isEqualTo(DoubleType.DOUBLE));
    }
    ...
    public void testCharMapping()
    {
        ...
        assertThat(toTrinoType(Types.CHAR, "char", 10, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(CharType.createCharType(10));
                });

        // CHAR(255)
        assertThat(toTrinoType(Types.CHAR, "char", 255, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(CharType.createCharType(255));
                });
    }
    ...
    public void testVarcharMapping()
    {
        ...
        assertThat(toTrinoType(Types.VARCHAR, "varchar", 10, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(VarcharType.createVarcharType(10));
                });

        // VARCHAR(255)
        assertThat(toTrinoType(Types.VARCHAR, "varchar", 255, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(VarcharType.createVarcharType(255));
                });

        // VARCHAR(65535)
        assertThat(toTrinoType(Types.VARCHAR, "varchar", 65535, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(VarcharType.createVarcharType(65535));
                });
    }
    ...
    public void testDecimalMapping()
    {
        ...
        assertThat(toTrinoType(Types.DECIMAL, "decimal", 3, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(DecimalType.createDecimalType(3, 0));
                });

        // DECIMAL(10, 2)
        assertThat(toTrinoType(Types.DECIMAL, "decimal", 10, 2))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(DecimalType.createDecimalType(10, 2));
                });

        // DECIMAL(38, 0)
        assertThat(toTrinoType(Types.DECIMAL, "decimal", 38, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(DecimalType.createDecimalType(38, 0));
                });

        // DECIMAL(38, 38)
        assertThat(toTrinoType(Types.DECIMAL, "decimal", 38, 38))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(DecimalType.createDecimalType(38, 38));
                });
    }
    ...
    public void testDateMapping()
    {
        ...
        assertThat(toTrinoType("date"))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(TimestampType.TIMESTAMP_SECONDS);
                });
    }
    ...
    public void testTimestampMapping()
    {
        ...
        assertThat(toTrinoType(Types.TIMESTAMP, "timestamp", 0, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(TimestampType.createTimestampType(0));
                });

        // TIMESTAMP(3)
        assertThat(toTrinoType(Types.TIMESTAMP, "timestamp", 0, 3))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(TimestampType.createTimestampType(3));
                });

        // TIMESTAMP(6)
        assertThat(toTrinoType(Types.TIMESTAMP, "timestamp", 0, 6))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(TimestampType.createTimestampType(6));
                });

        // TIMESTAMP(9)
        assertThat(toTrinoType(Types.TIMESTAMP, "timestamp", 0, 9))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(TimestampType.createTimestampType(9));
                });
    }
    ...
    public void testVarbinaryMapping()
    {
        ...
        assertThat(toTrinoType(Types.VARBINARY, "raw", 100, 0))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(VarbinaryType.VARBINARY);
                });
    }
    ...
    public void testClobMapping()
    {
        ...
        assertThat(toTrinoType(Types.CLOB, "clob"))
                .hasValueSatisfying(mapping -> {
                    assertThat(mapping.getType()).isEqualTo(VarcharType.createUnboundedVarcharType());
                });
    }
