        ...
        extends BaseJdbcClient
{
    ...
    public WriteMapping toWriteMapping(ConnectorSession session, Type type)
    {
        ...
        if (type instanceof TimestampType timestampType) {
            if (timestampType.isShort()) {
                return WriteMapping.longMapping("timestamp(" + timestampType.getPrecision() + ")", tiberoTimestampWriteFunction(timestampType));
            }
            return WriteMapping.objectMapping("timestamp(" + timestampType.getPrecision() + ")", tiberoLongTimestampWriteFunction(timestampType));
        }
