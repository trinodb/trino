...
public class TestFireboltClient
{
    ...
    private static final JdbcColumnHandle VARCHAR_COLUMN =
            JdbcColumnHandle.builder()
                    ...
                    .setColumnType(createVarcharType(MAX_LENGTH))
                    .setJdbcTypeHandle(new JdbcTypeHandle(Types.VARCHAR, Optional.of("varchar"), Optional.of(MAX_LENGTH), Optional.empty(), Optional.empty(), Optional.empty()))
                    .build();
    ...
    private static final JdbcClient JDBC_CLIENT = new FireboltClient(
            new BaseJdbcConfig(),
    ...
    public void testConvertLike()
    {
        ...
        Optional<ParameterizedExpression> escapeConverted = JDBC_CLIENT.convertPredicate(SESSION,
                        translateToConnectorExpression(
                                new LikePredicate(
        ...
        // Not supported
        assertThat(escapeConverted).isEmpty();
    }
