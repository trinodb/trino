        ...
        extends BaseJdbcClient
{
            ...
            RemoteQueryModifier queryModifier)
    {
        ...
        this.connectorExpressionRewriter = JdbcConnectorExpressionRewriterBuilder.newBuilder()
                ...
                .withTypeClass("non_approx_numeric_type", ImmutableSet.of("tinyint", "smallint", "integer", "bigint", "varchar", "char"))
                .map("$equal(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left = right")
                .map("$not_equal(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left <> right")
