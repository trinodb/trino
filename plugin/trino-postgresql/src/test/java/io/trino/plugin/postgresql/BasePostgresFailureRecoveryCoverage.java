...
public abstract class BasePostgresFailureRecoveryCoverage
        extends BaseJdbcFailureRecoveryCoverage
{
    private TestingPostgreSqlServer postgreSqlServer;

    public BasePostgresFailureRecoveryCoverage(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
     ...
     */
    // TODO move this test to BaseJdbcFailureRecoveryCoverage
    @Test
    @Timeout(60)
