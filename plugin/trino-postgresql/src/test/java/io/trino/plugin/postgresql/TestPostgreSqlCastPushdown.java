...
public class TestPostgreSqlCastPushdown
        extends BaseJdbcCastPushdownTest
{
    ...
    public void testCastPushdownOutOfRangeValue()
    {
        ...
        assertInvalidCast(
                ...
                ImmutableList.of(
                        ...
                        new InvalidCastTestCase("c_small_serial_1", "tinyint", "Out of range for tinyint: -32768"),
                        new InvalidCastTestCase("c_small_serial_2", "tinyint", "Out of range for tinyint: 32767"),
                        ...
                        new InvalidCastTestCase("c_serial_1", "tinyint", "Out of range for tinyint: -2147483648"),
                        new InvalidCastTestCase("c_serial_2", "tinyint", "Out of range for tinyint: 2147483647"),
                        ...
                        new InvalidCastTestCase("c_big_serial_1", "tinyint", "Out of range for tinyint: -9223372036854775808"),
                        new InvalidCastTestCase("c_big_serial_2", "tinyint", "Out of range for tinyint: 9223372036854775807"),

                        new InvalidCastTestCase("c_int_1", "smallint", "Out of range for smallint: -65537", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_int_2", "smallint", "Out of range for smallint: 65536", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_serial_1", "smallint", "Out of range for smallint: -2147483648", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_serial_2", "smallint", "Out of range for smallint: 2147483647", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_bigint_1", "smallint", "Out of range for smallint: -2147483649", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_bigint_2", "smallint", "Out of range for smallint: 2147483648", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_bigint_1", "integer", "Out of range for integer: -2147483649", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_bigint_2", "integer", "Out of range for integer: 2147483648", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_big_serial_1", "integer", "Out of range for integer: -9223372036854775808", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_big_serial_2", "integer", "Out of range for integer: 9223372036854775807", "ERROR: integer out of range"),
                        ...
                        new InvalidCastTestCase("c_decimal_5", "smallint", "Cannot cast '-65537.49' to SMALLINT", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_decimal_6", "smallint", "Cannot cast '-65536.94' to SMALLINT", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_decimal_7", "smallint", "Cannot cast '65535.94' to SMALLINT", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_decimal_8", "smallint", "Cannot cast '65536.49' to SMALLINT", "ERROR: smallint out of range"),
                        new InvalidCastTestCase("c_decimal_9", "integer", "Cannot cast '-2147483649.49' to INTEGER", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_decimal_10", "integer", "Cannot cast '-2147483648.94' to INTEGER", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_decimal_11", "integer", "Cannot cast '2147483647.94' to INTEGER", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_decimal_12", "integer", "Cannot cast '2147483648.49' to INTEGER", "ERROR: integer out of range"),
                        new InvalidCastTestCase("c_decimal_13", "bigint", "Cannot cast '-9223372036854775809.49' to BIGINT", "ERROR: bigint out of range"),
                        new InvalidCastTestCase("c_decimal_14", "bigint", "Cannot cast '-9223372036854775808.94' to BIGINT", "ERROR: bigint out of range"),
                        new InvalidCastTestCase("c_decimal_15", "bigint", "Cannot cast '9223372036854775807.94' to BIGINT", "ERROR: bigint out of range"),
                        new InvalidCastTestCase("c_decimal_16", "bigint", "Cannot cast '9223372036854775808.49' to BIGINT", "ERROR: bigint out of range"),
    ...
    protected List<CastTestCase> supportedCastTypePushdown()
    {
        return ImmutableList.of(
                ...
                new CastTestCase("c_small_serial", "smallint", "c_smallint"),
                ...
                new CastTestCase("c_serial", "integer", "c_integer"),
                ...
                new CastTestCase("c_big_serial", "bigint", "c_bigint"));
    }
    ...
    protected List<CastTestCase> unsupportedCastTypePushdown()
    {
        return ImmutableList.of(
                ...
                new CastTestCase("c_smallint_negative", "tinyint", "c_smallint"),
                new CastTestCase("c_integer", "tinyint", "c_smallint"),
                new CastTestCase("c_integer_negative", "tinyint", "c_smallint"),
                new CastTestCase("c_bigint", "tinyint", "c_smallint"),
                new CastTestCase("c_bigint_negative", "tinyint", "c_smallint"),
                ...
                new CastTestCase("c_numeric_negative", "tinyint", "c_smallint"),
                ...
                new CastTestCase("c_double_precision_negative", "tinyint", "c_smallint"),
                ...
                new CastTestCase("c_double_precision_negative", "smallint", "c_smallint"),
                ...
                new CastTestCase("c_double_precision_negative", "integer", "c_integer"),
                ...
                new CastTestCase("c_double_precision_negative", "bigint", "c_bigint"),
                ...
                new CastTestCase("c_smallint_negative", "boolean", "c_boolean"),
                new CastTestCase("c_real", "double", "c_double_precision"),
                new CastTestCase("c_double_precision", "real", "c_real"),
                new CastTestCase("c_double_precision_negative", "real", "c_real"),
                new CastTestCase("c_double_precision", "decimal(10,2)", "c_decimal_10_2"),
                new CastTestCase("c_double_precision_negative", "decimal(10,2)", "c_decimal_10_2"),
                new CastTestCase("c_decimal_negative", "decimal(10,2)", "c_decimal_10_2"),
                new CastTestCase("c_numeric_negative", "decimal(10,2)", "c_decimal_10_2"));
    }
    ...
    protected List<InvalidCastTestCase> invalidCast()
    {
        return ImmutableList.of(
                ...
                new InvalidCastTestCase("c_xml", "tinyint"),
                new InvalidCastTestCase("c_xml", "smallint"),
                new InvalidCastTestCase("c_xml", "int"),
                new InvalidCastTestCase("c_xml", "bigint"));
    }
}
