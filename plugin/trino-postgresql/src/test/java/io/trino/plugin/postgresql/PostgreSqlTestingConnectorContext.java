...
public final class PostgreSqlTestingConnectorContext
        implements ConnectorContext
{
    ...
    public PostgreSqlTestingConnectorContext()
    {
        ...
        typeManager = new InternalTypeManager(metadataManager, typeOperators);
