...
public class AlluxioCacheConfig
{
    ...
    public AlluxioCacheConfig setCacheDirectories(List<String> cacheDirectories)
    {
    ...
    public AlluxioCacheConfig setMaxCacheSizes(List<DataSize> maxCacheSizes)
    {
    ...
    public AlluxioCacheConfig setCacheTTL(Duration cacheTTL)
    {
        this.cacheTTL = Optional.of(cacheTTL);
        return this;
    }

    public AlluxioCacheConfig disableTTL()
    {
    ...
    public AlluxioCacheConfig setMaxCacheDiskUsagePercentages(List<Integer> maxCacheDiskUsagePercentages)
    {
    ...
    public AlluxioCacheConfig setCachePageSize(DataSize cachePageSize)
    {
