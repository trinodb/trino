...
public class AlluxioBlobCacheConfig
{
    ...
    public AlluxioBlobCacheConfig setCacheDirectories(List<String> cacheDirectories)
    {
    ...
    public AlluxioBlobCacheConfig setMaxCacheSizes(List<DataSize> maxCacheSizes)
    {
    ...
    public AlluxioBlobCacheConfig setCacheTTL(Duration cacheTTL)
    {
        this.cacheTTL = Optional.of(cacheTTL);
        return this;
    }

    public AlluxioBlobCacheConfig disableTTL()
    {
    ...
    public AlluxioBlobCacheConfig setMaxCacheDiskUsagePercentages(List<Integer> maxCacheDiskUsagePercentages)
    {
    ...
    public AlluxioBlobCacheConfig setCachePageSize(DataSize cachePageSize)
    {
