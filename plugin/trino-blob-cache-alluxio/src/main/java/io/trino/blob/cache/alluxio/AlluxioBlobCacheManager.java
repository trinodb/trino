        ...
        implements BlobCacheManager
{
    ...
    @Inject
    public AlluxioBlobCacheManager(Tracer tracer, AlluxioCache sharedCache, MBeanExporter exporter)
    {
    ...
    private record CatalogScopedBlobCache(AlluxioCache delegate, CatalogName catalog, Tracer tracer, AlluxioCacheStats stats)
