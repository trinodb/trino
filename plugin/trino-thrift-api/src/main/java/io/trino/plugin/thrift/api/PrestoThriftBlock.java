...
import io.trino.plugin.thrift.api.datatypes.PrestoThriftBigintArray;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftBoolean;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftColumnData;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftDate;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftDouble;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftHyperLogLog;
...
import io.trino.plugin.thrift.api.datatypes.PrestoThriftTimestamp;
import io.trino.plugin.thrift.api.datatypes.PrestoThriftVarchar;
