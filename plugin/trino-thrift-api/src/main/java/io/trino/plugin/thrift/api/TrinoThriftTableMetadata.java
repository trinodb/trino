...
@ThriftStruct
public final class TrinoThriftTableMetadata
{
    private final TrinoThriftSchemaTableName schemaTableName;
    private final List<TrinoThriftColumnMetadata> columns;
    private final String comment;
    private final List<Set<String>> indexableKeys;

    @ThriftConstructor
    public TrinoThriftTableMetadata(
            @ThriftField(name = "schemaTableName") TrinoThriftSchemaTableName schemaTableName,
            @ThriftField(name = "columns") List<TrinoThriftColumnMetadata> columns,
    ...
    @ThriftField(1)
    public TrinoThriftSchemaTableName getSchemaTableName()
    {
        return schemaTableName;
    }

    @ThriftField(2)
    public List<TrinoThriftColumnMetadata> getColumns()
    {
        return columns;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        TrinoThriftTableMetadata other = (TrinoThriftTableMetadata) obj;
