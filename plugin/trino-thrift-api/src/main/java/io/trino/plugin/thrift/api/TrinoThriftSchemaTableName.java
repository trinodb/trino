...
@ThriftStruct
public final class TrinoThriftSchemaTableName
{
    private final String schemaName;
    private final String tableName;

    @ThriftConstructor
    public TrinoThriftSchemaTableName(String schemaName, String tableName)
    {
        this.schemaName = checkValidName(schemaName);
        this.tableName = checkValidName(tableName);
    }

    public TrinoThriftSchemaTableName(SchemaTableName schemaTableName)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        TrinoThriftSchemaTableName other = (TrinoThriftSchemaTableName) obj;
