...
import static io.trino.plugin.thrift.api.TrinoThriftBlock.varcharData;
        ...
        implements TrinoThriftColumnData
{
    ...
    public boolean equals(Object obj)
    {
        ...
        TrinoThriftVarchar other = (TrinoThriftVarchar) obj;
    ...
    {
        return fromSliceBasedBlock(block, type, (nulls, sizes, bytes) -> varcharData(new TrinoThriftVarchar(nulls, sizes, bytes)));
    }
}
