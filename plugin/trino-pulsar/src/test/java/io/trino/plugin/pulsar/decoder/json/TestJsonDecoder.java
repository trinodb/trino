        ...
        extends AbstractDecoderTester
{
    ...
    public void testArray()
    {
        ...
        PulsarColumnHandle columnHandle = new PulsarColumnHandle(getCatalogName().toString(), "arrayField", columnType, null, null, "arrayField", false, false, false, PulsarColumnHandle.HandleKeyValueType.NONE);
    ...
    public void testRow()
    {
        ...
        PulsarColumnHandle columnHandle = new PulsarColumnHandle(getCatalogName().toString(), "rowField", columnType, null, null, "rowField", false, false, false, PulsarColumnHandle.HandleKeyValueType.NONE);
    ...
    public void testMap()
    {
        ...
        PulsarColumnHandle columnHandle = new PulsarColumnHandle(getCatalogName().toString(), "mapField", columnType, null, null, "mapField", false, false, false, PulsarColumnHandle.HandleKeyValueType.NONE);
    ...
    public void testCompositeType()
    {
        ...
        PulsarColumnHandle columnHandle = new PulsarColumnHandle(getCatalogName().toString(), "compositeRow", columnType, null, null, "compositeRow", false, false, false, PulsarColumnHandle.HandleKeyValueType.NONE);
