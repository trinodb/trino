...
{
    private static final Logger log = LoggerFactory.getLogger(OffloadPoliciesImpl.class);
    ...
    @OffloadPoliciesImpl.Configuration
    @JsonProperty(access = JsonProperty.Access.READ_WRITE)
     ...
     * @return field value
     */
    private static Object getCompatibleValue(Properties properties,
                                             Field field)
    {
        Object object;
