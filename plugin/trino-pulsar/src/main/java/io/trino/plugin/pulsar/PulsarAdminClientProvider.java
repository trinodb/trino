...
public class PulsarAdminClientProvider
{
    ...
    public static synchronized void setPulsarAdmin(PulsarAdmin pulsarAdmin)
    {
        PulsarAdminClientProvider.pulsarAdmin = pulsarAdmin;
    }

    @NotNull
    public static synchronized PulsarAdmin getPulsarAdmin(PulsarConnectorConfig config) throws PulsarClientException
    {
        if (pulsarAdmin == null) {
            ...
            pulsarAdmin = builder.serviceHttpUrl(config.getWebServiceUrl()).build();
        }
        return pulsarAdmin;
    }
