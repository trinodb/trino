        ...
        implements ConnectorSplitManager
{
    ...
    {
        if (handle instanceof ListFilesTableHandle listFiles) {
            return new FixedSplitSource(new StorageSplit(listFiles.location()));
        }
        if (handle instanceof ReadCsvTableHandle readCsv) {
            return new FixedSplitSource(new StorageSplit(readCsv.location()));
        }
