...
import io.trino.plugin.storage.functions.ListFilesPageSource;
        ...
        implements ConnectorPageSourceProvider
{
    ...
    @Inject
    public StoragePageSourceProvider(TrinoFileSystemFactory fileSystemFactory, StorageRecordSetProvider recordSetProvider)
    {
    ...
    {
        if (table instanceof ListFilesTableHandle listFiles) {
            TrinoFileSystem fileSystem = fileSystemFactory.create(session);
            return new ListFilesPageSource(fileSystem, listFiles.location(), columns);
        }
