...
public final class AntdbSessionProperties
        implements SessionPropertiesProvider
{
    ...
    @Inject
    public AntdbSessionProperties(AntdbConfig antdbConfig)
    {
        sessionProperties = ImmutableList.of(
                enumProperty(
                        ARRAY_MAPPING,
                        "Handling of AntDB arrays",
                        ArrayMapping.class,
                        antdbConfig.getArrayMapping(),
                        false),
                booleanProperty(
                        ENABLE_STRING_PUSHDOWN_WITH_COLLATE,
                        "Enable string pushdown with collate (experimental)",
                        antdbConfig.isEnableStringPushdownWithCollate(),
                        false));
    }
