...
public class AntdbConfig
{
    ...
    @Config("antdb.array-mapping")
    @LegacyConfig("antdb.experimental.array-mapping")
    public AntdbConfig setArrayMapping(ArrayMapping arrayMapping)
    {
    ...
    @Config("antdb.include-system-tables")
    public AntdbConfig setIncludeSystemTables(boolean includeSystemTables)
    {
    ...
    @Config("antdb.experimental.enable-string-pushdown-with-collate")
    public AntdbConfig setEnableStringPushdownWithCollate(boolean enableStringPushdownWithCollate)
    {
