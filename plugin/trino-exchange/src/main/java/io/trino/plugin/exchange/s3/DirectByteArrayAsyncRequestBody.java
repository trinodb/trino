 ...
 */
public final class DirectByteArrayAsyncRequestBody
        implements AsyncRequestBody
{
    private static final Logger log = Logger.loggerFor(DirectByteArrayAsyncRequestBody.class);

    private final ByteBuffer byteBuffer;

    private final String mimetype;

    public DirectByteArrayAsyncRequestBody(ByteBuffer byteBuffer, String mimetype)
    {
    ...
    {
        return Optional.of((long) byteBuffer.capacity());
    }
    ...
    {
        return new DirectByteArrayAsyncRequestBody(byteBuffer, Mimetype.MIMETYPE_OCTET_STREAM);
    }
}
