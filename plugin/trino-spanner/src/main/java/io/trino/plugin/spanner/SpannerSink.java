        ...
        implements ConnectorPageSink
{
    ...
    public SpannerSink(ConnectorSession session, JdbcOutputTableHandle handle, SpannerClient spannerClient, ConnectorPageSinkId pageSinkId, RemoteQueryModifier remoteQueryModifier)
    {
