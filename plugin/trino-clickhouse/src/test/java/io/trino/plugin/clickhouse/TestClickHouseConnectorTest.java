        ...
        extends BaseJdbcConnectorTest
{
    ...
    @Test
    protected void testDropMergeTreeColumn()
    {
    ...
    @Test
    protected void testAddMergeTreeColumn()
    {
        skipTestUnless(supportsCreateTable());

        String tableName = "test_add_column_" + randomTableSuffix();
        // Only MergeTree engine families can add column
    ...
    @Test
    protected void testDifferentEngine()
    {
        skipTestUnless(supportsCreateTable());
     ...
     */
    @Test
    protected void testTableProperty()
    {
        skipTestUnless(supportsCreateTable());
