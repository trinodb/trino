        ...
        implements Module
{
    ...
    public static ConnectionFactory createConnectionFactory(BaseJdbcConfig config, CredentialProvider credentialProvider, DatabendConfig databendConfig, OpenTelemetry openTelemetry)
            throws SQLException
    {
        return DriverConnectionFactory.builder(new DatabendDriver(), config.getConnectionUrl(), credentialProvider).setConnectionProperties(getConnectionProperties(databendConfig)).setOpenTelemetry(openTelemetry).build();
    }
