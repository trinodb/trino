        ...
        extends AbstractTestQueryFramework
{
    ...
    @Test
    public void testNumberMappingsNativeQuery()
    {
    ...
    private void testTimestamp(ZoneId sessionZone)
    {
        ...
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("timestamp", "TIMESTAMP '0001-01-01 00:00:00.000'", createTimestampType(3), "TIMESTAMP '0001-01-01 00:00:00.000'") // min value in Exasol
                .addRoundTrip("timestamp", "TIMESTAMP '1582-09-30 13:18:03.123'", createTimestampType(3), "TIMESTAMP '1582-09-30 13:18:03.123'")
                .addRoundTrip("timestamp", "TIMESTAMP '1582-10-01 13:18:03.123'", createTimestampType(3), "TIMESTAMP '1582-10-01 13:18:03.123'")
                .addRoundTrip("timestamp", "TIMESTAMP '1582-10-02 13:18:03.123'", createTimestampType(3), "TIMESTAMP '1582-10-02 13:18:03.123'")
                .addRoundTrip("timestamp", "TIMESTAMP '1582-10-14 13:18:03.123'", createTimestampType(3), "TIMESTAMP '1582-10-15 13:18:03.123'")
                .addRoundTrip("timestamp", "TIMESTAMP '1582-10-15 13:18:03.123'", createTimestampType(3), "TIMESTAMP '1582-10-15 13:18:03.123'")
                ...
                .addRoundTrip("timestamp", "TIMESTAMP '9999-12-31 23:59:59.999'", createTimestampType(3), "TIMESTAMP '9999-12-31 23:59:59.999'") // max value in Exasol
