        ...
        extends AbstractTestQueryFramework
{
    ...
    private void testTimestamp(ZoneId sessionZone)
    {
        ...
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("timestamp(6)", resolveInvalidDstGapValue("2018-04-01 02:13:55.123456"), createTimestampType(6), "TIMESTAMP '2018-04-01 03:13:55.123456'")
                ...
                // Min value in Exasol
                .addRoundTrip("timestamp(0)", "TIMESTAMP '0001-01-01'", createTimestampType(0), "TIMESTAMP '0001-01-01'")
                .addRoundTrip("timestamp(3)", "TIMESTAMP '0001-01-01 00:00:00.123'", createTimestampType(3), "TIMESTAMP '0001-01-01 00:00:00.123'")
                .addRoundTrip("timestamp(6)", "TIMESTAMP '0001-01-01 00:00:00.123456'", createTimestampType(6), "TIMESTAMP '0001-01-01 00:00:00.123456'")
                .addRoundTrip("timestamp(9)", "TIMESTAMP '0001-01-01 00:00:00.123456789'", createTimestampType(9), "TIMESTAMP '0001-01-01 00:00:00.123456789'")

                // Historical dates before Julian-Gregorian calendar cut-over
                .addRoundTrip("timestamp(1)", "TIMESTAMP '1582-09-30 00:00:00.1'", createTimestampType(1), "TIMESTAMP '1582-09-30 00:00:00.1'")
                .addRoundTrip("timestamp(2)", "TIMESTAMP '1582-10-01 00:00:00.12'", createTimestampType(2), "TIMESTAMP '1582-10-01 00:00:00.12'")
                .addRoundTrip("timestamp(3)", "TIMESTAMP '1582-10-02 00:00:00.123'", createTimestampType(3), "TIMESTAMP '1582-10-02 00:00:00.123'")
                .addRoundTrip("timestamp(4)", "TIMESTAMP '1582-10-03 00:00:00.1234'", createTimestampType(4), "TIMESTAMP '1582-10-03 00:00:00.1234'")
                .addRoundTrip("timestamp(5)", "TIMESTAMP '1582-10-04 00:00:00.12345'", createTimestampType(5), "TIMESTAMP '1582-10-04 00:00:00.12345'")

                // Julian-Gregorian calendar cut-over
                .addRoundTrip("timestamp(6)", "TIMESTAMP '1582-10-05 00:00:00.123456'", createTimestampType(6), "TIMESTAMP '1582-10-15 00:00:00.123456'")
                .addRoundTrip("timestamp(9)", "TIMESTAMP '1582-10-13 00:00:00.123456789'", createTimestampType(9), "TIMESTAMP '1582-10-15 00:00:00.123456789'")
                .addRoundTrip("timestamp(2)", "TIMESTAMP '1582-10-14 00:00:00.12'", createTimestampType(2), "TIMESTAMP '1582-10-15 00:00:00.12'")
                .addRoundTrip("timestamp(0)", "TIMESTAMP '1582-10-15'", createTimestampType(0), "TIMESTAMP '1582-10-15'")

                // Historical dates after Julian-Gregorian calendar cut-over
                .addRoundTrip("timestamp(4)", "TIMESTAMP '1899-12-31 00:00:00.1234'", createTimestampType(4), "TIMESTAMP '1899-12-31 00:00:00.1234'")
                .addRoundTrip("timestamp(5)", "TIMESTAMP '1950-01-01 00:00:00.12345'", createTimestampType(5), "TIMESTAMP '1950-01-01 00:00:00.12345'")
    ...
    void testUnsupportedTimestampValues()
    {
        ...
        testUnsupportedTimestampInsertValue(
                "TIMESTAMP",
    ...
    private void testUnsupportedTimestampInsertValue(
            String exasolType,
            String inputLiteral,
            String expectedException)
    {
        try (TestTable table = new TestTable(
                onRemoteDatabase(),
                TEST_SCHEMA + ".test_unsupported_timestamp",
