        ...
        implements Closeable
{
    ...
    /**
     * Name of the test schema. Must not contain an underscore, required by {@link io.trino.plugin.exasol.TestExasolConnectorCoverage#testShowSchemasLikeWithEscape()}
     */
