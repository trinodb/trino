...
Spark SQL:
```
CREATE SCHEMA checksum_without_metadata LOCATION 'file:///tmp/checksum_without_metadata';
CREATE TABLE checksum_without_metadata.checksum_without_metadata (data INTEGER) USING DELTA TBLPROPERTIES (delta.checkpointInterval = 1);
INSERT INTO checksum_without_metadata.checksum_without_metadata values 1;
```
