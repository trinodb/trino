...
Subsequently, the latest checksum file (`_delta_log/00000000000000000001.crc`) was overwritten by
hand with additional trailing content past the end of the JSON object. This fixture is otherwise
identical to `deltalake/checksum`.
