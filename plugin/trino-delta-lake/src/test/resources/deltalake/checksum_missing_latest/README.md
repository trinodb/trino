...
Subsequently, the latest checksum file (`_delta_log/00000000000000000001.crc`) was deleted by hand.
This fixture is otherwise identical to `deltalake/checksum`.
