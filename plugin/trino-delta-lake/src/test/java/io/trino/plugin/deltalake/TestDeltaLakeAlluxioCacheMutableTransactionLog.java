    ...
    public void testTableDataCachedWhileTransactionLogNotCached()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheFileSystemTraceUtils.CacheOperation>builder()
                        ...
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Alluxio.readCached", "key=p1/", 0, 301))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Alluxio.readCached", "key=p2/", 0, 301))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Input.readFully", "key=p1/", 0, 301))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Input.readFully", "key=p2/", 0, 301))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Alluxio.writeCache", "key=p1/", 0, 301))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("Alluxio.writeCache", "key=p2/", 0, 301))
                        .build());
        assertFileSystemAccesses(
                "SELECT * FROM test_transaction_log_not_cached",
                ImmutableMultiset.<CacheFileSystemTraceUtils.CacheOperation>builder()
