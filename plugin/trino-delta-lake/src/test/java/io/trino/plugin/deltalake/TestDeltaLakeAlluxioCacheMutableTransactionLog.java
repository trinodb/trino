    ...
    public void testTableDataCachedWhileTransactionLogNotCached()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheFileSystemTraceUtils.CacheOperation>builder()
                        ...
                        .add(new CacheFileSystemTraceUtils.CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheFileSystemTraceUtils.CacheOperation("InputFile.newStream", "00000000000000000002.json"))
