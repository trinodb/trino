...
public class TestTransactionLogAccess
{
    ...
    @Test
    public void testAllGetProtocolEntry()
            throws Exception
    {
        testAllGetProtocolEntry("person", "databricks73/person");
        testAllGetProtocolEntry("person_without_last_checkpoint", "databricks73/person_without_last_checkpoint");
        testAllGetProtocolEntry("person_without_old_jsons", "databricks73/person_without_old_jsons");
        testAllGetProtocolEntry("person_without_checkpoints", "databricks73/person_without_checkpoints");
    }

    private void testAllGetProtocolEntry(String tableName, String resourcePath)
            throws Exception
    {
        setupTransactionLogAccessFromResources(tableName, resourcePath);
