        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testCacheFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 858))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000001.json", 0, 737))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000002.json", 0, 737))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000002.json", 0, 737))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000002.json", 0, 737))
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000002.json", 0, 737))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000003.json", 0, 737))
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000004.json", 0, 737))
                        .add(new CacheOperation("InputFile.length", "00000000000000000004.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000005.json", 0, 737))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000005.json", 0, 737))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000005.json", 0, 737))
    ...
    public void testCacheCheckpointAndExtendedStatsFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000003.json", 0, 722))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000003.json", 0, 722))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000003.json", 0, 722))
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.json"))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000003.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000004.json"))
    ...
    public void testTimeTravelWithLastCheckpointUsingTemporalVersion()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .addCopies(new CacheOperation("Alluxio.readCached", "data", 0, 199), 3)
                        .addCopies(new CacheOperation("InputFile.newStream", "_last_checkpoint"), 2)
                        .addCopies(new CacheOperation("InputFile.length", "00000000000000000002.json"), 3)
                        .addCopies(new CacheOperation("Alluxio.readCached", "00000000000000000002.json", 0, 613), 2)
                        .build());
        assertFileSystemAccesses(
                "SELECT * FROM time_travel_with_last_checkpoint_using_temporal FOR TIMESTAMP AS OF TIMESTAMP '2024-03-13 04:33:19.342 UTC'", // version 2
                ImmutableMultiset.<CacheOperation>builder()
    ...
    public void testReadV2CheckpointJson()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000001.json", 0, 663))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000001.json", 0, 663))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000001.json", 0, 663))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
    ...
    public void testCreateOrReplaceTable()
    {
        ...
        assertFileSystemAccesses("CREATE OR REPLACE TABLE test_create_or_replace (id VARCHAR, age INT)",
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 863))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000000.json", 0, 863))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000000.json"))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000000.json", 0, 863))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.exists", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
    ...
    public void testCreateOrReplaceTableAsSelect()
    {
        ...
        assertFileSystemAccesses(
                "CREATE OR REPLACE TABLE test_create_or_replace_as_select AS SELECT 1 col_name",
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 1142))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000000.json", 0, 1142))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000000.json", 0, 1142))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.exists", "00000000000000000001.json"))
