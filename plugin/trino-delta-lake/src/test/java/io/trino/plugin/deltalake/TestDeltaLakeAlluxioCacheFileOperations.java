        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testCacheFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 1108))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000001.json", 0, 803))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000002.json", 0, 803))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000002.json", 0, 803))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000002.json", 0, 803))
                        ...
                        .add(new CacheOperation("Alluxio.readCached", "key=p1/", 0, 301))
                        .add(new CacheOperation("Alluxio.readCached", "key=p2/", 0, 301))
                        .add(new CacheOperation("Input.readFully", "key=p1/", 0, 301))
                        .add(new CacheOperation("Input.readFully", "key=p2/", 0, 301))
                        .add(new CacheOperation("Alluxio.writeCache", "key=p1/", 0, 301))
                        .add(new CacheOperation("Alluxio.writeCache", "key=p2/", 0, 301))
                        .build());
        assertFileSystemAccesses(
                "SELECT * FROM test_cache_file_operations",
                ImmutableMultiset.<CacheOperation>builder()
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000002.json", 0, 803))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000003.json", 0, 803))
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000004.json", 0, 803))
                        .add(new CacheOperation("InputFile.length", "00000000000000000004.json"))
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000005.json", 0, 803))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000005.json", 0, 803))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000005.json", 0, 803))
                        ...
                        .add(new CacheOperation("Alluxio.readCached", "key=p1/", 0, 301))
                        .add(new CacheOperation("Alluxio.readCached", "key=p2/", 0, 301))
                        .add(new CacheOperation("Alluxio.readCached", "key=p3/", 0, 301))
                        .add(new CacheOperation("Alluxio.readCached", "key=p4/", 0, 301))
                        .add(new CacheOperation("Alluxio.readCached", "key=p5/", 0, 301))
                        .add(new CacheOperation("Input.readFully", "key=p3/", 0, 301))
                        .add(new CacheOperation("Input.readFully", "key=p4/", 0, 301))
                        .add(new CacheOperation("Input.readFully", "key=p5/", 0, 301))
                        .add(new CacheOperation("Alluxio.writeCache", "key=p3/", 0, 301))
                        .add(new CacheOperation("Alluxio.writeCache", "key=p4/", 0, 301))
                        .add(new CacheOperation("Alluxio.writeCache", "key=p5/", 0, 301))
                        .build());
        assertFileSystemAccesses(
                "SELECT * FROM test_cache_file_operations",
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("InputFile.length", "00000000000000000006.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .addCopies(new CacheOperation("Alluxio.readCached", "key=p1/", 0, 301), 1)
                        .addCopies(new CacheOperation("Alluxio.readCached", "key=p2/", 0, 301), 1)
                        .addCopies(new CacheOperation("Alluxio.readCached", "key=p3/", 0, 301), 1)
                        .addCopies(new CacheOperation("Alluxio.readCached", "key=p4/", 0, 301), 1)
                        .addCopies(new CacheOperation("Alluxio.readCached", "key=p5/", 0, 301), 1)
                        .build());
    }
    ...
    public void testCreateOrReplaceTable()
    {
        ...
        assertFileSystemAccesses("CREATE OR REPLACE TABLE test_create_or_replace (id VARCHAR, age INT)",
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 1113))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000000.json", 0, 1113))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000000.json"))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000000.json", 0, 1113))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.exists", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
    ...
    public void testCreateOrReplaceTableAsSelect()
    {
        ...
        assertFileSystemAccesses(
                "CREATE OR REPLACE TABLE test_create_or_replace_as_select AS SELECT 1 col_name",
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Alluxio.readCached", "00000000000000000000.json", 0, 1341))
                        .add(new CacheOperation("Alluxio.readExternalStream", "00000000000000000000.json", 0, 1341))
                        .add(new CacheOperation("Alluxio.writeCache", "00000000000000000000.json", 0, 1341))
                        .add(new CacheOperation("InputFile.newStream", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.json"))
                        .add(new CacheOperation("InputFile.exists", "00000000000000000001.json"))
