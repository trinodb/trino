        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testCacheFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Input.readFully", "00000000000000000002.json", 0, 658))
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Input.readFully", "00000000000000000005.json", 0, 658))
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("InputFile.length", "00000000000000000006.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "key=p1/"), 1)
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "key=p2/"), 1)
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "key=p3/"), 1)
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "key=p4/"), 1)
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "key=p5/"), 1)
                        .build());
    }
    ...
    public void testCacheCheckpointAndExtendedStatsFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "00000000000000000003.checkpoint.parquet"), 2)
                        .addCopies(new CacheOperation("InputFile.length", "00000000000000000003.checkpoint.parquet"), 2)
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.crc"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000004.json"))
                        .addAll(Stream.of("int_part=10/string_part=part1/", "int_part=20/string_part=part2/", "int_part=__HIVE_DEFAULT_PARTITION__/string_part=__HIVE_DEFAULT_PARTITION__/")
                                .flatMap(fileId ->
                                        Stream.of(
                                                new CacheOperation("Alluxio.readCachedTail", fileId),
                                                new CacheOperation("Input.readTail", fileId),
                                                new CacheOperation("Alluxio.writeCacheTail", fileId)))
                                .iterator())
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .build());
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "00000000000000000003.checkpoint.parquet"), 3)
                        .addCopies(new CacheOperation("InputFile.length", "00000000000000000003.checkpoint.parquet"), 3)
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.crc"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000004.json"))
                        .addAll(Stream.of("int_part=10/string_part=part1/", "int_part=20/string_part=part2/", "int_part=__HIVE_DEFAULT_PARTITION__/string_part=__HIVE_DEFAULT_PARTITION__/")
                                .flatMap(fileId -> Stream.of(new CacheOperation("Alluxio.readCachedTail", fileId)))
                                .iterator())
    ...
    public void testCacheDeletionVectorsFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.crc"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000003.json"))
                        .add(new CacheOperation("Alluxio.readCachedTail", "data"))
                        .add(new CacheOperation("Input.readTail", "data"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "data"))
    ...
    public void testChangeDataFileOperations()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .add(new CacheOperation("Alluxio.readCachedTail", "change_data/key=1/"))
                        .add(new CacheOperation("Input.readTail", "change_data/key=1/"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "change_data/key=1/"))
                        ...
                        .add(new CacheOperation("Alluxio.readCachedTail", "change_data/key=2/"))
                        .add(new CacheOperation("Input.readTail", "change_data/key=2/"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "change_data/key=2/"))
    ...
    public void testTimeTravelWithLastCheckpoint()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Input.readFully", "00000000000000000000.json", 0, 1015))
                        ...
                        .add(new CacheOperation("InputFile.length", "00000000000000000000.json"))
                        .add(new CacheOperation("Input.readFully", "00000000000000000001.json", 0, 613))
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "00000000000000000002.checkpoint.parquet"), 2)
                        ...
                        .add(new CacheOperation("Input.readTail", "data"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "data"))
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "data"), 3)
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .build());
        assertFileSystemAccesses(
                "SELECT * FROM time_travel_with_last_checkpoint FOR VERSION AS OF 2",
    ...
    public void testTimeTravelWithLastCheckpointUsingTemporalVersion()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Input.readFully", "00000000000000000002.json", 0, 613))
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "data"), 2)
                        .build());
        assertFileSystemAccesses(
            ...
            throws Exception
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("Input.readTail", "00000000000000000002.checkpoint.parquet"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "00000000000000000002.checkpoint.parquet"))
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "00000000000000000002.checkpoint.parquet"), 2)
                        .addCopies(new CacheOperation("InputFile.length", "00000000000000000002.checkpoint.parquet"), 2)
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.crc"))
                        .add(new CacheOperation("InputFile.exists", "00000000000000000002.json"))
    ...
    public void testReadV2CheckpointJson()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Input.readFully", "00000000000000000001.checkpoint.73a4ddb8-2bfc-40d8-b09f-1b6a0abdfb04.json", 0, 765))
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        ...
                        .add(new CacheOperation("Alluxio.readCachedTail", "00000000000000000001.checkpoint.0000000001.0000000001.90cf4e21-dbaa-41d6-8ae5-6709cfbfbfe0.parquet"))
                        .add(new CacheOperation("Input.readTail", "00000000000000000001.checkpoint.0000000001.0000000001.90cf4e21-dbaa-41d6-8ae5-6709cfbfbfe0.parquet"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "00000000000000000001.checkpoint.0000000001.0000000001.90cf4e21-dbaa-41d6-8ae5-6709cfbfbfe0.parquet"))
    ...
    public void testReadV2CheckpointParquet()
    {
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("InputFile.newStream", "_last_checkpoint"))
                        .add(new CacheOperation("Alluxio.readCachedTail", "00000000000000000001.checkpoint.156b3304-76b2-49c3-a9a1-626f07df27c9.parquet"))
                        .add(new CacheOperation("Input.readTail", "00000000000000000001.checkpoint.156b3304-76b2-49c3-a9a1-626f07df27c9.parquet"))
                        ...
                        .add(new CacheOperation("Alluxio.writeCacheTail", "00000000000000000001.checkpoint.156b3304-76b2-49c3-a9a1-626f07df27c9.parquet"))
                        .build());
        ...
        assertFileSystemAccesses(
                ...
                ImmutableMultiset.<CacheOperation>builder()
                        .addCopies(new CacheOperation("Alluxio.readCachedTail", "00000000000000000001.checkpoint.156b3304-76b2-49c3-a9a1-626f07df27c9.parquet"), 2)
                        ...
                        .add(new CacheOperation("Alluxio.readCachedTail", "00000000000000000001.checkpoint.0000000001.0000000001.03288d7e-af16-44ed-829c-196064a71812.parquet"))
                        ...
                        .add(new CacheOperation("Input.readTail", "00000000000000000001.checkpoint.0000000001.0000000001.03288d7e-af16-44ed-829c-196064a71812.parquet"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "00000000000000000001.checkpoint.0000000001.0000000001.03288d7e-af16-44ed-829c-196064a71812.parquet"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000002.json"))
                        .add(new CacheOperation("InputFile.length", "00000000000000000001.crc"))
                        .add(new CacheOperation("Alluxio.writeCacheTail", "data"))
                        .add(new CacheOperation("Alluxio.readCachedTail", "data"))
    ...
    @Test
    public void testCacheFileOperationsWithChecksumFilesDisabled()
    {
        ...
        assertUpdate("DROP TABLE IF EXISTS test_cache_file_operations_without_checksum");
        assertUpdate("CREATE TABLE test_cache_file_operations_without_checksum(key varchar, data varchar) with (partitioned_by=ARRAY['key'])");
        assertUpdate("INSERT INTO test_cache_file_operations_without_checksum VALUES ('p1', '1-abc')", 1);
        assertUpdate("INSERT INTO test_cache_file_operations_without_checksum VALUES ('p2', '2-xyz')", 1);
