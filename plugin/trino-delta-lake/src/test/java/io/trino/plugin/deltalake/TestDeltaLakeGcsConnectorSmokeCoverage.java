...
public class TestDeltaLakeGcsConnectorSmokeCoverage
        extends BaseDeltaLakeConnectorSmokeCoverage
{
    private static final Logger LOG = Logger.get(TestDeltaLakeGcsConnectorSmokeCoverage.class);
    ...
    public TestDeltaLakeGcsConnectorSmokeCoverage()
    {
