        ...
        implements ExtendedStatisticsAccess
{
    ...
    {
        try {
            String statisticsPath = stringPathOf(tableLocation, statisticsDirectory, statisticsFile);
    ...
    {
        try {
            String statisticsPath = stringPathOf(tableLocation, STATISTICS_META_DIR, STATISTICS_FILE);
            ...
            String starburstStatisticsPath = stringPathOf(tableLocation, STARBURST_META_DIR, STARBURST_STATISTICS_FILE);
