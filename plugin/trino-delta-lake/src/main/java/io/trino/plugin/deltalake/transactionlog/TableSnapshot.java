...
public class TableSnapshot
{
            ...
            Executor executor)
    {
        ...
        List<CompletableFuture<Stream<DeltaLakeTransactionLogEntry>>> logEntryStreamFutures =
                getV2CheckpointEntries(session, entryTypes, metadataEntry, protocolEntry, checkpointSchemaManager, typeManager, stats, checkpoint, checkpointFile, domains, addStatsMinMaxColumnFilter, fileSystem, fileSize)
