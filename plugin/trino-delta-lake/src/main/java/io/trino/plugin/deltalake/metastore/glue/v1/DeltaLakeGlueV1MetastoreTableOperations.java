        ...
        extends DeltaLakeTableOperations
{
    ...
    public DeltaLakeGlueV1MetastoreTableOperations(
    ...
    public void commitToExistingTable(long version, String schemaString, Optional<String> tableComment)
    {
        ...
        glueVersionId = currentTable.getVersionId();
        ...
        parameters.putAll(deltaParameters(version, schemaString, tableComment));
