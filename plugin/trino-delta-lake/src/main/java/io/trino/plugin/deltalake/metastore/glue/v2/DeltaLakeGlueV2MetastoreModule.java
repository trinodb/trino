...
public class DeltaLakeGlueV2MetastoreModule
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(DeltaLakeTableOperationsProvider.class).to(DeltaLakeGlueV2MetastoreTableOperationsProvider.class).in(Scopes.SINGLETON);
