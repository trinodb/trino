        ...
        implements ConnectorPageSink
{
    ...
    protected final ImmutableList.Builder<Slice> dataFileSlices = ImmutableList.builder();
    ...
    public CompletableFuture<Collection<Slice>> finish()
    {
        ...
        return MoreFutures.toCompletableFuture(Futures.immediateFuture(buildResult()));
    }
    ...
    protected abstract String getRootTableLocation();

    protected abstract String getPartitionPrefixPath();

    protected abstract Collection<Slice> buildResult();

    protected abstract void collectDataFileInfo(DataFileInfo dataFileInfo);
}
