...
public class DeltaLakeGlueV2MetastoreTableOperationsProvider
        implements DeltaLakeTableOperationsProvider
{
    ...
    @Inject
    public DeltaLakeGlueV2MetastoreTableOperationsProvider(GlueClient glueClient, GlueMetastoreStats stats)
    {
    ...
    {
        return new DeltaLakeGlueV2MetastoreTableOperations(glueClient, stats);
    }
}
