...
public abstract class DeltaLakeAbstractPageSink
        implements ConnectorPageSink
{
    private static final Logger LOG = Logger.get(DeltaLakeAbstractPageSink.class);
    ...
    public DeltaLakeAbstractPageSink(
