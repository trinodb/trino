        ...
        implements ConnectorMetadata
{
    ...
    private RelationCommentMetadata getRelationCommentMetadata(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        try {
            ...
            TrinoFileSystem fileSystem = fileSystemFactory.create(session, convertToDeltaMetastoreTable(table));
            ...
            UnaryOperator<Set<SchemaTableName>> relationFilter)
    {
        ...
        for (SchemaTableName tableName : listTables(session, schemaName)) {
            try {
                ...
                VendedCredentialsHandle credentialsHandle = new VendedCredentialsHandle(deltaMetastoreTable.catalogOwned(), deltaMetastoreTable.managed(), deltaMetastoreTable.location(), deltaMetastoreTable.vendedCredentials());
    ...
    private VendedCredentialsHandle fetchCredentialsForLocation(String tableLocation)
    {
        ...
        return vendedCredentialsProvider.getFreshCredentials(new VendedCredentialsHandle(false, false, tableLocation, Optional.of(VendedCredentials.empty())));
    }
