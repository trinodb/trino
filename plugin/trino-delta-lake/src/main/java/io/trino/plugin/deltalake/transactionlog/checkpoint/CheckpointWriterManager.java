...
public class CheckpointWriterManager
{
    ...
    public void writeCheckpoint(ConnectorSession session, TableSnapshot snapshot)
    {
        try {
            ...
            String targetFile = stringPathOf(transactionLogDirectory, String.format("%020d.checkpoint.parquet", newCheckpointVersion));
            ...
            String checkpointPath = stringPathOf(transactionLogDirectory, LAST_CHECKPOINT_FILENAME);
