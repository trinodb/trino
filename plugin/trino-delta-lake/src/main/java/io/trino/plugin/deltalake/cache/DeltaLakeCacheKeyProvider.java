        ...
        implements CacheKeyProvider
{
    ...
    public Optional<CacheKey> getCacheKey(TrinoInputFile inputFile)
    {
        ...
        // Key by the location's path components so that a file's key starts with the key of any
        // directory containing it, letting a directory's entries be invalidated on drop or rename
