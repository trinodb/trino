        ...
        implements Module
{
            ...
            throws SQLException
    {
        ...
        checkArgument(driver.acceptsURL(config.getConnectionUrl()),
                "Trino only support Ignite thin client, connection url should start with 'jdbc:ignite:thin://', actual get " + config.getConnectionUrl());
