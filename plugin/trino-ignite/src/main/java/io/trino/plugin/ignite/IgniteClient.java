        ...
        extends BaseJdbcClient
{
            ...
            RemoteQueryModifier queryModifier)
    {
        ...
        this.connectorExpressionRewriter = JdbcConnectorExpressionRewriterBuilder.newBuilder()
                ...
                .withTypeClass("non_approx_numeric_type", ImmutableSet.of("boolean", "tinyint", "smallint", "integer", "bigint", "decimal", "varchar", "date"))
                ...
                .map("$equal(left: approx_numeric_type, right: approx_numeric_type)").to("left = right")
                .map("$not_equal(left: approx_numeric_type, right: approx_numeric_type)").to("left <> right OR (left = 'NaN' AND right = 'NaN')")
                .map("$identical(left, right)").to("left IS NOT DISTINCT FROM right")
                .map("$less_than(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left < right")
                .map("$less_than_or_equal(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left <= right")
                .map("$greater_than(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left > right")
                .map("$greater_than_or_equal(left: non_approx_numeric_type, right: non_approx_numeric_type)").to("left >= right")
