        ...
        extends BaseCaseInsensitiveMappingTest
{
            ...
            throws Exception
    {
        ...
        igniteServer = closeAfterClass(new TestingIgniteServer());
        return IgniteQueryRunner.createIgniteQueryRunner(
                igniteServer,
                ImmutableMap.of(),
            ...
            throws Exception
    {
        try (AutoCloseable ignore1 = withSchema("Public");
            ...
            assertQuery("SHOW TABLES FROM public", "VALUES 'lower_case_name', 'mixed_case_name', 'upper_case_name'");
    ...
    {
        return requireNonNull(igniteServer, "postgreSqlServer is null")::execute;
    }
}
