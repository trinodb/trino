...
import io.trino.plugin.ignite.custom.TestIgniteJdbcTestPlugin;
...
public final class IgniteQueryRunner
{
    ...
    public static DistributedQueryRunner createIgniteQueryRunner(
            ...
            throws Exception
    {
        return createIgniteQueryRunner(server, extraProperties, connectorProperties, false);
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            if (usingCustomClient) {
                queryRunner.installPlugin(new TestIgniteJdbcTestPlugin());
            }
            else {
