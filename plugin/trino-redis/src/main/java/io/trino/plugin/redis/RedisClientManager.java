...
public class RedisClientManager
{
    ...
    RedisClientManager(RedisConnectorConfig redisConnectorConfig, Set<RedisClientConfigurator> clientConfigurators)
    {
        ...
        this.clientConfigurators = ImmutableSet.copyOf(requireNonNull(clientConfigurators, "clientConfigurators is null"));
    }
    ...
    private RedisClient createClient(HostAddress host)
    {
        ...
        for (RedisClientConfigurator clientConfigurator : clientConfigurators) {
            clientConfigurator.configure(clientConfigBuilder);
        }
