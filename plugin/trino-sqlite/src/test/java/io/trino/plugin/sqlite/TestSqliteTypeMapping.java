        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testDecimal()
    {
        ...
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("decimal(14, 2)", "CAST('123456789012.12' AS decimal(14, 2))", createDecimalType(14, 2), "CAST('123456789012.12' AS decimal(14, 2))")
                .addRoundTrip("decimal(14, 4)", "CAST('1234567890.1234' AS decimal(14, 4))", createDecimalType(14, 4), "CAST('1234567890.1234' AS decimal(14, 4))")
    ...
    {
        return new CreateAndInsertDataSetup(sqliteServer::execute, tableNamePrefix, this::canonicalize);
    }
