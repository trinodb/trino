        ...
        implements AutoCloseable
{
    ...
    static {
        try {
            SQLITE_PATH = Paths.get(Files.createTempDirectory("sqlite").toFile().getAbsolutePath()).toUri().toString();
        }
        catch (IOException e) {
    ...
    {
        return new JdbcSqlExecutor(getJdbcUrl(), getProperties(DEFAULT_USER, DEFAULT_PASSWORD));
    }
