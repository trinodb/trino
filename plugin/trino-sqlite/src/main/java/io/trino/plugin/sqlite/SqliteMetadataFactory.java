...
public class SqliteMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public SqliteMetadataFactory(JdbcClient jdbcClient, SqliteConfig sqliteConfig, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
        super(jdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners, identityCacheMapping);
        this.sqliteConfig = requireNonNull(sqliteConfig, "sqliteConfig is null");
    ...
    {
        return new SqliteMetadata(transactionCachingJdbcClient, sqliteConfig, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
