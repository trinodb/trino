        ...
        extends BaseJdbcClient
{
    ...
    public String getTableRemoteSchemaName(ResultSet resultSet)
            throws SQLException
    {
        return Optional.ofNullable(resultSet.getString("TABLE_SCHEM")).orElse(MAIN_SCHEMA);
    }
    ...
    public Optional<ColumnMapping> toColumnMapping(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        return switch (typeHandle.jdbcType()) {
            ...
            case Types.DECIMAL, Types.NUMERIC -> {
                ...
                yield Optional.of(decimalColumnMapping(createDecimalType(max(precision, 1), max(decimalDigits, 0))));
            }
            case Types.CHAR, Types.VARCHAR, Types.CLOB -> Optional.of(defaultVarcharColumnMapping(typeHandle.requiredColumnSize(), true));
    ...
    protected List<String> createTableSqls(RemoteTableName remoteTableName, List<String> columnNames, List<String> columnDefinitions, ConnectorTableMetadata tableMetadata)
    {
        ...
        if (primaryKeys.isPresent() && !hasAutoIncrement(columnDefinitions)) {
            setPrimaryKey(columns, remoteTableName, tableMetadata, primaryKeys.get());
        }
            ...
            throws SQLException
    {
        ...
        try (PreparedStatement statement = getPreparedStatement(connection, sql, Optional.of(1));
                ResultSet rs = getTableDefinitionResultSet(statement, tableName)) {
