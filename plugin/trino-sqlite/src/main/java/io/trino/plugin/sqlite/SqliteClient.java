        ...
        extends BaseJdbcClient
{
    ...
    public List<JdbcColumnHandle> getColumns(ConnectorSession session, SchemaTableName schemaTableName, RemoteTableName remoteTableName)
    {
        try (Connection connection = connectionFactory.openConnection(session);
            ...
            while (resultSet.next()) {
                ...
                int dataType = getSqliteDataType(typeName);
                JdbcTypeHandle typeHandle = new JdbcTypeHandle(
                        dataType,
                        Optional.of(JDBCType.valueOf(dataType).getName()),
    ...
    private int getSqliteDataType(Optional<String> typeName)
    {
        ...
        if (typeName.isPresent() && !typeName.get().isEmpty()) {
            ...
            return getCustomDataType(typeName.get());
        }
        return Types.BLOB;
    }

    private int getCustomDataType(String typeName)
    {
