        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(BarbApiClient.class).in(Scopes.SINGLETON);
        binder.bind(ExampleSplitManager.class).in(Scopes.SINGLETON);
        binder.bind(ExampleRecordSetProvider.class).in(Scopes.SINGLETON);
        configBinder(binder).bindConfig(BarbApiConfig.class);

        jsonCodecBinder(binder).bindMapJsonCodec(String.class, listJsonCodec(BarbApiTable.class));
    }
}
