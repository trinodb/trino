...
public class TestLocalFileSystemExchangeManagerWithCommitFiles
        extends AbstractTestExchangeManager
{
    @Override
    protected ExchangeManager createExchangeManager()
    {
        String baseDirectory1 = System.getProperty("java.io.tmpdir") + "/trino-local-file-system-exchange-manager-commit-1";
        String baseDirectory2 = System.getProperty("java.io.tmpdir") + "/trino-local-file-system-exchange-manager-commit-2";
        return new FileSystemExchangeManagerFactory().create(
                ImmutableMap.of(
                        ...
                        "exchange.commit-manifest-enabled", "true"),
