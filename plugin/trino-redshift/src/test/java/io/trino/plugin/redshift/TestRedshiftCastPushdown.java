        ...
        extends BaseJdbcCastPushdownTest
{
    ...
    public void testCastPushdownOutOfRangeValue()
    {
        ...
        assertInvalidCast(
                table.getName(),
                ImmutableList.of(
                        new InvalidCastTestCase("c_smallint_1", "tinyint", "Out of range for tinyint: -129", "Bad value for type byte : -129"),
                        new InvalidCastTestCase("c_smallint_2", "tinyint", "Out of range for tinyint: 128", "Bad value for type byte : 128"),
                        new InvalidCastTestCase("c_int_1", "tinyint", "Out of range for tinyint: -65537", "(?s).*Value out of range for 2 bytes(?s).*"),
                        new InvalidCastTestCase("c_int_2", "tinyint", "Out of range for tinyint: 65536", "(?s).*Value out of range for 2 bytes(?s).*"),
                        ...
                        new InvalidCastTestCase("c_bigint_1", "tinyint", "Out of range for tinyint: -2147483649", "(?s).*Value out of range for 2 bytes(?s).*"),
                        new InvalidCastTestCase("c_bigint_2", "tinyint", "Out of range for tinyint: 2147483648", "(?s).*Value out of range for 2 bytes(?s).*"),
                        ...
                        new InvalidCastTestCase("c_decimal_1", "tinyint", "Cannot cast '-129.49' to TINYINT", "Bad value for type byte : -129"),
                        new InvalidCastTestCase("c_decimal_2", "tinyint", "Cannot cast '-128.94' to TINYINT", "Bad value for type byte : -129"),
                        new InvalidCastTestCase("c_decimal_3", "tinyint", "Cannot cast '127.94' to TINYINT", "Bad value for type byte : 128"),
                        new InvalidCastTestCase("c_decimal_4", "tinyint", "Cannot cast '128.49' to TINYINT", "Bad value for type byte : 128"),
    ...
    {
        return ImmutableList.of(
                new CastTestCase("c_real", "tinyint", "c_tinyint"),
                new CastTestCase("c_float4", "tinyint", "c_tinyint"),
                new CastTestCase("c_double_precision", "tinyint", "c_tinyint"),
                new CastTestCase("c_float", "tinyint", "c_tinyint"),
                new CastTestCase("c_float8", "tinyint", "c_tinyint"),
                new CastTestCase("c_varchar_numeric", "tinyint", "c_tinyint"),
                new CastTestCase("c_text_numeric", "tinyint", "c_tinyint"),
                new CastTestCase("c_nvarchar_numeric", "tinyint", "c_tinyint"),
                new CastTestCase("c_varchar_numeric_sign", "tinyint", "c_tinyint"),
    ...
    {
        return ImmutableList.of(
                new InvalidCastTestCase("c_varchar_decimal", "smallint"),
                new InvalidCastTestCase("c_varchar_decimal_sign", "smallint"),
                new InvalidCastTestCase("c_varchar_alpha_numeric", "smallint"),
                new InvalidCastTestCase("c_char_50", "smallint"),
                new InvalidCastTestCase("c_char_numeric", "smallint"),
                new InvalidCastTestCase("c_bpchar_numeric", "smallint"),
