...
abstract class RedshiftCastPushdownTest
        extends BaseCastPushdownTest
{
    public RedshiftCastPushdownTest(Session session, QueryRunner queryRunner, SqlExecutor sqlExecutor)
    {
    ...
    public void setupTable()
    {
        table1 = CastDataTypeTest.create()
                ...
                .execute(sqlExecutor, TEST_SCHEMA + "." + "table_1_");
        ...
        table2 = CastDataTypeTest.create()
                ...
                .execute(sqlExecutor, TEST_SCHEMA + "." + "table_2_");
    }
    ...
    public void testJoinPushdownWithNestedCast()
    {
        ...
        assertJoinFullyPushedDown(session, table1.tableName(), table2.tableName(), "JOIN", "CAST(CAST(l.%s AS %s) AS integer) = r.%s".formatted(testCase.sourceColumn(), testCase.castType(), testCase.targetColumn().orElseThrow()));
    }
    ...
    protected List<CastTestCase> supportedCastTypePushdown()
    {
        return ImmutableList.of(
                ...
                new CastTestCase("c_real", "tinyint", Optional.of("c_smallint")),
                new CastTestCase("c_double_precision", "tinyint", Optional.of("c_smallint")),
                ...
                new CastTestCase("c_real", "integer", Optional.of("c_integer")),
                new CastTestCase("c_float4", "integer", Optional.of("c_integer")),
                new CastTestCase("c_double_precision", "integer", Optional.of("c_integer")),
                new CastTestCase("c_float", "integer", Optional.of("c_integer")),
                new CastTestCase("c_float8", "integer", Optional.of("c_integer")),
                ...
                new CastTestCase("c_real", "bigint", Optional.of("c_bigint")),
                new CastTestCase("c_double_precision", "bigint", Optional.of("c_bigint")),
