        ...
        extends BaseJdbcClient
{
    ...
    {
        // Deactivated because test 'testJoinPushdown()' requires write access which is not implemented yet for HsqlDB
        return false;
    }
    ...
    {
        // Deactivated because test 'testCaseSensitiveAggregationPushdown()' requires write access which is not yet implemented for HsqlDB
    ...
    public Optional<ColumnMapping> toColumnMapping(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        switch (typeHandle.jdbcType()) {
            ...
            case Types.DECIMAL, Types.NUMERIC:
                ...
                // XXX: For HsqlDB, if the precision is not specified, its value is 128,
                // XXX: whereas it seems that Trino imposes a maximum of 38.
                if (columnSize > MAX_PRECISION) {
                    columnSize = MAX_PRECISION;
                }
    ...
    {
        return Optional.of((sql, limit) -> format("%s LIMIT %s", sql, limit));
    }
