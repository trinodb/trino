        ...
        extends AbstractTestQueryFramework
{
    ...
    private SqlDataTypeTest commonTimeTest(Function<String, String> inputLiteralFactory)
    {
        return SqlDataTypeTest.create()
    ...
    private void assertHsqlDbQueryFails(String sql, String expectedMessage)
    {
