        ...
        extends AbstractTestQueryFramework
{
    ...
    @Test
    @Disabled
        // FIXME: Cant run this test without an SQL Error after table creation on data insertion and before any query assertion.
    ...
    {
        return new CreateAndInsertDataSetup(hsqldbServer.getSqlExecutor(), tableNamePrefix);
    }
