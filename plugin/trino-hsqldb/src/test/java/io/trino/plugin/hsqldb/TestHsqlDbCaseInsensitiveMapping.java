        ...
        extends BaseCaseInsensitiveMappingTest
{
    ...
    {
        String query = "CREATE SCHEMA " + quoted(schemaName);
        System.out.println("TestHsqlDbCaseInsensitiveMapping.withSchema(): " + query);
    ...
    protected AutoCloseable withTable(String remoteSchemaName, String remoteTableName, String tableDefinition)
    {
        ...
        String query = format("CREATE TABLE %s %s", quotedName, tableDefinition);
        System.out.println("TestHsqlDbCaseInsensitiveMapping.withTable(): " + query);
        onRemoteDatabase().execute(format("CREATE TABLE %s %s", quotedName, tableDefinition));
        return () -> onRemoteDatabase().execute("DROP TABLE " + quotedName + " RESTRICT");
    }
}
