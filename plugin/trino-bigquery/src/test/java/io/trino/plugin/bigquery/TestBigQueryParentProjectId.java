        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        testingProjectId = requiredNonEmptySystemProperty("bigquery-testing.project-id");
        testingParentProjectId = requiredNonEmptySystemProperty("bigquery-testing.parent-project-id");
    }
