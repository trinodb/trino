...
import static io.trino.plugin.bigquery.BigQueryType.getNativeType;
...
public final class Conversions
{
    ...
    public static BigQueryColumnHandle toColumnHandle(Field field)
    {
        ...
        Type trinoType = BigQueryType.getNativeType(field).orElseThrow(() -> new IllegalArgumentException("Unsupported type: " + field));
        return new BigQueryColumnHandle(
                field.getName(),
                field.getMode() == REPEATED ? new ArrayType(trinoType) : trinoType,
    ...
    public static boolean isSupportedType(Field field)
    {
        ...
        return getNativeType(field).isPresent();
    }
