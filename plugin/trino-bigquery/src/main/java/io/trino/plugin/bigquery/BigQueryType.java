...
public final class BigQueryType
{
    ...
    {
        Type trinoType = getNativeType(field).orElseThrow(() -> new IllegalArgumentException("Unsupported column " + field));
    ...
    public static Optional<Type> getNativeType(Field field)
    {
