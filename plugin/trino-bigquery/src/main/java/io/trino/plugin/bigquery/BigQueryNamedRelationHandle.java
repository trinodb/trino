        ...
        extends BigQueryRelationHandle
{
    ...
    private final boolean connectionIdExists;
    ...
    public BigQueryNamedRelationHandle(
            ...
            @JsonProperty("connectionIdExists") boolean connectionIdExists)
    {
    ...
    @JsonProperty
    public boolean isConnectionIdExists()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(schemaTableName, that.schemaTableName) &&
               ...
               connectionIdExists == that.connectionIdExists;
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(schemaTableName, type, partitionType, comment, connectionIdExists);
    }
    ...
    public String toString()
    {
        return toStringHelper(this)
                ...
                .add("type", type)
                .add("comment", comment)
                .add("connectionIdExists", connectionIdExists)
                .toString();
    }
}
