...
public class TestStatistics
{
    ...
    public void testFromComputedStatistics()
    {
        ...
        ComputedStatistics statistics = ComputedStatistics.builder(ImmutableList.of(), ImmutableList.of())
                ...
                .addColumnStatistic(new ColumnStatisticMetadata("a_column", MIN_VALUE.getAggregationName()), singleIntegerValueBlock.apply(1))
                .addColumnStatistic(new ColumnStatisticMetadata("a_column", MAX_VALUE.getAggregationName()), singleIntegerValueBlock.apply(5))
                .addColumnStatistic(new ColumnStatisticMetadata("a_column", NUMBER_OF_DISTINCT_VALUES.getAggregationName()), singleIntegerValueBlock.apply(5))
                .addColumnStatistic(new ColumnStatisticMetadata("a_column", NUMBER_OF_NON_NULL_VALUES.getAggregationName()), singleIntegerValueBlock.apply(5))
                .addColumnStatistic(new ColumnStatisticMetadata("b_column", NUMBER_OF_NON_NULL_VALUES.getAggregationName()), singleIntegerValueBlock.apply(4))
                .build();
