...
import io.trino.spi.subfield.Subfield.AllSubscripts;
import io.trino.spi.subfield.Subfield.NestedField;
import io.trino.spi.subfield.Subfield.PathElement;
import io.trino.spi.subfield.Subfield.StringSubscript;
...
public class TestPruneTypeForPath
{
    ...
    public void fallback()
    {
        ...
        assertEquals(originalType, actualPrunedType);
    }

    /**
     * See https://t.corp.amazon.com/P45710920
     */
    @Test
    public void fallbackWithNullOriginalType()
    {
        GroupType originalType = null;
    ...
    public void oneLevelNesting()
    {
        ...
        Type actualPrunedType = ParquetPageSourceFactory.pruneColumnTypeForPath(originalType, path);
        assertEquals(expectedPrunedType, actualPrunedType);
    }
    ...
    public void arrayOfStructsType2()
    {
        ...
        Type actualPrunedType = ParquetPageSourceFactory.pruneColumnTypeForPath(originalType, path);
        assertEquals(actualPrunedType, expectedPrunedType);
    }
