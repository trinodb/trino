        ...
        extends BasePlanTest
{
    ...
    public void testPruneSimplePartitionLikeFilter()
    {
        assertDistributedPlan(
                ...
                output(
                        filter("\"$like\"(STR_PART, \"$literal$\"(from_base64('DgAAAFZBUklBQkxFX1dJRFRIAQAAAAgAAAAACAAAAAIAAAB0JQAA')))",
                        ...
                        join(INNER, builder -> builder
                                ...
                                .left(
                                        exchange(REMOTE, REPARTITION,
                                                project(
                                                        filter("\"$like\"(L_STR_PART, \"$literal$\"(from_base64('DgAAAFZBUklBQkxFX1dJRFRIAQAAAAgAAAAACAAAAAIAAAB0JQAA')))",
                                                                tableScan("table_str_partitioned", Map.of("L_INT_COL", "int_col", "L_STR_PART", "str_part"))))))
                                .right(exchange(LOCAL,
                                        exchange(REMOTE, REPARTITION,
                                                project(
                                                        filter("R_STR_COL IN ('three', CAST('two' AS varchar(5))) AND \"$like\"(R_STR_COL, \"$literal$\"(from_base64('DgAAAFZBUklBQkxFX1dJRFRIAQAAAAgAAAAACAAAAAIAAAB0JQAA')))",
