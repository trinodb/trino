        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        assertQueryFails(createAdminSession(), createRoleSql("role1 WITH ADMIN admin"), ".*?Hive Connector does not support WITH ADMIN statement");
    }
    ...
    {
        return "DROP ROLE " + role + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String createRoleSql(String role)
    {
        return "CREATE ROLE " + role + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String grantRoleToUserSql(String role, String toUser)
    {
        return "GRANT " + role + " TO USER " + toUser + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String grantRoleToUserWithAdminSql(String role, String toUser)
    {
        return "GRANT " + role + " TO USER " + toUser + " WITH ADMIN OPTION " + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String grantRoleToRoleSql(String role, String toRole)
    {
        return "GRANT " + role + " TO ROLE " + toRole + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String grantRoleToRoleWithAdminSql(String role, String toRole)
    {
        return "GRANT " + role + " TO ROLE " + toRole + " WITH ADMIN OPTION " + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String revokeRoleFromUserSql(String role, String toUser)
    {
        return "REVOKE " + role + " FROM USER " + toUser + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String revokeAdminOptionForRoleFromUserSql(String role, String toUser)
    {
        return "REVOKE ADMIN OPTION FOR " + role + " FROM USER " + toUser + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String revokeRoleFromRoleSql(String role, String fromRole)
    {
        return "REVOKE " + role + " FROM ROLE " + fromRole + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }

    private String revokeAdminOptionForRoleFromRoleSql(String role, String fromRole)
    {
        return "REVOKE ADMIN OPTION FOR " + role + " FROM ROLE " + fromRole + (legacyCommands ? "" : " IN " + HIVE_CATALOG);
    }
}
