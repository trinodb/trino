...
class TestGlueConverter
{
    ...
    {
        io.trino.metastore.Database trinoDatabase = GlueConverter.fromGlueDatabase(glueDatabase);
    ...
    void testConvertTableWithOpenCSVSerDe()
    {
        software.amazon.awssdk.services.glue.model.Table glueTable = this.glueTable.toBuilder()
                .storageDescriptor(this.glueTable.storageDescriptor().toBuilder()
                        ...
                        .build())
                .build();
        io.trino.metastore.Table trinoTable = GlueConverter.fromGlueTable(glueTable, glueTable.databaseName());
    ...
    {
        io.trino.metastore.Partition trinoPartition = GlueConverter.fromGluePartition(gluePartition.databaseName(), gluePartition.tableName(), gluePartition);
    ...
    void testTableNullParameters()
    {
        software.amazon.awssdk.services.glue.model.Table table = glueTable.toBuilder()
                ...
                .storageDescriptor(glueTable.storageDescriptor().toBuilder()
                        ...
                        .build())
                .build();
        io.trino.metastore.Table trinoTable = GlueConverter.fromGlueTable(table, glueTable.databaseName());
    ...
    @Test
    public void testIcebergViewsNullStorageDescriptor()
    {
        ...
        trinoTable = GlueConverter.fromGlueTable(glueView, glueView.databaseName());
        assertThat(trinoTable.getDataColumns()).hasSize(1);
    }
    ...
    private static void assertStorage(StorageDescriptor glueStorage, Storage trinoStorage)
    {
        ...
        if (trinoStorage.getBucketProperty().isPresent()) {
            ...
            assertThat(glueStorage.bucketColumns()).isEqualTo(bucketProperty.bucketedBy());
            assertThat(glueStorage.numberOfBuckets().intValue()).isEqualTo(bucketProperty.bucketCount());
        }
    }
}
