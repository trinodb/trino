...
class TestGlueConverter
{
    ...
    private final Table trinoTable = Table.builder()
            ...
            .withStorage(storage -> storage.setStorageFormat(StorageFormat.create("TableSerdeLib", "TableInputFormat", "TableOutputFormat", "TableExtension"))
    ...
    private final Partition trinoPartition = Partition.builder()
            ...
            .setParameters(ImmutableMap.of())
            .withStorage(storage -> storage.setStorageFormat(StorageFormat.create("PartitionSerdeLib", "PartitionInputFormat", "PartitionOutputFormat", "PartitionExtension"))
