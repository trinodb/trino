        ...
        extends HiveFlociDataLake
{
    ...
    public Hive3FlociDataLake(String bucketName)
    {
        this(bucketName, HiveHadoop.HIVE3_IMAGE);
    }

    public Hive3FlociDataLake(String bucketName, String hiveHadoopImage)
    {
        this(bucketName,
                ImmutableMap.of(
    ...
    public Hive3FlociDataLake(String bucketName, Map<String, String> hiveHadoopFilesToMount, String hiveHadoopImage)
    {
        super(bucketName);
