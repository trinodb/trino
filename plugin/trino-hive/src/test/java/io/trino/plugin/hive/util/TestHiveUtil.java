...
public class TestHiveUtil
{
    ...
    public void testShouldUseRecordReaderFromInputFormat()
    {
        ...
        assertFalse(shouldUseRecordReaderFromInputFormat(new Configuration(false), parquetSchema, Collections.emptyMap()));
        ...
        assertTrue(shouldUseRecordReaderFromInputFormat(new Configuration(false), realtimeSchema, customSplitInfo));
    }
