...
import io.trino.testing.ExtendedFailureRecoveryCoverage;
...
public abstract class BaseHiveFailureRecoveryCoverage
        extends ExtendedFailureRecoveryCoverage
{
    protected BaseHiveFailureRecoveryCoverage(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
