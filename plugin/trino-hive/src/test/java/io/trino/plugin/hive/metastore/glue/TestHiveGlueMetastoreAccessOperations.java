        ...
        extends AbstractTestQueryFramework
{
            ...
            throws IOException
    {
        ...
        try {
            ...
            checkState(files.hasNext(), "No files found in partition location: %s", sourcePartitionLocation);
            Location sourceFile = files.next().location();
            checkState(!files.hasNext(), "Multiple files found in partition location: %s", sourcePartitionLocation);
