...
public class TestHiveBucketing
{
    ...
    public void testHashingCompare()
    {
        ...
        assertBucketEquals("array<struct<field1:bigint,field2:double,field3:string>>", ImmutableList.of(ImmutableList.of(10L, 12.3, "Trino Rocks!!")), 277146753, 1264647249);
        assertBucketEquals("map<string,struct<field1:bigint,field2:double,field3:string>>", ImmutableMap.of("key1", ImmutableList.of(10L, 12.3, "Trino Rocks!!")), 280412467, -167351608);
