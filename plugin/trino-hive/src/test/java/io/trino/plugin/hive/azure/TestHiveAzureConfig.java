...
public class TestHiveAzureConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                .put("azure.wasb.storage-account", "testwasbstorage")
                .put("azure.wasb.access-key", "secret")
                .put("azure.abfs.storage-account", "abfsstorage")
                .put("azure.abfs.access-key", "abfssecret")
                .put("azure.adl.client-id", "adlclientid")
                .put("azure.adl.credential", "adlcredential")
                .put("azure.adl.refresh-url", "adlrefreshurl")
                .put("azure.adl.proxy-host", "proxy-host:9800")
                .put("azure.abfs.oauth.endpoint", "abfsoauthendpoint")
                .put("azure.abfs.oauth.client-id", "abfsoauthclientid")
                .put("azure.abfs.oauth.secret", "abfsoauthsecret")
                .buildOrThrow();
