...
public class TestHiveConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(HiveConfig.class)
                ...
                .setPartitionSamplingTimeLimit(new Duration(30, TimeUnit.SECONDS))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("hive.partition-statistics-sampling-time-limit", "1h")
        ...
        HiveConfig expected = new HiveConfig()
                ...
                .setPartitionSamplingTimeLimit(new Duration(1, TimeUnit.HOURS))
