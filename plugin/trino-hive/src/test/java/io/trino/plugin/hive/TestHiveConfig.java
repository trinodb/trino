...
public class TestHiveConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(HiveConfig.class)
                ...
                .setFileStatusCacheListingTimeout(new Duration(0, TimeUnit.MINUTES))
                .setFileStatusCacheListingElementTimeout(new Duration(0, TimeUnit.MINUTES))
                .setFileStatusCacheListingMaxRetries(0)
                .setFileStatusCacheListingMaxThreads(8)
                .setFileStatusCacheListingQueueCapacity(1000)
            ...
            throws IOException
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("hive.file-status-cache.listing-timeout", "45s")
                .put("hive.file-status-cache.listing-element-timeout", "5s")
                .put("hive.file-status-cache.listing-max-retries", "3")
                .put("hive.file-status-cache.listing-max-threads", "5")
                .put("hive.file-status-cache.listing-queue-capacity", "250")
                ...
                .put("hive.metadata.virtual-threads-enabled", "false")
        ...
        HiveConfig expected = new HiveConfig()
                ...
                .setFileStatusCacheListingTimeout(new Duration(45, TimeUnit.SECONDS))
                .setFileStatusCacheListingElementTimeout(new Duration(5, TimeUnit.SECONDS))
                .setFileStatusCacheListingMaxRetries(3)
                .setFileStatusCacheListingMaxThreads(5)
                .setFileStatusCacheListingQueueCapacity(250)
