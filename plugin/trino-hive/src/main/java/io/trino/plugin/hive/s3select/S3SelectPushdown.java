...
public final class S3SelectPushdown
{
    ...
    private static final S3SelectSerDeDataTypeMapper serDeDataTypeMapper = new S3SelectSerDeDataTypeMapper();
    ...
    private static boolean isSerDeSupported(Properties schema)
    {
        ...
        return serDeDataTypeMapper.doesSerDeExist(serdeName);
    }
