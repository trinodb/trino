        ...
        implements SqlStandardAccessControlMetadataMetastore
{
            ...
            extends TableAndMore
    {
        ...
        public TableAndMergeResults(Table table, HiveIdentity identity, Optional<PrincipalPrivileges> principalPrivileges, Optional<Path> currentLocation, List<PartitionUpdateAndMergeResults> partitionMergeResults, List<Partition> partitions)
        {
            super(table, identity, principalPrivileges, currentLocation, Optional.empty(), false, PartitionStatistics.empty(), PartitionStatistics.empty());
