        ...
        implements ConnectorPageSource
{
    ...
    public EsriPageSource(EsriReader esriReader, EsriDeserializer esriDeserializer, PageBuilder pageBuilder, Location filePath)
    {
        this.esriReader = requireNonNull(esriReader, "esriReader is null");
        this.esriDeserializer = requireNonNull(esriDeserializer, "deserializer is null");
    ...
    public SourcePage getNextSourcePage()
    {
        try {
            String jsonStr;
            while (!pageBuilder.isFull() && (jsonStr = esriReader.next()) != null) {
                esriDeserializer.deserialize(pageBuilder, jsonStr);
            }
    ...
    {
        return INSTANCE_SIZE + esriReader.getBytesRead() + pageBuilder.getRetainedSizeInBytes();
    }
