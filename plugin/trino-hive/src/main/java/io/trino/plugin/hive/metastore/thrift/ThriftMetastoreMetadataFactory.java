...
public class ThriftMetastoreMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public ThriftMetastoreMetadataFactory(JdbcClient jdbcClient, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
    ...
    {
        return new ThriftMetastoreMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
