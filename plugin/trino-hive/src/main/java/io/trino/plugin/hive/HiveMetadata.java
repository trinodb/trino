        ...
        implements TransactionalMetadata
{
    ...
    public HiveTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName)
    {
        ...
        rejectRedirectedTables(session, tableName);
    ...
    {
        rejectRedirectedTables(session, table);
    ...
    {
        rejectRedirectedTables(session, schemaTableName);
    ...
    private void rejectRedirectedTables(ConnectorSession session, SchemaTableName tableName)
    {
        if (redirectTable(session, tableName).isPresent()) {
