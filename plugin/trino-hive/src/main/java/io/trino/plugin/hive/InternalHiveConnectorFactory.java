    ...
    public static Connector createConnector(String catalogName, Map<String, String> config, ConnectorContext context, Module module, Optional<HiveMetastore> metastore, Optional<CachingDirectoryLister> cachingDirectoryLister)
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            Bootstrap app = new Bootstrap(
                    ...
                    new HiveModule(),
                    conditionalModule(HiveConfig.class, hiveConfig -> hiveConfig.isFileStatusCacheTablesEnabled(), new CachingDirectoryListerModule(cachingDirectoryLister)),
                    conditionalModule(HiveConfig.class, hiveConfig -> !hiveConfig.isFileStatusCacheTablesEnabled(), new DefaultDirectoryListerModule()),
                    new HiveHdfsModule(),
                    new HiveS3Module(),
                    new HiveGcsModule(),
                    new HiveAzureModule(),
