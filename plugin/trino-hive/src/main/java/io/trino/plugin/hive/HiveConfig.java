...
public class HiveConfig
{
    ...
    public HiveConfig setPreferMetadataToListHudiFiles(boolean preferMetadataToListHudiFiles)
    {
    ...
    public HiveConfig setHudiMetadataVerificationEnabled(boolean hudiMetadataVerificationEnabled)
    {
