        ...
        implements SessionPropertiesProvider
{
    ...
    private static final String PARQUET_HYBRID_CALENDAR_SUPPORT_ENABLED = "parquet_hybrid_calendar_support_enabled";
            ...
            ParquetWriterConfig parquetWriterConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        false),
                booleanProperty(
                        PARQUET_HYBRID_CALENDAR_SUPPORT_ENABLED,
                        "Support for reading Date values written in hybrid (Julian + Gregorian) Calendar in Parquet",
                        hiveConfig.isParquetHybridCalendarSupportEnabled(),
                        false),
                dataSizeProperty(
    ...
    public static boolean isHybridCalendarSupportEnabled(ConnectorSession session)
    {
        return session.getProperty(PARQUET_HYBRID_CALENDAR_SUPPORT_ENABLED, Boolean.class);
    }
