...
public final class TrinoViewHiveMetastore
{
    ...
    public TrinoViewHiveMetastore(boolean isUsingSystemSecurity, HiveMetastore metastore, String trinoVersion, String connectorName)
    {
    ...
    public void createView(ConnectorSession session, SchemaTableName schemaViewName, ConnectorViewDefinition definition, boolean replace)
    {
        ...
        io.trino.plugin.hive.metastore.Table.Builder tableBuilder = io.trino.plugin.hive.metastore.Table.builder()
                ...
                .setParameters(createViewProperties(session, connectorName, trinoVersion))
