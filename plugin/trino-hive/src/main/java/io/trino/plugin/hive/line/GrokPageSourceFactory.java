...
import io.trino.hive.formats.line.grok.GrokDeserializerFactory;
import io.trino.hive.formats.line.text.TextLineReaderFactory;
import io.trino.plugin.hive.HiveConfig;

import static java.lang.Math.toIntExact;

public class GrokPageSourceFactory
        extends LinePageSourceFactory
{
    @Inject
    public GrokPageSourceFactory(TrinoFileSystemFactory trinoFileSystemFactory, HiveConfig config)
    {
        super(trinoFileSystemFactory,
                new GrokDeserializerFactory(),
