...
public final class LokiQueryRunner
{
    ...
    public static Builder builder(LokiTestServer lokiServer)
    {
        return new Builder()
    ...
    public static LokiClient createLokiClient(LokiTestServer server)
    {
        LokiClientConfig config = new LokiClientConfig(server.getUri(), Duration.ofSeconds(10));
            ...
            throws Exception
    {
        ...
        QueryRunner queryRunner = builder(new LokiTestServer())
