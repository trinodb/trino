        ...
        implements LokiQueryResultIterator
{
    ...
    {
        // this packTimeWithTimeZone expects nanos since epoch. That's why we are passing the key here.
        return packTimeWithTimeZone(nanos, TimeZoneKey.UTC_KEY.getKey());
    }
}
