        ...
        extends AbstractConnectorTableFunction
{
    ...
    {
        final ScalarArgument argument = (ScalarArgument) arguments.get("QUERY");
        String query = ((Slice) argument.getValue()).toStringUtf8();

        final LongTimestampWithTimeZone startArgument = (LongTimestampWithTimeZone) ((ScalarArgument) arguments.get("START")).getValue();
        final LongTimestampWithTimeZone endArgument = (LongTimestampWithTimeZone) ((ScalarArgument) arguments.get("END")).getValue();
