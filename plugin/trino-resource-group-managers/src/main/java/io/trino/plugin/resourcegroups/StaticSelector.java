        ...
        implements ResourceGroupSelector
{
            ...
            ResourceGroupIdTemplate group)
    {
        ...
        this.selectionMatchers = ImmutableList.<Optional<SelectionMatcher>>builder()
                ...
                .add(authenticatedUserRegex.map(authenticatedUserRegexValue -> {
                    ...
                    return new OptionalPatternMatcher(variableNames, authenticatedUserRegexValue, SelectionCriteria::getAuthenticatedUser);
                }))
                .add(sourceRegex.map(sourceRegexValue -> {
                    addNamedGroups(sourceRegexValue, variableNames);
                    return new OptionalPatternMatcher(variableNames, sourceRegexValue, SelectionCriteria::getSource);
                }))
            ...
            implements SelectionMatcher
    {
        ...
        public PatternMatcher(Set<String> variableNames, Pattern pattern, Function<SelectionCriteria, String> valueExtractor)
        {
            ...
            extends PatternMatcher
    {
        ...
        public OptionalPatternMatcher(Set<String> variableNames, Pattern pattern, Function<SelectionCriteria, Optional<String>> valueExtractor)
        {
            super(variableNames, pattern, criteria -> valueExtractor.apply(criteria).get());
            this.valueExtractor = valueExtractor;
        }
