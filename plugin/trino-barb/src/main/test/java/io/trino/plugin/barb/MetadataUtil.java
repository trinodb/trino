...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<BARBTable>>> CATALOG_CODEC;
    public static final JsonCodec<BARBTable> TABLE_CODEC;
    public static final JsonCodec<BARBColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(BARBTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(BARBTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(BARBColumnHandle.class);
    }
