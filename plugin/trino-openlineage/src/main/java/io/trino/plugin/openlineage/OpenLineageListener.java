        ...
        implements EventListener
{
                ...
                .map(table -> {
                    ...
                    DatasetFacetsBuilder datasetFacetsBuilder = openLineage.newDatasetFacetsBuilder()
                            .dataSource(openLineage.newDatasourceDatasetFacet(
                                    getQualifiedSchemaName(table.getCatalog(), table.getSchema()),
                                    trinoURI.resolve(getQualifiedSchemaName(table.getCatalog(), table.getSchema()))))
            ...
            return ImmutableList.of(
                    openLineage.newOutputDatasetBuilder()
                            ...
                            .facets(openLineage.newDatasetFacetsBuilder()
                                    ...
                                    .dataSource(openLineage.newDatasourceDatasetFacet(
                                            getQualifiedSchemaName(outputMetadata.getCatalogName(), outputMetadata.getSchema()),
                                            trinoURI.resolve(getQualifiedSchemaName(outputMetadata.getCatalogName(), outputMetadata.getSchema()))))
                                    .build()
                            ).build());
        }
        return ImmutableList.of();
    ...
    private static String getQualifiedSchemaName(String catalogName, String schemaName)
    {
