...
{
    private final URI openLineageProducer;

    public OpenLineageListenerModule(URI openLineageProducer)
    {
        this.openLineageProducer = requireNonNull(openLineageProducer, "openLineageProducer is null");
    }
    ...
    private OpenLineage createOpenLineage()
    {
        return new OpenLineage(openLineageProducer);
    }
}
