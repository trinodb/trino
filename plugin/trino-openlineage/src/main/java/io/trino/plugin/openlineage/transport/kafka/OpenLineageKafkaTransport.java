        ...
        implements OpenLineageTransportCreator
{
            ...
            Optional<KafkaSslConfig> sslConfig)
    {
        ...
        log.info("Initializing OpenLineage Kafka transport: brokers=%s, topic=%s, security=%s, messageKey=%s",
    ...
    public KafkaTransport buildTransport()
    {
        ...
        log.info("Created OpenLineage Kafka transport for topic: %s", topicName);
        return transport;
    }
            ...
            Optional<KafkaSslConfig> sslConfig)
    {
        ...
        properties.putAll(config.getKafkaClientOverrides());
        return properties;
    }
}
