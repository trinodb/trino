...
final class TestOpenLineageListenerConfig
{
            ...
            throws Exception
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("openlineage-event-listener.job.name-format", "$QUERY_ID-$USER-$SOURCE-abc123")
                .buildOrThrow();
        ...
        OpenLineageListenerConfig expected = new OpenLineageListenerConfig()
                ...
                .setJobNameFormat("$QUERY_ID-$USER-$SOURCE-abc123");
            ...
            throws Exception
    {
        ...
        assertThat(configWithFormat("$QUERY_ID-$USER-$SOURCE-abc123").isJobNameFormatValid()).isTrue();

        assertThat(configWithFormat("$UNKNOWN").isJobNameFormatValid()).isFalse();
        assertThat(configWithFormat("$QUERY_ID-$USER-$SOURCE-$UNKNOWN").isJobNameFormatValid()).isFalse();
    }

    private OpenLineageListenerConfig configWithFormat(String format)
    {
