...
{
    private static final Duration DURATION_10S = Duration.valueOf("10s");
    protected static final String TRINO_URI = "http://trino-integration-test:1337";
    protected static final String OL_NAMESPACE = format("trino://%s:%s", URI.create(TRINO_URI).getHost(), URI.create(TRINO_URI).getPort());
            ...
            throws Exception
    {
        ...
        assertEventually(DURATION_10S, () -> assertCreateTableAsSelectFromTable(queryId, createTableQuery));
    }
            ...
            throws Exception
    {
        ...
        assertEventually(DURATION_10S, () -> assertCreateTableAsSelectFromView(
                createViewQueryId,
                createViewQuery,
                createTableQueryId,
                createTableQuery));
