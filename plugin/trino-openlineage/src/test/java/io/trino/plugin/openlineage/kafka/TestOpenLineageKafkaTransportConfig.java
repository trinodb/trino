...
final class TestOpenLineageKafkaTransportConfig
{
    ...
    void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("openlineage-event-listener.kafka-transport.client-config-overrides", "batch.size=32768,linger.ms=100")
        ...
        OpenLineageKafkaTransportConfig expected = new OpenLineageKafkaTransportConfig()
                ...
                .setKafkaClientOverrides("batch.size=32768,linger.ms=100")
