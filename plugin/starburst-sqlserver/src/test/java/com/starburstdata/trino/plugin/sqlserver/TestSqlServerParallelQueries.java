...
import static com.starburstdata.trino.plugin.sqlserver.StarburstSqlServerSessionProperties.PARALLEL_CONNECTIONS_COUNT;
        ...
        extends AbstractTestQueryFramework
{
    ...
    private void verifyTableSplitCount(String tableName, Optional<Integer> connectionsCount, int expectedSplits)
    {
        ...
        MaterializedResultWithPlan result = queryRunner.executeWithPlan(session, format("SELECT * FROM %s", tableName));
