...
public class DuckDbMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public DuckDbMetadataFactory(JdbcClient jdbcClient, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
    ...
    {
        return new DuckDbMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
