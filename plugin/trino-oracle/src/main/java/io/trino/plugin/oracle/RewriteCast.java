        ...
        extends AbstractRewriteCast
{
    ...
    protected boolean eligibleForPushdown(Type sourceType, Type targetType)
    {
        ...
        if (targetType instanceof VarcharType varcharType) {
            return !varcharType.isUnbounded()
                    ...
                    && varcharType.getLength().orElseThrow() <= ORACLE_VARCHAR2_MAX_CHARS
    ...
    private static boolean supportedSourceTypeToCastInVarchar(Type sourceType)
    {
        return sourceType instanceof TinyintType
    ...
    private static boolean supportedSourceTypeToCastInChar(Type sourceType)
    {
        return sourceType instanceof CharType
                || sourceType instanceof VarcharType;
    }
}
