        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testJulianGregorianDate()
    {
        ...
        try (TestTable table = createTable("test_julian_dt", "(ts date)")) {
    ...
    {
        try (TestTable table = createTable("test_unsupported_dt", "(ts date)")) {
            assertQueryFails(
    ...
    {
        // Oracle TO_DATE function returns +10 days during julian and gregorian calendar switch
        try (TestTable table = createTable("test_julian_ts", "(ts date)")) {
    ...
    {
        try (TestTable table = createTable("test_unsupported_ts", "(ts timestamp)")) {
            assertQueryFails(
