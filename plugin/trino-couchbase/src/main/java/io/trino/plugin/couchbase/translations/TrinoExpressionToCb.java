...
public class TrinoExpressionToCb
{
    ...
    private static ParametrizedString processCall(Call call, Map<String, ColumnHandle> assignments)
    {
        ...
        else if ("$and".equals(fname)) {
            return ParametrizedString.join(
                    convert(call.getArguments(), assignments), " AND ", "", "");
        }
        ...
        else if ("$modulus".equals(fname) || "mod".equals(fname) || "$modulo".equals(fname)) {
            return ParametrizedString.join(
                    convert(call.getArguments(), assignments),
                    " % ",
                    "",
        ...
        else if ("$greater_than_or_equal".equals(fname)) {
            return ParametrizedString.join(
                    convert(call.getArguments(), assignments),
                    " >= ",
                    "",
        ...
        else if ("$less_than_or_equal".equals(fname)) {
            return ParametrizedString.join(
                    convert(call.getArguments(), assignments),
                    " <= ",
                    "",
        ...
        else if ("$greater_than".equals(fname)) {
            return ParametrizedString.join(
                    convert(call.getArguments(), assignments),
                    " > ",
                    "",
    ...
    private static String getCastFn(Type type)
    {
        ...
        else if (type.getJavaType() == String.class || type.getJavaType() == Slice.class || type instanceof VarcharType) {
            return "TOSTRING";
        }
        else {
            throw new RuntimeException("Unsupported by Couchbase connector cast type: " + type);
        }
    }
