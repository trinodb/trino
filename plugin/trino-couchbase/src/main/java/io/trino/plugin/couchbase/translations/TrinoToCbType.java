...
public final class TrinoToCbType
{
    ...
    public static Object serialize(Type type, Object value)
    {
        ...
        if (type == DateType.DATE) {
        ...
        else if (type.equals(BigintType.BIGINT) || type.equals(DoubleType.DOUBLE) || type.equals(INTEGER) || type.equals(REAL)) {
            return value;
        }
            ...
            throw new RuntimeException("Unsupported by Couchbase trino value type: " + type);
        }
    }
