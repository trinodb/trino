...
//        }
    ...
    public SourcePage getNextSourcePage()
    {
        ...
        String queryString = String.format(
                "SELECT %s, META().id __trino_id FROM (%s) data",
        ...
        try {
            ...
            LOG.debug("Couchbase query ({} result rows): {}; arguments: {}", rows.size(), queryString, queryArgs);
        ...
        try {
            if (type == BooleanType.BOOLEAN) {
                ...
                if (type.equals(BigintType.BIGINT)) {
                    ...
                    // storing value as string to avoid precision loss
