...
public class SybaseConfig
{
    ...
    @Config("sybase.varchar-max-length")
    @ConfigDescription("Max length of varchar type in CREATE TABLE statement")
    public SybaseConfig setVarcharMaxLength(int varcharMaxLength)
    {
    ...
    @Config("sybase.iam-api-key")
    @ConfigSecuritySensitive
    @ConfigDescription("API key for IAM authentication")
    public SybaseConfig setApiKey(String apiKey)
    {
        this.apiKey = apiKey;
        return this;
    }
