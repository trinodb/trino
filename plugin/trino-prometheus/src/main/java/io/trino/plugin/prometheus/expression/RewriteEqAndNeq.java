...
public class RewriteEqAndNeq
        implements ConnectorExpressionRule<Call, ImmutableList<LabelFilterExpression>>
{
    ...
    public RewriteEqAndNeq()
    {
        pattern = call()
                .with(functionName().matching(fn -> ImmutableSet.of(
    ...
    @Override
    public Optional<ImmutableList<LabelFilterExpression>> rewrite(Call call, Captures captures, RewriteContext<ImmutableList<LabelFilterExpression>> context)
    {
