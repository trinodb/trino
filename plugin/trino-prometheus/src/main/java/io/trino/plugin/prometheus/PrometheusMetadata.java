        ...
        implements ConnectorMetadata
{
    ...
    public PrometheusTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName, Optional<ConnectorTableVersion> startVersion, Optional<ConnectorTableVersion> endVersion)
    {
        ...
        return new PrometheusTableHandle(tableName.getSchemaName(), tableName.getTableName(), Optional.empty(), ImmutableList.of());
    }
    ...
    public Optional<ConstraintApplicationResult<ConnectorTableHandle>> applyFilter(ConnectorSession session, ConnectorTableHandle handle, Constraint constraint)
    {
        ...
        ConnectorExpressionRewriter<ImmutableList<LabelFilterExpression>> rewriter = new ConnectorExpressionRewriter<>(LabelFilterExpression.APPLICABLE_EXPRESSION_RULES);
