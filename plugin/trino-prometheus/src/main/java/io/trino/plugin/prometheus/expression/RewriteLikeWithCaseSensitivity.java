        ...
        implements ConnectorExpressionRule<Call, ImmutableList<LabelFilterExpression>>
{
    ...
    @Override
    public Optional<ImmutableList<LabelFilterExpression>> rewrite(Call expression, Captures captures, RewriteContext<ImmutableList<LabelFilterExpression>> context)
    {
