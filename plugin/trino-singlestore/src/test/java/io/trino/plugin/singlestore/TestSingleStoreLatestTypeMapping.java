        ...
        extends BaseSingleStoreTypeMapping
{
    ...
    {
        try (TestTable table = createTable("tpch.test_unsupported_tinyint", "(value tinyint)")) {
    ...
    {
        try (TestTable table = createTable("tpch.test_unsupported_smallint", "(value smallint)")) {
    ...
    {
        try (TestTable table = createTable("tpch.test_unsupported_integer", "(value integer)")) {
    ...
    {
        try (TestTable table = createTable("tpch.test_unsupported_bigint", "(value bigint)")) {
