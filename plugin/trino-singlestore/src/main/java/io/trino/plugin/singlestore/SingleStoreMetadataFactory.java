...
public class SingleStoreMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public SingleStoreMetadataFactory(JdbcClient jdbcClient, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
    ...
    {
        return new SingleStoreMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
