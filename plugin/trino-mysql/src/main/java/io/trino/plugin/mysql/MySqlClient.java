        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public MySqlClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, TypeManager typeManager, QueryBuilder queryBuilder, IdentifierMapping identifierMapping)
    {
