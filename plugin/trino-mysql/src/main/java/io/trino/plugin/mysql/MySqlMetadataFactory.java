        ...
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public MySqlMetadataFactory(MySqlClient mySqlClient, VersioningService versioningService)
    {
        super(mySqlClient);
    ...
    {
        return new MySqlMetadata(transactionCachingJdbcClient, versioningService);
    }
}
