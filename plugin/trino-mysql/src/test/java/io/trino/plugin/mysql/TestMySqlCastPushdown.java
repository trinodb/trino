        ...
        extends BaseJdbcCastPushdownTest
{
    ...
    void testCastPushdownOutOfRangeValue()
    {
        CastDataTypeTestTable table = closeAfterClass(CastDataTypeTestTable.create(1)
                ...
                .addColumn("c_double_5", "double precision", List.of("2147483647.94"))
                .addColumn("c_double_6", "double precision", List.of("-2147483649.49"))
                .addColumn("c_double_7", "double precision", List.of("9223372036854775808.49"))
                .addColumn("c_double_8", "double precision", List.of("-9223372036854775810.94"))
    ...
    protected List<CastTestCase> supportedCastTypePushdown()
    {
        return ImmutableList.<CastTestCase>builder()
                ...
                // Cast from all types (boolean, tinyint, smallint, integer, bigint, float, real, double, decimal, numeric) to (integer) using cast type 'real'
                .add(new CastTestCase("c_boolean", "real", "c_integer"))
                .add(new CastTestCase("c_tinyint", "real", "c_integer"))
                .add(new CastTestCase("c_smallint", "real", "c_integer"))
                .add(new CastTestCase("c_integer", "real", "c_integer"))
                .add(new CastTestCase("c_bigint", "real", "c_integer"))
                .add(new CastTestCase("c_float", "real", "c_integer"))
                .add(new CastTestCase("c_real", "real", "c_integer"))
                .add(new CastTestCase("c_double_precision", "real", "c_integer"))
                .add(new CastTestCase("c_double_precision_negative", "real", "c_integer"))
                .add(new CastTestCase("c_decimal_10_2", "real", "c_integer"))
                .add(new CastTestCase("c_numeric_30_2", "real", "c_tinyint"))
                ...
                // Cast from all types (boolean, tinyint, smallint, integer, bigint, float, real, double, decimal, numeric) to (float) using cast type 'decimal'
                .add(new CastTestCase("c_boolean", "decimal", "c_float"))
                .add(new CastTestCase("c_tinyint", "decimal", "c_float"))
                .add(new CastTestCase("c_smallint", "decimal", "c_float"))
                .add(new CastTestCase("c_integer", "decimal", "c_float"))
                .add(new CastTestCase("c_bigint", "decimal", "c_float"))
                .add(new CastTestCase("c_float", "decimal", "c_float"))
                .add(new CastTestCase("c_real", "decimal", "c_float"))
                .add(new CastTestCase("c_double_precision", "decimal", "c_float"))
                .add(new CastTestCase("c_double_precision_negative", "decimal", "c_float"))
                .add(new CastTestCase("c_decimal_10_2", "decimal", "c_float"))
                .add(new CastTestCase("c_numeric_30_2", "decimal", "c_float"))

                // Cast from all types (boolean, tinyint, smallint, integer, bigint, float, real, double, decimal, numeric) to (double) using cast type 'real'
                .add(new CastTestCase("c_boolean", "real", "c_double_precision"))
                .add(new CastTestCase("c_tinyint", "real", "c_double_precision"))
                .add(new CastTestCase("c_smallint", "real", "c_double_precision"))
                .add(new CastTestCase("c_integer", "real", "c_double_precision"))
                .add(new CastTestCase("c_bigint", "real", "c_double_precision"))
                .add(new CastTestCase("c_float", "real", "c_double_precision"))
                .add(new CastTestCase("c_real", "real", "c_double_precision"))
                .add(new CastTestCase("c_double_precision", "real", "c_double_precision"))
                .add(new CastTestCase("c_double_precision_negative", "real", "c_double_precision"))
                .add(new CastTestCase("c_decimal_10_2", "real", "c_double_precision"))
                .add(new CastTestCase("c_numeric_30_2", "real", "c_double_precision"))

                // Cast from all types (boolean, tinyint, smallint, integer, bigint, float, real, double, decimal, numeric) to (numeric) using cast type 'double'
                .add(new CastTestCase("c_boolean", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_tinyint", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_smallint", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_integer", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_bigint", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_float", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_real", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_double_precision", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_double_precision_negative", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_decimal_10_2", "double", "c_numeric_30_2"))
                .add(new CastTestCase("c_numeric_30_2", "double", "c_numeric_30_2"))

                // Cast from all types (boolean, tinyint, smallint, integer, bigint, float, real, double, decimal, numeric) to (decimal) using cast type 'decimal'
                .add(new CastTestCase("c_boolean", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_tinyint", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_smallint", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_integer", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_bigint", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_float", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_real", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_double_precision", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_double_precision_negative", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_decimal_10_2", "decimal", "c_decimal_10_2"))
                .add(new CastTestCase("c_numeric_30_2", "decimal", "c_decimal_10_2"))
                .build();
    }
    ...
    {
        return ImmutableList.<CastTestCase>builder()
                // Using cast type 'tinyint' is not supported in mysql, irrespective of source or target columns
                ...
                // Using cast type 'smallint' is not supported in mysql, irrespective of source or target columns
                ...
                // Using cast type 'integer' is not supported in mysql, irrespective of source or target columns
                ...
                // Using cast type 'bigint' is not supported in mysql, irrespective of source or target columns
