...
public class TestingDorisContainer
        extends JdbcDatabaseContainer<TestingDorisContainer>
{
    private static final String STARROCKS_IMAGE = "starrocks/allin1-ubuntu:2.5.6";

    public TestingDorisContainer()
    {
    ...
    @Override
    public TestingDorisContainer withUrlParam(String paramName, String paramValue)
    {
