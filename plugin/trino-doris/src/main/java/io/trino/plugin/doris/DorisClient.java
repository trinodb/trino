...
{
    private static final Logger log = Logger.get(DorisClient.class);
    ...
    private static final PredicatePushdownController SQL_CHARACTER_PUSHDOWN = (session, domain) -> {
            ...
            RemoteQueryModifier queryModifier)
    {
        ...
        this.datetimeColumnSize = dorisConfig.getDatetimeColumnSize();
        this.forceAggregationPushdown = dorisConfig.isForceAggregationPushdown();
        this.forceTopNPushdown = dorisConfig.isForceTopNPushdown();
    ...
    {
        if (this.forceAggregationPushdown) {
            return true;
        }
    ...
    public Optional<ColumnMapping> toColumnMapping(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        switch (typeHandle.jdbcType()) {
            ...
            case Types.TIMESTAMP:
                TimestampType timestampType = createTimestampType(getTimestampPrecision(typeHandle.columnSize().orElse(datetimeColumnSize)));
    ...
    {
        PredicatePushdownController pushdownController = SQL_CHARACTER_PUSHDOWN;
    ...
    public void createTable(ConnectorSession session, ConnectorTableMetadata tableMetadata)
    {
        try {
            ...
            boolean exists = e.getErrorCode() == ER_TABLE_EXISTS_ERROR;
