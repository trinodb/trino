        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testMergeDoesNotDoubleCount()
    {
        ...
        left.setSketch(toSketchSlice(new int[] {1, 2, 3}, DEFAULT_UPDATE_SEED, DEFAULT_ENTRIES));

        SketchState right = factory.createSingleState();
        right.setNominalEntries(DEFAULT_ENTRIES);
        right.setSeed(DEFAULT_UPDATE_SEED);
        right.setSketch(toSketchSlice(new int[] {3, 4, 5}, DEFAULT_UPDATE_SEED, DEFAULT_ENTRIES));
    ...
    public void testMergeWithEmptyStateDoesNotFail()
    {
        ...
        populated.setSketch(toSketchSlice(new int[] {1, 2, 3, 4}, DEFAULT_UPDATE_SEED, DEFAULT_ENTRIES));
