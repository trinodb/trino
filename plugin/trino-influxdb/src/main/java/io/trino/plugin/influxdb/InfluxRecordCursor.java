        ...
        implements RecordCursor
{
    ...
    public InfluxRecordCursor(List<InfluxColumnHandle> columnHandles, InfluxRecord sourceData)
    {
        ...
        boolean noTimeCol = columnHandles.stream().noneMatch(columnHandle -> columnHandle.name().equals(TIME.getName()));
        ...
        List<String> names = columnHandles.stream().map(InfluxColumnHandle::name).toList();
