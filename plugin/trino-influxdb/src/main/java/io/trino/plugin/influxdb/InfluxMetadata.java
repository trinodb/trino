...
{
    private final NativeInfluxClient client;

    @Inject
    public InfluxMetadata(NativeInfluxClient client)
    {
    ...
    public List<SchemaTableName> listTables(ConnectorSession session, Optional<String> optionalSchemaName)
    {
        ...
        return schemaNames.stream()
                .flatMap(schemaName -> client.listTables(schemaName).stream())
    ...
    private ConnectorTableHandle getTableHandle(SchemaTableName schemaTableName)
    {
        return client.findTableHandle(schemaTableName.getSchemaName(), schemaTableName.getTableName())
                .map(_ -> InfluxTableHandle.of(schemaTableName.getSchemaName(), schemaTableName.getTableName())).orElse(null);
    }
