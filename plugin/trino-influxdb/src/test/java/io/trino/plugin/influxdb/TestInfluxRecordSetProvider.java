...
public class TestInfluxRecordSetProvider
{
    ...
    private static NativeInfluxClient client;
    ...
    public void testGetRecordSet()
    {
        ...
        assertThat(influxRecordSet.getSourceData().columns().containsAll(
                ImmutableList.of("time", "f1", "f2", "f3", "f4", "country"))).isTrue();
        assertThat(influxRecordSet.getSourceData().values().size()).isEqualTo(100);
    }
}
