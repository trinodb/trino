...
public class InfluxDataTool
{
    ...
    public static final String TEST_DATABASE_TEMPORARY = "test_database_temporary";
    public static final String TEST_MEASUREMENT_W = "test_measurement_w";
    ...
    {
        setUpDatabase(ImmutableList.of(TEST_DATABASE, TEST_DATABASE_ANOTHER));
    }
    ...
    {
        setUpDataForTest(TEST_DATABASE, ImmutableList.of(TEST_MEASUREMENT_X, TEST_MEASUREMENT_Y));
        setUpDataForTest(TEST_DATABASE_ANOTHER, ImmutableList.of(TEST_MEASUREMENT_Z));
    }
        ...
        for (String tableName : tableNames) {
            for (int i = 0; i < 100; i++) {
                Point.Builder builder = Point.measurement(tableName)
                        ...
                        .time(start + i * 1000L, TimeUnit.MILLISECONDS);
