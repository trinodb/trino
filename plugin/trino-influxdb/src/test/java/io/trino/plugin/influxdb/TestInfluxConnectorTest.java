        ...
        extends BaseConnectorTest
{
    ...
    protected boolean hasBehavior(TestingConnectorBehavior connectorBehavior)
    {
        return switch (connectorBehavior) {
            ...
            case SUPPORTS_RENAME_SCHEMA, SUPPORTS_CREATE_VIEW, SUPPORTS_CREATE_MATERIALIZED_VIEW,
                 SUPPORTS_CREATE_TABLE, SUPPORTS_RENAME_TABLE,
                 SUPPORTS_ADD_COLUMN, SUPPORTS_RENAME_COLUMN, SUPPORTS_SET_COLUMN_TYPE,
                 SUPPORTS_COMMENT_ON_TABLE, SUPPORTS_COMMENT_ON_COLUMN,
                 SUPPORTS_INSERT, SUPPORTS_UPDATE, SUPPORTS_DELETE, SUPPORTS_MERGE,
                 SUPPORTS_ARRAY, SUPPORTS_ROW_TYPE -> false;
