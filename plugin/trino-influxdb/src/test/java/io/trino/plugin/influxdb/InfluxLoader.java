        ...
        extends AbstractTestingTrinoClient<Void>
{
            ...
            implements ResultsSession<Void>
    {
        ...
        public void addResults(QueryStatusInfo statusInfo, ResultRows data)
        {
            ...
            BatchPoints.Builder points = BatchPoints.database(schemaName);
            for (List<Object> fields : data) {
                ...
                Point.Builder pointBuilder = Point.measurement(tableName).time(timestamp++, MILLISECONDS);
            ...
            session.writeBatch(schemaName, points.build());
        }
