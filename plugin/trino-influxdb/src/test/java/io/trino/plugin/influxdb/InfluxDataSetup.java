        ...
        implements DataSetup
{
    ...
    public InfluxDataSetup(TrinoSqlExecutor trinoSqlExecutor, InfluxSession session, String tableNamePrefix)
    {
    ...
    {
        TestingInfluxTable testTable = new TestingInfluxTable(trinoSqlExecutor, this.tableNamePrefix);
        try {
    ...
    {
        Map<String, Object> nullValueFields = HashMap.newHashMap(inputs.size());
