...
public class TestInfluxConfig
{
    ...
    public void testValidation()
    {
        ...
        assertFailsValidation(
                new InfluxConfig().setEndpoint("http://localhost:8086").setUsername("testuser").setPassword("testpass").setInsecureAllowed(false),
                "secureWhenCredentialsConfigured",
                "Credentials require HTTPS. Set 'influx.insecure-allowed=true' to permit HTTP.",
                AssertTrue.class);
    }
