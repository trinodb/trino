...
import static io.trino.plugin.hudi.util.TupleDomainUtils.extractPredicatesForColumns;
...
public class HudiRecordLevelIndexSupportTest
{
    ...
    public void testExtractPredicatesForColumns_None()
    {
        ...
        TupleDomain<String> result = TupleDomainUtils.extractPredicatesForColumns(tupleDomain, columns);
    ...
    public void testConstructRecordKeys_WithInClause()
    {
        ...
        List<String> result = TupleDomainUtils.constructRecordKeys(recordKeyDomains, recordKeys);
