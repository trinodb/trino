        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testTimelineTable()
    {
        ...
        assertQuery(
                "SELECT timestamp, action, state FROM tests.\"hudi_cow_pt_tbl$timeline\"",
                "VALUES ('20220906063435640', 'commit', 'COMPLETED'), ('20220906063456550', 'commit', 'COMPLETED')");

        assertQueryFails(
                "SELECT timestamp, action, state FROM tests.\"non_existing$timeline\"",
    ...
    {
        assertQueryFails(
                "SELECT * FROM tests.\"hudi_cow_pt_tbl$data\"",
    ...
    {
        assertQueryFails(
                "SELECT * FROM tests.\"hudi_cow_pt_tbl$invalid\"",
