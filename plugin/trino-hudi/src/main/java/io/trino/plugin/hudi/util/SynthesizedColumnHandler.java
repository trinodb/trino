...
public class SynthesizedColumnHandler
{
    ...
    public static class SplitMetadata
    {
        ...
        /**
         * Creates SplitMetadata from a Hudi split.
         */
        ...
        public SplitMetadata(HudiSplit hudiSplit)
        {
            ...
            this.filePath = hudiSplit.getLocation();
            this.fileSize = hudiSplit.getFileSize();
            this.modifiedTime = hudiSplit.getFileModifiedTime();
        }
