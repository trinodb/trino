 ...
 *   <li>This class reads the merged-record iterator one page at a time and converts each record back
 *       to a Trino {@link io.trino.spi.Page} via {@link io.trino.plugin.hudi.util.HudiAvroSerializer}.</li>
        ...
        implements ConnectorPageSource
{
    ...
    {
        while (fileGroupReaderIterator.hasNext() && !pageBuilder.isFull()) {
