    ...
    static {
        try {
            EXCLUSIONS = ImmutableSet.<Method>builder()
                    ...
                    .add(ConnectorMetadata.class.getMethod("canonicalize", String.class, boolean.class))
                    .add(ConnectorMetadata.class.getMethod("compare", String.class))
                    .add(ConnectorMetadata.class.getMethod("compareSchema", String.class))
                    .add(ConnectorMetadata.class.getMethod("compareTable", String.class))
                    .add(ConnectorMetadata.class.getMethod("compareColumn", String.class))
                    .add(ConnectorMetadata.class.getMethod("predicate", String.class))
                    .build();
        }
