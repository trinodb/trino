...
import io.trino.testing.BaseConnectorSmokeCoverage;
...
public abstract class BaseLakehouseConnectorSmokeCoverage
        extends BaseConnectorSmokeCoverage
{
    ...
    protected BaseLakehouseConnectorSmokeCoverage(TableType tableType)
    {
    ...
    protected QueryRunner createQueryRunner()
            throws Exception
    {
        HiveFlociDataLake hiveFloci = closeAfterClass(new Hive3FlociDataLake(bucketName));
        hiveFloci.start();
