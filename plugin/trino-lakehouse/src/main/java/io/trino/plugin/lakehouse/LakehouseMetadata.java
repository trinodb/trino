        ...
        implements ConnectorMetadata
{
    ...
    {
        verify(left.getClass() == right.getClass(), "mismatched partitioning handles: %s <> %s", left.getClass().getName(), right.getClass().getName());
    ...
    {
        return forHandle(table).getInfo(table);
    }
