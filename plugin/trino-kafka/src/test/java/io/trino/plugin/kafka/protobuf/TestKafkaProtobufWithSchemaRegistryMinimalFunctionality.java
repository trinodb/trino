        ...
        extends AbstractTestQueryFramework
{
    ...
    private static String getExpectedValues(List<ProducerRecord<DynamicMessage, DynamicMessage>> messages, Descriptors.Descriptor descriptor, boolean isKeyIncluded)
    {
    ...
    private static void addExpectedColumns(Descriptors.Descriptor descriptor, DynamicMessage message, ImmutableList.Builder<String> columnsBuilder)
    {
        for (Descriptors.FieldDescriptor field : descriptor.getFields()) {
            Descriptors.FieldDescriptor fieldDescriptor = message.getDescriptorForType().findFieldByName(field.getName());
    ...
    private static Descriptors.Descriptor getInitialSchema()
            throws Exception
    {
        return getDescriptor("initial_schema.proto");
    }

    private static Descriptors.Descriptor getEvolvedSchema()
            throws Exception
    {
        return getDescriptor("evolved_schema.proto");
    }

    private static Descriptors.Descriptor getKeySchema()
            throws Exception
    {
        return getDescriptor("key_schema.proto");
    }

    public static Descriptors.Descriptor getDescriptor(String fileName)
            throws Exception
    {
    ...
    private static List<ProducerRecord<DynamicMessage, DynamicMessage>> createMessages(String topicName, int messageCount, boolean useInitialSchema, Descriptors.Descriptor descriptor, Descriptors.Descriptor keyDescriptor)
    {
    ...
    private static DynamicMessage createKeySchema(long key, Descriptors.Descriptor descriptor)
    {
    ...
    private static DynamicMessage createRecordWithInitialSchema(long key, Descriptors.Descriptor descriptor)
    {
        return DynamicMessage.newBuilder(descriptor)
    ...
    private static DynamicMessage createRecordWithEvolvedSchema(long key, Descriptors.Descriptor descriptor)
    {
        return DynamicMessage.newBuilder(descriptor)
                .setField(descriptor.findFieldByName("col_1"), format("string-%s", key))
                .setField(descriptor.findFieldByName("col_2"), multiplyExact(key, 100))
