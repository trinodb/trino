...
import static io.trino.plugin.kafka.protobuf.ProtobufUtils.getProtoFile;
...
public class TestProtobufDecoder
{
    ...
    private RowDecoder createRowDecoder(String fileName, Set<DecoderColumnHandle> columns)
            throws Exception
    {
        return DECODER_FACTORY.create(ImmutableMap.of("dataSchema", getProtoFile("protobuf/" + fileName)), columns);
    }
