...
import static io.trino.plugin.kafka.protobuf.ProtobufErrorCode.INVALID_PROTOBUF_MESSAGE;
import static io.trino.plugin.kafka.protobuf.ProtobufErrorCode.INVALID_PROTO_FILE;
import static io.trino.plugin.kafka.protobuf.ProtobufRowDecoderFactory.DEFAULT_MESSAGE;
import static io.trino.plugin.kafka.protobuf.ProtobufUtils.getFileDescriptor;
        ...
        implements DynamicMessageProvider
{
            ...
            implements DynamicMessageProvider.Factory
    {
        ...
        public DynamicMessageProvider create(Optional<String> protoFile)
        {
            ...
            try {
                Descriptor descriptor = getFileDescriptor(protoFile.get()).findMessageTypeByName(DEFAULT_MESSAGE);
