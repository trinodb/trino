        ...
        extends AbstractTestQueryFramework
{
    ...
    @Test
    void testSelectOptionsProperty()
    {
        @Language("SQL")
        String tableQuery =
                """
                CREATE TABLE faker.default.all_types_options (
                rnd_bigint bigint NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_integer integer NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_smallint smallint NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_tinyint tinyint NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_boolean boolean NOT NULL WITH (options = ARRAY['true', 'false']),
                rnd_date date NOT NULL WITH (options = ARRAY['2022-03-01', '2022-03-02']),
                rnd_decimal1 decimal NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_decimal2 decimal(18,5) NOT NULL WITH (options = ARRAY['0.00000', '0.00001']),
                rnd_decimal3 decimal(38,0) NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_decimal4 decimal(38,38) NOT NULL WITH (options = ARRAY['0.00000000000000000000000000000000000000', '0.00000000000000000000000000000000000001']),
                rnd_decimal5 decimal(5,2) NOT NULL WITH (options = ARRAY['0.00', '0.01']),
                rnd_real real NOT NULL WITH (options = ARRAY['0.0', '1.4E-45']),
                rnd_double double NOT NULL WITH (options = ARRAY['0.0', '4.9E-324']),
                rnd_interval_day_time interval day to second NOT NULL WITH (options = ARRAY['0.000', '0.001']),
                rnd_interval_year interval year to month NOT NULL WITH (options = ARRAY['0', '1']),
                rnd_timestamp timestamp NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000', '2022-03-21 00:00:00.001']),
                rnd_timestamp0 timestamp(0) NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00', '2022-03-21 00:00:01']),
                rnd_timestamp6 timestamp(6) NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000000', '2022-03-21 00:00:00.000001']),
                rnd_timestamp9 timestamp(9) NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000000000', '2022-03-21 00:00:00.000000001']),
                rnd_timestamptz timestamp with time zone NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000 +01:00', '2022-03-21 00:00:00.001 +01:00']),
                rnd_timestamptz0 timestamp(0) with time zone NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00 +01:00', '2022-03-21 00:00:01 +01:00']),
                rnd_timestamptz6 timestamp(6) with time zone NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000000 +01:00', '2022-03-21 00:00:00.000001 +01:00']),
                rnd_timestamptz9 timestamp(9) with time zone NOT NULL WITH (options = ARRAY['2022-03-21 00:00:00.000000000 +01:00', '2022-03-21 00:00:00.000000001 +01:00']),
                rnd_time time NOT NULL WITH (options = ARRAY['01:02:03.456', '01:02:03.457']),
                rnd_time0 time(0) NOT NULL WITH (options = ARRAY['01:02:03', '01:02:04']),
                rnd_time6 time(6) NOT NULL WITH (options = ARRAY['01:02:03.000456', '01:02:03.000457']),
                rnd_time9 time(9) NOT NULL WITH (options = ARRAY['01:02:03.000000456', '01:02:03.000000457']),
                rnd_timetz time with time zone NOT NULL WITH (options = ARRAY['01:02:03.456 +01:00', '01:02:03.457 +01:00']),
                rnd_timetz0 time(0) with time zone NOT NULL WITH (options = ARRAY['01:02:03 +01:00', '01:02:04 +01:00']),
                rnd_timetz6 time(6) with time zone NOT NULL WITH (options = ARRAY['01:02:03.000456 +01:00', '01:02:03.000457 +01:00']),
                rnd_timetz9 time(9) with time zone NOT NULL WITH (options = ARRAY['01:02:03.000000456 +01:00', '01:02:03.000000457 +01:00']),
                rnd_timetz12 time(12) with time zone NOT NULL,
                rnd_varbinary varbinary NOT NULL WITH (options = ARRAY['ff', '00']),
                rnd_varchar varchar NOT NULL WITH (options = ARRAY['aa', 'bb']),
                rnd_nvarchar varchar(1000) NOT NULL WITH (options = ARRAY['aa', 'bb']),
                rnd_ipaddress ipaddress NOT NULL WITH (options = ARRAY['0.0.0.0', '1.2.3.4']),
                rnd_uuid uuid NOT NULL WITH (options = ARRAY['1fc74d96-0216-449b-a145-455578a9eaa5', '3ee49ede-0026-45e4-ba06-08404f794557']))
                """;
        assertUpdate(tableQuery);
        ...
        assertUpdate("DROP TABLE faker.default.all_types_options");
    }
}
