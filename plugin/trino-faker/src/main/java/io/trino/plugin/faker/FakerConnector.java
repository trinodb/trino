...
import static io.trino.plugin.faker.ColumnInfo.OPTIONS_PROPERTY;
        ...
        implements Connector
{
    ...
    public List<PropertyMetadata<?>> getColumnProperties()
    {
        return ImmutableList.of(
                ...
                stringProperty(
                        MIN_PROPERTY,
                        "Minimum constraint for generated values, inclusive",
                        null,
                        false),
                stringProperty(
                        MAX_PROPERTY,
                        "Maximum constraint for generated values, inclusive",
                        null,
                        false),
