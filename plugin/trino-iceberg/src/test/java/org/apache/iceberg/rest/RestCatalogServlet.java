 ...
 */
// forked from org.apache.iceberg.rest.RESTCatalogServlet
public class RestCatalogServlet
        extends HttpServlet
{
    private static final Logger LOG = Logger.get(RestCatalogServlet.class);
            ...
            throws IOException
    {
        ...
        try {
            ...
            LOG.error(e, "Error processing REST request");
