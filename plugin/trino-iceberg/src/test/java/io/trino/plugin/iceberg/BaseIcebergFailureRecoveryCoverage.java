...
public abstract class BaseIcebergFailureRecoveryCoverage
        extends BaseFailureRecoveryCoverage
{
    protected BaseIcebergFailureRecoveryCoverage(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
    ...
    // Copied from BaseDeltaFailureRecoveryCoverage
    @Test
    @Override
