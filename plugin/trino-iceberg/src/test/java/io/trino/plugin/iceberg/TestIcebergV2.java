        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testCreateTableWithMultiIdentifierFields()
    {
        try (TestTable table = newTrinoTable("test_identifier_fields",
            ...
            List<String> identifierFieldNames = icebergTable.schema().identifierFieldNames().stream().sorted().collect(Collectors.toList());
            ...
            identifierFieldNames = icebergTable.schema().identifierFieldNames().stream().sorted().collect(Collectors.toList());
