...
final class TestIcebergGcsVendingRestCatalogConnectorSmokeCoverage
        extends BaseIcebergConnectorSmokeCoverage
{
    private static final Logger LOG = Logger.get(TestIcebergGcsVendingRestCatalogConnectorSmokeCoverage.class);
    ...
    public TestIcebergGcsVendingRestCatalogConnectorSmokeCoverage()
    {
