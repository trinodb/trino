        ...
        extends BaseConnectorSmokeTest
{
            ...
            throws Exception
    {
        ...
        String metadataLocation = getMetadataLocation(tableName);
        TableMetadata tableMetadata = TableMetadataParser.read(trinoFileSystem.toFileIo(), metadataLocation);
            ...
            throws Exception
    {
        ...
        String metadataLocation = getMetadataLocation(tableName);
        TableMetadata tableMetadata = TableMetadataParser.read(trinoFileSystem.toFileIo(), metadataLocation);
        String manifestListFile = tableMetadata.currentSnapshot().allManifests(trinoFileSystem.toFileIo()).get(0).path();
