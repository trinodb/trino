 ...
 */
@Disabled("Measures wall time rather than asserting it, so there is nothing here for CI to check")
...
class TestDeleteManagerParallelLoading
{
            ...
            throws Exception
    {
        ...
        DeleteManager deleteManager = new DeleteManager(TESTING_TYPE_MANAGER, Optional.of(BLOCKS_HASH_FACTORY), () -> {}, loadingExecutor);
    ...
    private static DeletePageSourceProvider deleteReads()
    {
        IcebergPageSourceProvider pageSourceProvider = new IcebergPageSourceProvider(
                ...
                Optional.of(BLOCKS_HASH_FACTORY),
