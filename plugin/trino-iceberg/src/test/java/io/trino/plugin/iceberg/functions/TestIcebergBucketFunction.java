...
final class TestIcebergBucketFunction
{
    ...
    void testIntegerTypes()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "CAST(null as INTEGER)", "16"))
                .isNull();
    }
    ...
    void testDecimalType()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "1110000000000000000000000.0", "16"))
                .hasType(IntegerType.INTEGER)
                .isEqualTo(10);

        assertThat(assertions.function("iceberg_bucket", "CAST(null as DECIMAL(5, 2))", "16"))
                .isNull();

        assertThat(assertions.function("iceberg_bucket", "CAST(null as DECIMAL(24, 2))", "16"))
                .isNull();
    }
    ...
    void testVarcharType()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "CAST(null AS VARCHAR)", "16"))
                .isNull();
    }
    ...
    void testDateType()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "CAST(null as DATE)", "16"))
                .isNull();
    }
    ...
    void testTimestampType()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "CAST(null as TIMESTAMP)", "16"))
                .isNull();
    }
    ...
    void testTimestampWithTimeZoneType()
    {
        ...
        assertThat(assertions.function("iceberg_bucket", "CAST(null as TIMESTAMP WITH TIME ZONE)", "16"))
                .isNull();
    }
