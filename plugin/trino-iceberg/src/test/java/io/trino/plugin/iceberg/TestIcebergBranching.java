        ...
        extends AbstractTestQueryFramework
{
    ...
    void testDropBranch()
    {
        try (TestTable table = new TestTable(getQueryRunner()::execute, "test_drop_branch", "(x int)")) {
            ...
            assertQueryFails("DROP BRANCH \"test-branch\" IN TABLE " + table.getName(), "Branch 'test-branch' does not exit");
    ...
    void testFastForwardNotAncestor()
    {
        try (TestTable table = new TestTable(getQueryRunner()::execute, "test_fast_forward", "(x int)")) {
            ...
            assertQueryFails(
                    "ALTER BRANCH main IN TABLE " + table.getName() + " FAST FORWARD TO \"test-branch\"",
