            ...
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = IcebergQueryRunner.builder()
                ...
                .setIcebergProperties(Map.of(
                        ...
                        "hive.metastore.uri", "thrift://" + dataLake.getHiveHadoop().getHiveMetastoreEndpoint(),
                        "hive.s3.aws-access-key", MINIO_ACCESS_KEY,
                        "hive.s3.aws-secret-key", MINIO_SECRET_KEY,
                        "hive.s3.endpoint", dataLake.getMinio().getMinioAddress(),
                ...
                .setSchemaInitializer(
                        SchemaInitializer.builder()
                                ...
                                .build())
                .build();
        fileSystemFactory = new HdfsFileSystemFactory(new HdfsEnvironment(
        ...
        tableOperationsProvider = new HiveMetastoreTableOperationsProvider(fileSystemFactory, new ThriftMetastoreFactory()
        {
            @Override
