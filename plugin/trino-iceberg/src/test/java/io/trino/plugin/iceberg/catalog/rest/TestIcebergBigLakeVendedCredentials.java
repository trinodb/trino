        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        // Not managed by the connector's Guice injector, so close explicitly instead of relying on its lifecycle
        closeAfterClass(fileSystemFactory::stop);
        closeAfterClass(storageFactory::stop);
