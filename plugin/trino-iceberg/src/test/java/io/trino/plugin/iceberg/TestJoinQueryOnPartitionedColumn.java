        ...
        extends AbstractTestQueryFramework
{
    ...
    public void setUp()
    {
        ...
        assertUpdate("INSERT INTO test_schema.test_table VALUES (0, CAST('2019-09-08' AS TIMESTAMP(6) with time zone), (1, 1)), " +
                "(1, CAST('2020-09-09' AS TIMESTAMP(6) with time zone), (1, 1)), " +
                "(2, CAST('2021-09-09' AS TIMESTAMP(6) with time zone), (1, 1))", 3);
        assertUpdate("INSERT INTO test_schema.test_table VALUES (15, CAST('2019-09-08' AS TIMESTAMP(6) with time zone), (1, 1)), " +
                "(20, CAST('2020-09-09' AS TIMESTAMP(6) with time zone), (1, 1)), " +
                "(50, CAST('2021-09-09' AS TIMESTAMP(6) with time zone), (1, 1))", 3);
