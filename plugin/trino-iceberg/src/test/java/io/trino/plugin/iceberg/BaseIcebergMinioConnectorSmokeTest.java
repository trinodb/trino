        ...
        return IcebergQueryRunner.builder()
                .setIcebergProperties(
                        ImmutableMap.<String, String>builder()
                                ...
                                .put("aws.s3.aws-access-key", ACCESS_KEY)
                                .put("aws.s3.aws-secret-key", SECRET_KEY)
                                .put("aws.s3.endpoint", "http://" + hiveMinioDataLake.getMinio().getMinioApiEndpoint())
                                .put("aws.s3.path-style-access", "true")
                                .put("aws.s3.streaming.part-size", "5MB")
                                .buildOrThrow())
