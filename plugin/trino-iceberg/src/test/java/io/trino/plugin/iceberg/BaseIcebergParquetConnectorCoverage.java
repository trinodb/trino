...
public abstract class BaseIcebergParquetConnectorCoverage
        extends BaseIcebergConnectorCoverage
{
    public BaseIcebergParquetConnectorCoverage(int formatVersion)
    {
