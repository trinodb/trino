...
public class TestIcebergGcsConnectorSmokeCoverage
        extends BaseIcebergConnectorSmokeCoverage
{
    private static final Logger LOG = Logger.get(TestIcebergGcsConnectorSmokeCoverage.class);
    ...
    public TestIcebergGcsConnectorSmokeCoverage()
    {
        super(ORC);
