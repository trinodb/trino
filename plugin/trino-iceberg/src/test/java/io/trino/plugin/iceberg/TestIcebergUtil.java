...
public class TestIcebergUtil
{
    ...
    public void testParseVersion()
    {
        ...
        assertEquals(parseVersion("s3://krvikash-test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/v14.metadata.json"), OptionalInt.of(14));
        ...
        assertThatThrownBy(() -> parseVersion("s3://krvikash-test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/v1_metadata_json"))
                .hasMessageMatching("Invalid metadata file: v1_metadata_json");
        assertThatThrownBy(() -> parseVersion("v10_metadata_json")).hasMessageMatching("Invalid metadata file: v10_metadata_json");
        ...
        assertEquals(parseVersion("/var/test/test_icerberg_util/orders_93p93eniuw-30fa27a68c734c2bafac881e905351a9/metadata/v10m.metadata.json"), OptionalInt.empty());
    }
}
