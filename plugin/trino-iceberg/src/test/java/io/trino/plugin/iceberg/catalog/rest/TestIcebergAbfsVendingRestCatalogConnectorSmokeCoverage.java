...
final class TestIcebergAbfsVendingRestCatalogConnectorSmokeCoverage
        extends BaseIcebergConnectorSmokeCoverage
{
    private static final Logger LOG = Logger.get(TestIcebergAbfsVendingRestCatalogConnectorSmokeCoverage.class);
    ...
    public TestIcebergAbfsVendingRestCatalogConnectorSmokeCoverage()
    {
