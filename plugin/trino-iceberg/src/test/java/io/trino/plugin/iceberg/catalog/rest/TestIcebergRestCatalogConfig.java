...
public class TestIcebergRestCatalogConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(IcebergRestCatalogConfig.class)
                ...
                .setCaseInsensitiveNameMatchingForTables(null)
                .setCaseInsensitiveNameMatchingForNamespaces(null)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("iceberg.rest-catalog.case-insensitive-name-matching.tables", "true")
                .put("iceberg.rest-catalog.case-insensitive-name-matching.namespaces", "true")
        ...
        IcebergRestCatalogConfig expected = new IcebergRestCatalogConfig()
                ...
                .setCaseInsensitiveNameMatchingForTables(true)
                .setCaseInsensitiveNameMatchingForNamespaces(true)
