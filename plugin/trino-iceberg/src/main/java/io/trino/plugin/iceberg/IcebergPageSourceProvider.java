...
//        }
//
//        throw new UnsupportedOperationException("Unsupported split type: " + split.getClass().getSimpleName());
//    }
    ...
    public ConnectorPageSource createPageSource(
            ...
            DynamicFilter dynamicFilter)
    {
        if (connectorSplit instanceof FilesTable.FilesTableSplit filesTableSplit) {
            return new FilesTablePageSource(
                    typeManager,
                    fileSystemFactory.create(session.getIdentity(), Collections.emptyMap()),
                    filesTableSplit);
