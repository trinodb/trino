        ...
        extends BaseSystemTable
{
    ...
    public EntriesTable(TypeManager typeManager, SchemaTableName tableName, Table icebergTable)
    {
        super(
    ...
    protected void addRow(PageListBuilder pagesBuilder, StructLike structLike, TimeZoneKey timeZoneKey, Map<String, Integer> columnNameToPositionInSchema)
    {
        ...
        pagesBuilder.appendInteger(structLike.get(columnNameToPositionInSchema.get("status"), Integer.class));
        pagesBuilder.appendBigint(structLike.get(columnNameToPositionInSchema.get("snapshot_id"), Long.class));
        pagesBuilder.appendBigint(structLike.get(columnNameToPositionInSchema.get("sequence_number"), Long.class));
        pagesBuilder.appendBigint(structLike.get(columnNameToPositionInSchema.get("file_sequence_number"), Long.class));
        StructProjection dataFile = structLike.get(columnNameToPositionInSchema.get("data_file"), StructProjection.class);
        appendDataFile((RowBlockBuilder) pagesBuilder.nextColumn(), dataFile);
        ReadableMetricsStruct readableMetrics = structLike.get(columnNameToPositionInSchema.get("readable_metrics"), ReadableMetricsStruct.class);
