        ...
        implements Provider<Procedure>
{
            ...
            Optional<String> metadataFileName)
    {
        ...
        metadataLocation.ifPresent(RegisterTableProcedure::validateMetadataLocationArgument);
    ...
    private static void validateMetadataLocationArgument(String metadataLocation)
    {
        checkProcedureArgument(!metadataLocation.isEmpty(), "metadata_location cannot be empty when provided as an argument");
    }
