...
public class IcebergFileWriterFactory
{
    ...
    {
        return switch (fileFormat) {
            case PUFFIN -> createDeletionVectorWriter(fileSystem, outputPath, dataFilePath, partitionSpec, partition, previousDeleteFiles);
            ...
            Map<String, DeleteFileSet> previousDeleteFiles)
    {
        ...
        return new DeletionVectorWriter(fileSystem, outputPath, dataFilePath, partitionSpec, partition, previousDeleteLoader::apply, positionChannel);
    }
