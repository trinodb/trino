...
import static io.trino.plugin.iceberg.catalog.rest.SigV4AwsCredentialProvider.AWS_STS__ACCESS_KEY_ID;
        ...
        implements AwsProperties
{
    ...
    private static final String CLIENT_CREDENTIAL_AWS_ACCESS_KEY_ID = CLIENT_CREDENTIAL_PROVIDER_PREFIX + AWS_STS__ACCESS_KEY_ID;
    ...
    public SigV4AwsProperties(IcebergRestCatalogSigV4Config sigV4Config, S3FileSystemConfig s3Config)
    {
        ...
        if (s3Config.getIamRole() != null) {
            builder
                    ...
                    .put(CLIENT_CREDENTIAL_AWS_SIGNER_REGION, requireNonNull(s3Config.getRegion(), "s3.region is null"));
