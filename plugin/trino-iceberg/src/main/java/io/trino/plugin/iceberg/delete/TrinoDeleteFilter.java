        ...
        extends DeleteFilter<TrinoRow>
{
    ...
    private static Types.NestedField toNestedField(Schema tableSchema, IcebergColumnHandle columnHandle)
    {
        ...
        if (columnHandle.isDeleteRowIdColumn()) {
            return Types.NestedField.of(TRINO_DELETE_ROW_ID_COLUMN_ID, false, TRINO_DELETE_ROW_ID_COLUMN_NAME, Types.StructType.of());
        }
