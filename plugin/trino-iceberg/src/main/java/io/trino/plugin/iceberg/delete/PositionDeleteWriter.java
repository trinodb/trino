...
public class PositionDeleteWriter
{
            ...
            Map<String, String> storageProperties)
    {
        ...
        this.writer = fileWriterFactory.createPositionDeleteWriter(catalog, tableName, fileSystem, Location.of(outputPath), session, dataFilePath, icebergFileFormat, partitionSpec, partition, storageProperties);
    }
