...
public class PlaintextEncryptionManagerFactory
        implements EncryptionManagerFactory
{
    ...
    public EncryptionManager create(List<EncryptedKey> encryptionKeys, Map<String, String> tableProperties)
    {
        ...
        if (tableKeyId != null) {
            throw new TrinoException(ICEBERG_CATALOG_ERROR, "%s is not supported for plaintext encryption".formatted(ENCRYPTION_TABLE_KEY));
        }
