        ...
        implements ConnectorPageSink
{
            ...
            FileFormat fileFormat)
    {
        ...
        String fileName = fileFormat.addExtension("delete/position/" + randomUUID());
        ...
        this.writer = fileWriterFactory.createFileWriter(new Path(outputPath), POSITION_DELETE_SCHEMA, jobConf, session, hdfsContext, fileFormat, FileContent.POSITION_DELETES);
    }
