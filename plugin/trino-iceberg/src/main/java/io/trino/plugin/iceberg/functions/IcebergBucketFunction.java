...
public final class IcebergBucketFunction
{
    ...
    public static long icebergBucket(
            ...
            @SqlType(StandardTypes.INTEGER) long numberOfBuckets)
    {
        return Transforms.bucket((int) numberOfBuckets)
                .bind(Types.StringType.get())
                .apply(partitionValue != null ? partitionValue.toStringUtf8() : partitionValue);
    }
    ...
    public static long icebergBucket(
            ...
            @SqlType(StandardTypes.INTEGER) long numberOfBuckets)
    {
        return Transforms.bucket((int) numberOfBuckets).bind(Types.IntegerType.get()).apply((int) partitionValue);
    }
    ...
    public static long icebergBucket(
            ...
            @SqlType(StandardTypes.INTEGER) long numberOfBuckets)
    {
        return Transforms.bucket((int) numberOfBuckets).bind(Types.LongType.get()).apply(partitionValue);
    }
    ...
    public static long icebergBucketTimestamp(
            ...
            @SqlType(StandardTypes.INTEGER) long numberOfBuckets)
    {
        return Transforms.bucket((int) numberOfBuckets).bind(Types.TimestampType.withZone()).apply(partitionValue);
    }
            ...
            @SqlType(StandardTypes.INTEGER) long numberOfBuckets)
    {
        ...
        return Transforms.bucket((int) numberOfBuckets).bind(Types.DateType.get()).apply((int) partitionValue);
    }
}
