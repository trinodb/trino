...
record OssVendedCredentials(String accessKey, String secretKey, Optional<String> securityToken, Optional<Instant> expirationTime)
        implements VendedCredentials
{
    public OssVendedCredentials
    {
    ...
    public Map<String, String> toExtraCredentials()
    {
        ...
        securityToken.ifPresent(token -> builder.put(EXTRA_CREDENTIALS_SESSION_TOKEN_PROPERTY, token));
