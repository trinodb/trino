...
public class IcebergConfig
{
    ...
    @ConfigDescription("Number of threads to use for loading delete files (position deletes and equality deletes) in parallel per node, or 0 to load them on the thread reading the split")
