        ...
        implements ConnectorMergeSink
{
    ...
    private PositionDeleteWriter createPositionDeleteWriter(String dataFilePath, PartitionSpec partitionSpec, String partitionDataJson)
    {
        ...
        return new PositionDeleteWriter(dataFilePath, partitionSpec, partitionData, locationProvider, fileWriterFactory, fileSystem, jsonCodec, session, formatVersion, fileFormat, storageProperties, previousDeleteFiles);
    }
