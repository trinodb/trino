        ...
        implements ConnectorSplitSource
{
        ...
        return toCompletableFuture(Futures.transform(
                ...
                fileAwareScanTasks -> {
                    ...
                    for (FileAwareScanTask fileAwareScanTask : fileAwareScanTasks) {
                        ...
                        if (pruneFileScanTask(scanTask, dynamicFilterPredicate)) {
                            continue;
                        }
                        ...
                        splits.add(toIcebergSplit(scanTask));
                    }
    ...
    private boolean pruneFileScanTask(FileScanTask fileScanTask, TupleDomain<IcebergColumnHandle> dynamicFilterPredicate)
    {
