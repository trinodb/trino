        ...
        implements SecurityProperties
{
    ...
    @Inject
    public GoogleAuthProperties(GoogleSecurityConfig config, GcsFileSystemConfig gcsConfig)
    {
        properties = ImmutableMap.<String, String>builder()
                .put(AUTH_TYPE, AUTH_TYPE_GOOGLE)
                .put(GCP_CREDENTIALS_PATH_PROPERTY, requireNonNull(gcsConfig.getJsonKeyFilePath(), "gcs.json-key-file-path config property is required"))
