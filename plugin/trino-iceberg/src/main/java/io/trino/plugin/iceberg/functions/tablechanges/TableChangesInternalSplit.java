...
public record TableChangesInternalSplit(
...
{
    private static final int INSTANCE_SIZE = SizeOf.instanceSize(TableChangesInternalSplit.class);

    public TableChangesInternalSplit
    {
