        ...
        implements ConnectorTableHandle
{
    ...
    // Coordinator-only - table partitioning applied to the table splits
    private final Optional<IcebergTablePartitioning> requiredTablePartitioning;
    ...
    public IcebergTableHandle(
            ...
            Optional<IcebergTablePartitioning> requiredTablePartitioning,
            ...
            Optional<Boolean> forAnalyze)
    {
        ...
        this.requiredTablePartitioning = requireNonNull(requiredTablePartitioning, "requiredTablePartitioning is null");
    ...
    /**
     * Get the required partitioning for the table splits.
     */
    @JsonIgnore
    public Optional<IcebergTablePartitioning> getRequiredTablePartitioning()
    {
        return requiredTablePartitioning;
    }
