...
public class DynamoDbIcebergTableOperationsProvider
        implements IcebergTableOperationsProvider
{
    ...
    @Inject
    public DynamoDbIcebergTableOperationsProvider(FileIoProvider fileIoProvider, DynamoDbClientFactory dynamoDbClientFactory)
    {
    ...
    {
        return new DynamoDbIcebergTableOperations(
