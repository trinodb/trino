        ...
        implements SystemTable
{
    ...
    BaseSystemTable(Table icebergTable, ConnectorTableMetadata tableMetadata, MetadataTableType metadataTableType, ExecutorService executorService)
    {
    ...
    private List<Page> buildPages(ConnectorTableMetadata tableMetadata, ConnectorSession session, Table icebergTable, MetadataTableType metadataTableType)
    {
        ...
        TableScan tableScan = createMetadataTableInstance(icebergTable, metadataTableType).newScan().planWith(executorService);
