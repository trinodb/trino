        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testStatsWithPredicatePushdown()
    {
        ...
        Session session = Session.builder(getSession())
                .setSystemProperty(SystemSessionProperties.STATISTICS_PRECALCULATION_FOR_PUSHDOWN_ENABLED, "true")
                .build();
    ...
    public void testStatsWithJoinPushdown()
    {
        ...
        String query =
                """
                SELECT r."regionkey", r."name" "r_name", n."name" "n_name" FROM "region" r JOIN "nation" n ON r."regionkey" = n."regionkey" WHERE n."nationkey" = 5\
                """;
