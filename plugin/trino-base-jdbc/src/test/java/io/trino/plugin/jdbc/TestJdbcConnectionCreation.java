        ...
        extends BaseJdbcConnectionCreationTest
{
    ...
    public Object[][] testCases()
    {
        return new Object[][] {
                ...
                {"CREATE TABLE copy_of_nation AS SELECT * FROM nation", 7, Optional.empty()},
                {"INSERT INTO copy_of_nation SELECT * FROM nation", 7, Optional.empty()},
                {"DELETE FROM copy_of_nation WHERE nationkey = 3", 2, Optional.empty()},
