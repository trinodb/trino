...
public class TestingH2JdbcMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public TestingH2JdbcMetadataFactory(JdbcClient jdbcClient, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
    ...
    {
        return new TestingH2JdbcMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
