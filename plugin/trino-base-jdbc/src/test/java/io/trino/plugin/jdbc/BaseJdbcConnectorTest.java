        ...
        extends BaseConnectorTest
{
    ...
    /**
     * Must return a TestTable with schema short_decimal decimal(9, 3), long_decimal decimal(30, 10), a_bigint bigint, t_double double precision
     * populated with the provided rows.
     */
    protected TestTable createTableWithNumericTypes(String name, List<String> rows)
    {
        return new TestTable(onRemoteDatabase(), name, "(short_decimal decimal(9, 3), long_decimal decimal(30, 10), a_bigint bigint, t_double double precision)", rows);
    }
