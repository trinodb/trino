        ...
        extends BaseConnectorTest
{
            ...
            throws Throwable
    {
        ...
        List<RemoteDatabaseEvent> remoteEvents = captureRemoteEventsDuring(() -> {
    ...
    private QueryId getQueryId(String sqlPattern)
    {
        ...
        assertEventually(() -> {
            MaterializedResult queriesResult = getQueryRunner().execute(format(
                    "SELECT query_id FROM system.runtime.queries WHERE state = 'RUNNING' AND query LIKE '%%%s%%' AND query NOT LIKE '%%system.runtime.queries%%'",
                    sqlPattern));
