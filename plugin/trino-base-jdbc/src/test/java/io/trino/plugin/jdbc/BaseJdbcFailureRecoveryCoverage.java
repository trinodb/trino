...
import io.trino.testing.BaseFailureRecoveryCoverage;
...
public abstract class BaseJdbcFailureRecoveryCoverage
        extends BaseFailureRecoveryCoverage
{
    public BaseJdbcFailureRecoveryCoverage(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
