        ...
        extends AbstractTestQueryFramework
{
            ...
            implements ConnectionFactory
    {
                ...
                throws SQLException
        {
            ...
            if (previous != null) {
                IllegalStateException exception = new IllegalStateException("Same connection %s returned twice from delegate".formatted(connection));
            ...
            return new ForwardingConnection()
            {
                        ...
                        throws SQLException
                {
                    ...
                    closed = true;
                    verify(connectionCreations.remove(connection) != null, "Connection was not created in with this factory: " + connection);
                    super.close();
                }
            };
        }
