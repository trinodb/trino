        ...
        implements JdbcMetadata
{
    ...
    public DefaultJdbcMetadata(JdbcClient jdbcClient, boolean precalculateStatisticsForPushdown, Set<QueryEventListener> queryEventListeners)
    {
    ...
    {
        onQueryEvent(queryEventListener -> queryEventListener.beginQuery(session), "Query begin failed");
    }
    ...
    private void onQueryEvent(Consumer<QueryEventListener> queryEventListenerConsumer, String errorMessage)
    {
        List<RuntimeException> exceptions = new ArrayList<>();
        for (QueryEventListener queryEventListener : queryEventListeners) {
            try {
                queryEventListenerConsumer.accept(queryEventListener);
            }
