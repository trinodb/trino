            ...
            DynamicFilter dynamicFilter)
    {
        ...
        for (ColumnHandle columnHandle : columns) {
            if (columnHandle.equals(mergeRowId.get())) {
                ...
                columnAdaptationsBuilder.add(ColumnAdaptation.sourceColumn(scanColumns.indexOf(columnHandle)));
            }
        }
