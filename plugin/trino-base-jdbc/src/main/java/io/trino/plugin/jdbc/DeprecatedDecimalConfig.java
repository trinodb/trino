...
/**
 * A {@link DecimalConfig}, similar to {@link LegacyDecimalConfig}, but with all configuration properties deprecated.
 */
public class DeprecatedDecimalConfig
        implements DecimalConfig
{
    private DecimalMapping decimalMapping = DecimalMapping.MAP_TO_NUMBER;
