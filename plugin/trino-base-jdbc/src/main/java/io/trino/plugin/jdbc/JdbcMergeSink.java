        ...
        implements ConnectorMergeSink
{
            ...
            ConnectorPageSinkId pageSinkId)
    {
        ...
        this.mergeRowIdConjuncts = jdbcClient.buildMergeRowIdConjuncts(session, mergeRowIdFieldNames, mergeRowIdFieldTypes);
    ...
    private List<Integer> getReservedChannelsForUpdate(JdbcOutputTableHandle outputTableHandle)
    {
