        ...
        implements QueryBuilder
{
            ...
            Map<JdbcColumnHandle, String> rightAssignments)
    {
        ...
        String query = format(
                ...
                rightRelationAlias,
                formatJoinConditions(client, leftRelationAlias, rightRelationAlias, joinConditions));
    ...
    public List<String> toConjuncts(
            JdbcClient client,
            ConnectorSession session,
            Connection connection,
            TupleDomain<ColumnHandle> tupleDomain,
    ...
    public String toPredicate(JdbcClient client, JdbcColumnHandle column, JdbcTypeHandle jdbcType, Type type, WriteFunction writeFunction, String operator, Object value, Consumer<QueryParameter> accumulator)
    {
        accumulator.accept(new QueryParameter(jdbcType, type, Optional.of(value)));
    ...
    protected WriteFunction getWriteFunction(JdbcClient client, ConnectorSession session, Connection connection, JdbcTypeHandle jdbcType, Type type)
    {
