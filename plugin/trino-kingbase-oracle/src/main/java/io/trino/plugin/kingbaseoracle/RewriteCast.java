...
import static io.trino.plugin.kingbaseoracle.KingbaseOracleClient.ORACLE_CHAR_MAX_CHARS;
import static io.trino.plugin.kingbaseoracle.KingbaseOracleClient.ORACLE_VARCHAR2_MAX_CHARS;
...
//        }
        if (targetType instanceof VarcharType varcharType) {
            ...
            return Optional.of(new JdbcTypeHandle(
                    jdbcType,
                    Optional.of(varcharType.getBaseName()),
