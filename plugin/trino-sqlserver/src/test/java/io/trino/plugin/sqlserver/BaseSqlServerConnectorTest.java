        ...
        extends BaseJdbcConnectorTest
{
    ...
    public void testDeleteWithVarcharInequalityPredicate()
    {
        ...
        try (TestTable table = createTable("test_delete_varchar", "(col varchar(1))", ImmutableList.of("'a'", "'A'", "null"))) {
    ...
    public void testConstantUpdateWithVarcharInequalityPredicates()
    {
        ...
        try (TestTable table = createTable("test_update_varchar", "(col1 INT, col2 varchar(1))", ImmutableList.of("1, 'a'", "2, 'A'"))) {
