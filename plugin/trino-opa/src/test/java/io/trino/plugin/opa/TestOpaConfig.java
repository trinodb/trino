...
final class TestOpaConfig
{
    ...
    void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                ...
                .put("opa.additional-context-properties", "src/test/resources/additional-context.properties")
                .buildOrThrow();
        ...
        OpaConfig expected = new OpaConfig()
                ...
                .setAdditionalContextFile(new File("src/test/resources/additional-context.properties"));
