...
public class TestOpaAccessControl
{
    ...
    /**
     * `SystemAccessControl#getColumnMask` is deprecated in favour of `getTableColumnMasks`.
    ...
    {
        testGetTableColumnMasks(ImmutableMap.of(createColumnSchema("some-column"), "{}"), ImmutableMap.of());

        String nullResponse = """
                {
                    "result": null
                }""";
        testGetTableColumnMasks(ImmutableMap.of(createColumnSchema("some-column"), nullResponse), ImmutableMap.of());
    ...
    @Test
    public void testGetTableColumnMaskDoesNothingIfNotConfigured()
    {
        InstrumentedHttpClient httpClient = createMockHttpClient(
                OPA_SERVER_URI,
                request -> {
    ...
    @Test
    public void testGetTableColumnMaskThrowsForIllegalResponse()
    {
    ...
    private void testGetTableColumnMasks(Map<ColumnSchema, String> columnResponseContent, Map<ColumnSchema, OpaViewExpression> expectedResult)
    {
        InstrumentedHttpClient httpClient = createMockHttpClient(
                OPA_COLUMN_MASKING_URI,
