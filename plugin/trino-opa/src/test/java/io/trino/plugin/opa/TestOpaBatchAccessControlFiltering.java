...
public class TestOpaBatchAccessControlFiltering
{
    ...
    public static final OpaConfig OPA_CONFIG_NO_CHUNKING = batchFilteringOpaConfig();
    public static final OpaConfig OPA_CONFIG_CHUNKING_SIZE_2 = batchFilteringOpaConfig().setOpaBatchSize(2);
    public static final OpaConfig OPA_CONFIG_CHUNKING_SIZE_3 = batchFilteringOpaConfig().setOpaBatchSize(3);
    public static final OpaConfig OPA_CONFIG_CHUNKING_SIZE_100 = batchFilteringOpaConfig().setOpaBatchSize(100);
    ...
    public void testFilterViewQueryOwnedBy()
    {
        ...
        List<TestCase> testCases = ImmutableList.of(
                new TestCase(OPA_CONFIG_NO_CHUNKING, ImmutableMap.of(11, 1),1),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_2, ImmutableMap.of(2, 5,1, 1),6),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_3, ImmutableMap.of(3, 3,2, 1),4),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_100, ImmutableMap.of(11, 1),1)
        );
    ...
    public void testFilterCatalogs()
    {
        ...
        Function<String, JsonNode> catalogToJsonNode = e -> toJsonNode(
                ...
                """.formatted(e));
        List<TestCase> testCases = ImmutableList.of(new TestCase(OPA_CONFIG_NO_CHUNKING, ImmutableMap.of(11, 1),1),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_2, ImmutableMap.of(2, 5,1, 1),6),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_3, ImmutableMap.of(3, 3,2, 1),4),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_100, ImmutableMap.of(11, 1),1)
        );
    ...
    public void testFilterTables()
    {
        ...
        List<TestCase> testCases = ImmutableList.of(new TestCase(OPA_CONFIG_NO_CHUNKING, ImmutableMap.of(12, 1),1),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_2, ImmutableMap.of(2, 6),6),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_3, ImmutableMap.of(3, 4),4),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_100, ImmutableMap.of(12, 1),1)
        );
    ...
    public void testFilterColumns()
    {
        ...
        List<TestCase> testCases = ImmutableList.of(new TestCase(OPA_CONFIG_NO_CHUNKING, ImmutableMap.of(12, 1, 10,1, 7,1),3),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_2, ImmutableMap.of(2, 6+ 5 + 3, 1, 1),6 + 5 + 4),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_3, ImmutableMap.of(3, 4 + 3 + 2, 1,2),4 + 4 + 3),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_100, ImmutableMap.of(12, 1, 10,1, 7,1),3)
        );
    ...
    public void testFilterFunctions()
    {
        ...
        List<TestCase> testCases = ImmutableList.of(new TestCase(OPA_CONFIG_NO_CHUNKING, ImmutableMap.of(14,1),1),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_2, ImmutableMap.of(2, 7),7),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_3, ImmutableMap.of(3, 4, 2,1),5),
                new TestCase(OPA_CONFIG_CHUNKING_SIZE_100, ImmutableMap.of(14, 1),1)
        );
    ...
    private static void assertFilteringAccessControlMethodDoesNotSendRequests(Function<OpaAccessControl, Collection<?>> method)
    {
        ...
        assertThat(method.apply(createOpaAuthorizer(batchFilteringOpaConfig().setOpaBatchSize(2), httpClientForEmptyRequest))).isEmpty();
