...
public class InMemoryBlobCacheConfig
{
    @VisibleForTesting
    ...
    public InMemoryBlobCacheConfig setCacheTtl(Duration ttl)
    {
        this.ttl = ttl;
        return this;
    }
    ...
    public InMemoryBlobCacheConfig setMaxSize(DataSize maxSize)
    {
    ...
    public InMemoryBlobCacheConfig setMaxContentLength(DataSize maxContentLength)
    {
