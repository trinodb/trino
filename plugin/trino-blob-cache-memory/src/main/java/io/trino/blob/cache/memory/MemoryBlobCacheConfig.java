...
public class MemoryBlobCacheConfig
{
    @VisibleForTesting
    ...
    public MemoryBlobCacheConfig setCacheTtl(Duration ttl)
    {
        this.ttl = ttl;
        return this;
    }
    ...
    public MemoryBlobCacheConfig setMaxSize(DataSize maxSize)
    {
    ...
    public MemoryBlobCacheConfig setMaxContentLength(DataSize maxContentLength)
    {
