...
import static io.trino.blob.cache.memory.MemoryBlobCacheConfig.DEFAULT_CACHE_SIZE;
import static java.util.concurrent.TimeUnit.HOURS;

public class TestMemoryBlobCacheConfig
{
    @Test
    void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(MemoryBlobCacheConfig.class)
            ...
            throws IOException
    {
        ...
        MemoryBlobCacheConfig expected = new MemoryBlobCacheConfig()
