...
import static io.trino.blob.cache.memory.InMemoryBlobCacheConfig.DEFAULT_CACHE_SIZE;
import static java.util.concurrent.TimeUnit.HOURS;

public class TestInMemoryBlobCacheConfig
{
    @Test
    void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(InMemoryBlobCacheConfig.class)
            ...
            throws IOException
    {
        ...
        InMemoryBlobCacheConfig expected = new InMemoryBlobCacheConfig()
