        ...
        extends BaseJdbcClient
{
    ...
    @Inject
    public MemSqlClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, TypeManager typeManager, QueryBuilder queryBuilder, IdentifierMapping identifierMapping)
    {
