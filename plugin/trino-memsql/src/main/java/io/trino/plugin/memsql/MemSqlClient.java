    ...
    public Optional<ColumnMapping> toColumnMapping(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        switch (typeHandle.getJdbcType()) {
            ...
            case Types.DATE:
                return Optional.of(ColumnMapping.longMapping(
                        DATE,
                        // TODO: Use 'StandardColumnMappings.dateReadFunctionUsingLocalDate' after merged https://github.com/trinodb/trino/pull/10054
                        (resultSet, columnIndex) -> resultSet.getObject(columnIndex, LocalDate.class).toEpochDay(),
                        dateWriteFunction()));
            case Types.TIME:
