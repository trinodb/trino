...
import static io.trino.plugin.cockroachdb.CockroachDbConfig.ArrayMapping.AS_ARRAY;
import static io.trino.plugin.cockroachdb.CockroachDbConfig.ArrayMapping.AS_JSON;
import static io.trino.plugin.cockroachdb.CockroachDbConfig.ArrayMapping.DISABLED;
...
public class TestCockroachDbTypeMapping
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        return createCockroachDbQueryRunner(
                cockroachDbServer,
                ImmutableMap.of(),
    ...
    public void setUp()
    {
        ...
        JdbcSqlExecutor executor = new JdbcSqlExecutor(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties());
    ...
    public void testReal()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("real", "'+Infinity'::real", REAL, "CAST(+infinity() AS real)")
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_real"));
    ...
    public void testDouble()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("double precision", "'-Infinity'::double precision", DOUBLE, "-infinity()")
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_double"));
    ...
    public void testDecimal()
    {
        SqlDataTypeTest.create()
                ...
                .addRoundTrip("decimal(38, 0)", "CAST('-27182818284590452353602874713526624977' AS decimal(38, 0))", createDecimalType(38, 0), "CAST('-27182818284590452353602874713526624977' AS decimal(38, 0))")
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("test_decimal"))
    ...
    public void testChar()
    {
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("test_char"))
    ...
    @Test
    public void testCockroachDbCreatedVarchar()
    {
        varcharDataTypeTest(DataType::varcharDataType)
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("test_varchar"));
    ...
    public void testVarbinary()
    {
        ...
        SqlDataTypeTest.create()
                ...
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("test_varbinary"));
    ...
    {
        JdbcSqlExecutor jdbcSqlExecutor = new JdbcSqlExecutor(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties());
    ...
    public void testArrayDisabled()
    {
        Session session = Session.builder(getSession())
                .setCatalogSessionProperty("cockroachdb", CockroachDbSessionProperties.ARRAY_MAPPING, DISABLED.name())
                .build();
    ...
    public void testArray()
    {
        ...
        arrayDateTest(TestCockroachDbTypeMapping::arrayDataType)
                .execute(getQueryRunner(), session, trinoCreateAsSelect(session, "test_array_date"));
        arrayDateTest(TestCockroachDbTypeMapping::cockroachdbArrayDataType)
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_date"));

        arrayDecimalTest(TestCockroachDbTypeMapping::arrayDataType)
                .execute(getQueryRunner(), session, trinoCreateAsSelect(session, "test_array_decimal"));
        arrayDecimalTest(TestCockroachDbTypeMapping::cockroachdbArrayDataType)
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_decimal"));

        arrayVarcharDataTypeTest(TestCockroachDbTypeMapping::arrayDataType)
                .execute(getQueryRunner(), session, trinoCreateAsSelect(session, "test_array_varchar"));
        arrayVarcharDataTypeTest(TestCockroachDbTypeMapping::cockroachdbArrayDataType)
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_varchar"));
        ...
        arrayUnicodeDataTypeTest(TestCockroachDbTypeMapping::arrayDataType, DataType::charDataType)
                .execute(getQueryRunner(), session, trinoCreateAsSelect(session, "test_array_parameterized_char_unicode"));
        arrayUnicodeDataTypeTest(TestCockroachDbTypeMapping::cockroachdbArrayDataType, DataType::charDataType)
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_parameterized_char_unicode"));
        arrayVarcharUnicodeDataTypeTest(TestCockroachDbTypeMapping::arrayDataType)
                .execute(getQueryRunner(), session, trinoCreateAsSelect(session, "test_array_parameterized_varchar_unicode"));
        arrayVarcharUnicodeDataTypeTest(TestCockroachDbTypeMapping::cockroachdbArrayDataType)
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_parameterized_varchar_unicode"));
    }
    ...
    public void testInternalArray()
    {
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), sessionWithArrayAsArray(), cockroachdbCreateAndInsert("test_array_with_native_name"));
    }
    ...
    {
        Session session = Session.builder(getSession())
                .setSystemProperty("cockroachdb.array_mapping", AS_JSON.name())
                .build();
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_boolean_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_integer_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_double_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_real_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_varchar_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_timestamp_array_as_json"));
        ...
        DataTypeTest.create()
                ...
                .execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_hstore_array_as_json"));
    }
    ...
    private static <E> DataType<List<E>> cockroachdbArrayDataType(DataType<E> elementType)
    {
    ...
    private static DataType<String> hstoreArrayAsJsonDataType()
    {
        return dataType(
                ...
                json -> HSTORE_CODEC.fromJson(json).stream()
                        .map(TestCockroachDbTypeMapping::hstoreLiteral)
    ...
    public void testDate()
    {
        ...
        for (String timeZoneId : ImmutableList.of(UTC_KEY.getId(), jvmZone.getId(), someZone.getId())) {
            Session session = Session.builder(getSession())
                    ...
                    .build();
            testCases.execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_date"));
    ...
    public void testTime(boolean insertWithTrino, ZoneId sessionZone)
    {
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_time"));
        }
    }
...
//                    .isNotFullyPushedDown(AggregationNode.class);
    ...
    public void testTimestamp(boolean insertWithTrino, ZoneId sessionZone)
    {
        ...
        // no need to test gap for multiple precisions as both Trino and CockroachDb JDBC
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_timestamp"));
        }
    }
    ...
    public void testArrayTimestamp(boolean insertWithTrino, ZoneId sessionZone)
    {
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), session, cockroachdbCreateAndInsert("test_array_timestamp"));
        }
    }
    ...
    public void testTimestampWithTimeZone(boolean insertWithTrino)
    {
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), cockroachdbCreateAndInsert("test_timestamp_with_time_zone"));
        }
    }
    ...
    public void testArrayTimestampWithTimeZone(boolean insertWithTrino)
    {
        ...
        if (insertWithTrino) {
            ...
            tests.execute(getQueryRunner(), sessionWithArrayAsArray(), cockroachdbCreateAndInsert("test_array_timestamp_with_time_zone"));
        }
    }
    ...
    public void testJson()
    {
        jsonTestCases(jsonDataType())
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_json"));
    ...
    public void testJsonb()
    {
        jsonTestCases(jsonbDataType())
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_jsonb"));
    }
    ...
    public void testHstore()
    {
        hstoreTestCases(hstoreDataType())
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_hstore"));

        hstoreTestCases(varcharMapDataType())
                .execute(getQueryRunner(), cockroachdbCreateTrinoInsert("cockroachdb_test_hstore"));
    }
    ...
    public void testUuid()
    {
        uuidTestCases(uuidDataType())
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("cockroachdb_test_uuid"));
    ...
    public void testMoney()
    {
        DataTypeTest.create(true)
                ...
                .execute(getQueryRunner(), cockroachdbCreateAndInsert("trino_test_money"));
    }
    ...
    private void testUnsupportedDataTypeConvertedToVarchar(Session session, String dataTypeName, String internalDataTypeName, String databaseValue, String trinoValue)
    {
        ...
        try (TestTable table = new TestTable(
            ...
            Session convertToVarchar = Session.builder(session)
                    .setCatalogSessionProperty("cockroachdb", UNSUPPORTED_TYPE_HANDLING, CONVERT_TO_VARCHAR.name())
                    .build();
            assertQuery(
                    convertToVarchar,
    ...
    public static DataType<ZonedDateTime> timestampWithTimeZoneDataType(int precision, boolean insertWithTrino)
    {
        if (insertWithTrino) {
            ...
            return cockroachDbTimestampWithTimeZoneDataType(precision);
        }
    }
    ...
    public static DataType<ZonedDateTime> cockroachDbTimestampWithTimeZoneDataType(int precision)
    {
        return dataType(
                format("timestamp(%d) with time zone", precision),
                createTimestampWithTimeZoneType(precision),
    ...
    public static DataType<List<ZonedDateTime>> arrayOfTimestampWithTimeZoneDataType(int precision, boolean insertWithTrino)
    {
        if (insertWithTrino) {
            ...
            return arrayDataType(cockroachDbTimestampWithTimeZoneDataType(precision), format("timestamptz(%d)[]", precision));
        }
    }
    ...
    private DataType<Map<String, String>> hstoreDataType()
    {
        return dataType(
                ...
                TestCockroachDbTypeMapping::hstoreLiteral);
    }
    ...
    private DataSetup cockroachdbCreateAndInsert(String tableNamePrefix)
    {
        return new CreateAndInsertDataSetup(new JdbcSqlExecutor(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties()), tableNamePrefix);
    }

    private DataSetup cockroachdbCreateTrinoInsert(String tableNamePrefix)
    {
        return new CreateAndTrinoInsertDataSetup(new JdbcSqlExecutor(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties()), new TrinoSqlExecutor(getQueryRunner()), tableNamePrefix);
    }
