...
import static io.trino.plugin.cockroachdb.CockroachDbQueryRunner.createCockroachDbQueryRunner;
        ...
        extends BaseJdbcConnectorTest
{
            ...
            throws Exception
    {
        ...
        return createCockroachDbQueryRunner(cockroachDbServer, Map.of(), Map.of(), REQUIRED_TPCH_TABLES);
    }
    ...
    protected boolean hasBehavior(TestingConnectorBehavior connectorBehavior)
    {
        switch (connectorBehavior) {
            ...
            case SUPPORTS_ARRAY:
                ...
                return new CockroachDbConfig().getArrayMapping() != CockroachDbConfig.ArrayMapping.DISABLED;
    ...
    protected TestTable createTableWithDefaultColumns()
    {
        return new TestTable(
                new JdbcSqlExecutor(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties()),
                "table",
    ...
    @Test
    public void testCockroachDbMaterializedView()
            throws Exception
    {
    ...
    public void testPredicatePushdown()
    {
        ...
        assertThat(query(
                Session.builder(getSession())
                        .setCatalogSessionProperty("cockroachdb", "domain_compaction_threshold", "1")
                        .build(),
    ...
    public void testTopNWithEnum()
    {
        ...
        cockroachDbServer.execute("CREATE TYPE " + enumType + " AS ENUM ('A', 'b', 'B', 'a')");
        try (TestTable testTable = new TestTable(
            ...
            cockroachDbServer.execute("DROP TYPE " + enumType);
        }
    }
    ...
    private void execute(String sql)
            throws SQLException
    {
        try (Connection connection = DriverManager.getConnection(cockroachDbServer.getJdbcUrl(), cockroachDbServer.getProperties());
    ...
    {
        return cockroachDbServer.getRemoteDatabaseEvents();
    }
