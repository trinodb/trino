...
public class CockroachDbConfig
{
    ...
    @Config("cockroachdb.array-mapping")
    @LegacyConfig("cockroachdb.experimental.array-mapping")
    public CockroachDbConfig setArrayMapping(ArrayMapping arrayMapping)
    {
    ...
    @Config("cockroachdb.include-system-tables")
    public CockroachDbConfig setIncludeSystemTables(boolean includeSystemTables)
    {
