        ...
        implements FunctionProvider
{
    ...
    private static final List<FunctionMetadata> FUNCTIONS = ImmutableList.<FunctionMetadata>builder()
            ...
            .add(function("ai_mask")
                    ...
                    .signature(signature(TEXT, TEXT, arrayType(TEXT)))
                    .build())
            .add(function("ai_similarity")
                    .description("Calculate the similarity between two strings")
                    .signature(signature(DOUBLE.getTypeSignature(), TEXT, TEXT))
                    .build())
    ...
    private static final MethodHandle AI_SIMILARITY;
    ...
    static {
        try {
            ...
            AI_SIMILARITY = lookup().findVirtual(AiFunctions.class, "aiSimilarity", methodType(double.class, Slice.class, Slice.class));
            ...
            InvocationConvention invocationConvention)
    {
        ...
        MethodHandle handle = switch (name) {
            ...
            case "ai_similarity" -> AI_SIMILARITY;
    ...
    public double aiSimilarity(Slice text1, Slice text2)
    {
        return client.similarity(text1.toStringUtf8(), text2.toStringUtf8());
    }
