...
import io.trino.plugin.jdbc.BaseJdbcFailureRecoveryCoverage;
...
public abstract class BaseMariaDbFailureRecoveryCoverage
        extends BaseJdbcFailureRecoveryCoverage
{
    public BaseMariaDbFailureRecoveryCoverage(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
