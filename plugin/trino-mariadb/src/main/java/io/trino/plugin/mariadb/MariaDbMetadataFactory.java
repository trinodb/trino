...
public class MariaDbMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    ...
    @Inject
    public MariaDbMetadataFactory(JdbcClient jdbcClient, TimestampTimeZoneDomain timestampTimeZoneDomain, Set<JdbcQueryEventListener> jdbcQueryEventListeners, IdentityCacheMapping identityCacheMapping)
    {
    ...
    {
        return new MariaDbMetadata(transactionCachingJdbcClient, timestampTimeZoneDomain, jdbcQueryEventListeners);
    }
}
