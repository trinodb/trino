        ...
        implements TablePropertiesProvider
{
    ...
    @Inject
    public StarRocksTableProperties(StarRocksConfig starRocksConfig)
    {
        tableProperties = ImmutableList.of(
                enumProperty(
                        ENGINE_PROPERTY,
                        "StarRocks Table Engine, defaults to OLAP",
                        StarRocksEngineType.class,
                        StarRocksEngineType.OLAP,
                        false),
                ...
                integerProperty(
                        REPLICATION_NUM,
                        "Value of StarRocks OLAP table data replication number",
