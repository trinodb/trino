...
public class TestStarRocksTypeMapping
        extends AbstractTestQueryFramework
{
    private TestingStarRocksServer starRocksServer;
    ...
    {
        return new StarRocksCreateAndInsertDataSetup(starRocksServer::execute, tableNamePrefix);
    }
