...
public class TestingStarRocksServer
        implements AutoCloseable
{
    private final TestingStarRocksContainer container;

    public TestingStarRocksServer()
    {
        container = new TestingStarRocksContainer();
        container.start();
