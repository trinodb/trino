...
public final class StarRocksQueryRunner
{
    ...
    public static DistributedQueryRunner createStarRocksQueryRunner(
            TestingStarRocksServer server,
    ...
    public static void main(String[] args)
            throws Exception
    {
        DistributedQueryRunner queryRunner = createStarRocksQueryRunner(
                new TestingStarRocksServer(),
                ImmutableMap.of("http-server.http.port", "8080"),
                ImmutableMap.of(),
                TpchTable.getTables());

        Logger log = Logger.get(StarRocksQueryRunner.class);
