        ...
        implements Closeable
{
    ...
    private void checkSizeEstimatesTableExist()
    {
        ...
        keyspaceMetadata.map(metadata -> metadata.getTable(SIZE_ESTIMATES))
                .orElseThrow(() -> new TrinoException(NOT_SUPPORTED, "Cassandra versions prior to 2.1.5 are not supported"));
    }
