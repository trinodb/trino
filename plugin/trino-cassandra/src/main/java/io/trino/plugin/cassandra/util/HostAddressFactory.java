...
public class HostAddressFactory
{
    ...
    public HostAddress toHostAddress(Node node)
    {
        ...
        if (address instanceof InetSocketAddress) {
            ...
            throw new TrinoException(GENERIC_INTERNAL_ERROR, format("Only endpoints which resolve to a InetSocketAddress are supported. Resolving to socket addresses of type %s is not supported", address.getClass().getName()));
        }
    }
