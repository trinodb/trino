...
public class CassandraSslModule
        implements Module
{
    @Override
    public void configure(Binder binder)
    {
        configBinder(binder).bindConfig(CassandraSslConfig.class);
    }

    @ProvidesIntoSet
    @Singleton
    public CassandraSessionConfigurator sslSpecificConfigurator(CassandraSslConfig config)
    {
