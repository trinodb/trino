...
public class TestLdapGroupProviderIntegration
{
    ...
    private static final ConfigBuilder WITH_GROUP_FILTER_MATCHING_RULE_WITHOUT_NESTED = builder -> {
        builder.put("ldap.use-group-filter", "true");
        builder.put("ldap.group-base-dn", "ou=groups,dc=trino,dc=testldap,dc=com");
        builder.put("ldap.group-search-nested-use-matching-rule-in-chain", "true");
        return builder;
    };
    ...
    public void testGetGroups()
    {
        ...
        assertGetGroups(WITH_GROUP_FILTER_MATCHING_RULE_WITHOUT_NESTED, "alicea", ImmutableSet.of("clients", "developers", "qualityAssurance"));
