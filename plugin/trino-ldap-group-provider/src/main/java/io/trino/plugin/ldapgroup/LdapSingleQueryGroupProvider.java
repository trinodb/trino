        ...
        implements GroupProvider
{
    ...
    /**
     * Perform an LDAP search for user, getting the DN and {@link LdapSingleQueryGroupProviderConfig#getLdapUserMemberOfAttribute()}.
     ...
     * @return The relative domain name of all the values of attribute {@link LdapSingleQueryGroupProviderConfig#getLdapUserMemberOfAttribute()}.
     */
    @Override
    ...
    private Optional<String> getGroupRelativeDN(String groupDistinguishedName)
    {
