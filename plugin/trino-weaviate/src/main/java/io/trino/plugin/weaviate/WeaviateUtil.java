...
public final class WeaviateUtil
{
    private WeaviateUtil() {}

    static final WeaviateColumnHandle UUID = new WeaviateColumnHandle(Property.text("_uuid"), true);
    static final WeaviateColumnHandle CREATED_AT = new WeaviateColumnHandle(Property.date("$created_at"), true);
    static final WeaviateColumnHandle LAST_UPDATED_AT = new WeaviateColumnHandle(Property.date("$last_updated_at"), true);
    ...
    static Type toTrinoType(Property property)
    {
    ...
    static Type toTrinoType(Map<String, VectorConfig> vectors)
    {
