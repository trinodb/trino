...
public class TestWeaviateConnectorTest
        extends BaseConnectorTest
{
    ...
    static final OffsetDateTime NOW = OffsetDateTime.of(6, 5, 4, 3, 2, 1, 0, ZoneOffset.UTC);
            ...
            throws Exception
    {
        ...
        return WeaviateQueryRunner.builder(server).build();
    }
    ...
    {
        assertQuery("SELECT date(prop_date) FROM " + COLLECTION_NO_TENANT, "SELECT '%s'".formatted(NOW.toLocalDate().toString()));
    }
    ...
    protected boolean hasBehavior(TestingConnectorBehavior connectorBehavior)
    {
        return switch (connectorBehavior) {
            case SUPPORTS_LIMIT_PUSHDOWN,
                 SUPPORTS_ROW_TYPE,
                 SUPPORTS_ARRAY,
                 SUPPORTS_COMMENT_ON_TABLE -> true;
