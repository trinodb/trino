...
import static io.trino.plugin.weaviate.TestWeaviateConnectorTest.NOW;
import static io.trino.plugin.weaviate.WeaviateUtil.BOOL_ARRAY;
import static io.trino.plugin.weaviate.WeaviateUtil.DATE_ARRAY;
import static io.trino.plugin.weaviate.WeaviateUtil.GEO_COORDINATES;
import static io.trino.plugin.weaviate.WeaviateUtil.INT_ARRAY;
import static io.trino.plugin.weaviate.WeaviateUtil.MULTI_VECTOR;
import static io.trino.plugin.weaviate.WeaviateUtil.NUMBER_ARRAY;
import static io.trino.plugin.weaviate.WeaviateUtil.PHONE_NUMBER;
import static io.trino.plugin.weaviate.WeaviateUtil.SINGLE_VECTOR;
import static io.trino.plugin.weaviate.WeaviateUtil.TEXT_ARRAY;
...
public class TestDecoder
{
    ...
    private static void checkPrimitiveValue(Object actual, Object expected, String fieldName)
    {
        ...
        else if (actual instanceof SqlTimestamp sqlTimestamp) {
            Assertions.assertThat(sqlTimestamp.getEpochMicros())
