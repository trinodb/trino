        ...
        implements MultiBucketsAggregation
{
    ...
    @Override
    protected XContentBuilder doXContentBody(XContentBuilder builder, ToXContent.Params params)
            throws IOException
    {
        if (keyed) {
    ...
    public abstract static class ParsedBucket
            implements MultiBucketsAggregation.Bucket
    {
        ...
        protected XContentBuilder keyToXContent(XContentBuilder builder)
                throws IOException
        {
            return builder.field(Aggregation.CommonFields.KEY.getPreferredName(), getKey());
        }
                ...
                throws IOException
        {
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                if (token == XContentParser.Token.FIELD_NAME) {
                    ...
                    else if (Aggregation.CommonFields.KEY.getPreferredName().equals(currentFieldName)) {
                        keyConsumer.accept(parser, bucket);
                    }
                    else if (Aggregation.CommonFields.DOC_COUNT.getPreferredName().equals(currentFieldName)) {
