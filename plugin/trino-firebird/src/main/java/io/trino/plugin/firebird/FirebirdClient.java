        ...
        extends BaseJdbcClient
{
    ...
    protected String getTableSchemaName(ResultSet resultSet)
            throws SQLException
    {
        // FIXME: this is necessary if we want to pass the 'testShowTables()' test.
        return schemaName;
    }
    ...
    {
        // Deactivated because test 'testJoinPushdown()' requires write access which is not implemented for Firebird
        return false;
    }
    ...
    {
        // Deactivated because test 'testCaseSensitiveAggregationPushdown()' requires write access which is not implemented for Firebird
