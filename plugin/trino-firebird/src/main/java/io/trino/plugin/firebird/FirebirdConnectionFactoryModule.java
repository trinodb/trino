...
public class FirebirdConnectionFactoryModule
        extends AbstractConfigurationAwareModule
{
    ...
    {
        return new FirebirdConnectionFactory(DriverConnectionFactory.builder(new FBDriver(), config.getConnectionUrl(), credentialProvider)
