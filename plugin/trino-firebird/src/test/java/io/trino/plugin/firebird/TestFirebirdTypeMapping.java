        ...
        extends AbstractTestQueryFramework
{
    ...
    @Test
    @Disabled // FIXME: Cant run this test without an SQL Error after table creation on data insertion and before any query assertion.
    void testCompareDecimal38()
    {
        try (TestTable testTable = new TestTable(
                firebirdServer::execute,
    ...
    @Test
    @Disabled // FIXME: Cant run this test without an SQL Error on table creation and before any query assertion.
    ...
    {
        return new CreateAndInsertDataSetup(firebirdServer.getSqlExecutor(), tableNamePrefix);
    }
