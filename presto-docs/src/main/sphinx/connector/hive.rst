...
`Alluxio CLI attachdb command <https://docs.alluxio.io/os/user/stable/en/operation/User-CLI.html#attachdb?utm_source=prestosql&utm_medium=prestodocs>`_.
...
For example, your ``etc/catalog/catalog_alluxio.properties`` includes
the following:
