...
``hive.metastore.glue.external-id``                  Optional information in an IAM role trust policy when
                                                     connecting to the Glue Catalog.
==================================================== ============================================================
...
``hive.s3.external-id``                      Optional information in an IAM role trust policy.
